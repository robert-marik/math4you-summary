...
\LANGes{
\Question{
El segundo término de la progresión aritmética es \( 3 \) y el término \( 14 \) es \( 51 \). Elige la fórmula incorrecta:}
{\( a_{20}=a_2+(51-3)\cdot18 \)}{\( a_{20}=75 \)}{\( a_{20}=a_{14}+6\cdot4 \)}{\( a_{20}=a_2+18\cdot4 \)}{\( a_{20}=3+\frac{18}{12} (a_{14}-a_2 ) \)}{}}
\End
...
{\( a_1=5;\ a_{n+1}=a_n-2  \text{ para todos } n\in\mathbb{N} \)}{\( a_1=2;\ a_{n+1}=a_n-2  \text{ para todos } n\in\mathbb{N} \)}{\( a_1=3;\ a_{n+1}=a_n-1  \text{ para todos } n\in\mathbb{N} \)}{\( a_1=5;\ a_{n+1}=a_n-4  \text{ para todos } n\in\mathbb{N} \)}{\( a_1=3;\ a_{n+1}=a_n-4  \text{ para todos } n\in\mathbb{N} \)}{}}
\End
...
{\( a_1=6;\ a_{n+1}=a_n-1 \text{ para todos } n\in\mathbb{N} \)}{\( a_1=6;\ a_{n+1}=a_n+1 \text{ para todos } n\in\mathbb{N} \)}{\(a_1=1;\ a_{n+1}=a_n+5 \text{ para todos } n\in\mathbb{N} \)}{\( a_1=1;\ a_{n+1}=a_n-5 \text{ para todos } n\in\mathbb{N} \)}{}{}}
\End
...
{\( a_n=3n-6 \text{ para todos } n\in\mathbb{N} \)}{\( a_n=3n-3   \text{ para todos } n\in\mathbb{N} \)}{\( a_n=3n  \text{ para todos } n\in\mathbb{N} \)}{\( a_n=3n+3  \text{ para todos } n\in\mathbb{N} \)}{\( a_n=3n+6   \text{ para todos } n\in\mathbb{N} \)}{}}
\End
...
y \(a_{21} = 43\), halla el primer término \(a_{1}\) y la diferencia \(d\).}
{\(a_{1} = -17;\ d = 3\)}{\(a_{1} = -1;\ d = 5\)}{\(a_{1} = 1;\ d = 15\)}{\(a_{1} = -1;\ d = 3\)}{}{}}
\End
...
\LANGes{
\Question{
Halla la suma desde el término $10$ hasta el término $20$ de una progresión aritmética dada: $a_{n+1}=a_n+2$ para todos $n\in\mathbb{N}$ y $a_1=-4$.}
{$264$}{$240$}{$480$}{$-320$}{$-352$}{}}
\End

\Data\ID{1003085206}
\Updated{2020-10-02 10:10:00}
\Level{B}
\SubArea{Arithmetic sequences}
\LANGen{
\Question{
...
\LANGes{
\Question{
Halla la suma de los $15$ primeros términos positivos de una progresión aritmética: $\left\{(3n-7)\right\}_{n=1}^{\infty}$.}
{$345$}{$255$}{$238$}{$260$}{$322$}{}}
\End
...
\LANGes{
\Question{
Halla el primer término de una progresión aritmética \( \left\{a_n\right\}_{n=1}^{\infty} \), si:
\[\begin{aligned}
a_2+a_9&=24 \\
a_8-a_6&=4
\end{aligned} \]}
...
\LANGes{
\Question{
Halla la diferencia de una progresión aritmética \( \left\{a_n\right\}_{n=1}^{\infty} \), si:
\[ \begin{aligned}
a_{11}+a_4&=-19 \\ 
a_6+a_7&=-13
\end{aligned} \]}
...
\LANGes{
\Question{
Halla la suma se los cinco primeros términos de una progresión aritmética \( \left\{a_n\right\}_{n=1}^{\infty} \), si:
\[ \begin{aligned}
a_1\cdot a_4&=100 \\ 
a_2+a_6&=10
\end{aligned} \]}
...
\LANGes{
\Question{
Halla el tercer término de una progresión aritmética \( \left\{a_n\right\}_{n=1}^{\infty} \), si:
\[ \begin{aligned}
2a_{10}-3a_3&=5 \\ 
5a_5+4a_1&=83
\end{aligned} \]}
...
\LANGes{
\Question{
Halla el cuadrado del primer término de una progresión aritmética \( \left\{a_n\right\}_{n=1}^{\infty} \), si:
\[ \begin{aligned}
a_2^2+a_3^2&=100 \\
a_5+a_7&=0
\end{aligned} \]}
...
\LANGes{
\Question{
Halla la suma de los diez primeros términos de una progresión aritmética \( \left\{a_n\right\}_{n=1}^{\infty} \), si:
\[ \begin{aligned}
a_1+a_5+a_{10}&=40 \\
a_{10}-a_5-a_1&=24
\end{aligned} \]}
...
\LANGes{
\Question{
La progresión aritmética viene dada por el primer término
...
y \(a_{9} = -24\), halla la suma de los catorce primeros términos de una progresión aritmética.}
{\(- 189\)}{\(189\)}{\(198\)}{\(- 198\)}{}{}}
\End
...
\LANGes{
\Question{
Un cierto tipo de bambú crece $1.3\,\mathrm{m}$ por día durante el período de vegetación. ¿Cuántos metros midió el primer día si sabemos que después de veinte días del crecimiento regular alcanzó la altura de $30\,\mathrm{m}$?}
{$4\,\mathrm{m}$}{$5.3\,\mathrm{m}$}{$2.7\,\mathrm{m}$}{$10\,\mathrm{m}$}{$4.3\,\mathrm{m}$}{}}
\End
...
\LANGes{
\Question{
Un estudiante resuelve varios ejercicios de matemáticas todos los días. ¿Cuántos ejercicios resolvería en $14$ días si fuera capaz de resolver $5$ ejercicios el primer día y luego aumentara gradualmente el número de ejercicios resueltos por $2$ al día?}
{$252$}{$140$}{$434$}{$364$}{$70$}{}}
\End
...
\LANGes{
\Question{
En la aplicación Duolingo, cada usuario gana los llamados lingots (=moneda virtual), siempre que estudie al menos $10$ minutos por $10$ días consecutivos. Durante los $10$ primeros días, un usuario gana $1$ lingot, $2$ lingots por el próximo período de diez días, $3$ lingots por los siguientes $10$ días (es decir, por los $30$ primeros días, un usuario gana $6$ lingots), etc. Halla el menor número de días para que un usuario gane  $1000$ lingots.}
{$450$}{$45$}{$440$}{$44$}{$430$}{}}
\End
...
\LANGes{
\Question{
Un pianista quería aprender una nueva composición en $3$ semanas ($21$ días). Decidió por aprender la misma cantidad de compases al día. Al final, sin embargo, cumplió su plan solo el primer día. Cada otro día, logró aprender un compás menos que el día anterior. Halla cuántos compases aprendió el día $15$ si sabemos que aprendió $462$ compases en $21$ días.}
{$18$}{$22$}{$32$}{$15$}{$20$}{}}
\End
...
\LANGes{
\Question{
Una ciclista planea viajar $1666\,\mathrm{km}$ en $14$ días durante sus vacaciones. Ella sabe que la cantidad de kilómetros que recorre todos los días disminuirá en la misma cantidad que el día anterior, y a base de eso planeó su ruta. Al comienzo del último día, estaba a solo $80\,\mathrm{km}$ de distancia de su objetivo. ¿Cuál es la diferencia entre la cantidad de kilómetros recorridos en dos días consecutivos?}
{$6\,\mathrm{km}$}{$7\,\mathrm{km}$}{$5\,\mathrm{km}$}{$4\,\mathrm{km}$}{$3\,\mathrm{km}$}{}}
\End
...
\LANGes{
\Question{
Cada escuela debe pagar una tarifa de inscripción por cada participante enviado a un concurso de matemáticas. La tarifa para el primer participante es $10$ euros, por cada uno más, la tarifa es un euro menos. El número máximo de participantes de una escuela es $10$. Halla la relación entre el precio ($c$) pagado por la escuela y el número de estudiantes registrados ($n$).}
{$c=\frac n2(21-n)$}{$c=10-\frac{n^2}2$}{$c=\frac{11n}2$}{$c=\frac n2(10+10n)$}{$c=\frac n2(11-n)$}{}}
\End
...
\LANGes{
\Question{
El segundo término de una progresión aritmética es $-21$, el quinto término es $21$. ¿Cuántos de los primeros términos consecutivos tenemos que sumar para que la suma sea mayor que $50$?}
{$8$}{$7$}{$6$}{$9$}{$5$}{}}
\End
...
\LANGes{
\Question{
Entre las raíces de la siguiente ecuación $x^2-10x-119=0$ inserta $3$ números para que junto con las raíces de la ecuación formen $5$ términos consecutivos de una prograsión aritmética. ¿Cuál es el número central?}
{$5$}{$17$}{$6$}{$-1$}{$-7$}{}}
\End
...
\LANGes{
\Question{
Los números positivos, que cuando se dividen entre $3$ dejan un resto de $2$, son términos de una progresión aritmética creciente. La suma de los $15$ primeros términos es $480$. Halla el tercer término de la progresión.}
{$17$}{$11$}{$20$}{$5$}{$23$}{}}
\End
...
\LANGes{
\Question{
Las medidas de los ángulos en un triángulo forman tres términos consecutivos de una progresión aritmética. La medida del ángulo más grande es un cuádruple del más pequeño. Calcula la medida del ángulo más pequeño del triángulo.}
{$24^{\circ}$}{$30^{\circ}$}{$60^{\circ}$}{$20^{\circ}$}{$35^{\circ}$}{}}
\End
...
\LANGes{
\Question{
Resuelve la ecuación con la variable natural $n$: 
$$ 5+8+11+14+\dots+(3n+2)=735 $$}
{$21$}{$65$}{$20$}{$68$}{$10$}{}}
\End
...
\LANGes{
\Question{
La progresión aritmética viene dada por el tercer término
...
\(44\).
La suma de los siguiente cuatro términos es mayor que el valor en
\(50\). Halla el término trece \(a_{13}\).}
{\(31\)}{\(22\)}{\(25\)}{\(28\)}{\(34\)}{}}
\End
