...
\LANGpl{
\Question{
Wstaw pięć liczb między \(15\) i \(57\) tak, aby otrzymany ciąg był częścią ciągu arytmetycznego i znajdź różnicę \(d\).}
{\( d=7\)}{\( d=6\)}{\( d=12\)}{\( d=-7\)}{}{}}
\LANGcs{
\Question{
...
{\( d=5\)}{\( d=6\)}{\( d=-5\)}{\( d=\frac{30}{7}\)}{}{}}
\LANGpl{
\Question{
Wstaw pięć liczb między \(3\) i \(33\) tak, aby otrzymany ciąg był częścią ciągu arytmetycznego i znajdź różnicę \(d\).}
{\( d=5\)}{\( d=6\)}{\( d=-5\)}{\( d=\frac{30}{7}\)}{}{}}
\LANGcs{
\Question{
...
\LANGcs{
\Question{
V aritmetické posloupnosti je \( n \)-tý člen rovný \( -70 \), diference je \( -6 \) a první člen je \( 2 \). Určete \( n \).}
{\( 13\)}{\(11\)}{\(-11\)}{\(-13\)}{\(12\)}{}}
\LANGsk{
\Question{
...
\LANGcs{
\Question{
V aritmetické posloupnosti $(a_n)_{n=1}^{\infty}$ je dáno: $a_5=\frac54$, $a_k=15$ a diference je $\frac{11}{4}$. Určete $k$.}
{\(10\)}{\(-6\)}{\(0\)}{\(9\)}{\( 6\)}{}}
\LANGsk{
\Question{
...
\Level{A}
\SubArea{Arithmetic Sequences}
\IMG{arithmeticseq1_8-figure0_0.pdf}
\LANGen{
\Question{
The picture shows a part of the graph of the arithmetic sequence. What is the thirty-second term?}
{\( 143\)}{\(148\)}{\( 32\)}{\( 158\)}{}{}}
\LANGpl{
\Question{
...
\Level{A}
\SubArea{Arithmetic Sequences}
\IMG{arithmeticseq1_8-figure1_0.pdf}
\LANGen{
\Question{
The picture shows a part of the graph of the arithmetic sequence. What is the twenty-third term?}
{\( -53\)}{\(-56\)}{\(-62\)}{\(-23\)}{}{}}
\LANGpl{
\Question{
Rysunek przedstawia fragment wykresu ciągu arytmetycznego. Jaki jest dwudziesty trzeci wyraz?}
{\( -53\)}{\(-56\)}{\(-62\)}{\(-23\)}{}{}}
\LANGcs{
\Question{
...
{The numbers of black squares in patterns determine an arithmetic sequence with the common difference \(6\).}{The numbers of white squares in patterns determine an arithmetic sequence with the common difference \(6\).}{The numbers of white squares in patterns determine an arithmetic sequence with the first term \(2\).}{The numbers of black squares in patterns determine an arithmetic sequence with the first term \(2\).}{}{}}
\LANGpl{
\Question{
...
{Liczby czarnych kwadratów we wzorach określają ciąg arytmetyczny o różnicy \(6\).}{Liczby białych kwadratów we wzorach określają ciąg arytmetyczny o różnicy \(6\).}{Liczby białych kwadratów we wzorach określają ciąg arytmetyczny z pierwszym wyrazem \(2\).}{Liczby czarnych kwadratów we wzorach wyznaczają ciąg arytmetyczny z pierwszym wyrazem \(2\).}{}{}}
\LANGcs{
\Question{
...
{Počet černých čtverců tvoří aritmetickou posloupnost s diferencí \(6\).}{Počet bílých čtverců tvoří aritmetickou posloupnost s diferencí \(6\).}{Počet bílých čtverců tvoří aritmetickou posloupnost s  prvním členem \(2\).}{Počet černých čtverců tvoří aritmetickou posloupnost s  prvním členem \(2\).}{}{}}
\LANGsk{
\Question{
...
{Počet čiernych štvorcov tvorí aritmetickú postupnosť s diferenciou \(6\).}{Počet bielych štvorcov tvorí aritmetickú postupnosť s diferenciou \(6\).}{Počet bielych štvorcov tvorí aritmetickú postupnosť s prvým členom \(2\).}{Počet čiernych štvorcov tvorí aritmetickú postupnosť s prvým členom \(2\).}{}{}}
\LANGes{
\Question{
...
{Los números de cuadrados negros en patrones determinan una progresión aritmética con la diferencia común \(6\).}{Los números de cuadrados blancos en patrones determinan una progresión aritmética con la diferencia común \(6\).}{Los números de cuadrados blancos en patrones determinan una progresión aritmética con el primer término \(2\).}{Los números de cuadrados negros en patrones determinan una progresión aritmética con el primer término \(2\).}{}{}}
\End

\Data\ID{2010006804}
\Updated{2022-08-25 10:08:45}
\Level{A}
\SubArea{Arithmetic Sequences}
\IMG{seq5_6_2.pdf}
\LANGen{
\Question{
In the picture there are the first four terms of the sequence of patterns that consist of black and white squares. Identify the true statement about the number of squares in these patterns, if you know that exactly one of the given statements is true.}
{The numbers of white squares in patterns determine an arithmetic sequence with the common difference \(4\).}{The numbers of black squares in patterns determine an arithmetic sequence with the common difference \(4\).}{The numbers of white squares in patterns determine an arithmetic sequence with the third term \(16\).}{The numbers of black squares in patterns determine an arithmetic sequence with the third term \(16\).}{}{}}
\LANGpl{
\Question{
Na rysunku znajdują się pierwsze cztery wyrazy ciągu wzorów, które składają się z czarnych i białych kwadratów. Zidentyfikuj prawdziwe stwierdzenie dotyczące liczby kwadratów w tych wzorach, jeśli wiesz, że dokładnie jedno z podanych stwierdzeń jest prawdziwe.}
{Liczby białych kwadratów we wzorach określają ciąg arytmetyczny o różnicy \(4\).}{Liczby czarnych kwadratów we wzorach określają ciąg arytmetyczny o różnicy \(4\).}{Liczby białych kwadratów we wzorach określają ciąg arytmetyczny z trzecim wyrazem \(16\).}{Liczby czarnych kwadratów we wzorach wyznaczają ciąg arytmetyczny z trzecim wyrazem \(16\).}{}{}}
\LANGcs{
\Question{
...
{Počet bílých čtverců tvoří aritmetickou posloupnost s diferencí \(4\).}{Počet černých čtverců tvoří aritmetickou posloupnost s diferencí \(4\).}{Počet bílých čtverců tvoří aritmetickou posloupnost s třetím členem \(16\).}{Počet černých čtverců tvoří aritmetickou posloupnost s třetím členem \(16\).}{}{}}
\LANGsk{
\Question{
Na obrázku vidíte prvé štyri členy postupnosti útvarov, ktorú tvoria čierne a biele štvorce. Vyberte pravdivé tvrdenie o počte štvorcov v týchto útvaroch ak viete, že práve jedno z uvedených tvrdení je pravdivé.}
{Počet bielych štvorcov tvorí aritmetickú postupnosť s diferenciou \(4\).}{Počet čiernych štvorcov tvorí aritmetickú postupnosť s diferenciou \(4\).}{Počet bielych štvorcov tvorí aritmetickú postupnosť s tretím členom \(16\).}{Počet čiernych štvorcov tvorí aritmetickú postupnosť s tretím členom \(16\).}{}{}}
\LANGes{
\Question{
En la imagen podemos ver los primeros cuatro términos de la secuencia de patrones que consisten en cuadrados blancos y negros. Identifica la proposición lógica verdadera sobre el número de cuadrados en estos patrones sabiendo que una de las proposiciones lógicas es verdadera.}
{Los números de cuadrados blancos en patrones determinan una progresión aritmética con la diferencia común \(4\).}{Los números de cuadrados negros en patrones determinan una progresión aritmética con la diferencia común \(4\).}{Los números de cuadrados blancos en patrones determinan una progresión aritmética con el tercer término \(16\).}{Los números de cuadrados negros en patrones determinan una progresión aritmética con el tercer término \(16\).}{}{}}
\End
...
{dziewiątemu}{ósmemu}{siódmemu}{dziesiątemu}{}{}}
\LANGcs{
\Question{
...
{el noveno}{el octavo}{el séptimo}{el décimo}{}{}}
\End
...
{Tenth}{Eighth}{Seventh}{Nineth}{}{}}
\LANGpl{
\Question{
Zdjęcie przedstawia pierwsze trzy wzory utworzone przez kropki. Liczby kropek we wzorach odpowiadają wyrazom ciągu arytmetycznego. Któremu wyrazowi odpowiada wzór, który będzie używał kropek \(41\)?}
{dziesiąty}{ósmy}{siódmy}{dziewiąty}{}{}}
\LANGcs{
\Question{
Aritmetická posloupnost je reprezentována útvary tvořenými tečkami. Na obrázcích jsou první tři členy této posloupnosti. Kolikátý útvar bude tvořený \(41\) tečkami?}
{desátý}{osmý}{sedmý}{devátý}{}{}}
\LANGsk{
\Question{
Aritmetická postupnosť je reprezentovaná útvarmi, ktoré sú tvorené bodkami. Na obrázku sú prvé tri útvary. Ktorý útvar bude tvorený \(41\) bodkami?}
{Desiaty}{Ôsmy}{Siedmy}{Deviaty}{}{}}
\LANGes{
\Question{
La imagen representa los primeros tres patrones formados por puntos. Los números de puntos en patrones corresponden a los términos de una progresión aritmética. ¿A qué término corresponde un patrón con \(41\) puntos?}
{el décimo}{el octavo}{el séptimo}{el noveno}{}{}}
\End
...
{\( 1,~-1,~1,~-1,~1\)}{\( 5,~5,~5,~5,~5\)}{\( 7,~12,~17,~22,~27\)}{\( -\frac12,~0,~\frac12,~1,~\frac32\)}{}{}}
\LANGpl{
\Question{
Podano pięć pierwszych wyrazów czterech ciągów. Jeden z tych ciągów nie jest ciągiem arytmetycznym. Wybierz ten ciąg.}
{\( 1,~-1,~1,~-1,~1\)}{\( 5,~5,~5,~5,~5\)}{\( 7,~12,~17,~22,~27\)}{\( -\frac12,~0,~\frac12,~1,~\frac32\)}{}{}}
\LANGcs{
\Question{
...
\Question{
First five terms of four sequences are given. One of these sequences is not an arithmetic sequence. Choose this sequence.}
{\( 2,~0,~2,~0,~2\)}{\( 7,~7,~7,~7,~7\)}{\( 6,~11,~16,~21,~26\)}{\( -\frac32,~-\frac12,~\frac12,~
\frac32,~\frac52\)}{}{}}
\LANGpl{
\Question{
Podano pięć pierwszych wyrazów czterech ciągów. Jeden z tych ciągów nie jest ciągiem arytmetycznym. Wybierz ten ciąg.}
...
\LANGen{
\Question{
One of the given graphs shows the first six terms of an arithmetic sequence.  Choose this graph.}
{}{}{}{}{}{}}
\LANGpl{
\Question{
Jeden z podanych wykresów przedstawia pierwsze sześć wyrazów ciągu arytmetycznego. Wybierz ten wykres.}
{}{}{}{}{}{}}
\LANGcs{
\Question{
...
\IMGanswer{2010010501-figure0.pdf}
\IMGanswer{2010010501-figure1_0.pdf}
\IMGanswer{2010010501-figure2_1.pdf}
\IMGanswer{2010010501-figure3_2.pdf}\End
...
\IMGanswer{2010010501-figure4.pdf}
\IMGanswer{2010010501-figure5.pdf}
\IMGanswer{2010010501-figure6.pdf}
\IMGanswer{2010010501-figure7.pdf}\End
...
\LANGpl{
\Question{
Znajdź sumę wszystkich wyrazów ciągu arytmetycznego, które są zaznaczone na wykresie.}
{\( 48\)}{\( 6\)}{\( 36\)}{\( 18\)}{}{}}
\LANGcs{
\Question{
Určete součet všech členů aritmetické posloupnosti, které jsou zobrazeny v grafu.}
{\( 48\)}{\( 6\)}{\( 36\)}{\( 18\)}{}{}}
\LANGsk{
\Question{
...
{\( 5\)}{\( 3\)}{\( 4\)}{There does not exist an arithmetic sequence defined in this way.}{}{}}
\LANGpl{
\Question{
Dla ciągu arytmetycznego z \(a_1=-2\), \(a_3=6\) i \(s_n=30\), znajdź \(n\).}
{\( 5\)}{\( 3\)}{\( 4\)}{Nie istnieje tak zdefiniowany ciąg arytmetyczny.}{}{}}
\LANGcs{
\Question{
V aritmetické posloupnosti platí, že \(a_1=-2\), \(a_3=6\) a \(s_n=30\). Určete číslo \(n\).}
{\( 5\)}{\( 3\)}{\( 4\)}{Taková aritmetická posloupnost neexistuje.}{}{}}
\LANGsk{
\Question{
V aritmetickej postupnosti je dané \(a_1=-2\), \(a_3=6\) a \(s_n=30\). Určte číslo \(n\).}
{\( 5\)}{\( 3\)}{\( 4\)}{Takto definovaná aritmetická postupnosť neexistuje.}{}{}}
\LANGes{
\Question{
Dada la sucesión aritmética con \(a_1=-2\), \(a_3=6\), y \(s_n=30\). Halla \(n\).}
{\( 5\)}{\( 3\)}{\( 4\)}{No hay ninguna sucesión aritmética así definida.}{}{}}
\End
...
\LANGen{
\Question{
The sum of the first \( 27 \) terms of an arithmetic sequence is \( 1242 \) and the first term is \( 7\). Choose the incorrect statement about its common difference.}
{\( d \) is an even number}{\( d < 4 \)}{\( d > 0 \)}{\( d \) is a prime number}{}{}}
\LANGpl{
\Question{
...
{\( d \) jest liczbą parzystą}{\( d < 4 \)}{\( d > 0 \)}{\( d \) jest liczbą pierwszą}{}{}}
\LANGcs{
\Question{
...
{\( d \) je sudé číslo}{\( d < 4 \)}{\( d > 0 \)}{\( d \) je prvočíslo}{}{}}
\LANGsk{
\Question{
...
{\( d \) je párne číslo}{\( d < 4 \)}{\( d > 0 \)}{\( d \) je prvočíslo}{}{}}
\LANGes{
\Question{
...
{\( d \) es un número par}{\( d < 4 \)}{\( d > 0 \)}{\( d \) es un número primo}{}{}}
\End
...
{\( s_{50} = -900 \)}{\( s_{50} < -900 \)}{\( s_{50} < 0 \) and \( s_{50} > -900 \)}{\( s_{50} > 0 \) and \( s_{50} < 900 \)}{\( s_{50} > 900 \)}{}}
\LANGpl{
\Question{
...
{\( s_{50} = -900 \)}{\( s_{50} < -900 \)}{\( s_{50} < 0 \) i \( s_{50} > -900 \)}{\( s_{50} > 0 \) i \( s_{50} < 900 \)}{\( s_{50} > 900 \)}{}}
\LANGcs{
\Question{
Pátý člen aritmetické posloupnosti je \( -100 \) a diference je \( 4 \). Pro součet prvních \( 50 \) členů této posloupnosti platí:}
{\( s_{50} = -900 \)}{\( s_{50} < -900 \)}{\( s_{50} < 0 \) a \( s_{50} > -900 \)}{\( s_{50} > 0 \) a \( s_{50} < 900 \)}{\( s_{50} > 900 \)}{}}
\LANGsk{
\Question{
...
{\( s_{50} = -900 \)}{\( s_{50} < -900 \)}{\( s_{50} < 0 \) y \( s_{50} > -900 \)}{\( s_{50} > 0 \) y \( s_{50} < 900 \)}{\( s_{50} > 900 \)}{}}
\End
...
\LANGen{
\Question{
Find the third term of an arithmetic sequence \( (a_n)^{\infty}_{n=1}\), if the sum of the first \(n\) terms is equal to  \(4n^2-3n\).}
{\( a_3 = 17\)}{\( a_3 = 27\)}{\( a_3 = 19\)}{\( a_3 = 38\)}{}{}}
\LANGpl{
\Question{
...
\LANGen{
\Question{
Find the third term of an arithmetic sequence \( (a_n)^{\infty}_{n=1}\), if the sum of the first \(n\) terms is equal to  \(2n^2+3n\).}
{\( a_3 = 13\)}{\( a_3 = 27\)}{\( a_3 = 23\)}{\( a_3 = 46\)}{}{}}
\LANGpl{
\Question{
...
\Level{B}
\SubArea{Arithmetic Sequences}
\IMG{arithmeticseq2_10-figure0.pdf}
\LANGen{
\Question{
The picture shows a part of the graph of the arithmetic sequence. Find the sum of the first twenty-five terms of the sequence.}
{\( -350\)}{\( -32\)}{\( -68\)}{\( -800\)}{}{}}
\LANGpl{
\Question{
...
\Level{B}
\SubArea{Arithmetic Sequences}
\IMG{arithmeticseq2_10-figure1.pdf}
\LANGen{
\Question{
...
\LANGpl{
\Question{
Rysunek przedstawia fragment wykresu ciągu arytmetycznego. Znajdź sumę pierwszych dwudziestu czterech wyrazów ciągu.}
{\( 192\)}{\( 560\)}{\( 576\)}{\( 200\)}{}{}}
\LANGcs{
\Question{
...
\LANGes{
\Question{
La imagen representa una parte de la gráfica de una progresión aritmética. Halla la suma de los primeros \( 24 \) términos de esta progresión.}
{\( 192\)}{\( 560\)}{\( 576\)}{\( 200\)}{}{}}
\End
...
{\( a_{19}\)}{\( a_{9}\)}{\( a_{7}\)}{\( a_{14}\)}{\( a_{12}\)}{}}
\LANGpl{
\Question{
Ciąg arytmetyczny jest zdefiniowany przez pierwszy wyraz
\(a_{1} = 15\) i czwarty wyraz  \(a_{4} = 13\).
Znajdź wyraz, który jest trzykrotnie mniejszy niż dziesiąty wyraz ciągu.}
{\( a_{19}\)}{\( a_{9}\)}{\( a_{7}\)}{\( a_{14}\)}{\( a_{12}\)}{}}
\LANGcs{
\Question{
...
\(a_{1} = 15\), \(a_{4} = 13\).
Vypočítajte, ktorý člen postupnosti je tretinou desiateho člena.}
{\( a_{19}\)}{\( a_{9}\)}{\( a_{7}\)}{\( a_{14}\)}{\( a_{12}\)}{}}
\LANGes{
\Question{
...
\LANGpl{
\Question{
Ile \(3\)-cyfrowych liczb dodatnich jest podzielnych przez \(4\)?}
{\( 225\)}{\( 223\)}{\( 224\)}{\( 996\)}{}{}}
\LANGcs{
\Question{
...
\LANGpl{
\Question{
Ile \(3\)-cyfrowych liczb dodatnich jest podzielnych przez \(3\)?}
{\( 300\)}{\( 298\)}{\( 299\)}{\( 999\)}{}{}}
\LANGcs{
\Question{
...
\LANGpl{
\Question{
Pierwsze trzy wyrazy ciągu arytmetycznego są reprezentowane odpowiednio przez liczby \(x+4\), \(3x-4\) i \(4x-5\). Znajdź wspólną różnicę tego ciągu.}
{\( 6\)}{\( 7\)}{\( 11\)}{\( 4\)}{}{}}
\LANGcs{
\Question{
...
\LANGpl{
\Question{
Pierwsze trzy wyrazy ciągu arytmetycznego są reprezentowane odpowiednio przez liczby \(x+8\), \(4x+5\) i \(6x+6\). Znajdź wspólną różnicę tego ciągu.}
{\( 9\)}{\( 4\)}{\( 12\)}{\( 8\)}{}{}}
\LANGcs{
\Question{
...
\LANGsk{
\Question{
Silný fajčiar sa rozhodne znížiť svoju dennú spotrebu o $2$ cigarety počas $30$ dní od začiatku nasledujúceho roka. Potom každých $30$ dní opäť zníži svoju spotrebu o $2$ cigarety denne. Koľko ušetrí za $360$ dní, ak jedna krabička ($20$ cigariet) stojí $80\ \mathrm{CZK}$?}
{$18\,720\ \mathrm{CZK}$}{$624\ \mathrm{CZK}$}{$4\,680\ \mathrm{CZK}$}{$12\,480\ \mathrm{CZK}$}{$6\,240\ \mathrm{CZK}$}{}}
\LANGes{
\Question{
...
\Data\ID{1003107206}
\Updated{2022-07-21 08:07:55}
\Level{C}
\SubArea{Arithmetic Sequences}
\LANGen{
\Question{
Solve the equation with the variable $n$, where $n$ is a natural number: 
...
\Data\ID{1003107207}
\Updated{2022-07-21 08:07:12}
\Level{C}
\SubArea{Arithmetic Sequences}
\LANGen{
\Question{
Find the set of all solutions of the given inequality with the variable $x$, where $x$ is a natural number:
...
\Data\ID{1003107208}
\Updated{2022-07-21 09:07:15}
\Level{C}
\SubArea{Arithmetic Sequences}
\LANGen{
\Question{
Solve the equation with the variable $x$, where $x$ is a natural number:
...
\Data\ID{1003107210}
\Updated{2022-07-21 09:07:16}
\Level{C}
\SubArea{Arithmetic Sequences}
\LANGen{
\Question{
Solve the inequality with the variable $x$, where $x$ is a natural number:
...
Resuelve la ecuación con la variable natural $x$:
$$\sum\limits_{n=1}^x \left(\frac25n-1\right) \leq x $$}
{$ x\leq9;\ x\in\mathbb{N}$}{$x\leq10;\ x\in\mathbb{N}$}{$x\in(-\infty;8]$}{$x\geq8;\ x\in\mathbb{N}$}{no hay solución en $\mathbb{N}$}{}}
\End
...
{\(d\) is a fraction greater than \(1\)}{\( d>0\)}{\(d\) is a fraction smaller than \(1\)}{\(d\) is a rational number}{}{}}
\LANGpl{
\Question{
...
{\(d\) jest ułamkiem większym niż \(1\)}{\( d>0\)}{\(d\) jest ułamkiem mniejszym niż \(1\)}{\(d\) jest liczbą wymierną}{}{}}
\LANGcs{
\Question{
...
{\(d\) je zlomek větší než \(1\)}{\( d>0\)}{\(d\) je zlomek menší než \(1\)}{\(d\) je racionální číslo}{}{}}
\LANGsk{
\Question{
...
{\(d\) je zlomok väčší ako \(1\)}{\( d>0\)}{\(d\) je zlomok menší ako \(1\)}{\(d\) je racionálne číslo}{}{}}
\LANGes{
\Question{
...
{\(d\) es una fracción mayor que \(1\)}{\( d>0\)}{\(d\) es una fracción menor que \(1\)}{\(d\) es un número racional}{}{}}
\End
...
{\(d\) is a fraction smaller than \(1\)}{\( d>0\)}{\(d\) is a fraction greater than \(1\)}{\(d\) is a rational number}{}{}}
\LANGpl{
\Question{
...
{\(d\) jest ułamkiem mniejszym niż  \(1\)}{\( d>0\)}{\(d\) jest ułamkiem większym niż \(1\)}{\(d\) jest liczbą wymierną}{}{}}
\LANGcs{
\Question{
...
{\(d\) je zlomek menší než \(1\)}{\( d>0\)}{\(d\) je zlomek větší než \(1\)}{\(d\) je racionální číslo}{}{}}
\LANGsk{
\Question{
...
{\(d\) je zlomok menší ako \(1\)}{\( d>0\)}{\(d\) je zlomok väčší ako \(1\)}{\(d\) je racionálne číslo}{}{}}
\LANGes{
\Question{
...
{\(d\) es una fracción menor que \(1\)}{\( d>0\)}{\(d\) es una fracción mayor que \(1\)}{\(d\) es un número racional}{}{}}
\End
...
\LANGcs{
\Question{
Určete součet všech celých čísel, která vyhovují nerovnici.
\[ 
 x^{2} + 8x - 153\leq 0
\]}
{\( -108\)}{\( 108\)}{\( 104\)}{\( -104\)}{\( -100\)}{}}
...
$$\sum\limits_{n=1}^x \left(5-\frac12n\right) \geq x $$}
{$ x\leq 15;\ x\in\mathbb{N}$}{$ x\geq 15;\ x\in\mathbb{N}$}{$ x\leq 17;\ x\in\mathbb{N}$}{$x\in(-\infty;15]$}{there is no solution in $\mathbb{N}$}{}}
\LANGpl{
\Question{
Rozwiąż nierówność za pomocą zmiennej naturalnej $x$:
$$\sum\limits_{n=1}^x \left(5-\frac12n\right) \geq x $$}
{$ x\leq 15;\ x\in\mathbb{N}$}{$ x\geq 15;\ x\in\mathbb{N}$}{$ x\leq 17;\ x\in\mathbb{N}$}{$x\in(-\infty;15\rangle$}{nie ma rozwiązania dla $\mathbb{N}$}{}}
\LANGcs{
\Question{
Řešte nerovnici s neznámou $x\in\mathbb{N}$:
$$\sum\limits_{n=1}^x \left(5-\frac12n\right) \geq x $$}
{$ x\leq 15;\ x\in\mathbb{N}$}{$ x\geq 15;\ x\in\mathbb{N}$}{$ x\leq 17;\ x\in\mathbb{N}$}{$x\in(-\infty;15\rangle$}{nemá řešení v $\mathbb{N}$}{}}
\LANGsk{
\Question{
Riešte nerovnicu s neznámou $x\in\mathbb{N}$:
$$\sum\limits_{n=1}^x \left(5-\frac12n\right) \geq x $$}
{$ x\leq 15;\ x\in\mathbb{N}$}{$ x\geq 15;\ x\in\mathbb{N}$}{$ x\leq 17;\ x\in\mathbb{N}$}{$x\in(-\infty;15\rangle$}{nemá riešenie v $\mathbb{N}$}{}}
\LANGes{
\Question{
Resuelve la ecuación con la variable natural $x$:
$$\sum\limits_{n=1}^x \left(5-\frac12n\right) \geq x $$}
{$ x\leq 15;\ x\in\mathbb{N}$}{$ x\geq 15;\ x\in\mathbb{N}$}{$ x\leq 17;\ x\in\mathbb{N}$}{$x\in(-\infty;15]$}{no hay solución en $\mathbb{N}$}{}}
\End
