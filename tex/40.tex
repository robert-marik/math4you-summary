...
\LANGsk{
\Question{
Sústavu dvoch lineárnych rovníc možno graficky znázorniť dvoma priamkami. Rozhodnite, ktorá z nižie uvedených sústav zodpovedá nasledujúcemu obrázku.}
{\[\begin{aligned}
x-y&=-4\\
x+\frac53y&=-\frac43\\
\end{aligned}\]}{\[\begin{aligned}
...
{\(x=6,\ y=-2\)}{\(x=5,\ y=-2\)}{\(x=6,\ y=-1\)}{\(x=6,\ y=-1.5\)}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Aké je riešenie sústavy dvoch lineárnych rovníc s dvoma neznámymi, ak jednu z rovníc znázorňuje modrá čiara a druhú červená (pozri obrázok)?}
{\(x=6,\ y=-2\)}{\(x=5,\ y=-2\)}{\(x=6,\ y=-1\)}{\(x=6,\ y=-1{,}5\)}{}{}}
\LANGes{
\Question{
...
{\(7x-11y+18=0\)}{\(x-y+2=0\)}{\(7x+11y-18=0\)}{\(x+y+2=0\)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
V soustavě dvou lineárních rovnic o dvou neznámých se zadání druhé rovnice nedopatřením rozmazalo, ale víme, že první složkou řešení soustavy je  \(x=-1\). Hodnotu \(y\) neznáme,  ale zachovala se část obrázku ilustrující grafické řešení. 

První rovnicí je \(x-y+2=0\). Určete druhou (rozmazanou) rovnici této soustavy.}
{\(7x-11y+18=0\)}{\(x-y+2=0\)}{\(7x+11y-18=0\)}{\(x+y+2=0\)}{}{}}
\LANGsk{
\Question{
V sústave dvoch lineárnych rovníc s dvomi neznámymi je priradenie druhej rovnice nedopatrením rozmazané, ale vieme, že prvá zložka riešenia sústavy je \(x=-1\). Nepoznáme hodnotu \(y\), ale časť obrázku ilustrujúca grafické riešenie je zachovaná.

Prvá rovnica je \(x-y+2=0\). Určte druhú (rozmazanú) rovnicu tejto sústavy.}
{\(7x-11y+18=0\)}{\(x-y+2=0\)}{\(7x+11y-18=0\)}{\(x+y+2=0\)}{}{}}
\LANGes{
\Question{
En un sistema de dos ecuaciones lineales con dos incógnitas, la asignación de la segunda ecuación no se aprecia claramente, pero sabemos que la primera componente de la solución del sistema es \(x=-1\). No conocemos el valor de \(y\), pero se conserva la parte de la figura que muestra la solución gráfica.

La primera ecuación es \(x-y+2=0\). Halla la segunda ecuación (azul) de este sistema.}
{\(7x-11y+18=0\)}{\(x-y+2=0\)}{\(7x+11y-18=0\)}{\(x+y+2=0\)}{}{}}
\End

\Data\ID{2000020406}
\Updated{2024-10-24 06:10:16}
\Level{A}
\SubArea{Systems of linear equations and inequalities}
\LANGen{
\Question{
...
{\(M\) is a line.}{\(M\) is a ray.}{\(M\) is a finite set of point.}{\(M\) is a half plane.}{}{}}
\LANGpl{
\Question{
...
{\(M\) jest linią.}{\(M\) jest promieniem.}{\(M\) jest skończonym zbiorem punktów.}{\(M\) jest półpłaszczyzną.}{}{}}
\LANGcs{
\Question{
...
{\(M\) je přímka.}{\(M\) je polopřímka.}{\(M\) je systém konečně mnoha bodů.}{\(M\) je polorovina.}{}{}}
\LANGsk{
\Question{
...
{\(M\) je priamka.}{\(M\) je vektor.}{\(M\) je konečná množina bodov.}{\(M\) je polrovina.}{}{}}
\LANGes{
\Question{
...
{\(M\) es una recta.}{\(M\) es una semirrecta.}{\(M\) es un conjunto finito de puntos.}{\(M\) es un semiplano.}{}{}}
\End
...
\LANGsk{
\Question{
Sústavu dvoch lineárnych rovníc možno graficky znázorniť dvoma priamkami. Rozhodnite, ktorý z obrázkov zodpovedá nasledujúcej sústave.
\[\begin{aligned}
-x+3y&=3{,}5\\
1{,}4x+y&=2{,}9\\
\end{aligned}
...
\LANGes{
\Question{
Un sistema de dos ecuaciones lineales se puede representar gráficamente mediante dos rectas. Decide cuál de las siguientes imágenes corresponde al siguiente sistema.
\[\begin{aligned}
-x+3y&=3.5\\
1.4x+y&=2.9\\
\end{aligned}
...
\IMGanswer{1obr1_0.pdf}
\IMGanswer{1obr2.pdf}
\IMGanswer{1obr3.pdf}
\IMGanswer{1obr4.pdf}\End

\Data\ID{2100020405}
\Updated{2024-10-24 06:10:02}
\Level{A}
\SubArea{Systems of linear equations and inequalities}
\LANGen{
\Question{
...
\LANGsk{
\Question{
Ktorý z nasledujúcich obrázkov by po doplnení chýbajúcich častí čiar znázorňoval grafické riešenie nasledujúcej sústavy?
\[\begin{aligned}
x-7r&=-9\\
3x-2y&=11\\
\end{aligned}\]}
...
\LANGes{
\Question{
Siempre que se completen las partes de las rectas que faltan, ¿cuál de las imágenes representaría la solución del sistema si se resolviera gráficamente?
\[\begin{aligned}
x-7y&=-9\\
3x-2y&=11\\
\end{aligned}\]}
...
\[\begin{aligned}
 ...
 \\2x - y & = -1. & &
 \end{aligned}\]
Ktoré z nasledujúcich tvrden je správne?}
{\(x\) 
je deliteľom \(6\).}{\(x\) 
je deliteľom \(3\).}{\(y\) 
je deliteľom \(4\).}{\(y\) 
...
\LANGsk{
\Question{
Je daná sústava troch rovníc o troch neznámych. Určte hodnosť  \(h(A)\) matice sstavy \(A\)
a hodnosť  \(h(A')\) rozšírenej matice sústavy \(A'\).
\[ 
\begin{array}{cl}
\phantom{ -} 3x + 5y +\phantom{ 2}z =\phantom{ -}10& 
...
\LANGcs{
\Question{
Vyberte obrázek, který znázorňuje grafické řešení nerovnice
\[ 1+2y\geq y-\frac{x-9}3 \]
