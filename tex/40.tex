...
\LANGcs{
\Question{
Máme dva rezistory s neznámými odpory \( R_1 \) a \( R_2 \), přičemž \( R_1 < R_2 \). Zapojíme-li tyto rezistory sériově (viz obr. A), mají celkov odpor \( R_S=64\,\Omega \). Zapojíme-li odpory paralelně (viz obr. B), mají celkový odpor \( R_P=15\,\Omega \). Určete odpor \( R_1 \).}
{\( 24 \)}{\( 22 \)}{\( 12 \)}{\( 15 \)}{}{}}
\LANGsk{
\Question{
...
\LANGsk{
\Question{
Je daná sústava \(3\) rovníc o \(3\) neznámych, ktorej matica sústavy je \(A\) a rozšrená matica sústavy je \(A'\).
...
matice soustavy \(A'\) 
je \(h(A') = 4\).
Kolik má dan soustava rovnic řešení?}
...
\LANGpl{
\Question{
Poniższy rysunek przedstawia graficzne rozwiązanie nastpującego układu. Wyznacz rozwiązanie układu w 
 \(\mathbb{R}\times \mathbb{R}\).
\[ \begin{alignedat}{80}
 &4x^{2} & + &y &^{2} & = &20 & & & & & & & & &
 \\ &2x & + &y & & = &6 & & & & & & & & &
...
pro nž platí, že \(y = 0\).}{Soustava nemá řešení.}{Soustava má právě jedno řešení \(\left [x,y\right ]\),
