...
\LANGsk{
\Question{
Tri zmrzlinové stánky firmy ICE hlásili za jl predaj porcií jednotlivých druhov zmrzliny. Údaje sú uvedené v nasledujúcej tabuľke.
...
\text{Cukier waniliowy (za }\mathrm{sztukę)} & 5{,}9\,\mathrm{CZK} & 5{,}1\,\mathrm{CZK} \\\hline
\end{array}\]
...
\text{EuroOil}& 29{,}60 &49 &18{,}20 \\\hline
\end{array}\]
Uvažujme následujcí součin dvou matic:
\[ 
\left( \MATRIX{ 
31{,}20& 57 & 16{,}90 \cr
27{,}20& 52 & 20 \cr
...
\LANGsk{
\Question{
Popíšte množinu vetkých usporiadaných dvojíc reálnych čísel v tvare \([x;y]\), ktoré sú riešením nasledujúcej rovnice.
\[
\frac{x-7}{y+1}=5
\]
...
2x + 3y &= 4 \\
4x + 6y &= 9\end{align*}
Které z následujícch tvrzení je správné?}
...
1& 1& 0} \right )$
\[\]
Chcemy przećwiczyć zasadę Cramera do rozwiązywania ukadu równań liniowych. Który z poniższych układów można rozwiązać za pomocą wyznaczników czterech macierzy podanych powyżej?}
{\[\begin{aligned}
 x- y = -3 & &
 \\2x + z = -5 & &
\\x + y -z= 0 & &
...
\LANGes{
\Question{
Sea \([x, y, z]\) la solución del sistema de \(3\) ecuaciones con \(3\) incógnitas representado por la matriz
\[\left(\begin{array}{ccc|c}
 1 & 2 & 1 & 6 \\
 2 & -1 & 1 & 1\\
 -1 & 1 & 1 & 2
...
\end{aligned}\]
Vyberte správné tvrzení.}
{Soustava má více než dvě řešení.}{Soustava nem řešení.}{Soustava má právě jedno řešení.}{Soustava má právě dvě řešení.}{}{}}
\LANGsk{
\Question{
...
\[\begin{aligned}
 ...
 \\2x^{2} + 2y^{2} - 12x - 4y + 18 = 0 & &
\end{aligned}\]}
{Sústava m viac než dve riešenia.}{Sústava nemá žiadne riešenie.}{Sústava má práve jedno riešenie.}{Sústava má práve dve riešenia.}{}{}}
\LANGes{
\Question{
Dado el sistema de ecuaciones:
\[\begin{aligned}
...
\LANGpl{
\Question{
Na rysunku zacieniowany obszar odpowiada zbiorowi punktw, który jest rozwiązaniem jednej z podanych nierówności. Która to nierówność?}
{\(y \geq x+1\)}{\(y \geq x-1\)}{\(y \leq x+1\)}{\(y \leq x-1\)}{}{}}
\LANGcs{
\Question{
...
\LANGes{
\Question{
Algunos estudiantes se han matriculado en los campamentos deportivos. Para el campamento de ciclismo se han matriculado \( 12 \) estudiantes más que para el campamento de navegación. Después de algún tiempo, uno de los estudiantes ha cambiado su inscripción del campamento de navegación al campamento de ciclismo. Ahora hay tres veces más ciclistas que navegantes. ¿Cuntos estudiantes se han matriculado originalmente en el campamento de ciclismo?}
{\( 20 \)}{\( 21 \)}{\( 7 \)}{\( 8 \)}{}{}}
\End

\Data\ID{2010011206}
\Updated{2023-12-28 07:12:19}
\Level{C}
\SubArea{Systems of equations and inequalities}
\LANGen{
\Question{
...
\[ \begin{alignedat}{80}
 ...
 \\8 &x & - &4y & + c & = 0 & & & & & &
 \\\end{alignedat}\]}
{Układ nie ma rozwiązania.}{Układ ma dwa rozwiązania.}{Układ ma tylko jedno rozwizanie.}{Układ ma nieskończenie wiele rozwiązań.}{}{}}
\LANGcs{
\Question{
Rozhodněte o počtu řešení soustavy dvou rovnic v
...
\(y < 0\).}{Soustava má prvě jedno řešení, pro které platí, že
...
\end{aligned}\]
Vyberte správné tvrzení.}
{Soustava má právě dvě řešení.}{Soustava nemá řešení.}{Soustava má právě jedno řešení.}{Soustava má více než dvě ešení.}{}{}}
\LANGsk{
\Question{
Vyriešte danú sústavu rovníc a vyberte pravdivé tvrdenie.
\[\begin{aligned}
