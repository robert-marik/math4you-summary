...
\LANGsk{
\Question{
Ktorá z nasledujúcich sústav rovníc nemá iadne riešenie?}
{\[\begin{aligned}
  y & = 10-2x & &
 \\ y & = 5 -2x& &
 \end{aligned}\]}{\[\begin{aligned}
...
\LANGsk{
\Question{
Je daná sústava troch lineárnych rovníc s troma neznmymi \(x\), \(y\), \(z\). Stĺpec pravej strany tejto sústavy je:
\[ 
\left( \MATRIX{ 
5\cr 
17\cr 
...
\LANGpl{
\Question{
Który układ nierównoci odpowiada zbiorowi przedstawionemu na rysunku poniżej?}
{\(\begin{aligned}2y -\phantom{ 2}x& < 4&
\\x - 2y & < 2
\\ \end{aligned}\)}{\(\begin{aligned}2y -\phantom{ 2}x& < 4&
\\x - 2y & > 2
