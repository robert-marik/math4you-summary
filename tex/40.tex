...
\LANGsk{
\Question{
Sú dané štyri sústavy rovnc. Koľko z uvedených sústav má nekonečne veľa riešení?
\[
\begin{array}{c|c}
\text{\( \begin{aligned}
4x-6y+10z&=8    \\
...
\LANGcs{
\Question{
Máme nerovnoramenné váhy s proměnnou délkou jednoho z ramen (takové váhy se často označují jako přezmeny a využívají se např. v rybářství pro vážení vylovených ryb). Na jedné straně  vodorovné "tyče" (vahadla) je zavěšeno břemeno a někde na druhé straně je závaží.  Stačí jediné závaží, které se posouvá po delším rameni páky tak dlouho, až nastane rovnováha. Břemeno se zavěšuje vždy \( 5\,\mathrm{cm} \) od bodu závěsu vahadla (viz obrázek). Má-li břemeno tíhu \( 80\,\mathrm{N} \), dosáhneme rovnováhy, když posuneme vyrovnávací závaží až na konec vahadla. Má-li břemeno tíhu \( 60\,\mathrm{N} \), rovnováha nastane, když závaž bude od bodu závěsu vzdáleno \( 30\,\mathrm{cm} \). Jak dlouhé je vahadlo?
\[ \]
...
\LANGpl{
\Question{
Kamil jest w stanie skosić łąkę w \( 12 \) godzin. Zdeněk ma lepszą kosiarkę i jest w stanie skosić tę samą łąkę w \( 9 \) godzin.  Uzgodnili, że Kamil zacznie sam kosić wcześniej, a później dołączy do niego Zdenk, dzięki czemu łączny czas koszenia wyniesie \( 8 \) godzin. Jak długo będą kosić razem?}
