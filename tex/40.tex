...
0& t& 0&t} \right ).
\]}
{Jeśli \(t=0\), to ranga wynosi \(1\), w przeciwnym razie wynosi \(2\).}{Jeśli \(t=0\), to ranga wynosi \(1\), w przeciwnym razie wynosi \(3\).}{Jeśli \(t=0\), to ranga wynosi \(2\), w przeciwnym razie wynosi \(1\).}{Jeli \(t=2\), to ranga wynosi \(3\), w przeciwnym razie wynosi \(1\).}{}{}}
\LANGcs{
\Question{
...
\LANGes{
\Question{
Resuelve el siguiente sistema de ecuaciones en el conjunto de los nmeros reales.
\[
\begin{aligned}
x+y&=-5\\
1+\sqrt{2x+4y}&=\sqrt{x+3y}\\
...
\LANGpl{
\Question{
Zakładając, że  \( x \in \mathbb{R}\), znajdź zbiór rozwiązań następujcego układu nierówności.
\[\begin{aligned}
2x- [x-(2x+1)]\cdot 3 &> (3+x)-2(1-x)-2x+6 \\
x^2-3\cdot [x-2x(1-x)] &< 5(10-x^2)-2x
\end{aligned}\]}
...
\LANGsk{
\Question{
Ktorá časť roviny znzorňuje riešenie danej sústavy nerovníc? 
\[\begin{aligned}
 x + y > &2 + x & &
 \\y + 1\leq &x + 1 & &
\end{aligned}\]}
...
\LANGpl{
\Question{
Rozwiąż nastpujący układ równań i wybierz poprawną odpowiedź. 
\[\begin{aligned}
 x - 2y + 5 = 0 & &
 \\x^{2} + y^{2} = 9 & &
\end{aligned}\]}
...
\end{aligned}\]
Vyberte správné tvrzení.}
{Soustava má právě dvě řešení.}{Soustava nemá řešení.}{Soustava má práv jedno řešení.}{Soustava má nekonečně mnoho řešení.}{}{}}
\LANGsk{
\Question{
Je daná sústava rovníc: 
\[\begin{aligned}
...
\LANGsk{
\Question{
Na obrázku sú znázornené 2 polkružnice \( \widehat{AB} \) a \( \widehat{DA} \).  Určte koeficient rovnoľahlosti, ak viete, že polkružnica \( \widehat{DA} \) je obrazom polkružnice \( \widehat{AB} \)  v rovnoahlosti so stredom \( C \).}
{\( -0{,}5 \)}{\( 0{,}5 \)}{\( -0{,}25 \)}{\( 0{,}75 \)}{}{}}
\LANGes{
\Question{
...
Wyznacz wartości rzeczywistego parametru
\(t\), dla którego
podany układ ma tylko jedno rozwizanie
\([a,b]\) takie, że 
zarówno \(a\) 
i \(b\) 
...
\(y < 0\).}{Soustava má právě jedno řešení, pro kter platí, že
...
\end{aligned}\]
Vyberte správné tvrzení.}
{Soustava má právě jedno řešení.}{Soustava nemá řeen.}{Soustava má právě dvě řešení.}{Soustava má více než dvě řešení.}{}{}}
\LANGsk{
\Question{
