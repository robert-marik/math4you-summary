...
\LANGes{
\Question{
Expande la suma dada enumerando términos individuales:
\[ \sum\limits_{n=2}^6(4n-5) \]}
{\( 3+7+11+15+19 \)}{\( -1+3+7+11+15 \)}{\( 4 + 8 +12 +16 +20 \)}{\( 3+ 8 + 11 + 15 + 19 \)}{\( 8 - 5 + 12 + 16 + 20 \)}{}}
\End
...
\Question{
Dada la serie geométrica infinita:
\(\sum _{n=1}^{\infty }3^{2-n}\). Su cociente \(q\) equivale a:}
{\(\frac{1}
{3}\)}{\(1\)}{\(\frac{1}
{9}\)}{\(-\frac{1} 
{9}\)}{}{}}
...
\LANGes{
\Question{
Expresa el decimal repetido \( 2.\overline{4} \) como una fracción en los términos más bajos.}
{\( \frac{22}9 \)}{\( \frac49 \)}{\( \frac{22}7 \)}{\( \frac{12}5 \)}{\( \frac9{22} \)}{}}
\End
...
\LANGes{
\Question{
Expresa el decimal repetido \( 0.5\overline{83} \) como una fracción en los términos más bajos.}
{\( \frac{289}{495} \)}{\( \frac{83}{990} \)}{\( \frac{495}{289} \)}{\( \frac{298}{495} \)}{\( \frac{583}{1\,000} \)}{}}
\End
...
\LANGes{
\Question{
Halla la suma de los números repetidos \( 0.\overline{27} \) y \( 0.4\overline{63} \).}
{\( \frac{81}{110} \)}{\( \frac{110}{81} \)}{\( \frac{80}{111} \)}{\( \frac{79}{110} \)}{\( \frac{81}{100} \)}{}}
\End
...
\(3\, \mathrm{cm}\). El radio de cada otra semicircunferencia en la espiral es mayor que el radio de la anterior por un tercio. Calcula la longitud total de la espiral.}
{\(\infty \)}{\(9\pi \)}{\(9\)}{\(3\pi \)}{}{}}
\End
...
\Question{
Una espiral infinita está formada por semicircunferencias. El radio de la primera semicircunferencia mide
\(3\, \mathrm{cm}\). El radio de cada otra semicircunferencia en la espiral es menor que el radio de la anterior por un tercio. Calcula la longitud total de la espiral.}
{\(9\pi \)}{\(9\)}{\(\frac{9}
{5}\pi \)}{\(\infty \)}{}{}}
\End
...
\Question{
Una espiral infinita está formada por semicircunferencias. El radio de la primera semicircunferencia mide
\(2\, \mathrm{cm}\). El radio de cada otra semicircunferencia en la espiral es el doble del radio de la anterior. Calcula la longitud total de la espiral.}
{\(\infty \)}{\(4\pi \)}{\(\frac{4}
{3}\pi \)}{\(- 4\pi \)}{}{}}
\End
...
\Question{
Una espiral infinita está formada por semicircunferencias. El radio de la primera semicircunferencia mide
\(2\, \mathrm{cm}\). El radio de cada otra semicircunferencia en la espiral mide la mitad  del radio de la anterior. Calcula la longitud total de la espiral.}
{\(4\pi \)}{\(\frac{4}
{3}\pi \)}{\(- 4\pi \)}{\(\infty \)}{}{}}
\End
...
Una espiral infinita está formada por cuartos de circunferencias. El radio del primer cuarto de circunferencia mide
 \(1\, \mathrm{cm}\).
El radio de cada otro cuarto de circunferencia en la espiral es más grande por la mitad que el radio del anterior. Calcula la longitud total de la espiral.}
{\(\infty \)}{\(4\pi \)}{\(\frac{2}
{5}\pi \)}{\(\frac{1}
{3}\pi \)}{}{}}
\End
...
El radio de cada otro cuarto de circunferencia en la espiral mide la mitad del radio del anterior. Calcula la longitud total de la espiral.}
{\(4\pi \)}{\(8\)}{\(\frac{8}
{3}\)}{\(\infty \)}{}{}}
\End
...
\LANGes{
\Question{
Dado el cuadrado cuyo lado mide \(4\, \mathrm{cm}\).
El segundo cuadrado se inscribe en el primer cuadrado uniendo los centros de todos los lados.
El proceso sigue de la misma manera. Halla la suma de los perímetros de todos los cuadrados.}
{\(32 + 16\sqrt{2}\)}{\(32 - 16\sqrt{2}\)}{\(32\)}{\(\infty \)}{}{}}
\End
...
\Question{
Dado el cuadrado cuyo lado mide \(4\, \mathrm{cm}\).
El segundo cuadrado se inscribe en el primer cuadrado uniendo los centros de todos los lados. El proceso sigue de la misma manera. Halla la suma de las áreas de todos los cuadrados.}
{\(32\)}{\(40\)}{\(\frac{32}
 {3} \)}{\(\infty \)}{}{}}
\End
...
qué \(x\in \mathbb{R}\) es esta serie divergente?}
{\(x = -5\)}{\(x = -\frac{9}
{2}\)}{\(x = -4\)}{\(x = -\frac{7}
{2}\)}{}{}}
\End
...
\Question{
Dada la serie geométrica infinita:
\(\sum _{n=1}^{\infty }(5 - 3x)^{n}\). ¿Para qué \(x\in \mathbb{R}\) es esta serie divergente?}
{\(x = \frac{1} 
{2}\)}{\(x = \frac{13} 
 {9} \)}{\(x = \frac{11} 
 {6} \)}{\(x = \frac{5} 
