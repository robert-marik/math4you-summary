...
What is the value of its common ratio?}
{\( \sqrt{2} \)}{\( \sqrt{2} - \sqrt{7}\)}{\(2\)}{\(7\)}{\( \sqrt{2} - 2\)}{}}
\LANGpl{
\Question{
Otrzymujemy nieskończony szereg geometryczny:
\[ \left(\sqrt2-\sqrt7\right)+\left(2-\sqrt{14}\right)+\left(2\sqrt2-2\sqrt{7}\right)+\dots\text{ .} \]
Jaka jest wartość ilorazu?}
{\( \sqrt{2} \)}{\( \sqrt{2} - \sqrt{7}\)}{\(2\)}{\(7\)}{\( \sqrt{2} - 2\)}{}}
\LANGcs{
\Question{
...
is equal to:}
{\( 1+\sqrt3 \)}{\(\sqrt3-1 \)}{\(  \frac{3-\sqrt{3}}{3}\)}{\(  \frac{\sqrt{3}-3}{3}\)}{\( \sqrt3\)}{}}
\LANGpl{
\Question{
...
\LANGpl{
\Question{
Oblicz następującą nieskończoną sumę.
\[ 
 \sum _{n=1}^{\infty }\left (-\frac{3}
{5}\right )^{n}
\]}
...
\[ 
 ...
 {\sqrt{5}} \right )^{n-1}
\]}
{\( \sqrt{5} \)}{\( \frac{\sqrt{5}}{5}\)}{\( \frac{\sqrt{5}-1}{5}\)}{Series diverges.}{}{}}
\LANGpl{
\Question{
...
\[ 
 ...
 {\sqrt{5}} \right )^{n-1}
\]}
{\( \sqrt{5} \)}{\( \frac{\sqrt{5}}{5}\)}{\( \frac{\sqrt{5}-1}{5}\)}{Suma nie istnieje.}{}{}}
\LANGcs{
\Question{
Určete součet nekonečné geometrické řady:
\[ 
 ...
 {\sqrt{5}} \right )^{n-1}
\]}
{\( \sqrt{5} \)}{\( \frac{\sqrt{5}}{5}\)}{\( \frac{\sqrt{5}-1}{5}\)}{Řada je divergentní.}{}{}}
\LANGsk{
\Question{
...
{\( \sqrt{5} \)}{\( \frac{\sqrt{5}}{5}\)}{\( \frac{\sqrt{5}-1}{5}\)}{Rad je divergentný.}{}{}}
\LANGes{
\Question{
...
\[ 
 ...
 {\sqrt{5}} \right )^{n-1}
\]}
{\( \sqrt{5} \)}{\( \frac{\sqrt{5}}{5}\)}{\( \frac{\sqrt{5}-1}{5}\)}{Es divergente.}{}{}}
\End
...
{\( \frac{81}{110} \)}{\( \frac{59}{110} \)}{\( \frac{110}{81} \)}{\( \frac{36}{110} \)}{\( \frac{81}{100} \)}{}}
\LANGpl{
\Question{
Jaka jest suma powtarzających się liczb \( 0{,}\overline{45} \) i \( 0{,}2\overline{81} \)?}
{\( \frac{81}{110} \)}{\( \frac{59}{110} \)}{\( \frac{110}{81} \)}{\( \frac{36}{110} \)}{\( \frac{81}{100} \)}{}}
\LANGcs{
\Question{
...
\LANGsk{
\Question{
Súčet periodických čísel \( 0{,}\overline{45} \) a \( 0{,}2\overline{81} \) 
 sa rovná:}
{\( \frac{81}{110} \)}{\( \frac{59}{110} \)}{\( \frac{110}{81} \)}{\( \frac{36}{110} \)}{\( \frac{81}{100} \)}{}}
\LANGes{
\Question{
...
{6}\)}{\(x = -\frac{1} 
{3}\)}{\(x = \frac{1} 
{3}\)}{La ecuación no tiene solución.}{}{}}
\End
...
\( 
 1 + 2x - 3 + (2x-3)^{2} + (2x - 3)^{3}+\cdots 
\).
Určte, pre ktoré \(x\)  je rad konvergentný.}
{\(x\in (1;2)\)}{\(x\in (-\infty ;-1)\)}{\(x\in (1;+\infty )\)}{\(x\in \mathbb{R}\)}{}{}}
\LANGes{
\Question{
...
{\( \frac{214}{495} \)}{\( \frac{98}{225} \)}{\( \frac{16}{495} \)}{\( \frac{8}{225} \)}{}{}}
\LANGpl{
\Question{
...
poloměr půlkružnice předcházející. Určete délku takto vzniklé spirály.}
{\(\infty \)}{\(9\pi \)}{\(9\)}{\(3\pi \)}{}{}}
\LANGsk{
\Question{
