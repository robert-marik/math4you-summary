...
\LANGes{
\Question{
Peter condujo de Ostrava a Varsovia. Condujo a una velocidad promedio de \( 104 \)  kilómetros por hora y llegó a Varsovia en \( 4 \) horas. Elige la función que describa la dependencia del tiempo de conducción de Peter \( t \) de la velocidad promedio \( v \) del coche.  (El tiempo de conducción \( t \) se da en horas y la velocidad promedio  \( v \) se da en kilómetros por hora).}
{\( t=\frac{416}v\text{ ,}\ v\in(0;\infty) \)}{\( t=\frac{26}v\text{ ,}\ v\in(0;\infty) \)}{\( t=\frac v{26}\text{ ,}\ v\in(0;\infty) \)}{\( t=\frac{104}v\text{ ,}\ v\in(0;\infty) \)}{}{}}
\End
...
\LANGes{
\Question{
El consumo de combustible de Skoda Fabia \( 1.4 \) MPi/\( 44\,\mathrm{kW} \) indicado por el fabricante varía entre \( 5.5\,\mathrm{l} \) / \( 100\,\mathrm{km} \) (fuera de una ciudad) a  \( 9.6\,\mathrm{l} \) / \( 100\,\mathrm{km} \) (en una ciudad). Imagina que el tanque de combustible del coche con capacidad \( 45\,\mathrm{l} \) está completamente lleno. Elige la función que describa la relación entre la distancia \( p \) en \( \mathrm{km} \)que el coche puede viajar sin llenar el tanque en el consumo de combustible \( s \).}
{\( f\colon p=\frac{4\:500}s;\ s\in[5.5;9.6] \)}{\( h\colon p=\frac{45}s;\ s\in[5.5;9.6] \)}{\( r\colon p=\frac s{0.45};\ s\in[5.5;9.6] \)}{\( g\colon p=45\cdot s;\ s\in[5.5;9.6] \)}{}{}}
\End
...
\LANGes{
\Question{
El suelo de la sala necesita nuevas baldosas. Todas las baldosas utilizadas serán del mismo tamaño. La imagen muestra la gráfica de la función que describe la dependencia del número \(p \) de baldosas necesarias en la sala en el área \(S \) de una baldosa. ¿Cuál es el área del suelo de la sala?}
{\( 10.5\,\mathrm{m}^2 \)}{\( 1\:050\,\mathrm{m}^2 \)}{\( 2\:100\,\mathrm{m}^2 \)}{\( 42\,\mathrm{m}^2 \)}{}{}}
\End
...
\LANGes{
\Question{
La imagen muestra gráficas de funciones:
\[ \begin{aligned}
f(x)&=\frac2x\text{, }x\in\left[\frac12;4\right], \\ 
g(x)&=\frac{-3}x\text{, }x\in\left[\frac12;4\right], \\
h(x)&=\frac4x\text{, }x\in\left[\frac12;4\right]. 
...
{La función \( f \) es graficada en azul y la función \( h \) es graficada en verde.}{La función \( g \) es graficada en rojo y la función\( f \) es graficada en verde.}{La función \( f \) es graficada en verde y la función \( h \) es graficada en azul.}{La función\( g \) es graficada en verde y la función\( f \) es graficada en azul.}{}{}}
\End
...
\LANGen{
\Question{
Consider a rectangle with fixed area
\(5\, \mathrm{cm}^{2}\). Find
the formula which relates both sides of the rectangle.}
{\(b = \frac{5} 
{a}\),
\(a\in (0;\infty )\)}{\(b = 5a\),
...
\LANGes{
\Question{
Considera un rectángulo con área fija
...
\(C = [4;1]\),
\(D = [2;2]\).
¿Cuántos de estos puntos hay en la gráfica de la función?
\(f\)?}
{\(2\)}{\(1\)}{\(3\)}{\(4\)}{}{}}
\End
...
{La función \( f \) está disminuyendo en el intervalo \( (3;\infty) \).}{La función \( f \) está disminuyendo en el intervalo \( (-3;\infty) \).}{La función\( f \)  está disminuyendo en el intervalo \( (-\infty;6) \).}{La función \( f \) está disminuyendo en el intervalo \( (-1;\infty) \).}{}{}}
\End
...
graph of the function \(f(x) = - \frac{1}
{x-1} + 1\) 
with \(x\)-
and \(y\)-axis,
...
con ejes \(x\)
e \(y\)
respectivamente. Calcula estos puntos.}
{\(X = [2;0]\),
\(Y = [0;2]\)}{\(X = [1;0]\),
\(Y = [0;1]\)}{\(X = [0;2]\),
\(Y = [2;0]\)}{\(X = Y = [0;0]\)}{}{}}
...
{x + 2}
\]
es una hipérbola. Determina el centro de esta hipérbola.}
{\(S = [-2;1]\)}{\(S = [3;1]\)}{\(S = [1;3]\)}{\(S = [1;-2]\)}{\(S = [-2;3]\)}{}}
\End
...
\LANGen{
\Question{
Find the intersection points of the graph of the rational function 
\[ 
 f\colon y = \frac{2x - 3} 
 {x - 2}
\]
...
{x} + 1\)?}
{La función \(f\) 
es una función uno a uno.}{La función \(f\) 
es impar.}{La función \(f\) 
es creciente.}{La gráfica de la función \(f\) 
es una hipérbola con ramas en el segundo y cuarto cuadrante.}{}{}}
\End
...
\LANGes{
\Question{
La función  \( f \)   está dada completamente por la gráfica. ¿Cuál de las siguientes proposiciones es falsa?}
{\( f(x)=\frac1x;\ x\in[-2;-0.5] \)}{\( f(x)=\left|-\frac1x\right|;\ x\in[-2;-0.5] \)}{\( f(x)=\frac1{|x|} ;\ x\in[-2;-0.5]  \)}{\( f(x)=-\frac1x;\ x\in[-2;-0.5]  \)}{}{}}
\End
...
y \(k_{2}\) no se puede determinar a base de la figura.}{}{}}
\End
...
el que asegura que las gráficas de ambas funciones sean simétricas sobre
el eje \(x\).}
{\(-\frac{1} 
{2}\)}{\(2\)}{\(- 2\)}{\(\frac{1}
{2}\)}{}{}}
...
\(f\) si se cambia el signo del coeficiente \(k\).}
{La función cambia el tipo de monotonía en los conjuntos
\(\mathbb{R}^{+}\) y
\(\mathbb{R}^{-}\) 
(o de una función creciente a una función decreciente o viceversa).}{La función cambia su paridad (de una función impar a una función par o de
una función par a una función impar).}{El dominio de la función cambia.}{Ninguna de las anteriores respuestas, ambas funciones tienen la misma paridad, monotonía y el dominio.}{}{}}
\End
...
la función \(f\) ha
cambiado.}
{Ninguna de las anteriores respuestas, ambas funciones tienen la misma paridad, monotonía y el dominio.}{La función cambia su paridad (de una función impar a una función par o de una función par a una función impar).}{El rango de la función cambia.}{La función cambia el tipo de monotonía en los conjuntos
\(\mathbb{R}^{+}\) y
\(\mathbb{R}^{-}\) 
