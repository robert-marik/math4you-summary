...
\LANGes{
\Question{
Dada la ecuación de elipse \( 5x^2+9y^2-30x-18y+9=0 \), ¿cuánto mide el semieje mayor?}
{\( 3 \)}{\( 5 \)}{\( 9 \)}{\( \sqrt5 \)}{\( 14 \)}{}}
\End

\Data\ID{1003020402}
\Updated{2020-08-23 08:08:35}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Dada la ecuación de elipse \( x^2+4y^2-6x+32y+48=0 \), ¿cuánto mide el semieje menor?}
{\( \frac52 \)}{\( 5 \)}{\( 25 \)}{\( \frac{25}4 \)}{\( \frac{15}2 \)}{}}
\End

\Data\ID{1003020403}
\Updated{2020-08-24 07:08:02}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Dada la ecuación de una elipse \( \frac{(x-2)^2}4+y^2=1 \). ¿Cuál de las imágenes abajo representa dada elipse en el sistema de coordenadas cartesianas?}
{}{}{}{}{}{}}
...
\LANGes{
\Question{
En la imagen se representa una elipse en el sistema de coordenadas cartesianas. encuentra la ecuación de forma estándar de la elipse.}
{\( \frac{(x-3)^2}4+\frac{(y-3)^2}9=1 \)}{\( \frac{(x-3)^2}9+\frac{(y-3)^2}4=1 \)}{\( \frac{(x+3)^2}4+\frac{(y+3)^2}9=1 \)}{\( \frac{(x+3)^2}9+\frac{(y+3)^2}4=1 \)}{}{}}
\End

\Data\ID{1103040103}
\Updated{2020-11-07 07:11:16}
\Level{A}
\SubArea{Conics}
\IMG{1103040103.pdf}
\LANGen{
...
\LANGes{
\Question{
En la imagen en el sistema de coordenadas cartesianas se representa una elipse. ¿Cuál es el semieje mayor de esta elipse?}
{El segmento \( SN \)}{El segmento\( SK \)}{La recta \( EF \)}{La recta \( KL \)}{}{}}
\End

\Data\ID{1103040106}
\Updated{2020-11-08 06:11:02}
\Level{A}
\SubArea{Conics}
\IMG{1103040106.pdf}
\LANGen{
...
\LANGes{
\Question{
En la imagen se representa un círculo en el sistema de coordenadas cartesianas. Identifica su ecuación estándar.}
{\( x^2+(y-3)^2=4 \)}{\( x^2+(y+3)^2=4 \)}{\( x^2+(y-3)^2=2 \)}{\( x^2+(y+3)^2=2 \)}{}{}}
\End

\Data\ID{1103040107}
\Updated{2020-11-08 06:11:18}
\Level{A}
\SubArea{Conics}
...
\LANGes{
\Question{
En la imagen se representa una elipse en el sistema de coordenadas cartesianas. Identifica ej semieje menor de esta elipse.}
{El segmento \( SM \)}{El segmento \( SL \)}{La recta \( MN \)}{La recta \( EF \)}{}{}}
\End

\Data\ID{9000091201}
\Updated{2020-11-07 08:11:18}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Consideremos el círculo \(k\colon x^{2} - 4x + y^{2} + 6y + 12 = 0\).
Halla el radio del círculo.}
{\(1\)}{\(2\)}{\(3\)}{\(4\)}{}{}}
\End

\Data\ID{9000091202}
\Updated{2020-11-08 07:11:59}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Consideremos el círculo \(k\colon x^{2} + 6x + y^{2} + 2y + 6 = 0\).
Encuentra el radio de este círculo.}
{\(2\)}{\(\sqrt{2}\)}{\(3\)}{\(4\)}{}{}}
\End

\Data\ID{9000091203}
\Updated{2021-01-05 08:01:56}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Consideremos el círculo \(x^{2} - 2x + y^{2} - 6y + 8 = 0\).
Encuentra el radio de este círculo.}
{\(\sqrt{2}\)}{\(2\)}{\(3\)}{\(4\)}{}{}}
\End

\Data\ID{9000091204}
\Updated{2020-11-08 07:11:22}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Consideremos el círculo \(k\colon x^{2} + 4x + y^{2} - 8y + 11 = 0\).
Encuentra el radio de este círculo.}
{\(3\)}{\(1\)}{\(2\)}{\(4\)}{}{}}
\End

\Data\ID{9000091205}
\Updated{2020-11-08 07:11:03}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Consideremos el círculo \(k\colon x^{2} - 10x + y^{2} + 10y + 34 = 0\).
Encuentra el radio de este círculo.}
{\(4\)}{\(2\)}{\(3\)}{\(1\)}{}{}}
\End

\Data\ID{9000091206}
\Updated{2020-11-08 07:11:40}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Consideremos el círculo \(k\colon x^{2} - 4x + y^{2} + 6y + 11 = 0\).
Encuentra el centro de este círculo.}
{\(S = [2;-3]\)}{\(S = [2;3]\)}{\(S = [-2;3]\)}{\(S = [-2;-3]\)}{}{}}
\End

\Data\ID{9000091207}
\Updated{2020-11-08 07:11:23}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Consideremos el círculo \(k\colon x^{2} + 2x + y^{2} - 4y + 2 = 0\).
Encuentra el centro de este círculo.}
{\(S = [-1;2]\)}{\(S = [-1;-2]\)}{\(S = [1;-2]\)}{\(S = [1;2]\)}{}{}}
\End

\Data\ID{9000091209}
\Updated{2020-11-08 07:11:46}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Consideremos el círculo \(k\colon x^{2} - 6x + y^{2} + 4y + 9 = 0\).
Encuentra el centro de este círculo. .}
{\(S = [3;-2]\)}{\(S = [-3;-2]\)}{\(S = [3;2]\)}{\(S = [-3;2]\)}{}{}}
\End

\Data\ID{9000091210}
\Updated{2020-11-08 07:11:29}
\Level{A}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Consideremos el círculo \(k\colon x^{2} + 8x + y^{2} - 2y + 12 = 0\).
Encuentra el centro de este círculo.}
{\(S = [-4;1]\)}{\(S = [-4;-1]\)}{\(S = [4;1]\)}{\(S = [4;-1]\)}{}{}}
\End
...
\LANGes{
\Question{
La hipérbola tiene dos asíntotas con las ecuaciones \( y=\frac13(x+2) \) y \(y=-\frac13(x+2)\). Define las coordenadas del centro de esta hipérbola.}
{\( [-2;0] \)}{\( [2;0] \)}{\( \left[-\frac13;0\right] \)}{\( [0;2] \)}{\( \left[\frac13;2\right] \)}{}}
\End

\Data\ID{1003020406}
\Updated{2020-08-24 09:08:24}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Dada la ecuación de la hipérbola \( \frac{x^2}4-\frac{y^2}3=1 \). Identifica ecuaciones de asíntotas de la hipérbola.}
{\( y=\pm\frac{\sqrt3}2x \)}{\( x=\pm\frac{\sqrt3}2y \)}{\( y=\pm\frac34 x \)}{\( y=\pm\frac43 x \)}{\( y=\pm\frac{2\sqrt3}3 x \)}{}}
\End

\Data\ID{1003020407}
\Updated{2020-08-24 09:08:36}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Dada la ecuación de la hipérbola \( \frac{x^2}9-\frac{y^2}{16}=1 \). Halla la distancia entre los focos de la hipérbola.}
{\( 10 \)}{\( 5 \)}{\( 16 \)}{\( 9 \)}{\( 4 \)}{}}
\End

\Data\ID{1003020409}
\Updated{2020-08-24 09:08:55}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
La parábola tiene su foco \( F=[5;0] \) y la directriz cuya ecuación es \( x=0 \). Halla las coordenadas de su vértice.}
{\( \left[\frac52;0\right] \)}{\( [0;0] \)}{\( \left[0;\frac52\right] \)}{\( [-5;0] \)}{\( \left[-\frac52;0\right] \)}{}}
\End

\Data\ID{1003020412}
\Updated{2020-11-07 07:11:31}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGsk{
\Question{
Parabola, ktorá prechádza bodmi \( K=[0;0] \) a \( L=[6;-2] \) a je súmerná podľa osy \( y \), má vrchol so súradnicami:}
{\( [0;0] \)}{\( [6;-2] \)}{\( [3;0] \)}{\( [-6;-2] \)}{\( [0;-1] \)}{}}
\LANGes{
\Question{
La parábola pasa por los puntos \( K=[0;0] \) y \( L=[6;-2] \) y es simétrica respecto al eje \( y \). Halla las coordenadas de su vértice.}
{\( [0;0] \)}{\( [6;-2] \)}{\( [3;0] \)}{\( [-6;-2] \)}{\( [0;-1] \)}{}}
\End

\Data\ID{1003020413}
\Updated{2020-08-30 06:08:58}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Dados los puntos \( A=[0;0] \), \( B=[1;7] \), \( C=[-1;-5] \) que son los puntos que se encuentran en la parábola. Halla la ecuación de la parábola.}
{\( y=x^2+6x \)}{\( y=x^2 \)}{\( y=7x^2 \)}{\( y=-x^2+4x \)}{\( x=y^2 \)}{}}
\End

\Data\ID{1003024004}
\Updated{2020-09-25 12:09:10}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Decide qué describe la ecuación \( 4x^2+9y^2-8x+18y+13=0 \) (en el plano \( x \)-\( y \)):}
{el punto}{una elipse}{una parábola}{una hipérbola}{el conjunto vacío}{}}
\End

\Data\ID{1003024005}
\Updated{2020-08-30 07:08:40}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Decide qué describe la ecuación \( 4x^2+4y-8x=1\) (en el plano \( x \)-\( y \)):}
{una parábola}{una elipse}{una circunferencia}{una hipérbola}{el punto \( \left[0;\frac14\right] \)}{}}
\End

\Data\ID{1003024006}
\Updated{2020-08-30 07:08:57}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Decide qué describe la ecuación \( (x+3)^2+(y+4)^2=5 \) (en el plano \( x \)-\( y \)):}
...
\LANGes{
\Question{
Decide qué describe la ecuación \( 2x^2-4y^2-6x-12y=0 \) (en el plano \( x \)-\( y \)):}
{una hipérbola}{una circunferencia}{una parábola}{una elipse}{el punto \( \left[\frac32;\frac{-3}2\right] \)}{}}
\End

\Data\ID{1003024008}
\Updated{2020-08-30 07:08:05}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Elige la ecuación de la hipérbola con el centro \( S=[-1;3] \),  el foco \( F=[4;3] \) y el vértice \( A=[2;3] \):}
{\( \frac{(x+1)^2}{9}-\frac{(y-3)^2}{16} =1 \)}{\( \frac{(x-1)^2}{9}-\frac{(y+3)^2}{16} =1 \)}{\( \frac{(x+1)^2}{9}+\frac{(y-3)^2}{16} =1 \)}{\( \frac{(x-1)^2}{16}-\frac{(y+3)^2}{9} =1 \)}{\( \frac{(y-3)^2}{16}-\frac{(x+1)^2}{9} =1 \)}{}}
\End

\Data\ID{1003024102}
\Updated{2020-08-30 07:08:54}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
En la imagen se representa una parábola en el sistema de coordenadas cartesianas. Identifica la ecuación de su vértice.}
{\( x^2 = 4(y-1) \)}{\( x^2 = 4(y+1) \)}{\( y^2 = 4(x-1) \)}{\( y^2 = 4(x+1) \)}{}{}}
\End
...
\LANGes{
\Question{
La parábola \(P\colon x^{2} - 6x - 4y + 5 = 0\) corta el eje \(x\) en dos puntos. Encuentra la distancia de estos dos puntos.}
{\(4\)}{\(6\)}{\(8\)}{\(10\)}{}{}}
\End

\Data\ID{9000105402}
\Updated{2020-11-08 07:11:32}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
La parábola \(P\colon x^{2} - 4x - 10y - 21 = 0\) corta el eje \(x\) en dos puntos. Encuentra la distancia de estos dos puntos.}
{\(10\)}{\(12\)}{\(8\)}{\(6\)}{}{}}
\End

\Data\ID{9000105403}
\Updated{2020-11-08 07:11:13}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
La parábola \(P\colon y^{2} + 2y + 10x - 24 = 0\) corta el eje \(y\) en dos puntos. Encuentra la distancia de estos dos puntos.}
{\(10\)}{\(8\)}{\(6\)}{\(4\)}{}{}}
\End

\Data\ID{9000105404}
\Updated{2020-11-08 07:11:52}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
La  parábola \(P\colon y^{2} + 4y + 6x - 5 = 0\) corta el eje \(y\) en dos puntos. Encuentra la distancia de estos dos puntos.}
{\(6\)}{\(8\)}{\(10\)}{\(4\)}{}{}}
\End

\Data\ID{9000105405}
\Updated{2020-11-08 09:11:16}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Una parábola es el conjunto de puntos en el plano equidistante de un punto fijo (llamado foco) y una línea fija (llamada directriz). Encuentra la ecuación de la directriz de la parábola
\(P\colon x^{2} - 4x - 6y - 17 = 0\).}
{\(y + 5 = 0\)}{\(y - 3 = 0\)}{\(x + 4 = 0\)}{\(x - 2 = 0\)}{}{}}
\End

\Data\ID{9000105406}
\Updated{2020-11-08 09:11:37}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Encuentra la distancia entre los puntos en los que el eje \(x\) corta la siguiente hipérbola. 
\[ 
 H\colon \frac{\left (x - 1\right )^{2}}
 {10} -\frac{\left (y - 3\right )^{2}} 
 {6} = 1
...
\LANGes{
\Question{
Halla una sección cónica por cuyo centro pase una recta y esta recta no tenga un punto en común con esta sección cónica.}
{hipérbola}{círculo}{elipse}{parábola}{Esta sección cónica no existe.}{}}
\End

\Data\ID{9000120005}
\Updated{2020-11-17 11:11:53}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Los organizadores de un campamento prepararon un juego. Para este juego es importante que la distancia aérea entre la cocina, la tienda y la hoguera sea para todas las tiendas de campaña igual. ¿Basta esta información para determinar la curva que pasa por todas estas tiendas? Es esta curva una sección cónica? Si es así en qué sección cónica están las tiendas?}
{Sí, todas la tiendas están en una elipse.}{Sí, todas las tiendas están en un círculo.}{Sí, todas las tiendas están en una parábola.}{Sí, todas la tiendas están en una hipérbola.}{No, no tenemos suficiente información para poder sacar conclusiones de esta sección cónica.}{}}
\End

\Data\ID{9000120007}
\Updated{2020-11-16 07:11:30}
\Level{B}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
En un mapa de la ciudad el ayuntamiento está representado como un punto y el río que pasa por la ciudad como una recta. En la ciudad hay lugares con la misma distancia tanto del río como del ayutamiento.  De la lista siguiente define la curva que pueda conectar todos estos lugares.}
{parábola}{círculo}{elipse}{hipérbola}{ninguna de la lista}{}}
\End
...
\LANGes{
\Question{
Encuentra el valor del parámetro \( q\in\mathbb{R} \) para el que la recta \( x+2y-1=0 \) es una tangente de la hipérbola \( x^2-2y^2=q \).}
{\( -1 \)}{\( 1 \)}{\( 2 \)}{\( -2 \)}{\( \frac12 \)}{}}
\End
...
\LANGes{
\Question{
Halla el valor del parámetro \( q\in\mathbb{R} \) para el que la recta \( x+2y-1=0 \) es una tangente de la elipse \( x^2+4y^2=q \).}
{\( \frac12 \)}{\( \frac14 \)}{\( 2 \)}{\( 4 \)}{\( 1 \)}{}}
\End
...
\LANGes{
\Question{
Halla el valor del parámetro \( p\in\mathbb{R} \) para el que la recta \( x+2y-1=0 \) es una tangente de la parábola \( y^2=2px \).}
{\( -\frac12 \)}{\( \frac12 \)}{\( 2 \)}{\( -2 \)}{\( 1 \)}{}}
\End

\Data\ID{1003024108}
\Updated{2020-08-30 07:08:07}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Halla el valor del parámetro \( q\in\mathbb{R} \) para el que la recta \( x+2y-1=0 \) es una tangente de la circunferencia \( x^2+y^2=q^2 \).}
{\( \frac{\sqrt5}5 \)}{\( 5 \)}{\( \sqrt5 \)}{\( \frac15 \)}{\( 1 \)}{}}
\End

\Data\ID{1003024109}
\Updated{2020-11-07 03:11:15}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Halla el conjunto de valores del parámetro \( c\in\mathbb{R} \) para el que la recta \( 3x+5y-c=0 \) es una secante de la elipse \( 16x^2+25y^2=400 \).}
{\( (-25;25) \)}{\( (-\infty;-25)\cup(25;\infty) \)}{\( \{25\} \)}{\( \{-25\} \)}{\( (25;\infty) \)}{}}
\End
...
\LANGes{
\Question{
Encuentra el valor del parámetro \( q\in\mathbb{R} \) para el que la recta \( y=x+q \) es una tangente de la parábola \( y^2=6x \).}
{\( \frac32 \)}{\( \frac23 \)}{\( 0 \)}{\( -\frac32 \)}{\( -\frac23 \)}{}}
\End
...
\LANGes{
\Question{
Dada la ecuación de la parábola \( y^2 -12x -6y+57=0 \). Halla la ecuación de la recta que pasa por el vértice de esta parábola y averigua si es paralela a la recta \( 5x-3y-2=0 \).}
{\( 5x-3y-11 = 0 \)}{\( -5x+3y-11 = 0 \)}{\( 5x-3y-3 = 0 \)}{\( 5x-3y+11 = 0 \)}{\(-5x+3y-3 = 0 \)}{}}
\End

\Data\ID{1003024201}
\Updated{2020-11-07 07:11:08}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Elige las ecuaciones de las tangentes del punto \( K=[5;0] \) al círculo dado por la ecuación \( (x-1)^2+(y-2)^2=4 \).}
{\( 4x+3y-20=0 \), \( y=0 \)}{\( 3x+4y-20=0 \), \( y=0 \)}{\( 4x+3y+20=0 \), \( y=0 \)}{\( -4x+3y-20=0 \), \( y=0 \)}{\( -3x+4y-20=0 \), \( y=0 \)}{}}
\End

\Data\ID{1003024202}
\Updated{2020-11-07 07:11:15}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Dada la ecuación de la elipse \( x^2+2y^2-8x+4y+12=0\), halla las ecuaciones de las tangentes del punto \( M=[0;0] \) a la elipse.}
{\( x-5y=0 \), \( x+y=0 \)}{\( 5x-y=0 \), \( x+y=0 \)}{\( x+5y=0 \), \( x-y=0 \)}{\( -x-5y=0 \), \( -x+y=0 \)}{\( 5x+y=0 \), \( x-y=0 \)}{}}
\End

\Data\ID{1003024203}
\Updated{2020-11-07 07:11:54}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Dada la ecuación de la parábola \( y^2-4x+2y+9=0 \), halla las ecuaciones de las tangentes del punto \( L=[1;-1] \).}
{\( x-y-2=0 \), \( x+y=0 \)}{\( x+y-2=0 \), \( x+y=0 \)}{\( x+y+2=0 \), \( x-y=0 \)}{\( x-y+2=0 \), \( -x+y=0 \)}{\( -x+y-2=0 \), \( x-y=0 \)}{}}
\End

\Data\ID{9000104801}
\Updated{2020-11-08 10:11:10}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\]
y la recta \(p\) 
paralela a uno de los ejes pero no idéntica con este eje. Encuentra el enunciado verdadero.}
{La recta \(p\) 
tiene una única intersección con la hipérbola.}{La recta \(p\) 
tiene dos intersecciones con la hipérbola.}{La recta \(p\) 
no tiene ninguna intersección con la hipérbola.}{Con la información dada no es posible concluir el número de las intersecciones de la recta
\(p\) con
la hipérbola.}{}{}}
\End

\Data\ID{9000104803}
\Updated{2020-11-08 10:11:49}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\]
y la recta \(p\) 
paralela a uno de los ejes to one of the axes. Identifica el enunciado verdadero.}
{No podemos concluir ningún número de intersecciones de la recta \(p\) con la hipérbola.}{La recta \(p\) 
tiene dos intersecciones con la hipérbola.}{La recta \(p\) 
tiene una única intersección con la hipérbola.}{La recta \(p\) 
...
\LANGes{
\Question{
Marca el enunciado verdadero en cuanto a la recta que pasa por el centro de la hipérbola 
\[ 
 \frac{(x - 2)^{2}} 
 {4} -\frac{(y + 3)^{2}} 
 {9} = 1
\]
y tiene la única intersección con esta hipérbola.}
{No hay solución, recta dada por estas propiedades no existe.}{La directriz de la línea es \(\frac{3}
{2}\).}{La directriz de la línea es \(-\frac{3} 
{2}\).}{La directriz de la línea es \(\frac{2}
{3}\).}{La directriz de la línea es \(1\).}{La directriz de la línea es \(0\).}}
\End

\Data\ID{9000104809}
\Updated{2020-11-16 05:11:01}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Todas las rectas representadas pasan por el punto \([-1;3]\)
Identifica la tangente de la siguiente hipérbola.  
\[ 
 (x + 2)\cdot (y - 2) = 1
\]}
{\(k\colon \ y = -x + 2\)}{\(p\colon \ y = 3\)}{\(q\colon \ x = -1\)}{\(r\colon \ y = x + 4\)}{None of the given answers is correct.}{}}
...
\LANGes{
\Question{
El cuerpo tirado en movimiento parabólico tiene el ángulo inicial \(\alpha = 45^{\circ }\) 
y la velocidad inicial \(v_{0} = 10\, \mathrm{m}/\mathrm{s}\).
Encuentra la ecuación de esta parábola. Pista: Las coordenadas del cuerpo que se mueve en el campo gravitatorio son:  
\[ 
\begin{aligned}x& = v_{0}t\cdot \cos \alpha , &
\\y& = v_{0}t\cdot \sin \alpha -\frac{1} 
{2}gt^{2}.
...
\LANGes{
\Question{
Consideremos un planeta que se mueve alrededor del Sol en una órbita elíptica. En el perihelio (punto de la órbita de un planeta más próximo al Sol) la distancia del planeta al Sol es \(4.5\, \mathrm{AU}\). La excentricidad de la elipse es \(0.5\, \mathrm{AU}\).
Halla la ecuación de la trayectoria de este planeta. Usa el sistema de coordenadas cuyo centro es el Sol y el eje \(x\) es el eje mayor de esta elipse.}
{\(\frac{(x-0.5)^{2}} 
 {25} + \frac{y^{2}} 
{24.75} = 1\)}{\(\frac{x^{2}} 
{25} + \frac{(y-0.5)^{2}} 
...
\LANGes{
\Question{
Movimiento uniformemente acelerado se describe con la siguiente ecuación \(s = \frac{1} 
{2}at^{2}\) y el gráfico que representa esta relación es una parábola. Encuentra la directriz de esta parábola, si la aceleración 
...
\LANGes{
\Question{
Movimiento rectilíneo uniformemente retardado se describe por la siguiente ecuación \[ 
 s = v_{0}t -\frac{1} 
{2}at^{2}.
\]
El gráfico que representa la distancia como una función de tiempo es parte de una parábola. Halla el foco de esta parábola, si \(v_{0} = 16\, \mathrm{m}/\mathrm{s}\) y
\(a = 4\, \mathrm{m}/\mathrm{s}^{2}\).}
{\([4;\ 31.875]\)}{\([8;\ 31.875]\)}{\([4;\ 63.5]\)}{\([8;\ 63.5]\)}{}{}}
\End

\Data\ID{9000106905}
\Updated{2020-11-17 09:11:00}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
{2}at^{2}.
\]
El gráfico que representa la distancia como una función de tiempo es parte de una parábola. Halla la ecuación del vértice de esta parábola, si \(v_{0} = 8\, \mathrm{m}/\mathrm{s}\) y
\(a = 4\, \mathrm{m}/\mathrm{s}^{2}\).}
{\(-\frac{1} 
{2}(s - 8) = (t - 2)^{2}\)}{\(\frac{1}
{2}(s + 4) = (t + 2)^{2}\)}{\(2(s + 8) = (t + 2)^{2}\)}{\(- 2(s + 4) = (t + 2)^{2}\)}{}{}}
...
\LANGes{
\Question{
El cuerpo tirado en movimiento parabólico tiene el ángulo inicial \(\alpha = 30^{\circ }\) y la velocidad inicial \(v_{0} = 20\, \mathrm{m}/\mathrm{s}\). Encuentra la directriz de esta parábola. Pista: Las coordenadas del cuerpo que se mueve en el campo gravitatorio son:
\[ 
\begin{aligned}x& = v_{0}t\cdot \cos \alpha , &
\\y& = v_{0}t\cdot \sin \alpha -\frac{1} 
{2}gt^{2}.
...
\LANGes{
\Question{
La Tierra se mueve alrededor del Sol en una órbita eclíptica. El Sol está en el foco de esta elipse. La distancia máxima de la Tierra al Sol es \(152.1\cdot 10^{6}\, \mathrm{km}\), la distancia mínima de la Tierra al Sol es \(147.1\cdot 10^{6}\, \mathrm{km}\).
...
\LANGes{
\Question{
Dadas magnitudes físicas identifica cuál de las respuestas representa una relación entre las magnitudes como una parte de hipérbola. (Se supone que otras magnitudes son constantes.)}
{La presión (\(p\)) y la superficie (\(S\)) en la que ejerce la fuerza de la presión, si \(F = p\cdot S\).}{La masa (\(m\)) y
...
{2}\cdot m\cdot v^{2}\).}{La masa (\(m\)) y la energía potencial (\(E_{p}\)) en el campo de gravedad homogéneo, si \(E_{p} = m\cdot g\cdot h\).}{}{}}
\End

\Data\ID{9000117705}
\Updated{2020-11-18 07:11:06}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\LANGes{
\Question{
Dadas magnitudes físicas identifica cuál de las respuestas representa una relación entre las magnitudes como una parte de parábola. (Se supone que otras magnitudes son constantes.)}
{El trabajo eléctrico (\(W\))
y corriente eléctrica (\(I\)),
...
\LANGes{
\Question{
Los satélites se mueven cerca de la Tierra por una velocidad orbital. Consideremos un satélite en la altura \(h\) medida de la Tierra. También consideremos el sistema de las coordenadas cuyo origen está en la Tierra directamente debajo del satélite y el eje \(y\) está orientada arriba (al satélite). El eje \(x\)
es perpendicular al eje \(y\)
y es el plano definido por la trayectoria del satélite. Omitamos la rotación de la Tierra. Encuentra la ecuación de la trayectoria del satélite. El radio de la Tierra es \(R\).}
{\(x^{2} + (y + R)^{2} = (R + h)^{2}\)}{\(x^{2} + y^{2} = (R + h)^{2}\)}{\(x^{2} + (y + R)^{2} = h^{2}\)}{\(x^{2} + y^{2} = h^{2}\)}{}{}}
\End

\Data\ID{9000123101}
\Updated{2020-11-08 09:11:44}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\[ 
 x^{2} + 4y^{2} - 8y = 0.
\]}
{La tangente a la elipse puede pasar por cualquier punto en la recta \(y = -1\).}{La tangente a la elipse puede pasar por cualquier punto de la recta 
\(x = 1\).}{La tangente a la elipse puede pasar por el punto 
\([-1;1]\).}{La tangente a la elipse puede pasar por cualquier punto en la recta 
\(y = 1\).}{}{}}
\End

\Data\ID{9000123103}
\Updated{2020-11-08 09:11:58}
\Level{C}
\SubArea{Conics}
\LANGen{
\Question{
...
\[ 
 5x^{2} + 9y^{2} = 45
\]
tiene la tangente \(2x + 3y = 9\). Encuentra todos los valores del parámetro real \(k\) de modo que la recta \(y = kx + 3\) 
sea una secante a la elipse.}
{\(k\in \left (-\infty ;-\frac{2}
{3}\right )\cup \left (\frac{2}
{3};\infty \right )\)}{\(k\in \left [ -\frac{2}
{3}; \frac{2} 
...
\LANGes{
\Question{
En la siguiente lista identifica una recta que sea una tangente a la elipse  
\[ 
 (x - 2)^{2} + \frac{y^{2}} 
 {9} = 1
\]}
...
\LANGes{
\Question{
Halla todos los valores del parámetro \(p\in \mathbb{R}\) a modo de que la recta \(q\colon y = x - 1\) 
sea una tangente a la parábola \[ 
 x^{2} = 2py.
\]}
{\(p = 2\)}{\(p\in \{0;2\}\)}{\(p = -2\)}{\(p\in \{ - 2;0\}\)}{}{}}
\End
...
\LANGes{
\Question{
En la siguiente lista identifica la recta que es la única intersección con la hipérbola \[ 
 x^{2} - y^{2} = 5
\]
pero al mismo tiempo la recta no es la tangente de esta hipérbola.}
{\(p\colon \frac{x}
{5} + \frac{y} 
{5} = 1\)}{\(p\colon y = 5x\)}{\(p\colon 2x + y = 5\)}{\(\begin{aligned}[t] p\colon x& = 1 &
\\y & = -1 + t\text{; }t\in \mathbb{R}
...
para las que valga que el ángulo entre cada tangente y el eje \(x\)
es \(45^{\circ }\).}
{\(y = x + 2\text{, }y = x - 2\text{, }y = -x + 2\text{, }y = -x - 2\)}{\(y = x + 2\text{, }y = x - 2\)}{\(y = x + 2\text{, }y = -x + 2\)}{\(y = x + 2\)}{}{}}
\End
