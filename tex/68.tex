...
\LANGes{
\Question{
Una parábola tiene su foco en \( F=(5;0) \) y su es \( x=0 \). Halla las coordenadas de su vértice.}
{\( \left[\frac52;0\right] \)}{\( [0;0] \)}{\( \left[0;\frac52\right] \)}{\( [-5;0] \)}{\( \left[-\frac52;0\right] \)}{}}
\End
...
\LANGes{
\Question{
Dados los puntos \( A=(0;0) \), \( B=(1;7) \), \( C=(-1;-5) \) que son puntos de la parábola. Halla la ecuación dicha parábola.}
{\( y=x^2+6x \)}{\( y=x^2 \)}{\( y=7x^2 \)}{\( y=-x^2+4x \)}{\( x=y^2 \)}{}}
\End
...
\LANGes{
\Question{
Dada la ecuación de la parábola \( x^2 -8x +3y-2=0 \). Halla la ecuación de la recta que pasa por el vértice de esta parábola y averigua si es paralela a la recta \( 2x-5y+8=0 \).}
{\( -2x+5y-22 = 0 \)}{\( 2x-5y-22 = 0 \)}{\( 2x-5y-38 = 0 \)}{\( 2x-5y+38 = 0 \)}{\( -2x+5y+22 = 0 \)}{}}
\End
