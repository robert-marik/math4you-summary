...
\LANGes{
\Question{
¿Qué opción no incluye una función logarítmica?}
{\( f(x) = \log_{-2}x\)}{\( g(x) = \log_{2}x\)}{\( h(x) = \log_{\frac12}x\)}{\( m(x) = \log_{0.2}x\)}{}{}}
\End
...
\LANGen{
\Question{
Find the following equality in logarithmic form. 
\[ 8^2  = 64 \]}
...
\LANGcs{
\Question{
Určete předpis logaritmické funkce, jejíž graf prochází body
\([5;0]\) a
\([-1;-2]\).}
{\(y =\log _{2}(x + 3) - 3\)}{\(y =\log _{5}(10 - x) - 1\)}{\(y =\log _{3}(4 + x) - 2\)}{\(y = 2 -\log _{3}(4 + x)\)}{\(y = 3 -\log _{2}(x + 3)\)}{\(y = 1 -\log _{5}(10 - x)\)}}
\LANGsk{
\Question{
Určte predpis logaritmickej funkcie, ktorej graf prechádza bodmi
\([5;0]\) a
\([-1;-2]\).}
{\(y =\log _{2}(x + 3) - 3\)}{\(y =\log _{5}(10 - x) - 1\)}{\(y =\log _{3}(4 + x) - 2\)}{\(y = 2 -\log _{3}(4 + x)\)}{\(y = 3 -\log _{2}(x + 3)\)}{\(y = 1 -\log _{5}(10 - x)\)}}
\LANGes{
...
\LANGen{
\Question{
In the following list identify a point which is not a point on the graph of the function
...
\LANGes{
\Question{
Identifica una expresión negativa.}
{\(\log _{0.1}20 -\log _{0.1}0.2\)}{\(\log _{3}9^{2.5} -\log _{4}4^{0.5}\)}{\(\log _{4}16^{\frac{3} 
{2} } +\log _{3}3^{\frac{1} 
{4} }\)}{\(\log _{3}7 +\log _{3}\frac{81} 
 {7} \)}{}{}}
...
para los que no vale la siguiente expresión. 
\[ 
 \log \left (2x^{2} + 4x - 6\right )
\]}
{\(\left [ -3;1\right ] \)}{\(\left (-\infty ;-3\right )\cup \left (1;\infty \right )\)}{\(\left (-3;1\right )\)}{\(\left (-\infty ;-3\right ] \cup \left [ 1;\infty \right )\)}{}{}}
...
los cuales no define la siguiente expresión. 
\[ 
 \log _{\frac{1} 
{4} }\left [\left (x + \frac{1} 
{2}\right )\left (5 - 2x\right )\right ]
...
\LANGes{
\Question{
De las expresiones dadas elige una que sea equivalente a \( \log\left( 8\cdot\sqrt[3]{75} \right) \), si \( \log2=a\), \( \log3=b \) y \( \log5=c \).}
{\( 3a+\frac13 b+\frac23 c \)}{\( 3a+\frac13 b+\frac13 c \)}{\( 4a+\frac13 b+\frac23 c \)}{\( a+\frac13 b+\frac23 c \)}{}{}}
\End
...
{La función \( f \) es decreciente.}{La función \( f \) es creciente.}{La función \( f \) está acotada.}{La función \( f \) está acotada por abajo.}{}{}}
\End
...
\(\ \log_74;\) \(\log_{\frac47}{0.4};\) \(\log_40.7;\) \(\log_{\frac74}4;\) \(\log_{0.7}0.4;\) \(\log_{0.4}4;\) \(\log_7{0.7}.\ \)
Sin utilizar la calculadora, determina cuántas valores son positivas.}
{\( 4 \)}{\( 3 \)}{\( 2 \)}{\( 5 \)}{}{}}
\End
...
\LANGes{
\Question{
Halla los valores del parámetro real \( a \), para el que vale la siguiente desigualdad \( \log_a\frac47 > \log_a \frac74 \).}
{\( 0 < a < 1 \)}{\( a > 1 \)}{\( a < 1 \)}{\( a > 0 \)}{}{}}
\End
...
\LANGes{
\Question{
Halla el valor del parámetro real \( a \) para el que vale la desigualdad \( \log_a7 < \log_a4 \).}
{\( 0 < a < 1 \)}{\( a > 1 \)}{\( a < 1 \)}{\( a > 0 \)}{}{}}
\End
...
\Question{
Teniendo valores
\( \log_{0.2}3;\) \(\log_20.3;\)  \(\log_{0.3}1;\) \(\log_23;\) \(\log_{\frac32}\frac23;\) \(\log_{\frac23}2;\) \(\log_{0.3}\frac32.\) determina cuántos de los valores dados son negativos. Usa la gráficca de la función logarítmica abajo.}
{\( 5 \)}{\( 4 \)}{\( 3 \)}{\( 2 \)}{}{}}
\End
...
\LANGes{
\Question{
Identifica una función acotada por abajo.}
{\(y = 3^{x}\)}{\(y = -3^{x}\)}{\(y =\log _{3}x\)}{\(y = -\log _{3}x\)}{}{}}
\End
...
\LANGes{
\Question{
Halla el enunciado verdadero de la función \( f(x)=\log_2|x| \).}
...
\LANGes{
\Question{
Si \( x\in(0;1)\cup(1;\infty) \), el producto de \( \left(\log_x3\right)\left(\log_5x\right) \) se puede escribir como:}
{\( \log_53 \)}{\( \log_35 \)}{\( \log_{5x}(3x) \)}{\( \log_x3+\log_5x \)}{}{}}
\End
...
\LANGes{
\Question{
El \( pH \) es el la medida del grado de acidez de una sustancia. En práctica, el \( pH \) es el logaritmo negativo de la concentración molar de los iones hidrógeno \( H^+ \)  (es decir, el número de moles de los iones hidrógeno en un litro de una solución):
\[ pH = -\log{(H^+ )}. \]
Si un zumo de manzanas tiene el \( pH \) igual a \( 3.8 \) y el zumo de pomelo tiene el \( pH \) igual a \( 3.6 \), ¿cuál es la diferencia de la concentración molar de los iones hidrógeno (\( \mathrm{mol}/\mathrm{l} \)) en el zumo de manzanas y en el zumo de pomelo? Aproxima el resultado a seis decimales.}
{\( 0.000093 \)}{\( -0.000093 \)}{\( 1.584893 \)}{\( 0 \)}{}{}}
\End
...
\LANGes{
\Question{
Dada la función \( f \)  por la gráfica de abajo. Identifica cuál de los siguientes enunciados es falso.}
{\( f(x)=\log_2|x|;\ x\in[0.25;8] \)}{\( f(x)=|\log_2 x |;\ x\in[0.25;8] \)}{\( f(x)=|-\log_2 x|;\ x\in[0.25;8]  \)}{\( f(x)=\left|\log_{\frac12} x \right|;\ x\in[0.25;8] \)}{}{}}
\End
...
no son negativos.}{La función \(f\) no tiene intersección con el eje \(y\).}{La intersección de la función \(f\) con el eje \(x\)
