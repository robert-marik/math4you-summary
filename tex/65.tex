...
\Data\ID{1003024307}
\Updated{2026-05-13 09:05:12}
\Level{A}
\SubArea{Points and Vectors}
\LANGen{
\Question{
Let \( \vec{a} = (-1;2) \), \( \vec{b} = (2;1) \), \( \vec{c} = (-4;3) \). Express vector \( \vec{c} \) as a linear combination of vectors \( \vec{a} \) and \( \vec{b} \).}
{\( \vec{c} = 2\vec{a} - \vec{b} \)}{\( \vec{c} = 4\vec{a} - 8\vec{b} \)}{\( \vec{c} = 4\vec{a} - \vec{b} \)}{\( \vec{c} = -2\vec{a} + \vec{b} \)}{}{}}
\LANGpl{
\Question{
...
{\( \vec{a}=-2\vec{v};\ \vec{b}=-2\vec{u}-2\vec{v} \)}{\( \vec{a}=\vec{b}+2\vec{u};\ \vec{b}=-2\vec{u}+2\vec{v} \)}{\( \vec{a}=\vec{b}-2\vec{u};\ \vec{b}=-\sqrt2\vec{u}-\sqrt2\vec{v} \)}{\( \vec{a}=-2\vec{v};\ \vec{b}=2\vec{u}+2\vec{v} \)}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
V rovnobežníku \( ABCD \) sú vyznačené body \( G \) - stred \( CD \), \( F \) - stred \( BC \) a vektory  \( \vec{u}=\overrightarrow{CG} \), \( \vec{v}=\overrightarrow{CF} \), \( \vec{a}=\overrightarrow{AD} \)  a  \( \vec{b}=\overrightarrow{AC} \). 
Vyjadrite vektory \( \overrightarrow{a} \)  a \( \overrightarrow{b} \) ako lineárna kombinácia vektorov \( \vec{u} \) a \( \vec{v} \).}
{\( \vec{a}=-2\vec{v};\ \vec{b}=-2\vec{u}-2\vec{v} \)}{\( \vec{a}=\vec{b}+2\vec{u};\ \vec{b}=-2\vec{u}+2\vec{v} \)}{\( \vec{a}=\vec{b}-2\vec{u};\ \vec{b}=-\sqrt2\vec{u}-\sqrt2\vec{v} \)}{\( \vec{a}=-2\vec{v};\ \vec{b}=2\vec{u}+2\vec{v} \)}{}{}}
\LANGes{
\Question{
...
\LANGes{
\Question{
En el triángulo \( ABC \), sean \( K \), \( L \) y \( M \) los puntos medios de \( AB \), \( BC \) y \( AC \) respectivamente y \( T \) el bicentro del triángulo \( ABC \). 
...
{\( \vec{c} = \vec{a} + \vec{b};\ \vec{d} = \vec{b} - \vec{a}  \)}{\( \vec{c} = 2\vec{a} + 2\vec{b};\ \vec{d} = 2\vec{b} - 0.5\vec{a}  \)}{\( \vec{c} = 2\vec{a} + \vec{b};\ \vec{d} = \vec{b} - \vec{a}  \)}{\( \vec{c} = \vec{a} + \vec{b};\ \vec{d} = \vec{a} - \vec{b}  \)}{}{}}
\LANGpl{
\Question{
...
{\(  \vec{x} =  \vec{a} +  \frac12\vec{b} + \vec{c};\  \vec{y} =  \vec{a} + \frac12\vec{b} + \frac12\vec{c} \)}{\(  \vec{x} =  \frac12\vec{a} +  \vec{b} + \frac12\vec{c};\  \vec{y} = \vec{a} - \frac12\vec{b} + \frac12\vec{c} \)}{\(  \vec{x} =  \vec{a} +  \frac12\vec{b} + \frac12\vec{c};\  \vec{y} =   \vec{a} - \frac12\vec{b} + \frac12\vec{c} \)}{\(  \vec{x} =  \vec{a} + \frac12\vec{b} + \frac12\vec{c};\  \vec{y} =  \frac12\vec{a} + \frac12\vec{b} + \frac12\vec{c} \)}{}{}}
\LANGpl{
\Question{
...
{\( \vec{e} = \frac12\vec{b} + \frac12\vec{c};\ \vec{f} = \frac12\vec{b} + \frac12\vec{c} - \vec{d} \)}{\( \vec{e} = \frac12\vec{b} + \frac12\vec{d};\ \vec{f} = \vec{b} + \vec{c} + \vec{d} \)}{\( \vec{e} = \vec{b} + \vec{c};\ \vec{f} =\frac12\vec{b} + \frac12\vec{c} - \vec{d} \)}{\( \vec{e} = \frac12\vec{b} + \frac12\vec{c};\ \vec{f} = \frac12\vec{b} + \frac12\vec{c} + \vec{d} \)}{}{}}
\LANGpl{
\Question{
...
{\( \vec{c} = -2\vec{a} + \vec{b}  \)}{\( \vec{c} = -\vec{a} + \frac12\vec{b}  \)}{\( \vec{c} = -\frac32\vec{a} + \vec{b}  \)}{\( \vec{c} = -2\vec{a} + \frac32\vec{b}  \)}{}{}}
\LANGpl{
\Question{
...
{\( \vec{b} = 2\vec{a} + \vec{c}  \)}{\( \vec{b} = 2\vec{a} - \vec{c}  \)}{\( \vec{b} = -2\vec{a} + \vec{c}  \)}{\( \vec{b} = -2\vec{a} - \vec{c}  \)}{}{}}
\LANGpl{
\Question{
...
{\( \vec{b} = \left(1;3;4.5\right);\ \vec{b} = \frac12\vec{a} + \frac12\vec{c}  \)}{\( \vec{b} = \left(3;1;4.5\right);\ \vec{b} = \vec{a} + \vec{c}  \)}{\( \vec{b} = \left(1;3;4.5\right);\ \vec{b} = \vec{a} + \vec{c}  \)}{\( \vec{b} = \left(3;1;4.5\right);\ \vec{b} = \frac12\vec{a} + \frac12\vec{c}  \)}{}{}}
\LANGpl{
\Question{
...
{\( \vec{x}=\frac13 \vec{a}+\frac13 \vec{c} \), \( \left|\vec{x}\right|=5 \)}{\( \vec{x}=\frac23 \vec{a}+\frac23 \vec{c} \), \( \left|\vec{x}\right|=10 \)}{\( \vec{x}=\frac12 \vec{a}+\frac12 \vec{c} \), \( \left|\vec{x}\right|=\frac{15}2 \)}{\( \vec{x}=\frac14 \vec{a}+\frac14 \vec{c} \), \( \left|\vec{x}\right|=\frac{225}{12} \)}{}{}}
\LANGpl{
\Question{
Dany jest trójkąt  KLM  i wektory \( \vec{a} \), \( \vec{c} \) w układzie współrzędnych. 
 Punkt  T to środek ciężkości trójkąta KLM. Przedstaw wektor \( \vec{x} \), gdzie \( \vec{x}=\overrightarrow{KT} \) jest liniową kombinacją  \( \vec{a} \) i \( \vec{c} \) i oblicz \( \left|\vec{x}\right| \).}
{\( \vec{x}=\frac13 \vec{a}+\frac13 \vec{c} \), \( \left|\vec{x}\right|=5 \)}{\( \vec{x}=\frac23 \vec{a}+\frac23 \vec{c} \), \( \left|\vec{x}\right|=10 \)}{\( \vec{x}=\frac12 \vec{a}+\frac12 \vec{c} \), \( \left|\vec{x}\right|=\frac{15}2 \)}{\( \vec{x}=\frac14 \vec{a}+\frac14 \vec{c} \), \( \left|\vec{x}\right|=\frac{225}{12} \)}{}{}}
\LANGcs{
\Question{
...
\LANGpl{
\Question{
Wyznacz długość wektora \((3; 4)\).}
{\(5\)}{\(7\)}{\(1\)}{\(-1\)}{}{}}
\LANGcs{
\Question{
Určete velikost vektoru \((3; 4)\).}
{\(5\)}{\(7\)}{\(1\)}{\(-1\)}{}{}}
\LANGsk{
\Question{
Určte veľkosť vektora \((3; 4)\).}
{\(5\)}{\(7\)}{\(1\)}{\(-1\)}{}{}}
\LANGes{
\Question{
...
\LANGen{
\Question{
Find the length of the vector \((-5; 2)\).}
{\(\sqrt{29}\)}{\(\sqrt{7}\)}{\(\sqrt{3}\)}{\(\sqrt{21}\)}{}{}}
\LANGpl{
\Question{
Wyznacz długość wektora  \((-5; 2)\).}
{\(\sqrt{29}\)}{\(\sqrt{7}\)}{\(\sqrt{3}\)}{\(\sqrt{21}\)}{}{}}
\LANGcs{
\Question{
Určete velikost vektoru \((-5; 2)\).}
{\(\sqrt{29}\)}{\(\sqrt{7}\)}{\(\sqrt{3}\)}{\(\sqrt{21}\)}{}{}}
\LANGsk{
\Question{
Určte veľkosť vektora \((-5; 2)\).}
{\(\sqrt{29}\)}{\(\sqrt{7}\)}{\(\sqrt{3}\)}{\(\sqrt{21}\)}{}{}}
\LANGes{
\Question{
...
\LANGen{
\Question{
Find the vector \(\overrightarrow{AB}\), where \(A=[3;5]\) and \(B=[5;2]\).}
{\( (2;-3)\)}{\((-2;3)\)}{\((4;3.5)\)}{\( (8;7)\)}{}{}}
\LANGpl{
\Question{
Wyznacz wektor \(\overrightarrow{AB}\), gdzie \(A=[3;5]\) i \(B=[5;2]\).}
{\( (2;-3)\)}{\((-2;3)\)}{\((4;3{,}5)\)}{\( (8;7)\)}{}{}}
\LANGcs{
\Question{
Určete vektor  \(\overrightarrow{AB}\), kde \(A=[3;5]\) a \(B=[5;2]\).}
{\( (2;-3)\)}{\((-2;3)\)}{\((4;3{,}5)\)}{\( (8;7)\)}{}{}}
\LANGsk{
\Question{
Určte vektor \(\overrightarrow{AB}\), ak \(A=[3;5]\) a \(B=[5;2]\).}
{\( (2;-3)\)}{\((-2;3)\)}{\((4;3{,}5)\)}{\( (8;7)\)}{}{}}
\LANGes{
\Question{
...
\LANGen{
\Question{
Find the vector \(\overrightarrow{AB}\), where \(A=[-3;1]\) and \(B=[4;2]\).}
{\( (7;1) \)}{\( (1;1) \)}{\( (7;-1) \)}{\( (-1;1) \)}{}{}}
\LANGpl{
\Question{
Wyznacz wektor  \(\overrightarrow{AB}\), gdzie \(A=[-3;1]\) i \(B=[4;2]\).}
{\( (7;1) \)}{\( (1;1) \)}{\( (7;-1) \)}{\( (-1;1) \)}{}{}}
\LANGcs{
\Question{
Určete vektor \(\overrightarrow{AB}\), kde \(A=[-3;1]\) a \(B=[4;2]\).}
{\( (7;1) \)}{\( (1;1) \)}{\( (7;-1) \)}{\( (-1;1) \)}{}{}}
\LANGsk{
\Question{
Určte vektor \(\overrightarrow{AB}\), ak \(A=[-3;1]\) a \(B=[4;2]\).}
{\( (7;1) \)}{\( (1;1) \)}{\( (7;-1) \)}{\( (-1;1) \)}{}{}}
\LANGes{
\Question{
...
\Data\ID{2000001405}
\Updated{2022-05-16 11:05:38}
\Level{A}
\SubArea{Points and Vectors}
\LANGen{
\Question{
Find the opposite vector of the vector \( (1;-3) \).}
{\( (-1;3) \)}{\( (-3;1) \)}{\( (3;1) \)}{\( (1;3) \)}{}{}}
\LANGpl{
\Question{
Wyznacz przeciwieństwo  wektora \( (1;-3) \).}
{\( (-1;3) \)}{\( (-3;1) \)}{\( (3;1) \)}{\( (1;3) \)}{}{}}
\LANGcs{
\Question{
Určete opačný vektor k vektoru \( (1;-3) \).}
{\( (-1;3) \)}{\( (-3;1) \)}{\( (3;1) \)}{\( (1;3) \)}{}{}}
\LANGsk{
\Question{
Určte opačný vektor k vektoru \( (1;-3) \).}
{\( (-1;3) \)}{\( (-3;1) \)}{\( (3;1) \)}{\( (1;3) \)}{}{}}
\LANGes{
\Question{
...
\LANGen{
\Question{
Find the vector \(\vec{c} = 2\vec{a} + \vec{b}\), where \(\vec{a}=(2;3) \) and \(\vec{b}=(-2;5) \).}
{\((2;11)\)}{\((0;8)\)}{\((6;11)\)}{\((6;8)\)}{}{}}
\LANGpl{
\Question{
Wyznacz wektor \(\vec{c} = 2\vec{a} + \vec{b}\), gdzie \(\vec{a}=(2;3) \), \(\vec{b}=(-2;5) \).}
{\((2;11)\)}{\((0;8)\)}{\((6;11)\)}{\((6;8)\)}{}{}}
\LANGcs{
\Question{
Určete vektor \(\vec{c} = 2\vec{a} + \vec{b}\), kde \(\vec{a}=(2;3) \) a \(\vec{b}=(-2;5) \).}
{\((2;11)\)}{\((0;8)\)}{\((6;11)\)}{\((6;8)\)}{}{}}
\LANGsk{
\Question{
Určte vektor \(\vec{c} = 2\vec{a} + \vec{b}\), ak \(\vec{a}=(2;3) \) a \(\vec{b}=(-2;5) \).}
{\((2;11)\)}{\((0;8)\)}{\((6;11)\)}{\((6;8)\)}{}{}}
\LANGes{
\Question{
...
\LANGen{
\Question{
Find the vector \(\vec{c} = \vec{a} + 2\vec{b}\), where \(\vec{a}=(-1;3) \) and \(\vec{b}=(1;-2) \).}
{\( (1;-1) \)}{\( (0;1) \)}{\( (-1;4) \)}{\( (1;7) \)}{}{}}
\LANGpl{
\Question{
Wyznacz wektor \(\vec{c} = \vec{a} + 2\vec{b}\), gdzie \(\vec{a}=(-1;3) \), \(\vec{b}=(1;-2) \).}
{\( (1;-1) \)}{\( (0;1) \)}{\( (-1;4) \)}{\( (1;7) \)}{}{}}
\LANGcs{
\Question{
Určete vektor \(\vec{c} = \vec{a} + 2\vec{b}\), kde \(\vec{a}=(-1;3) \) a \(\vec{b}=(1;-2) \).}
{\( (1;-1) \)}{\( (0;1) \)}{\( (-1;4) \)}{\( (1;7) \)}{}{}}
\LANGsk{
\Question{
Určte vektor \(\vec{c} = \vec{a} + 2\vec{b}\), ak \(\vec{a}=(-1;3) \) a \(\vec{b}=(1;-2) \).}
{\( (1;-1) \)}{\( (0;1) \)}{\( (-1;4) \)}{\( (1;7) \)}{}{}}
\LANGes{
\Question{
...
\LANGpl{
\Question{
Wyznacz wektor \(\vec{c} = \vec{a} - \vec{b}\), gdzie \(\vec{a}=(1;2) \) i \(\vec{b}=(-3;4) \).}
{\( (4;-2)\)}{\( (-2;-2)\)}{\( (4;2)\)}{\( (2;-2)\)}{}{}}
\LANGcs{
\Question{
Určete vektor \(\vec{c} = \vec{a} - \vec{b}\), kde \(\vec{a}=(1;2) \) a \(\vec{b}=(-3;4) \).}
{\( (4;-2)\)}{\( (-2;-2)\)}{\( (4;2)\)}{\( (2;-2)\)}{}{}}
\LANGsk{
\Question{
Určte vektor \(\vec{c} = \vec{a} - \vec{b}\), ak \(\vec{a}=(1;2) \) a \(\vec{b}=(-3;4) \).}
{\( (4;-2)\)}{\( (-2;-2)\)}{\( (4;2)\)}{\( (2;-2)\)}{}{}}
\LANGes{
\Question{
Determina el vector  \(\vec{c} = \vec{a} - \vec{b}\), donde \(\vec{a}=(1;2) \) y \(\vec{b}=(-3;4) \).}
{\( (4;-2)\)}{\( (-2;-2)\)}{\( (4;2)\)}{\( (2;-2)\)}{}{}}
\End
...
\LANGpl{
\Question{
Wyznacz wektor \(\vec{c} = 2\vec{a} - \vec{b}\), gdzie \(\vec{a}=(3;5) \), \(\vec{b}=(-1;4) \).}
{\( (7;6) \)}{\( (5;6) \)}{\( (5;14) \)}{\( (4;1) \)}{}{}}
\LANGcs{
\Question{
Určete vektor \(\vec{c} = 2\vec{a} - \vec{b}\), kde \(\vec{a}=(3;5) \) a \(\vec{b}=(-1;4) \).}
{\( (7;6) \)}{\( (5;6) \)}{\( (5;14) \)}{\( (4;1) \)}{}{}}
\LANGsk{
\Question{
Určte vektor \(\vec{c} = 2\vec{a} - \vec{b}\), ak \(\vec{a}=(3;5) \) a \(\vec{b}=(-1;4) \).}
{\( (7;6) \)}{\( (5;6) \)}{\( (5;14) \)}{\( (4;1) \)}{}{}}
\LANGes{
\Question{
...
\LANGpl{
\Question{
Wyznacz wektor prostopadły do wektora  \((3; -4)\).}
{\( (8;6)\)}{\( (-6;8)\)}{\( (6;-8)\)}{\( (3;4)\)}{}{}}
\LANGcs{
\Question{
...
\LANGpl{
\Question{
Wyznacz wektor prostopadły do wektora \((-1; 4)\).}
{\( (8;2)\)}{\( (2;8)\)}{\( (1;4)\)}{\( (-2;8)\)}{}{}}
\LANGcs{
\Question{
...
\LANGpl{
\Question{
Wyznacz wektor równoległy do wektora \((1; 4)\).}
{\( (2;8)\)}{\( (2;2)\)}{\( (-1;2)\)}{\( (8;-2)\)}{}{}}
\LANGcs{
\Question{
...
{\( \left(\sqrt{2};0\right)\)}{\( (2;0)\)}{\( (0;2)\)}{\( \left(0;\sqrt{2}\right)\)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
\( S \) je středem úsečky \( AB \). \( B = [3; -5] \), \( S = [0; -7] \). Určete souřadnice bodu \( A \).}
{\( A = [-3; -9] \)}{\( A = [1{,}5; -6] \)}{\( A = [3; -12] \)}{\( A = [-3; -2] \)}{}{}}
\LANGsk{
\Question{
...
{\( \overrightarrow{AC} \)}{\( \overrightarrow{FH} \)}{\( \overrightarrow{AG} \)}{\( \overrightarrow{BH} \)}{}{}}
\LANGpl{
\Question{
...
\Data\ID{2010015704}
\Updated{2026-05-13 09:05:56}
\Level{A}
\SubArea{Points and Vectors}
\IMG{2010015701-figure1.pdf}
\LANGen{
\Question{
Given the vectors \( \vec{a} \), \( \vec{b} \), and \( \vec{c} \) shown in the picture, express the vector \( \vec{c} \) as a linear combination of vectors \( \vec{a} \) and \( \vec{b} \).}
{\( \vec{c} = -\vec{a}-2\vec{b}  \)}{\( \vec{c} = -\vec{a} + \frac12 \vec{b}  \)}{\( \vec{c} = -2\vec{a} - \vec{b}  \)}{\( \vec{c} = 2\vec{a} + \frac32 \vec{b}  \)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Jsou dány vektory \( \vec{a} \), \( \vec{b} \) a \( \vec{c} \). Vyjádřete vektor \( \vec{c} \) jako lineární kombinaci vektorů \( \vec{a} \) a \( \vec{b} \).}
{\( \vec{c} = -\vec{a}-2\vec{b}  \)}{\( \vec{c} = -\vec{a} + \frac12 \vec{b}  \)}{\( \vec{c} = -2\vec{a} - \vec{b}  \)}{\( \vec{c} = 2\vec{a} + \frac32 \vec{b}  \)}{}{}}
\LANGsk{
\Question{
Dané sú vektory \( \vec{a} \), \( \vec{b} \) a \( \vec{c} \) znázornené na obrázku. Vyjadrite vektor
\( \vec{c} \) ako lineárnu kombináciu vektorov\( \vec{a} \) a \( \vec{b} \).}
{\( \vec{c} = -\vec{a}-2\vec{b}  \)}{\( \vec{c} = -\vec{a} + \frac12 \vec{b}  \)}{\( \vec{c} = -2\vec{a} - \vec{b}  \)}{\( \vec{c} = 2\vec{a} + \frac32 \vec{b}  \)}{}{}}
\LANGes{
\Question{
...
{\(|\vec{u}| = 5\)}{\(|\vec{u}| = \sqrt{10}\)}{\(|\vec{u}| = 3\)}{\(|\vec{u}| = 1\)}{}{}}
\LANGpl{
\Question{
...
\Data\ID{1003030603}
\Updated{2026-05-13 09:05:15}
\Level{B}
\SubArea{Points and Vectors}
\LANGen{
\Question{
Let \( \vec{v}=(12;5) \). Find all the vectors \( \vec{u} \) that are perpendicular to the vector  \( \vec{v} \) and have the length of \( 26 \).}
{\( \vec{u_1}  =(10;-24);\  \vec{u_2}=(-10; 24) \)}{\( \vec{u}=(10;-24) \)}{\( \vec{u_1}=\frac12 (5;-12);\ \vec{u_2}=\frac12 (-5; 12) \)}{\( \vec{u_1}=26\cdot(5;-12);\ \vec{u_2}=26\cdot(-5; 12) \)}{}{}}
\LANGpl{
\Question{
...
\Data\ID{1003030604}
\Updated{2026-05-13 09:05:19}
\Level{B}
\SubArea{Points and Vectors}
\LANGen{
\Question{
Let \( \vec{a}=(2;- 3) \)  and \( \vec{b}=(3;-2) \).  Find all the vectors \( \vec{c} \) such that 
\[ \vec{a}\cdot\vec{c}=8\ \text{ and }\  \vec{b}\cdot\vec{c}=27. \]}
{\( \vec{c}=(13;6) \)}{\( \vec{c_1}=(13;6);\ \vec{c_2}=(-13;-6) \)}{\( \vec{c}=(13k;6k);\ k\in\mathbb{R} \)}{\( \vec{c}=(-13;-6) \)}{}{}}
\LANGpl{
\Question{
Podano \( \vec{a}=(2;- 3) \)  i \( \vec{b}=(3;-2) \).  Wskaż wszystkie wektory \( \vec{c} \) tak, aby
\[ \vec{a}\cdot\vec{c}=8\ \text{ i }\  \vec{b}\cdot\vec{c}=27. \]}
{\( \vec{c}=(13;6) \)}{\( \vec{c_1}=(13;6);\ \vec{c_2}=(-13;-6) \)}{\( \vec{c}=(13k;6k);\ k\in\mathbb{R} \)}{\( \vec{c}=(-13;-6) \)}{}{}}
\LANGcs{
\Question{
...
\LANGes{
\Question{
Sean \( \vec{a}=(2;- 3) \)  y \( \vec{b}=(3;-2) \).  Determina todos los vectores \( \vec{c} \) para los que se cumple : 
\[ \vec{a}\cdot\vec{c}=8\ \text{ y }\  \vec{b}\cdot\vec{c}=27. \]}
{\( \vec{c}=(13;6) \)}{\( \vec{c_1}=(13;6);\ \vec{c_2}=(-13;-6) \)}{\( \vec{c}=(13k;6k);\ k\in\mathbb{R} \)}{\( \vec{c}=(-13;-6) \)}{}{}}
\End

\Data\ID{1003030605}
\Updated{2026-05-13 09:05:53}
\Level{B}
\SubArea{Points and Vectors}
\LANGen{
\Question{
Let \( \vec{a}=(3;-5) \) and \( \vec{b}=(6;-10) \). Find all the vectors  \( \vec{c} \) such that 
\[ \vec{a}\cdot\vec{c}=11\ \text{ and }\ \vec{b}\cdot\vec{c}=22\text{ .} \]}
{\( \vec{c}=(2+5k;-1+3k);\ k\in\mathbb{R} \)}{\( \vec{c}_1=(7;2);\ \vec{c}_2=(-7;-2) \)}{\( \vec{c}=(2k;-k);\ k\in\mathbb{R} \)}{\( \vec{c}_1=(2;-1);\ \vec{c}_2=(-2;1) \)}{}{}}
\LANGpl{
\Question{
Dane są wektory \( \vec{a}=(3;-5) \) i \( \vec{b}=(6;-10) \). Wskaż wszystkie wektory  \( \vec{c} \) tak, aby
\[ \vec{a}\cdot\vec{c}=11\ \text{ i }\ \vec{b}\cdot\vec{c}=22\text{ .} \]}
{\( \vec{c}=(2+5k;-1+3k);\ k\in\mathbb{R} \)}{\( \vec{c}_1=(7;2);\ \vec{c}_2=(-7;-2) \)}{\( \vec{c}=(2k;-k);\ k\in\mathbb{R} \)}{\( \vec{c}_1=(2;-1);\ \vec{c}_2=(-2;1) \)}{}{}}
\LANGcs{
\Question{
...
\LANGes{
\Question{
Sean \( \vec{a}=(3;-5) \) y \( \vec{b}=(6;-10) \). Determina todos los vectores  \( \vec{c} \) par los que se cumple que : 
\[ \vec{a}\cdot\vec{c}=11\ \text{ y }\ \vec{b}\cdot\vec{c}=22\text{ .} \]}
{\( \vec{c}=(2+5k;-1+3k);\ k\in\mathbb{R} \)}{\( \vec{c}_1=(7;2);\ \vec{c}_2=(-7;-2) \)}{\( \vec{c}=(2k;-k);\ k\in\mathbb{R} \)}{\( \vec{c}_1=(2;-1);\ \vec{c}_2=(-2;1) \)}{}{}}
\End

\Data\ID{1003040210}
\Updated{2022-05-23 12:05:55}
\Level{B}
\SubArea{Points and Vectors}
\LANGen{
\Question{
...
{\( \vec{v}\cdot\vec{w}=9 \), \( \vec{v}\cdot\vec{z} = 0 \), \( \vec{v}\cdot\vec{u}=27 \)}{\( \vec{v}\cdot\vec{w}=9 \), \( \vec{v}\cdot\vec{z} = 0 \), \( \vec{v}\cdot\vec{u}=9\sqrt6 \)}{\( \vec{v}\cdot\vec{w}=\frac92 \), \( \vec{v}\cdot\vec{z} = 0 \), \( \vec{v}\cdot\vec{u}=9\sqrt6 \)}{\( \vec{v}\cdot\vec{w}=\frac92 \), \( \vec{v}\cdot\vec{z} = 1 \), \( \vec{v}\cdot\vec{u}=27 \)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Sea \( ABCDEF \)  un hexágono regular con centro \( S \) y longitud del lado \( 3\,\mathrm{cm}\).
El punto \( G \) es el centro del segmento \( AB \).
Los vectores  \( \vec{u} \), \( \vec{v} \), \( \vec{w} \), \( \vec{z} \) están representados en el hexágono de la imagen.
Calcula el producto escalar: \( \vec{v}\cdot\vec{w} \), \( \vec{v}\cdot\vec{z} \) and \( \vec{v}\cdot\vec{u} \).}
{\( \vec{v}\cdot\vec{w}=9 \), \( \vec{v}\cdot\vec{z} = 0 \), \( \vec{v}\cdot\vec{u}=27 \)}{\( \vec{v}\cdot\vec{w}=9 \), \( \vec{v}\cdot\vec{z} = 0 \), \( \vec{v}\cdot\vec{u}=9\sqrt6 \)}{\( \vec{v}\cdot\vec{w}=\frac92 \), \( \vec{v}\cdot\vec{z} = 0 \), \( \vec{v}\cdot\vec{u}=9\sqrt6 \)}{\( \vec{v}\cdot\vec{w}=\frac92 \), \( \vec{v}\cdot\vec{z} = 1 \), \( \vec{v}\cdot\vec{u}=27 \)}{}{}}
\End
...
\LANGen{
\Question{
The vectors \( \vec{u} \), \( \vec{v}\), \( \vec{w} \), \( \vec{z} \) are indicated in a cube shown in the figure. The cube  edge length is \( 1 \). Find the dot products of:
\[ \vec{v}\cdot\vec{z}\text{ ,}\ \ \vec{u}\cdot\vec{v} \text{ ,}\ \ \vec{w}\cdot\vec{u}\]}
{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=\frac{\sqrt2}2 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{\( \vec{v}\cdot\vec{z}=\sqrt2 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{}{}}
\LANGpl{
\Question{
W sześcianie wskazano wektory \( \vec{u} \), \( \vec{v}\), \( \vec{w} \), \( \vec{z} \). Krawędź sześcianu jest równa \( 1 \). Oblicz iloczyn skalarny:
\[ \vec{v}\cdot\vec{z}\text{ ,}\ \ \vec{u}\cdot\vec{v} \text{ ,}\ \ \vec{w}\cdot\vec{u} \]}
{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=\frac{\sqrt2}2 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{\( \vec{v}\cdot\vec{z}=\sqrt2 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{}{}}
\LANGcs{
\Question{
V krychli o délce hrany \( 1 \) jsou vyznačeny vektory \( \vec{u} \), \( \vec{v}\), \( \vec{w} \), \( \vec{z} \). Vypočtěte skalární součiny:
\[ \vec{v}\cdot\vec{z}\text{ ,}\ \ \vec{u}\cdot\vec{v} \text{ ,}\ \ \vec{w}\cdot\vec{u} \]}
{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=\frac{\sqrt2}2 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{\( \vec{v}\cdot\vec{z}=\sqrt2 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{}{}}
\LANGsk{
\Question{
V kocke s dĺžkou hrany \( 1 \) sú vyznačené vektory \( \vec{u} \), \( \vec{v}\), \( \vec{w} \), \( \vec{z} \). Vypočítajte skalárne súčiny:
\[ \vec{v}\cdot\vec{z}\text{ ,}\ \ \vec{u}\cdot\vec{v} \text{ ,}\ \ \vec{w}\cdot\vec{u}\]}
{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=\frac{\sqrt2}2 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{\( \vec{v}\cdot\vec{z}=\sqrt2 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{}{}}
\LANGes{
\Question{
Los vectores \( \vec{u} \), \( \vec{v}\), \( \vec{w} \), \( \vec{z} \) se muestran en el cubo de la figura. La longitud de la arista del cubo es \( 1 \). Determina el producto escalar de:
\[ \vec{v}\cdot\vec{z}\text{ ,}\ \ \vec{u}\cdot\vec{v} \text{ ,}\ \ \vec{w}\cdot\vec{u}\]}
{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=\frac{\sqrt2}2 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{\( \vec{v}\cdot\vec{z}=\sqrt2 \), \( \vec{u}\cdot\vec{v}=0 \), \( \vec{w}\cdot\vec{u}=1 \)}{\( \vec{v}\cdot\vec{z}=1 \), \( \vec{u}\cdot\vec{v}=1 \), \( \vec{w}\cdot\vec{u}=\sqrt3 \)}{}{}}
\End
...
{\( \vec{u}=(-3;6);\ \ \vec{v} =(-9;-6);\ \  \vec{u}\cdot\vec{v} = -9 \)}{\( \vec{u}=(3;-6);\ \ \vec{v} =(9;6);\ \  \vec{u}\cdot\vec{v} = -9 \)}{\( \vec{u}=(-3;6);\ \ \vec{v} =(-9;-6);\ \  \vec{u}\cdot\vec{v} = 9 \)}{\( \vec{u}=(3;-6);\ \ \vec{v} =(9;6);\ \  \vec{u}\cdot\vec{v} = 0 \)}{}{}}
\LANGpl{
\Question{
...
\Question{
Find the coordinates of the vectors \(  \vec{u} \) and \(  \vec{v} \) given by the picture and evaluate their dot product.}
{\( \vec{u}=(-8;-7;9);\ \ \vec{v} =(8;7;9);\ \  \vec{u}\cdot\vec{v} = -32 \)}{\( \vec{u}=(-8;-7;9);\ \ \vec{v} =(8;7;9);\ \  \vec{u}\cdot\vec{v} = 0 \)}{\( \vec{u}=(-8;-7;9);\ \ \vec{v} =(8;7;9);\ \  \vec{u}\cdot\vec{v} = (-64;-49;81) \)}{\( \vec{u}=(8;7;-9);\ \ \vec{v} =(-8;-7;-9);\ \  \vec{u}\cdot\vec{v} = (-64;-49;81) \)}{}{}}
\LANGpl{
\Question{
Określ współrzędne wektorów \(  \vec{u} \) i \(  \vec{v} \) podanych na rysunku i oblicz iloczyn skalarny.}
{\( \vec{u}=(-8;-7;9);\ \ \vec{v} =(8;7;9);\ \  \vec{u}\cdot\vec{v} = -32 \)}{\( \vec{u}=(-8;-7;9);\ \ \vec{v} =(8;7;9);\ \  \vec{u}\cdot\vec{v} = 0 \)}{\( \vec{u}=(-8;-7;9);\ \ \vec{v} =(8;7;9);\ \  \vec{u}\cdot\vec{v} = (-64;-49;81) \)}{\( \vec{u}=(8;7;-9);\ \ \vec{v} =(-8;-7;-9);\ \  \vec{u}\cdot\vec{v} = (-64;-49;81) \)}{}{}}
...
\Data\ID{1103030504}
\Updated{2026-05-13 09:05:03}
\Level{B}
\SubArea{Points and Vectors}
\IMG{1103030504.pdf}
\LANGen{
\Question{
The vectors \( \vec{u} \)  and \( \vec{v} \) are given by the figure. Find cosine of the angle \(\varphi \) between \( \vec{u} \) and \( \vec{v} \).
...
\LANGpl{
\Question{
W układzie współrzędnych podano wektory \( \vec{u} \)  i \( \vec{v} \). Oblicz cosinus kąta \(\varphi \) między \( \vec{u} \) i \( \vec{v} \).
Wskazówka: Użyj iloczynu skalarnego wektorów.}
{\( \cos\varphi=\frac{13\sqrt{10}}{50} \)}{\( \cos\varphi=\frac{970}{50} \)}{\( \cos\varphi=\frac{3\sqrt{10}}{10} \)}{\( \cos\varphi=\frac{\sqrt{10}}{5} \)}{}{}}
\LANGcs{
\Question{
V souřadném systému jsou znázorněny vektory \( \vec{u} \)  a \( \vec{v} \). Určete kosinus jejich odchylky \(\varphi \).
Nápověda: Užijte skalární součin vektorů.}
{\( \cos\varphi=\frac{13\sqrt{10}}{50} \)}{\( \cos\varphi=\frac{970}{50} \)}{\( \cos\varphi=\frac{3\sqrt{10}}{10} \)}{\( \cos\varphi=\frac{\sqrt{10}}{5} \)}{}{}}
\LANGsk{
\Question{
V súradnicovom systéme sú znázornené vektory \( \vec{u} \)  a \( \vec{v} \). Určte kosínus ich odchýlky \(\varphi \).
...
\LANGcs{
\Question{
Vektory \( \vec{u} \) a \( \vec{v} \) jsou zadány v souřadném systému. Určete kosinus jejich odchylky \( \varphi \).
Nápověda: Užijte skalární součin daných vektorů.}
{\( \cos\varphi=-\frac9{17} \)}{\( \cos\varphi=\frac9{17} \)}{\( \cos\varphi=\frac{\sqrt{17}}{2\sqrt{13}} \)}{\( \cos\varphi=-\frac{\sqrt{17}}{2\sqrt{13}} \)}{}{}}
\LANGsk{
\Question{
Vektory \( \vec{u} \) a \( \vec{v} \) sú zadané v súradnicovom systéme. Určte kosínus ich odchýlky \( \varphi \).
...
\Data\ID{1103030601}
\Updated{2026-05-13 11:05:02}
\Level{B}
\SubArea{Points and Vectors}
\IMG{1103030601.pdf}
\LANGen{
\Question{
In the cube \( ABCDEFGH \) find the angle \( \varphi \) between the vectors \( \vec{b}=\overrightarrow{EB} \) and  \( \vec{a}=\overrightarrow{AK} \), where \( K \) is the midpoint of \( HG \). Round \( \varphi \) to the nearest degree.
Help: Choose the appropriate coordinate system.}
{\( \varphi\doteq 104^{\circ} \)}{\( \varphi\doteq 76^{\circ} \)}{\( \varphi\doteq 100^{\circ} \)}{\( \varphi\doteq 80^{\circ} \)}{}{}}
\LANGpl{
\Question{
W sześcianie \( ABCDEFGH \) wyznacz kąt \( \varphi \) między wektorami \( \vec{b}=\overrightarrow{EB} \) i  \( \vec{a}=\overrightarrow{AK} \), gdzie \( K \) to środek \( HG \).  Zaokrągli  \( \varphi \) do pełnych stopni.
...
\LANGes{
\Question{
En el cubo \( ABCDEFGH \) determina el ángulo \( \varphi \) entre los vectores \( \vec{b}=\overrightarrow{EB} \) y  \( \vec{a}=\overrightarrow{AK} \), donde \( K \) es el centro de \( HG \). Redondea \( \varphi \) al grado más cercano.
Pista: Elige un sistema de coordenadas apropiado.}
{\( \varphi\doteq 104^{\circ} \)}{\( \varphi\doteq 76^{\circ} \)}{\( \varphi\doteq 100^{\circ} \)}{\( \varphi\doteq 80^{\circ} \)}{}{}}
\End

\Data\ID{1103030602}
\Updated{2021-12-05 11:12:07}
\Level{B}
\SubArea{Points and Vectors}
...
{$\varphi\doteq 8^{\circ}$}{$\varphi\doteq 9^{\circ}$}{$\varphi\doteq 10^{\circ}$}{$\varphi\doteq 11^{\circ}$}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
En la imagen, aparecen los vectores $\vec{u}$ y $\vec{v}$  en tres cuadrados. Calcula la desviación  $\varphi$ entre $\vec{u}$ y $\vec{v}$. Redondea $\varphi$ al grado más cercano.
Pista: Soluciona  en un sistema de coordenadas adecuadamente elegido.}
{$\varphi\doteq 8^{\circ}$}{$\varphi\doteq 9^{\circ}$}{$\varphi\doteq 10^{\circ}$}{$\varphi\doteq 11^{\circ}$}{}{}}
\End

\Data\ID{2000001801}
\Updated{2022-05-23 02:05:43}
\Level{B}
\SubArea{Points and Vectors}
\LANGen{
\Question{
Find the perpendicular vector to the vector \((2; 5)\).}
{\( (5;-2) \)}{\( (5;2) \)}{\( (-2;-5) \)}{\( (-5;-2) \)}{}{}}
\LANGpl{
\Question{
...
\Data\ID{2000001802}
\Updated{2022-05-23 02:05:05}
\Level{B}
\SubArea{Points and Vectors}
\LANGen{
\Question{
Choose the perpendicular vector to the vector \( (-4; 8)\).}
{\( (-2;-1) \)}{\( (1;2) \)}{\( (-2;1) \)}{\( (2;-1) \)}{}{}}
\LANGpl{
\Question{
...
\Data\ID{2000001803}
\Updated{2022-05-23 02:05:26}
\Level{B}
\SubArea{Points and Vectors}
\LANGen{
\Question{
Choose the parallel vector to the vector \( (-1; 3)\).}
{\( (-3; 9) \)}{\( (3; 1) \)}{\( (-2; 4) \)}{\( (0; 3) \)}{}{}}
\LANGpl{
\Question{
...
\LANGen{
\Question{
Choose the parallel vector to the vector \((4; 2)\).}
{\( (-2; -1) \)}{\( (2; -4) \)}{\( (1;2) \)}{\( (-1; 2) \)}{}{}}
\LANGpl{
\Question{
...
\LANGen{
\Question{
Find the point that is obtained by translating the point \([3; 5]\) by the vector \((4; 2)\).}
{\( [7;7] \)}{\( [-1;3] \)}{\( [12;10] \)}{\( [7;3] \)}{}{}}
\LANGpl{
\Question{
...
\LANGen{
\Question{
Find the point that is obtained by translating the point \([-2; 1]\) by two times the vector \( (-2; 3) \).}
{\( [-6; 7] \)}{\( [-4; 4] \)}{\( [0; -2] \)}{\( [-6; 5] \)}{}{}}
\LANGpl{
\Question{
...
suponiendo que es perpendicular a  los vectores dados.}
{\(\vec{c} = (-1;1;1)\)}{\(\vec{c} = (-3;0;1)\)}{\(\vec{c} = (2;4;2)\)}{\(\vec{c} = (-1;-1;1)\)}{}{}}
\End
...
{\(\vec{a}\times\vec{b}=(6;-1;3); \left(\vec{a}\times\vec{b}\right)\cdot\vec{c}=-2\)}{\(\vec{a}\times\vec{b}=8; \left(\vec{a}\times\vec{b}\right)\cdot\vec{c}=(-8,16,16)\)}{\(\vec{a}\times\vec{b}=(-6;1;-3); \left(\vec{a}\times\vec{b}\right)\cdot\vec{c}=2\)}{\(\vec{a}\times\vec{b}=\sqrt{46}; \left(\vec{a}\times\vec{b}\right)\cdot\vec{c}=2\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Dados los puntos $A = [1;5]$ y $B = [-4;2]$, calcula todos los puntos $C$ que se encuentran en el eje $x$, suponiendo que la área del triángulo  $ABC$ sea $14$.
Pista: Usa un producto vectorial.}
{$C_1=[2;0];\ C_2=\left[-\frac{50}3;0\right]$}{$C_1=[1;0];\ C_2=\left[-\frac{47}3;0\right]$}{$C_1=[2;0];\ C_2=\left[-\frac{47}3;0\right]$}{$C_1=[1;0];\ C_2=\left[-\frac{50}3;0\right]$}{}{}}
\End

\Data\ID{1103040208}
\Updated{2022-06-08 12:06:34}
\Level{C}
\SubArea{Points and Vectors}
...
{$m=3$}{$m=-3$}{$m=1$}{požadované $m$ neexistuje}{}{}}
\LANGsk{
\Question{
...
\LANGes{
\Question{
Dados los puntos $A = [4;5;-1]$, $B = [-2;-1;2]$, $C = [-1;-3;0]$ y  $D = [0;m;2]$.  Halla la coordenada que falta del punto $D$ suponiendo que el punto $D$ se encuentra en el plano determinado por los puntos $A$, $B$ y $C$.
Pista: Usa la combinación lineal de vectores representada en la imagen o usa su producto mixto.}
{$m=3$}{$m=-3$}{$m=1$}{$m$ no existe}{}{}}
\End
...
{\( -3 \)}{The mixed product is not defined.}{\( (0;-2;0) \)}{\( -2 \)}{}{}}
\LANGpl{
\Question{
Dane są wektory $\vec{a}=(1;2;-3)$, $\vec{b}=(0;-1;2)$ i $\vec{c}=(-1 ;1;0)$. Znajdź mieszany produkt $(\vec{a}\times\vec{b})\cdot\vec{c}$.}
{\( -3 \)}{Iloczyn mieszany nie jest określony.}{\( (0;-2;0) \)}{\( -2 \)}{}{}}
\LANGcs{
\Question{
Jsou dány vektory $\vec{a}=(1;2;-3)$, $\vec{b}=(0;-1;2)$  a $\vec{c}=(-1;1;0)$. Vypočítejte smíšený součin $(\vec{a}\times\vec{b})\cdot\vec{c}$.}
{\( -3 \)}{Smíšený součin není definován.}{\( (0;-2;0) \)}{\( -2 \)}{}{}}
\LANGsk{
\Question{
Dané sú vektory $\vec{a}=(1;2;-3)$, $\vec{b}=(0;-1;2)$ a $\vec{c}=(-1;1;0)$. Určte zmiešaný súčin $(\vec{a}\times\vec{b})\cdot\vec{c}$.}
{\( -3 \)}{Zmiešaný súčin nie je definovaný.}{\( (0;-2;0) \)}{\( -2 \)}{}{}}
\LANGes{
\Question{
Dados los vectores $\vec{a}=(1;2;-3)$, $\vec{b}=(0;-1;2)$,  y $\vec{c}=(-1;1;0)$. Determina el producto mixto $(\vec{a}\times\vec{b})\cdot\vec{c}$.}
{\( -3 \)}{El producto mixto no es definido.}{\( (0;-2;0) \)}{\( -2 \)}{}{}}
\End
