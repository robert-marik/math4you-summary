...
\LANGen{
\Question{
Given vectors \(\vec{a} = (1;y;3)\),
\(\vec{b} = (2;-1;-2)\), find the coordinate
\(y\) which guarantees
...
which ensures that the vector \(\vec{w} = (8;2;z)\) 
...
{$(\vec{a}\times\vec{b})\cdot\vec{c}=-1$}{$(\vec{a}\times\vec{b})\cdot\vec{c}=(1;-2;-2)$}{$(\vec{a}\times\vec{b})\cdot\vec{c}$ není definován}{$(\vec{a}\times\vec{b})\cdot\vec{c}=(-8;8;0)$}{}{}}
\LANGsk{
\Question{
