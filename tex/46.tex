...
\LANGpl{
\Question{
Dana jest funkcja \( f(x) = 2x +7 \). Podaj argument, dla którego wartość funkcji  \( f \) wynosi \( -9 \).}
{\( -8\)}{\( -11\)}{\( -1 \)}{\( 25 \)}{}{}}
\LANGcs{
\Question{
...
\LANGsk{
\Question{
Daná je lineárna funkcia  \( f(x) = 2x +7 \). V ktorom bode bude funkčná hodnota funkcie \( f \) rovná  \( -9 \)?}
{\( -8\)}{\( -11\)}{\( -1 \)}{\( 25 \)}{}{}}
\LANGes{
\Question{
...
{\( [ -10; \infty) \)}{\( (-\infty;-10)\)}{\( (-\infty;-10 ] \)}{\( (-10;\infty)\)}{}{}}
\LANGpl{
\Question{
Dana jest funkcja \(f(x) = -2x - 6\)
gdzie \(x\in (-\infty ;2\rangle \). Znajdź zakres funkcji \(f\).}
{\( \langle -10; \infty) \)}{\( (-\infty;-10)\)}{\( (-\infty;-10 \rangle \)}{\( (-10;\infty)\)}{}{}}
\LANGcs{
\Question{
...
\(A = (2;3)\) y
\(B = (-1;6)\). Halla la expresión analítica de la funcin \(f\).}
{\(f(x)= -x + 5\)}{\(f(x) = x + 1\)}{\(f(x)= 2x - 1\)}{\(f(x) = -5x + 1\)}{}{}}
\End
...
\LANGcs{
\Question{
Okamžitá rychlost vlaku je při rovnoměrném brzdění popsána rovnicí \( v=45-25t \). Z následujících možností vyberte graf odpovídající závislosti okamžité rychlosti vlaku \( v \) na době jeho brzdní \( t \).}
{}{}{}{}{}{}}
\LANGsk{
\Question{
