...
\LANGes{
\Question{
Sea la función lineal \( f(x)=-2x+4 \). ¿Cuál de las gráficas es la de \( f \)?}
{}{}{}{}{}{}}
...
\LANGsk{
\Question{
Teploty tuhnutia a varu vody (obidve za normálneho tlaku) sú základnými bodmi v Europe najpoužívanejšej teplotnej stupnice — Celziovej (jednotka \( ^{\circ}\mathrm{C} \)). V USA je však rozšírenejšia  Fahrenheitova stupnica  (jednotka \( ^{\circ}\mathrm{F} \)). Uvádzané teploty sú pri oboch stupniciach vyjadren hodnotami:
\[ \begin{array}{l}
...
\LANGsk{
\Question{
Automat vyrobí \(12\) sčiastok za minútu a ukladá ich do zásobníka, ktorého kapacita je \(1\: 500\) kusov. 
...
empieza a frenar. Disminuye su velocidad con una acceleración constante de
\(2\, \mathrm{m}/\mathrm{s}^{2}\).
