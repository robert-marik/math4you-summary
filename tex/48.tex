...
\LANGes{
\Question{
¿Cuál de las siguientes funciones tiene mínimo en \( x=3 \)?}
{\( f(x)=2|x-3|+1 \)}{\( h(x)=2|x+3|-1 \)}{\( g(x)=-2|x-3|+3 \)}{\( m(x)=2|x+3| \)}{}{}}
\End

\Data\ID{9000024403}
\Updated{2020-11-24 11:11:47}
\Level{A}
\SubArea{Functions with absolute values}
...
{Función \( f \) tiene mínimo en \( x=-1 \) y en \( x=2 \).}{Función \( f \) tiene mínimo en \( x=-1 \) y máximo en \( x=2 \).}{Función \( f \) tiene máximo en \( x=-1 \) y en \( x=2 \).}{Función \( f \) tiene mínimo en \( x=3 \).}{}{}}
\End

\Data\ID{1003030905}
\Updated{2020-11-24 08:11:05}
\Level{B}
\SubArea{Functions with absolute values}
\LANGen{
\Question{
...
{La función \( f \) es encerrada superiormente y no es encerrada inferiormente.}{La función \( f \) es encerrada inferiormente y no es encerrada superiormente.}{La función \( f \) es encerrada.}{La función \( f \) no es encerrada inferiormente ni superiormente.}{}{}}
\End
...
{El Rango de la función \( f \) es el intervalo \( [-3;\infty ) \).}{El Dominio de la función \( f \) es el intervalo \( (-\infty;\infty) \).}{La función \( f \) es par.}{La función \( f \) es encerrada inferiormente.}{}{}}
\End
...
{La función \( f \) es par.}{La función \( f \) is decreasing in the interval \( [3; \infty) \).}{La función \( f \) tiene máximo en \( x=-3 \).}{El Rango de la función \( f \) es el intervalo \( (-\infty; 0] \).}{}{}}
\End
...
\LANGes{
\Question{
Identifica el número real \( a \) tal que la función \( f(x)=a|-12-ax|-a \) tenga máximo máximo en \( x=3 \).}
...
\LANGes{
\Question{
¿Cuál de las funciones es encerrada?}
{\( g(x)=|x-2|-|x| \)}{\( f(x)=|x-2|+|x| \)}{\( h(x)=|x+2|+|x| \)}{\( m(x)=|2x|-|x| \)}{}{}}
\End
...
{La función \( f \) es inyectiva.}{La función \( f \) tiene mínimo en \( x=-1 \).}{La función \( f \) es encerrada inferiormente.}{El Rango de la función \( f \) es \( [-2;\infty) \).}{}{}}
\End

\Data\ID{1103072501}
\Updated{2020-11-24 09:11:33}
\Level{B}
\SubArea{Functions with absolute values}
\IMG{1103072501.pdf}
\LANGen{
...
\LANGes{
\Question{
La función \( f \) es dada por la gráfica, identifica cuál de las declaraciones es correcta.}
{\( f(x)=x-|x|;\ x\in[-4;4] \)}{\( f(x)=x+|x|;\ x\in[-4;4] \)}{\( f(x)=|x|-x;\ x\in[-4;4] \)}{\( f(x)=-x-|x|;\ x\in[-4;4] \)}{}{}}
\End

\Data\ID{1103072502}
\Updated{2020-11-24 09:11:01}
\Level{B}
\SubArea{Functions with absolute values}
\IMG{1103072502.pdf}
\LANGen{
...
\LANGes{
\Question{
La función \( f \) es dada por la gráfica. Identifica cuál de las declaraciones es falsa.}
{\( f(x)=|x-1|-|2x|;\ x\in[-4;4] \)}{\( f(x)=|2x|-|x-1|;\ x\in[-4;4] \)}{\( f(x)=|2x|-|1-x|;\ x\in[-4;4] \)}{\( f(x)=2|x|-|x-1|;\ x\in[-4;4] \)}{}{}}
\End
...
\LANGes{
\Question{
Con ayuda de la gráfica de la función \( f \), encuentra todos \( x \) tales que \( |f(x)-2|=1 \).}
{\( x\in\{-4;-2\} \)}{\( x\in\{-4;2\} \)}{\( x\in\{-2;2\} \)}{\( x\in\{-3\} \)}{}{}}
\End
...
{La función \( f \) tiene mínimo en \( x=-1 \).}{La función \( f \) es encerrada.}{La función \( f \) es creciente en el intervalo \( (0;\infty) \).}{El Rango de \( f \) es \( [1;\infty) \).}{}{}}
\End
...
\LANGes{
\Question{
Sea \( f(x)=\left|3|2x-1|-9\right| \). El valor del argumento \( x \) para cuál \( f(x)=2 \) es:}
{\( 4 \)}{\( 2 \)}{\( 3 \)}{\( 1 \)}{}{}}
\End
