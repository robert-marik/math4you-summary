...
\Level{A}
\SubArea{Linear functions with absolute values}
\LANGen{
\Question{
...
\Level{A}
\SubArea{Linear functions with absolute values}
\IMG{2010009201-figure2.pdf}
\LANGen{
\Question{
Identify the value of a real parameter \(a\) such that the graph of the function 
\[ 
 f(x) =3- |x - a|
\]
...
\LANGpl{
\Question{
Wskaż taką wartość rzeczywistego parametru \(a\),  żeby wykres funkcji
\[ 
 f(x) =3- |x - a|
\]
odpowiadał wykresowi przedstawionemu na rysunku.}
{\( -2 \)}{\( 2 \)}{\( 1\)}{\( 3 \)}{}{}}
\LANGcs{
\Question{
Pro který reálný parametr \(a\) odpovídá graf funkce 
\[ 
 f(x) =3- |x - a|
\]
uvedenému obrázku?}
...
\LANGsk{
\Question{
Rozhodnite, pre ktoré hodnoty reálneho parametra \(a\) je graf na obrázku grafom funkcie určenej predpisom \(f(x) =3- |x - a|\).}
{\( -2 \)}{\( 2 \)}{\( 1\)}{\( 3 \)}{}{}}
\LANGes{
\Question{
Halla el valor del parámetro real \(a\) tal que la gráfica de la función 
\[ 
 f(x) =3- |x - a|
\]
...
\LANGpl{
\Question{
Wskaż takie wartości rzeczywistych parametrów \(a\) 
i \(b\),
żeby wykres funkcji
\[ 
 f(x)= |x + a| + b
...
\LANGcs{
\Question{
Najděte takové hodnoty reálného parametru \(a\) 
a \(b\), 
aby graf funkce 
\[ 
 f(x)= |x + a| + b
...
\LANGsk{
\Question{
Rozhodnite, pre ktoré hodnoty reálnych parametrov \(a\), \(b\) je graf na obrázku grafom funkcie určenej predpisom \(f(x)= |x + a| + b\).}
{\(\ \ a = -1,\ b = 2\)}{\(\ \ a = 1,\ b = 2\)}{\(\ \ a = -1,\ b = -2\)}{\(\ \ a = 1,\ b = -2\)}{}{}}
\LANGes{
\Question{
Halla los valores de los parámetros reales \(a\) 
y \(b\) 
...
\LANGpl{
\Question{
Który z wykresów jest wykresem poniższej funkcji?
\[f(x)=|x+2|+|2x+1|-|x-3|;\quad x\in\langle-4;1\rangle\]}
{}{}{}{}{}{}}
\LANGcs{
\Question{
...
\IMGanswer{8-figure0_0.pdf}
\IMGanswer{8-figure1_1.pdf}
\IMGanswer{8-figure2_1.pdf}
\IMGanswer{8-figure3_1.pdf}\End
...
\LANGsk{
\Question{
Ktorý z nasledujúcich grafov je grafom funkcie \(f(x)= |x|+3\)?}
{}{}{}{}{}{}}
\LANGes{
\Question{
...
\IMGanswer{2010009201-figure4_0.pdf}
\IMGanswer{2010009201-figure5.pdf}
\IMGanswer{2010009201-figure6.pdf}
\IMGanswer{2010009201-figure7.pdf}\End
...
{The function \(f\) is bounded.}{The function \(f\) has its maximum and has no minimum.}{The function \(f\) is a one-to-one function and is decreasing.}{The function \(f\) is an odd function and is bounded below.}{}{}}
\LANGpl{
\Question{
Rysunek przedstawia wykres funkcji \(f\). Które stwierdzenie jest poprawne?}
{Funkcja \(f\) jest ograniczona.}{Funkcja \(f\) ma maximum ale nie ma minimum.}{Funkcja \(f\) jest różnowartościowa i malejąca.}{Funkcja \(f\) jest nieparzysta i ograniczona od dołu.}{}{}}
\LANGcs{
\Question{
Na obrázku je graf funkce \(f\). Vyberte pravdivý výrok.}
{Funkce \(f\) je omezená.}{Funkce \(f\) má maximum a nemá minimum.}{Funkce \(f\) je prostá a klesající.}{Funkce \(f\) je lichá a zdola omezená.}{}{}}
\LANGsk{
\Question{
Na obrázku je graf funkcie \(f\). Ktoré z nasledujúcich tvrdení je pravdivé?}
{Funkcia \(f\) je ohraničená.}{Funkcia \(f\) má maximum a nemá minimum.}{Funkcia \(f\) je prostá a klesajúca.}{Funkcia \(f\) je nepárna a ohraničená zdola.}{}{}}
\LANGes{
\Question{
En la imagen, se muestra la gráfica de una función \(f\). ¿Cuál de las siguientes afirmaciones es verdadera?}
{La función \(f\) está acotada.}{La función \(f\) presenta máximo pero no mínimo.}{La función \(f\) es inyectiva y decreciente.}{La función \(f\) es una función impar y está acotada inferiormente.}{}{}}
\End
...
{\(f(x)=|x+1|-2x;\quad x\in[-2;3]\)}{\(f(x)=|x+1|+2x;\quad x\in[-2;3]\)}{\(f(x)=|x-1|-2x;\quad x\in[-2;3]\)}{\(f(x)=|x-1|+2x;\quad x\in[-2;3]\)}{}{}}
\LANGpl{
\Question{
Na rysunku przedstawiony jest wykres funkcji \(f\). Wskaż jej wzór.}
{\(f(x)=|x+1|-2x;\quad x\in\langle-2;3\rangle\)}{\(f(x)=|x+1|+2x;\quad x\in\langle-2;3\rangle\)}{\(f(x)=|x-1|-2x;\quad x\in\langle-2;3\rangle\)}{\(f(x)=|x-1|+2x;\quad x\in\langle-2;3\rangle\)}{}{}}
\LANGcs{
\Question{
...
\Data\ID{2000021003}
\Updated{2023-01-23 10:01:28}
\Level{B}
\SubArea{Linear functions with absolute values}
\LANGen{
\Question{
Consider the function \(f(x)=|x+1|-2\). Which of the statements is true?}
{The function \(f\) has a minimum at the point \(x=-1\).}{The function \(f\) has a minimum at the point \(x=-2\).}{The function \(f\) has no minimum.}{The function \(f\) has a maximum at the point \(x=-1\).}{}{}}
\LANGpl{
\Question{
Dana jest funkcja \(f(x)=|x+1|-2\). Wskaż poprawne stwierdzenie.}
{Funkcja \(f\) ma minimum w punkcie \(x=-1\).}{Funkcja \(f\) ma minimum w punkcie \(x=-2\).}{Funkcja \(f\) nie ma minimum.}{Funkcja \(f\) ma maximum w punkcie \(x=-1\).}{}{}}
\LANGcs{
\Question{
Je daná funkce \(f(x)=|x+1|-2\). Vyberte pravdivý výrok.}
{Funkce \(f\) má minimum v bodě \(x=-1\).}{Funkce \(f\) má minimum v bodě \(x=-2\).}{Funkce \(f\) nemá minimum.}{Funkce \(f\) má maximum v bodě \(x=-1\).}{}{}}
\LANGsk{
\Question{
Je daná funkcia \(f(x)=|x+1|-2\). Ktoré z tvrdení je pravdivé?}
{Funkcia \(f\) má minimum v bode \(x=-1\).}{Funkcia \(f\) má minimum v bode \(x=-2\).}{Funkcia \(f\) nemá minimum.}{Funkcia \(f\) má maximum v bode \(x=-1\).}{}{}}
\LANGes{
\Question{
Se considera la función \(f(x)=|x+1|-2\). ¿Cuál de las siguientes afirmaciones es verdadera?}
{La función \(f\) presenta un mínimo en el punto \(x=-1\).}{La función \(f\) presenta un mínimo en el punto \(x=-2\).}{La función \(f\) no presenta mínimo.}{La función \(f\) presenta un máximo en el punto \(x=-1\).}{}{}}
\End
...
{\(H(f)=[1;\infty)\)}{\(H(f)=\mathbb{R}\)}{\(H(f)=[-1;2]\)}{\(H(f)=[-1;\infty)\)}{}{}}
\LANGpl{
\Question{
Które stwierdzenie o zbiorze wartości \(H(f)\) funkcji \(f(x)=|2-x|+|1+x|-2\) jest poprawne?}
{\(H(f)=\langle1;\infty)\)}{\(H(f)=\mathbb{R}\)}{\(H(f)=\langle-1;2\rangle\)}{\(H(f)=\langle-1;\infty)\)}{}{}}
\LANGcs{
\Question{
...
{\(R(f)=[1;\infty)\)}{\(R(f)=\mathbb{R}\)}{\(R(f)=[-1;2]\)}{\(R(f)=[-1;\infty)\)}{}{}}
\End
...
{\(D(f)=\mathbb{R}\)}{\(D(f)=[-3;\infty)\)}{\(D(f)=[ -2;1]\)}{\(D(f)=\mathbb{R}\setminus \left\{-2;1\right\} \)}{}{}}
\LANGpl{
\Question{
Które stwierdzenie o dziedzinie \(D(f)\) funkcji \(f(x)=3|x+2|-|x-1|\) jest poprawne?}
{\(D(f)=\mathbb{R}\)}{\(D(f)=\langle-3;\infty)\)}{\(D(f)=\langle -2;1\rangle\)}{\(D(f)=\mathbb{R}\setminus \left\{-2;1\right\} \)}{}{}}
\LANGcs{
\Question{
...
{\(f(x)=|1-x|+|x+1|\)}{\(g(x)=|1-x|-|x+1|\)}{\(h(x)=|1+x|+|x+1|\)}{\(k(x)=|1-x|+|x-1|\)}{}{}}
\LANGpl{
\Question{
...
{\(f(x)=|x-1|-|x+1|\)}{\(g(x)=|x-1|+|x+1|\)}{\(h(x)=-|x-1|-|x+1|\)}{\(k(x)=|1-x|+|x-1|\)}{}{}}
\LANGpl{
\Question{
...
\Question{
Which of the following functions is bounded?}
{\( f(x)=|3+x|-|x| \)}{\( g(x)=|3+x|+|x| \)}{\( h(x)=|x-3|+|x| \)}{\( m(x)=3-|x| \)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Která z uvedených funkcí je ohraničená?}
{\( f(x)=|3+x|-|x| \)}{\( g(x)=|3+x|+|x| \)}{\( h(x)=|x-3|+|x| \)}{\( m(x)=3-|x| \)}{}{}}
\LANGsk{
\Question{
Ktorá z následujúcich funkcií je ohraničená?}
...
\LANGes{
\Question{
¿Cuál de las siguientes funciones está acotada?}
{\( f(x)=|3+x|-|x| \)}{\( g(x)=|3+x|+|x| \)}{\( h(x)=|x-3|+|x| \)}{\( m(x)=3-|x| \)}{}{}}
\End
...
\Level{B}
\SubArea{Linear functions with absolute values}
\IMG{2010009201-figure0.pdf}
\LANGen{
\Question{
Function \( f \) is given by the graph. Identify which of the following statements is true.}
{\( f(x)=2|x|+x;\ x\in [ -3;2 ] \)}{\( f(x)=2|x|-x;\ x\in [ -3;2 ] \)}{\( f(x)=-x-2|x|;\ x\in [ -3;2 ] \)}{\( f(x)=x-2|x|;\ x\in [ -3;2 ] \)}{}{}}
\LANGpl{
\Question{
Wykres przedstawia funkcję \( f \). Wskaż poprawne stwierdzenie.}
{\( f(x)=2|x|+x;\ x\in \langle -3;2 \rangle \)}{\( f(x)=2|x|-x;\ x\in \langle -3;2 \rangle \)}{\( f(x)=-x-2|x|;\ x\in \langle -3;2 \rangle \)}{\( f(x)=x-2|x|;\ x\in \langle -3;2 \rangle \)}{}{}}
\LANGcs{
\Question{
...
\LANGes{
\Question{
La función \( f \) viene dada por la siguiente gráfica. Elige cuál de las siguientes afirmaciones es verdadera.}
{\( f(x)=2|x|+x;\ x\in [ -3;2 ] \)}{\( f(x)=2|x|-x;\ x\in [ -3;2 ] \)}{\( f(x)=-x-2|x|;\ x\in [ -3;2 ] \)}{\( f(x)=x-2|x|;\ x\in [ -3;2 ] \)}{}{}}
\End
...
\Level{B}
\SubArea{Linear functions with absolute values}
\IMG{2010009201-figure1.pdf}
\LANGen{
\Question{
Function \( f \) is given by the graph. Identify which of the following statements is true.}
{\( f(x)=|x-1|-|x|;\ x\in [ -4;2 ] \)}{\( f(x)=|x+1|-|x|;\ x\in [ -4;2 ] \)}{\( f(x)=|x+1|+|x|;\ x\in [ -4;2 ] \)}{\( f(x)=|x|-|x-1|;\ x\in [ -4;2 ] \)}{}{}}
\LANGpl{
\Question{
Wykres przedstawia funkcję \( f \). Wskaż poprawne stwierdzenie.}
{\( f(x)=|x-1|-|x|;\ x\in \langle -4;2 \rangle \)}{\( f(x)=|x+1|-|x|;\ x\in \langle -4;2 \rangle \)}{\( f(x)=|x+1|+|x|;\ x\in \langle -4;2 \rangle \)}{\( f(x)=|x|-|x-1|;\ x\in \langle -4;2 \rangle \)}{}{}}
\LANGcs{
\Question{
...
\LANGes{
\Question{
La función \( f \) viene dada por la siguiente gráfica. Elige la afirmación verdadera.}
{\( f(x)=|x-1|-|x|;\ x\in [ -4;2 ] \)}{\( f(x)=|x+1|-|x|;\ x\in [ -4;2 ] \)}{\( f(x)=|x+1|+|x|;\ x\in [ -4;2 ] \)}{\( f(x)=|x|-|x-1|;\ x\in [ -4;2 ] \)}{}{}}
\End
...
{\( f(x)= 2\bigl| |x+3|-2\bigr|\)}{\( g(x)= 2\bigl| |x-3|-2\bigr|\)}{\( h(x)= -2\bigl| |x+3|-2\bigr|\)}{\( k(x)= 2\bigl| |x-3|+2\bigr|\)}{}{}}
\LANGpl{
\Question{
Która z podanych funkcji jest rosnąca w przedziale \(\langle -1;\infty)\)?}
{\( f(x)= 2\bigl| |x+3|-2\bigr|\)}{\( g(x)= 2\bigl| |x-3|-2\bigr|\)}{\( h(x)= -2\bigl| |x+3|-2\bigr|\)}{\( k(x)= 2\bigl| |x-3|+2\bigr|\)}{}{}}
\LANGcs{
\Question{
...
\LANGsk{
\Question{
Ktorá z nasledujúcich funkcií je rastúca na intervale \(\langle -1;\infty)\)?}
{\( f(x)= 2\bigl| |x+3|-2\bigr|\)}{\( g(x)= 2\bigl| |x-3|-2\bigr|\)}{\( h(x)= -2\bigl| |x+3|-2\bigr|\)}{\( k(x)= 2\bigl| |x-3|+2\bigr|\)}{}{}}
\LANGes{
\Question{
...
\LANGen{
\Question{
Let \( f(x)=|4-3|x| | +|2x|\). Identify which of the following function values is the biggest.}
{\( f(3) \)}{\( f(-2) \)}{\( f(0) \)}{\( f(-1) \)}{}{}}
\LANGpl{
\Question{
Dana jest funkcja \( f(x)=|4-3|x| | +|2x|\). Wskaż, która z poniższych wartości funkcji jest największa.}
{\( f(3) \)}{\( f(-2) \)}{\( f(0) \)}{\( f(-1) \)}{}{}}
\LANGcs{
\Question{
Je dána funkce \( f(x)=|4-3|x| | +|2x|\). Která z daných funkčních hodnot je největší?}
{\( f(3) \)}{\( f(-2) \)}{\( f(0) \)}{\( f(-1) \)}{}{}}
\LANGsk{
\Question{
Daná je funkcia \( f(x)=|4-3|x| | +|2x|\). Ktorá z nasledujúcich funkčných hodnôt je najväčšia?}
{\( f(3) \)}{\( f(-2) \)}{\( f(0) \)}{\( f(-1) \)}{}{}}
\LANGes{
\Question{
...
\LANGpl{
\Question{
Który z poniższych wykresów to wykres funkcji \(f(x)= \Bigl| \bigl| |x-1|-2\bigr|-3\Bigr|\); \(x \in \langle -6;8\rangle\)?}
{}{}{}{}{}{}}
\LANGcs{
\Question{
...
\IMGanswer{2010018601-figure0.pdf}
\IMGanswer{2010018601-figure1.pdf}
\IMGanswer{2010018601-figure2.pdf}
\IMGanswer{2010018601-figure3.pdf}\End
