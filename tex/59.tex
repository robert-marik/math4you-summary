...
{Las diagonales del rombo forman un ángulo agudo.}{Los lados opuestos de un paralelogramo son congruentes.}{Si uno de los ángulos interiores de un cuadrilátero es mayor que el ángulo recto, el cuadrilátero no es convexo.}{Todos los ángulos interiores en un cuadrado son rectos.}{}{}}
\End
...
\Question{
Elige la proposición falsa:}
{La suma de los ángulos opuestos en un rectángulo son \( 360^{\circ} \).}{La suma de los ángulos interiores de un polígono convexo es \( (n-2)\cdot180^{\circ} \).}{Si solo hay un par de lados paralelos en un cuadrilátero y el otro lado es perpendicular a ellos, entonces el cuadrilátero es un trapecio rectángulo.}{Al menos uno de los ángulos interiores en un trapecio es obtuso.}{}{}}
\End
...
\LANGes{
\Question{
Dado un rectángulo con los lados \( a \), \( b \). Las diagonales forman un ángulo \( \alpha = 60^{\circ} \). Lado más largo mide \( a = 6\,\mathrm{cm} \). Calcula la longitud de lado más corto \( b \).}
{\( \frac6{\sqrt3}\,\mathrm{cm} \)}{\( \frac3{\sqrt3}\,\mathrm{cm} \)}{\( \frac1{\sqrt3}\,\mathrm{cm} \)}{\( 6\sqrt3\,\mathrm{cm} \)}{}{}}
\End
...
\LANGes{
\Question{
Dado un cuadrado \( ABCD \). Calcula la medida del ángulo \( EGD \) suponiendo que el ángulo \( CFG \) mide \( 50^{\circ} \).}
{\( 5^{\circ}\)}{\( 10^{\circ}\)}{\( 15^{\circ}\)}{\( 20^{\circ}\)}{}{}}
\End
...
\LANGcs{
\Question{
Ve čtverci \( ABCD \), \( |AB| = 6\,\mathrm{cm} \). Vypočítejte obsah vyznačeného trojúhelníku, jestliže bod \( E \) je středem strany  \( AB \).}
{\( 3\,\mathrm{cm}^2 \)}{\( 6\,\mathrm{cm}^2 \)}{\( 9\,\mathrm{cm}^2 \)}{\( 12\,\mathrm{cm}^2 \)}{}{}}
\LANGsk{
\Question{
...
\LANGes{
\Question{
Dado el cuadrado \( ABCD \), \( |AB| = 6\,\mathrm{cm} \). Calcula el área del triángulo marcado si el punto \( E \) es el centro del lado \( AB \).}
{\( 3\,\mathrm{cm}^2 \)}{\( 6\,\mathrm{cm}^2 \)}{\( 9\,\mathrm{cm}^2 \)}{\( 12\,\mathrm{cm}^2 \)}{}{}}
\End

\Data\ID{9000046401}
\Updated{2021-02-22 04:02:36}
\Level{A}
\SubArea{Polygons}
\IMG{000464_01-figure0.pdf}
\LANGen{
\Question{
...
V obdĺžniku \(ABCD\) 
platí: \(|AB| = 6\, \mathrm{cm}\),
\(|BC| = 2\sqrt{3}\, \mathrm{cm}\). Určte
veľkosť \(\measuredangle CAB\).}
{\(30^{\circ }\)}{\(45^{\circ }\)}{\(60^{\circ }\)}{}{}{}}
\LANGes{
\Question{
...
\Data\ID{9000046402}
\Updated{2021-02-22 04:02:48}
\Level{A}
\SubArea{Polygons}
\IMG{000464_02-figure0.pdf}
\LANGen{
\Question{
Consider the rectangle \(ABCD\) 
with length and height \(|AB| = 6\, \mathrm{cm}\) 
...
\(|BC| = 2\sqrt{3}\, \mathrm{cm}\).
\(S\) 
je priesečník uhlopriečok obdĺžnika. Určte veľkosť
\(\measuredangle ASB\).}
{\(120^{\circ }\)}{\(60^{\circ }\)}{\(90^{\circ }\)}{}{}{}}
\LANGes{
\Question{
...
\Data\ID{9000121706}
\Updated{2021-02-22 04:02:03}
\Level{A}
\SubArea{Polygons}
\IMG{001217_06-figure0.pdf}
\LANGen{
\Question{
...
\Question{
Dado el rectángulo \(ABCD\) 
con el punto \(E\) que está en el centro del lado \(CD\). La medida del ángulo \( EAD\) 
es \(30^{\circ }\). Calcula la medida del ángulo \( AEB\).}
{\(60^{\circ }\)}{\(30^{\circ }\)}{\(45^{\circ }\)}{\(90^{\circ }\)}{}{}}
\End

\Data\ID{9000121707}
\Updated{2021-02-22 04:02:15}
\Level{A}
\SubArea{Polygons}
\IMG{001217_07-figure0.pdf}
\LANGen{
\Question{
Consider a rectangle \(ABCD\) 
and a point \(S\) 
...
Dado el rectángulo \(ABCD\) 
con el punto \(S\) 
que es el punto de intersección de las diagonales. La medida del ángulo
\( BAS\) es
...
\Data\ID{9000121708}
\Updated{2021-02-22 04:02:28}
\Level{A}
\SubArea{Polygons}
\IMG{001217_08-figure0.pdf}
\LANGen{
\Question{
...
{\(65^{\circ }\)}{\(45^{\circ }\)}{\(50^{\circ }\)}{\(70^{\circ }\)}{}{}}
\LANGpl{
\Question{
Rozważ kwadrat \(ABCD\) 
...
mide \(20^{\circ }\).
El punto \(F\) sobre el lado \(CD\) y la longitud del \(AF\) equivale a la longitud del \(AE\) 
...
of the angle \( EFG\).}
{\(50^{\circ }\)}{\(65^{\circ }\)}{\(75^{\circ }\)}{\(130^{\circ }\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Un cuadrilátero es simétrico en una de sus diagonales y puede inscribirse en un círculo. La medida de uno de sus ángulos interiores es \( 80^{\circ} \). Calcula la medida de su ángulo interior más grande.}
{\( 100^{\circ} \)}{\( 160^{\circ} \)}{\( 200^{\circ} \)}{\( 120^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
¿Cuántos vértices tiene un polígono convexo, si la media aritmética de las medidas de sus ángulos interiores es \( 140 \)?}
{\( 9 \)}{\( 8 \)}{\( 10 \)}{\( 12 \)}{}{}}
\End
...
\LANGes{
\Question{
El lado de un hexágono regular mide \( 4\,\mathrm{cm} \). ¿Cuál de los números puestos equivale a su área?}
{\( 24\sqrt3\,\mathrm{cm}^2 \)}{\( 4\sqrt3\,\mathrm{cm}^2 \)}{\( 48\sqrt3\,\mathrm{cm}^2 \)}{\( 20\sqrt3\,\mathrm{cm}^2 \)}{}{}}
\End
...
\LANGes{
\Question{
Dado un decágono (de \( 10 \) lados) cuyo lado mide \( 4\,\mathrm{cm} \). ¿Cuál de los números puestos equivale con mayor precisión a su área?}
{\( 123\,\mathrm{cm}^2 \)}{\( 12\,\mathrm{cm}^2 \)}{\( 55\,\mathrm{cm}^2 \)}{\( 185\,\mathrm{cm}^2 \)}{}{}}
\End
...
\LANGen{
\Question{
\( ABCD \) is a rhombus, the height \( v = 48\,\mathrm{cm} \) and the shorter diagonal \( u = 60\,\mathrm{cm} \). Express the measure of the acute interior angle of the rhombus. Round the result to two decimal places.}
...
\LANGes{
\Question{
Dado el rombo \( ABCD \), con la altura \( v = 48\,\mathrm{cm} \) y diagonal más corta \( u = 60\,\mathrm{cm} \). Calcula la medida del ángulo interno agudo del rombo. Redondea el resultado a dos decimales.}
{\( 73.74^{\circ} \)}{\( 36.87^{\circ} \)}{\( 24.12^{\circ} \)}{\( 27.13^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
Un lado de un rombo mide \( 35\,\mathrm{cm} \) y la longitud de una de sus diagonales es \( 56\,\mathrm{cm} \). Calcula la medida del ángulo que forma la otra diagonal con el lado del rombo. Redondea el resultado a dos decimales.}
{\( 53.13^{\circ} \)}{\( 38.94^{\circ} \)}{\( 36.87^{\circ} \)}{\( 106.26^{\circ} \)}{}{}}
\End
...
\LANGen{
\Question{
The isosceles trapezium \( ABCD \) is in the picture. The measure of the angle \( BCD \) is \( 140^{\circ} \). Express the measure of the angle \( DAB \).}
...
\LANGes{
\Question{
El corte vertical del terraplén de un estanque tiene una forma de un trapecio isósceles. Calcula el ángulo de inclinación del terraplén si su altura es \( 2\,\mathrm{m} \), el ancho superior es \( 3\,\mathrm{m} \) y los brazos miden \( 4\,\mathrm{m} \).}
{\( 30^{\circ} \)}{\( 60^{\circ} \)}{\( 26.57^{\circ} \)}{\( 45^{\circ} \)}{}{}}
\End
...
\LANGen{
\Question{
Given the isosceles trapezium \( ABCD \), \( |AB| = 12\,\mathrm{cm} \), \( |BC| = 2\,\mathrm{cm} \), \( |CD| = 14\,\mathrm{cm} \) and \( |AD| = 2\,\mathrm{cm} \). Express the measure of \( \measuredangle ABC \).}
...
\LANGes{
\Question{
Dado el trapecio isósceles \( ABCD \), \( |AB| = 12\,\mathrm{cm} \), \( |BC| = 2\,\mathrm{cm} \), \( |CD| = 14\,\mathrm{cm} \) and \( |AD| = 2\,\mathrm{cm} \). Calcula la medida de \( \measuredangle ABC \).}
{\( 120^{\circ} \)}{\( 30^{\circ} \)}{\( 180^{\circ} \)}{\( 150^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
Calcula el área del trapecio isósceles \( ABCD \), si  \( AB \parallel CD \), \( |CD| = 4\,\mathrm{cm} \), la altura \( v = 16\,\mathrm{cm} \) y la medida de \( \measuredangle CAB \) es \( 30^{\circ} \). Redondea el resultado a unidades.}
{\( 443\,\mathrm{cm}^2 \)}{\( 10\,\mathrm{cm}^2 \)}{\( 411\,\mathrm{cm}^2 \)}{\( 143\,\mathrm{cm}^2 \)}{}{}}
\End
...
\LANGes{
\Question{
Dado el trapecio isósceles \( ABCD \). Las longitudes de las bases \( a \), \( c \) y la altura \( v \) están en proporción \( 6 : 4 : 3 \). Calcula la tangente del ángulo entre el brazo y la base más larga.}
{\( 3 \)}{\( \frac13 \)}{\( 2 \)}{\( 71.57^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
La imagen representa un trapecio rectángulo cuyas bases miden \( 21\,\mathrm{cm} \) y \( 15\,\mathrm{cm} \), y un brazo más largo mide \( 10\,\mathrm{cm} \). Calcula el seno del ángulo interior más pequeño del trapecio.}
{\( 0.8 \)}{\( 0.6 \)}{\( 53.13^{\circ} \)}{\( 36.87^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
El área de un trapecio rectángulo es \( 35\,\mathrm{cm}^2 \). Las bases miden \( 6\,\mathrm{cm} \) y \( 8\,\mathrm{cm} \). Calcula la medida del ángulo entre base más larga y brazo más largo del trapecio. Redondea el resultado a un decimal.}
{\( 68.2^{\circ} \)}{\( 23.6^{\circ} \)}{\( 66.4^{\circ} \)}{\( 39.3^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
La imagen representa el cruce de dos calles. Dos coches de la limpieza pasaron el cruce mientras rociaban toda la superficie de la calle. Cada uno de los coches continuó por la calle por donde había venido. Determina cuántos metros cuadrados de la superficie de la calle se rociaron dos veces.}
{\( 96\,\mathrm{m}^2 \)}{\( 48\,\mathrm{m}^2 \)}{\( 124\,\mathrm{m}^2 \)}{\( 140\,\mathrm{m}^2 \)}{}{}}
\End
...
\LANGen{
\Question{
\( ABCDEFGH \) is a regular octagon. Express the measure of the angle \( SAB \), where \( S \) is the midpoint of \( AE \). (See the picture.)}
{\( 67.5^{\circ} \)}{\( 22.5^{\circ} \)}{\( 90^{\circ} \)}{\( 45^{\circ} \)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
El pentágono regular \( ABCDE \) se inscribe en una circunferencia con el centro \( S \) (mira la imagen). Calcula la medida del ángulo \( ASB \).}
{\( 72^{\circ} \)}{\( 36^{\circ} \)}{\( 54^{\circ} \)}{\( 108^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
El pentágono regular \( ABCDE \) se inscribe en una circunferencia con el centro \( S \) (mira la imagen). Calcula la medida del ángulo \( SAB \).}
{\( 54^{\circ} \)}{\( 72^{\circ} \)}{\( 36^{\circ} \)}{\( 108^{\circ} \)}{}{}}
\End
...
Base más larga mide \(7\, \mathrm{cm}\) 
y el ángulo entre la base y el brazo mide
\(52^{\circ }\). Calcula el perímetro del trapecio y redondea el resultado a los centímetros más cercanos.}
{\(20\, \mathrm{cm}\)}{\(18\, \mathrm{cm}\)}{\(19\, \mathrm{cm}\)}{\(21\, \mathrm{cm}\)}{}{}}
\End
...
\LANGes{
\Question{
Halla el número de las diagonales en un decágono regular.}
{\(35\)}{\(7\)}{\(10\)}{\(70\)}{}{}}
\End
...
\LANGen{
\Question{
Measure of the interior angle in a regular polygon is
\(160^{\circ }\). Find
the number of vertices of this polygon. In the figure a regular hexagon with an interior angle marked in red is shown.}
{\(18\)}{\(16\)}{\(32\)}{\(9\)}{}{}}
\LANGpl{
\Question{
...
\Level{B}
\SubArea{Polygons}
\IMG{001218_07-figure0.pdf}
\LANGen{
\Question{
Consider a regular polygon with the central angle of
\(40^{\circ }\). In the figure the cut of a regular polygon with unspecified number of vertices is shown. The red angle is the central angle of the polygon, the blue angle is the interior angle of the polygon. Find
the interior angle of this polygon.}
{\(140^{\circ }\)}{\(80^{\circ }\)}{\(200^{\circ }\)}{\(120^{\circ }\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
En un mapa catastral con la escala
\(1\colon 2\: 000\) 
