...
\LANGes{
\Question{
En el dibujo hay la gráfica de la función cuadrática \( f \). ¿Cuál es su expression analítica?}
{\( f(x)=-(x-1)^2+2 \)}{\( f(x)=(x-1)^2+2 \)}{\( f(x)=(x+1)^2+2 \)}{\( f(x)=-(x+1)^2+2 \)}{}{}}
\End

\Data\ID{1103083102}
\Updated{2020-10-08 11:10:21}
\Level{A}
\SubArea{Quadratic functions}
\IMG{1103083102.pdf}
\LANGen{
...
\LANGes{
\Question{
La gráfica de la función \( f \) establishments en el dabuji. ¿Cuál es su expresión analítica?}
{\( f(x)=\frac13(x-3)^2+1 \)}{\( f(x)=4\cdot(x-3)^2+1 \)}{\( f(x)=(x+3)^2+4 \)}{\( f(x)=4\cdot(x+1)^2+3 \)}{}{}}
\End

\Data\ID{1103083103}
\Updated{2020-10-08 01:10:32}
\Level{A}
\SubArea{Quadratic functions}
\IMG{1103083103.pdf}
\LANGen{
...
\LANGes{
\Question{
En el dibujo hay la gráfica de la función cuadrática \( f \). ¿Cuál es su expresión analítica?}
{\( f(x)=-x^2-2x+1  \)}{\( f(x)=x^2+2x+1 \)}{\( f(x)=-x^2+2x+1 \)}{\( f(x)=-x^2-4x-5 \)}{}{}}
\End

\Data\ID{1103083104}
\Updated{2020-10-08 01:10:41}
\Level{A}
\SubArea{Quadratic functions}
\IMG{1103083104.pdf}
\LANGen{
...
{2}\right ] \).}{La dunción es creciente en todo su Dominio.}{}{}}
\End

\Data\ID{9000014809}
\Updated{2020-11-20 01:11:15}
\Level{A}
\SubArea{Quadratic functions}
\LANGen{
\Question{
Find the \(y\)-intercept
of the function \(f\colon y = 10x^{2} - 18x - 6.3\).}
...
de la función \(f\colon y = 10x^{2} - 18x - 6.3\).}
...
\LANGes{
\Question{
Completa la siguiente frase, si es posible: „La función \(f\colon y = -x^{2} - 2x + 15\) logra solamente valores ... en el intervalo \([- 5;3] \).”}
...
\Data\ID{1003083114}
\Updated{2020-09-30 03:09:55}
\Level{B}
\SubArea{Quadratic functions}
\LANGen{
\Question{
Determine the coordinates of the parabola vertex, if the parabola is the graph of \( f(x)=4x^2+16x+11 \).}
{\( [-2;-5] \)}{\( [-2;7] \)}{\( [2;11] \)}{\( [-2;11] \)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Dadas las gráficas de las funciones \( f(x)=x^2+2x-3\) y \( g(x)=-x^2+3x-4 \), encuentra el conjunto de solución de la siguiente inecuación.
\[ x^2+2x-3\leq-x^2+3x-4  \]}
{\( \emptyset \)}{\( \mathbb{R} \)}{\( (-\infty;0] \)}{\( [-3;1] \)}{}{}}
\End

\Data\ID{1103034606}
\Updated{2020-10-08 11:10:49}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
Dadas las gráficas de las funciones \( f(x)=x^2-4x\) y \( g(x)=4x^2-16x+12 \), encuentra el conjunto de solución de la siguiente inecuación.
\[ 4x^2-16x+12\leq x^2-4x \]}
{\( \{2\} \)}{\( \mathbb{R} \)}{\( \{-4\} \)}{\( [1;3] \)}{}{}}
\End

\Data\ID{1103034701}
\Updated{2020-10-08 01:10:02}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
Dadas las gráficas de las funciones \( f(x)=2x^2-2x-4 \) y \( g(x)=2x+2 \), encuentra el conjunto de solución de la siguiente ecuación.
\[ 2x^2-2x-4=2x+2 \]}
{\( \{-1;3\} \)}{\( \{-1;2\} \)}{\( \{0;8\} \)}{\( \{-4;0\} \)}{}{}}
\End
...
\LANGes{
\Question{
dadas las gráficas de las funciones \( f(x)=x^2-4x \) y \( g(x)=4x^2-16x+12 \), encuentra el conjunto de solución de la siguiente ecuación.
\[ 4x^2-16x+12=x^2-4x \]}
{\( \{2\} \)}{\( \{-4\} \)}{\( \{0;4\} \)}{\( \{0\} \)}{}{}}
\End

\Data\ID{1103034703}
\Updated{2020-10-08 01:10:11}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
Dada la gráfica de la función \( f(x)=2x^2-2x-4 \) y los puntos \( A \), \( B \), \( C \), \( D \), \( E \), encuentra el conjunto de solución de la siguiente ecuación.
\[ 2x^2-2x-4=1 \]}
{\( \{a;e\} \)}{\( \{b;d\} \)}{\( \{c;e\} \)}{\( \{ c \} \)}{}{}}
\End

\Data\ID{1103034704}
\Updated{2020-10-08 12:10:12}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
Dadas las gráficas de las funciones \( f(x)=-x^2+4\) y \( g(x)=x+2 \), encuentra el conjunto de solución de la siguiente ecuación.
\[ -x^2+4=x+2 \]}
{\( \{-2;1\} \)}{\( \{0;3\} \)}{\( \{-2;2\} \)}{\( \{0;4\} \)}{}{}}
\End

\Data\ID{1103034705}
\Updated{2020-10-08 12:10:02}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
Dadas las gráficas de las funciones \( f(x)=-x^2-x+6 \) y \( g(x)=x^2-4x+4 \), encuentra el conjunto de solución de la siguiente ecuación.
\[ x^2-4x+4 = -x^2-x+6 \]}
{\( \{-0.5;2\} \)}{\( \{2\} \)}{\( \{-3;2\} \)}{\( \{0;6.25\} \)}{}{}}
\End

\Data\ID{1103034706}
\Updated{2020-10-08 12:10:16}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
Dadas las gráficas de las funciones \( f(x)=-x^2-x+6 \) y \( g(x)=x^2-4x+4 \), encuentra el conjunto de solución de la siguiente equación.
\[ -x^2-x+6=0 \]}
{\( \{-3;2\} \)}{\( \{-0.5;2\} \)}{\( \{2\} \)}{\( \{0;6.25\} \)}{}{}}
\End

\Data\ID{1103083107}
\Updated{2020-11-06 01:11:36}
\Level{B}
\SubArea{Quadratic functions}
\IMG{1103083107.pdf}
\LANGen{
...
\LANGes{
\Question{
Las gráficas de las dos funciones cuadráticas \( f \) y \( g \) que tienen el mismo vértice \( V \) están en el dibujo. La gráfica de \( g \) es la reflexión de la gráfica de \( f \) respecto al vértice \( V \). Además ambas gráficas son simétricas respecto el eje \( y \). Identifica la declaración correcta sobre \( f \) y \( g \).}
...
\LANGes{
\Question{
En el dibujo hay las gráficas de las funciones cuadráticas \( f \) y \( g \) . La gráfica de \( g \) es la reflección de la gráfica de \( f \) respecto al eje \( y \). Identifica cuál de las declaraciones sobre \( f \) y \( g \) es correcta.}
{Las ecuaciones de \( f \) y \( g \) difieren solamente en el siglo del coeficiente en el término lineal.}{Las ecuaciones de \( f \) y \( g \) difieren solamente en el signo del coeficiente en el término cuadrático.}{Las ecuaciones de \( f \) y ( g \) difieren solamente en el signo del coeficiente en el término absoluto.}{Ninguna de las declaraciones es correcta.}{}{}}
\End

\Data\ID{1103120001}
\Updated{2020-10-09 12:10:59}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
En el dibujo A, tenemos dada la gráfica de la función cuadrática \( f(x)=\frac12x^2 \).  Usa la gráfica de \( f \) como ayuda para identificar cuál de las gráficas en el dibujo B es la gráfica de \( g(x) =\frac12 x^2-2 \). Elije cuál es el color de la gráfica de \( g \). (Nota: Las gráficas en el dibujo B fueron obtenidas moviendo la gráfica de \( f \).)}
{azul}{verde}{rojo}{amarillo}{}{}}
\End

\Data\ID{1103120002}
\Updated{2020-10-09 08:10:10}
\Level{B}
\SubArea{Quadratic functions}
\IMG{1103120002.pdf}
\LANGen{
...
\LANGes{
\Question{
Sea \( f(x)=2x^2 \). Dada la gráfica de la función \( f \) y la gráfica de la función \( g \) que fue obtenida moviendo la gráfica de \( f \) a la derecha (ve el dibujo), alije la función \( g \).}
{\( g(x) = 2(x-3)^2 \)}{\( g(x) = 2(x+3)^2 \)}{\( g(x) = 2x^2+3 \)}{\( g(x) = 2x^2-3 \)}{}{}}
\End

\Data\ID{1103120003}
\Updated{2020-10-09 08:10:07}
\Level{B}
\SubArea{Quadratic functions}
\IMG{1103120003a.pdf}
\LANGen{
...
\LANGes{
\Question{
En el dibujo A tenemos dada la gráfica de la función cuadrática \( f(x)=-2x^2 \).  Usa la gráfica de \( f \) como ayuda para determinar cuál de las gráficas en el dibujo B es la de \( g(x)=-2(x+4)^2 \). Elije qué color tiene la gráfica de la función \( g \). (Nota: Las gráficas en el dibujo B fueron obtenidas moviendo la gráfica de \(  f \).)}
{rojo}{azul}{verde}{amarillo}{}{}}
\End

\Data\ID{1103120005}
\Updated{2020-10-09 08:10:42}
\Level{B}
\SubArea{Quadratic functions}
\IMG{1103120005a.pdf}
\LANGen{
...
\LANGes{
\Question{
En el dibujo A tenemos dada la gráfica de la función cuadrática \( f(x)=x^2 \).  Usa la gráfica de \( f \) como ayuda para identificar cuál de las gráficas dadas en el dibujo B es la gráfica de \( g(x)=\frac32(x+3)^2-2 \). Elije el color de la gráfica de \( g \). (Nota: Las gráficas en el dibujo B fueron obtenidas moviendo y estrechando la gráfica de \( f \).)}
{verde}{rojo}{azul}{amarillo}{}{}}
\End

\Data\ID{1103120006}
\Updated{2020-10-09 08:10:00}
\Level{B}
\SubArea{Quadratic functions}
\IMG{1103120006a.pdf}
\LANGen{
...
\LANGes{
\Question{
En el dibujo A tenemos dada la gráfica de la función cuadrática \( f(x)=x^2 \). Usa la gráfica de \( f \) como ayuda para identificar cuál de las gráficas dadas en el dibujo B es la de \( g(x)=-(x+1)^2-3 \). Elije qué color tiene la gráfica de\( g \).}
{azul}{rojo}{amarillo}{verde}{}{}}
\End

\Data\ID{1103120007}
\Updated{2020-10-09 08:10:23}
\Level{B}
\SubArea{Quadratic functions}
\IMG{1103120007.pdf}
\LANGen{
...
\LANGes{
\Question{
Sea \( f(x)=x^2 \). Dada la gráfica de la función \( f \) y la gráfica de la función \( g \) obtenida moviendo la gráfica de \( f \) (ve el dibujo), elije la función \( g \).}
{\( g(x) = (x+2)^2-4 \)}{\( g(x) = (x-2)^2-4 \)}{\( g(x)=(x-4)^2-2 \)}{\( g(x) = (x-2)^2+4 \)}{}{}}
\End
...
\LANGes{
\Question{
Elije la ecuación cuya solución está en rojo el dibujo.}
{\( -x^2+2=0 \)}{\( -x^2-2=0 \)}{\( x^2+\sqrt2=0 \)}{\( (x-\sqrt2)(x+\sqrt2)=0 \)}{}{}}
\End

\Data\ID{1103123809}
\Updated{2020-11-03 09:11:51}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
Elije la ecuación cuya solución está en el dibujo.}
{\( x^2-4x=0 \)}{\( x^2-4=0 \)}{\( x^2-2x=0 \)}{\( x^2-2=0 \)}{}{}}
\End

\Data\ID{1103148604}
\Updated{2020-11-20 01:11:03}
\Level{B}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
En el dibujo hay gráfica de una función cuadrática y tres puntos pertenecientes a dicha gráfica. ¿Cuál de los puntos de la lista también pertenece a la gráfica?}
{\([0.4;0.16]\)}{\([0.4;0.2]\)}{\([0.4;0.8]\)}{\([0.04;0.16]\)}{}{}}
\End

\Data\ID{9000007107}
\Updated{2020-11-20 11:11:53}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
En el dibujo hay la gráfica de una función cuadrática y tres puntos pertenecientes a dicha gráfica. ¿Cuál de os puntos de la lista tambiěn pertenece a la gráfica?}
{\([2;3]\)}{\([2;2]\)}{\([2;4]\)}{\([2;5]\)}{}{}}
\End

\Data\ID{9000007110}
\Updated{2020-11-20 11:11:44}
\Level{B}
\SubArea{Quadratic functions}
...
\LANGes{
\Question{
En el dibujo hay la gráfica de una función cuadrática y tres puntos sobre ella, ¿Cuál de los puntos de la lista también pertenece a la gráfica de la misma función?}
{\([-1;-3]\)}{\([-1;-1]\)}{\([-1;-2]\)}{\([-1;-4]\)}{}{}}
\End

\Data\ID{9000014803}
\Updated{2020-11-22 03:11:43}
\Level{B}
\SubArea{Quadratic functions}
\LANGen{
\Question{
Consider a parabola defined as the graph of the function
\(f(x) = 6x^{2} + 3\).
Which of the following points is the vertex of this parabola?}
{\(V = [0;3]\)}{\(V = [3;0]\)}{\(V = [1;9]\)}{\(V = [1;2]\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Usando la función de la gráfica \(f(x) = x^{2} - x - 6\) 
...
\LANGes{
\Question{
¿Cuál de las ecuaciones cuadráticas se puede resolver por la gráfica en el dibujo?}
{\(x^{2} - 6x + 9 = 0\)}{\(x^{2} + 9x - 3 = 0\)}{\(x^{2} - 9x - 3 = 0\)}{\(x^{2} + 6x + 9 = 0\)}{}{}}
\End

\Data\ID{9100025608}
\Updated{2020-11-20 12:11:55}
\Level{B}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
Supongamos que queremos pintar un cubo tal que en cada cara quede una banda sin pintar en todos lados. La anchura de cada banda debería ser \( 1\,\mathrm{cm} \). El tinte tiene consunción \( 100\,\mathrm{ml}/1\,\mathrm{m}^2 \). De las siguientes funciones elije la que describe la dependencia de la consunción del color \( V \) a la longitud del lado del cubo \( a \). La consunción  \( V \) está dada en milímetros  la longitud del lado del cubo \( a \) en metros.}
{\( V=\left(a-\frac1{50}\right)^2\cdot600 \)}{\( V=\left(a-\frac1{50}\right)^2\cdot\frac3{50} \)}{\( V=\left(a-\frac1{100}\right)^2\cdot600 \)}{\( V=(a-2)^2\cdot100 \)}{}{}}
\End

\Data\ID{1003124802}
\Updated{2020-11-03 10:11:21}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
Queremos plantar flores en un florero rectangular con el lado largo un metro más largo que el lado corto. Cada flor necesita \( 1\,\mathrm{dm}^2 \) de lugar. De las funciones siguientes elije la que describe la dependencia del número de flores plantadas \( n \) a la longitud del lado más corto del florero \( a \).  (Supone que las dimensiones del florero están dadas en metros enteros)}
{\( n=\left(a^2+a\right)\cdot100 \)}{\( n=\left(a^2+a\right)\cdot\frac1{100} \)}{\( n=(a+1)^2\cdot100 \)}{\( n=\left(a^2+a\right) \)}{}{}}
\End

\Data\ID{1003124803}
\Updated{2020-11-03 10:11:10}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
Un componente en forma de anillo está hecho de un metal. El diámetro del agujero es  \( 25\,\% \)  del diámetro de toda la componente. Elije la función que describe la dependencia del área (\( S \)) del material usado para producir una componente al diámetro exterior (\( d \)).}
{\( S=\frac{15}{64}\,\pi d^2 \)}{\( S=\frac38\,\pi d^2 \)}{\( S=\frac{15}{32}\,\pi d^2 \)}{\( S=\frac{31}{64}\,\pi d^2 \)}{}{}}
\End

\Data\ID{1003124804}
\Updated{2020-11-21 08:11:57}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
En el centro de una plaza en forma de cuadro hay una fuente, La fuente tiene froma de cuadro con el lado de \( 4.5\,\mathrm{m} \). El cuadro debería ser pavimentado por guijarros de tamaño  \( 25\,\mathrm{cm} \times 25\,\mathrm{cm} \). Elije la función que describe la dependencia del número de guijarros necesitados (\( n \)) a la longitud de la plaza (\( a \)) dada en metros.}
{\( n=16a^2-324 \)}{\( n=\frac{a^2}{625}-324 \)}{\( n=16a^2-625 \)}{\( n=\frac{a^2}{16}-324 \)}{}{}}
\End

\Data\ID{1003124805}
\Updated{2020-11-23 03:11:52}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
En una bobina de \( 0.5\,\mathrm{kg} \) de masa está sinuoso un alambre de aluminio de longitud de \( 100\,\mathrm{m} \). Elije la función que describe la dependencia de la masa de la bobina con el alambre  \( m \) (en kilos) al diámetro del alambre \( d \) (en milímetros). La densidad del alambre es \( 2\,700\frac{kg}{m^3} \).
\[ \] Pista: La densidad de un objeto se define como la proporción entre la masa y el volumen del objeto,}
{\( m=\frac{27\pi}{400} d^2+0.5 \)}{\( m= 67 500\pi d^2+0.5 \)}{\( m=\frac{27\pi}{400} d^2-0.5 \)}{\( m=\frac{27\pi}{200} d^2+0.5 \)}{}{}}
\End

\Data\ID{1003124806}
\Updated{2020-10-08 07:10:02}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
Necesitamos cercar la tierra en forma de un triángulo equilátero. Elige la función que determina na dependencia del área de tierra cercado \( S \) (en metros cuadrados) a la longitud \( d \) (en metros) de la cerca usada.}
{\( S=\frac{\sqrt3}{36} d^2 \)}{\( S=\frac{\sqrt3}{18} d^2 \)}{\( S=\frac{\sqrt3}4 d^2 \)}{\( S=\frac1{36} d^2 \)}{}{}}
\End

\Data\ID{1003148601}
\Updated{2020-10-08 07:10:13}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
Considera un objeto tirado hacia arriba de la tierra con la velocidad inicial de \( 30\frac{\mathrm{m}}{\mathrm{s}} \). El objeto se mueve hacia arriba con la velocidad vertical disminuyendo hasta que para. Luego empieza a moverse verticalmente hacia abajo. Encuentra la mayor altura que alcanza.
\[ \]
Nota: La distancia vertical \( y \) de un objeto tirado se puede describir por la ecuación \( y=v_0t-\frac12gt^2 \), dónde \( v_0 \) es la velocidad inicial del objeto tirado,  \( g \) es la aceleración gravitatoria (cuenta con el valor aproximado \( 10\frac{\mathrm{m}}{\mathrm{s}^2}\)), y \( t \) es el periodo del movimiento del objeto en segundos.}
{\( 45\,\mathrm{m} \)}{\( 135\,\mathrm{m} \)}{\( 360\,\mathrm{m} \)}{\( 40\,\mathrm{m} \)}{}{}}
\End

\Data\ID{1003148602}
\Updated{2020-10-08 07:10:42}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
Considera un objeto tirado con el ángulo \( 30^{\circ} \) encima la horizontal con la velocidad inicial \( 40\frac{\mathrm{m}}{\mathrm{s}} \). ¿Cuánto tiempo tardará el objeto en alcanzar su altura máxima?
\[ \]
Nota: La altura \( y \) de un objeto tirado se puede describir por la ecuación \( y=v_0t\sin\alpha-\frac12gt^2 \), dónde \( v_0 \) es la velocidad inicial,  \( g \) es la aceleración gravitatoria (cuenta con el valor aproximado \( 10\frac{\mathrm{m}}{\mathrm{s}^2}\)), y \( t \) es el periodo del movimiento del objeto en segundos y \( \alpha \) es el ángulo horizontal con el cuál tiramos el objeto.}
{\( 2\,\mathrm{s} \)}{\( 4\,\mathrm{s} \)}{\( 8\,\mathrm{s} \)}{\( 1\,\mathrm{s} \)}{}{}}
\End

\Data\ID{1003158901}
\Updated{2020-10-08 08:10:02}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
Un objeto se mueve con una desaceleración constante en un línea recta. Desplazamiento \( s \) (en metros) en tiempo \( t \) (en segundos) se puede describir por \( s=24t-3t^2 \). Encuentra el desplazamiento del objeto desde en momento cuando empieza a desacelerar hasta que para.}
{\( 48\,\mathrm{m} \)}{\( 144\,\mathrm{m} \)}{\( 16\,\mathrm{m} \)}{\( 96\,\mathrm{m} \)}{}{}}
\End

\Data\ID{1003158902}
\Updated{2020-10-08 10:10:00}
\Level{C}
\SubArea{Quadratic functions}
\IMG{1103158902.pdf}
\LANGen{
...
\LANGes{
\Question{
La longitud de un rectángulo es \( 4\,\mathrm{cm} \) y su anchura es \( x\,\mathrm{cm} \). El rectángulo está dividido por una recta vertical en dos partes para que una parte sea un cuadro con el lado de \( x\,\mathrm{cm} \) (ve en el dibujo). ¿Cuál es el área máximo de la parte que queda del rectángulo?}
{\( 4\,\mathrm{cm}^2 \)}{\( 2\,\mathrm{cm}^2 \)}{\( 16\,\mathrm{cm}^2 \)}{\( 1\,\mathrm{cm}^2 \)}{}{}}
\End

\Data\ID{1003162301}
\Updated{2021-02-15 07:02:43}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGcs{
\Question{
Pro které hodnoty parametru \( m \) bude funkce \( f(x)=-2(x-m)^2+3 \) sudá?}
{\( m=0 \)}{\( m=3 \)}{\( m=-3 \)}{\( m\in(-\infty;\infty) \)}{}{}}
\LANGsk{
\Question{
...
\LANGcs{
\Question{
Pro které hodnoty parametru \( m \) bude funkce \( f(x)=3(x+m)^2-2 \) rostoucí na intervalu \( (0;\infty) \)?}
{\( m\in\langle0;\infty) \)}{\( m\in(-\infty;0) \)}{\( m\in(-\infty;0\rangle \)}{\( m\in(-\infty;2\rangle \)}{}{}}
\LANGsk{
\Question{
...
\LANGes{
\Question{
Dada la gráfica de la función \( f(x)=x^2 + 2x - 4 \), halla el cunjunto de solución de la siguiente ecuación.
\[ \left|x^2 + 2x - 4\right|= 4 \]}
{\( \{ -4; -2; 0 ; 2 \} \)}{\( \{ -4; 2 \} \)}{\( \{ -4; 0; 2 \} \)}{\( \left\{ -1-\sqrt5;-1+ \sqrt5 \right\} \)}{}{}}
\End

\Data\ID{1103067809}
\Updated{2020-10-08 12:10:11}
\Level{C}
\SubArea{Quadratic functions}
\IMG{1103067809.pdf}
\LANGen{
...
\LANGes{
\Question{
Dadas las gráficas de las funciones \( f(x)=\frac12x^2-3 \) y \( g(x)=\frac12x \), encuentra el conjunto de solución de la siguiente ecuación,
\[ \left|\frac12 x^2-3\right|=\left|\frac12 x\right| \]}
{\( \{ -3; -2; 2; 3 \} \)}{\( \{ -2; 3 \} \)}{\( \{ 2; 3 \} \)}{\( \left\{ -\sqrt6; -2; \sqrt6; 3 \right\} \)}{}{}}
\End

\Data\ID{1103082702}
\Updated{2020-10-08 12:10:36}
\Level{C}
\SubArea{Quadratic functions}
\IMG{1103082702.pdf}
\LANGen{
...
\LANGes{
\Question{
La función \( f \) está dada completamente por la gráfica. Identifica cuál de las declaraciones es correcta.}
{\( f(x)=\left|x^2-1\right|;\ x\in[-2;2] \)}{\( f(x)=\left|x^2\right|-1;\ x\in[-2;2] \)}{\( f(x)=-\left|x^2+1\right|;\ x\in[-2;2] \)}{\( f(x)=\left|-x^2\right|+1;\ x\in[-2;2] \)}{}{}}
\End

\Data\ID{1103120009}
\Updated{2020-11-06 02:11:38}
\Level{C}
\SubArea{Quadratic functions}
\IMG{1103120009.pdf}
\LANGen{
...
\LANGes{
\Question{
En el dibujo hay dos parábolas. Una parabola puede identificarse con la otra moviéndola. Estas parábolas son gráficas de las funciones cuadráticas
\[ f(x)=-(x-a)^2+b\ \text{ y }\ g(x)=-(x-c)^2+d, \]
dónde \( a \), \( b \), \( c \), \( d\in\mathbb{R} \).
Las declaraciones siguientes describen las relaciones entre las parejas de coeficientes \( a \), \( b \), \( c \) y \( d \). Elije la declaración correcta.}
{\( a=c-1\wedge b=d+4 \)}{\( a=c+1\wedge b=d-4 \)}{\( a=c-4\wedge b=d+1 \)}{\( a=c+4\wedge b=d-1 \)}{}{}}
\End

\Data\ID{1103120010}
\Updated{2020-11-03 09:11:45}
\Level{C}
\SubArea{Quadratic functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
Considera un circuito simple en cual una batería de fuerza electromotiva \( U_e \) y resitencia interna \( R_i \) conduce corriente \( I \) por un resistor external de resistencia \( R \) (ve dibujo ). El resistor external podría ser por ejemplo una luz eléctrica, un elemento de calefacción eléctrica, o posiblemente un motor eléctrico. El objeto elemental del circuito es la transferencia de energía de la batería al resistor external, dónde se usa. (por ejemplo enciende una luz)
\[ \]
La fuerza \( P \) transferida al resistor external se describe por la fórmula \( P=U_eI-R_i I^2 \). ¿Cuál es la fuerza máxima que se puede transferir al resistor external si tenemos una fuente con  \( R_i=0.25\,\Omega \) y \( U_e=20\,\mathrm{V} \)?}
{\( 400\,\mathrm{W} \)}{\( 80\,\mathrm{W} \)}{\( 40\,\mathrm{W} \)}{\( 790\,\mathrm{W} \)}{}{}}
\End

\Data\ID{1103148605}
\Updated{2020-11-20 01:11:13}
\Level{C}
\SubArea{Quadratic functions}
\IMG{1103148605.pdf}
\LANGen{
...
\LANGes{
\Question{
Supongamos que un objeto en reposo empieza a acelerar con una aceleración constante \( a \). La distancia \( s \) viajada por el objeto en tiempo \( t \) es dada por la fórmula \( s=\frac12at^2 \). En el dibujo se puede ver la gráfica de la dependencia de la distancia  \( s \) al tiempo \( t \). Halla la aceleración \( a \) del objeto.}
{\( 8\frac{\mathrm{m}}{\mathrm{s}^2} \)}{\( 16\frac{\mathrm{m}}{\mathrm{s}^2} \)}{\( 4\frac{\mathrm{m}}{\mathrm{s}^2} \)}{\( 2\frac{\mathrm{m}}{\mathrm{s}^2} \)}{}{}}
\End
...
\LANGes{
\Question{
En el dibujo hay gráficas de tres funciones cuadráticas. Elije la fórmula que corresponde a todas las tres funciones funciones. Supongamos que  \( a\in\mathbb{R}^+ \).}
{\( y=a(x+2)^2-1 \)}{\( y=a(x-2)^2-1 \)}{\( y=a(x-1)^2+2 \)}{\( y=2(x-a)^2+1 \)}{}{}}
\End
...
\LANGes{
\Question{
En el dibujo hay gráficas de tres funciones cuadráticas. Elije la fórmula que corresponde a todas las tres funciones funciones.}
{\( y=-(x+a)^2+3 \), \( a\in(-\infty; 0] \)}{\( y=-(x+a)^2+3 \), \( a\in\mathbb{R}^+ \)}{\( y=-(x+3)^2+a \), \( a\in\mathbb{R}^+ \)}{\( y=-(x-3)^2+a \), \( a\in\mathbb{R}^+ \)}{}{}}
\End

\Data\ID{9000007101}
\Updated{2020-11-20 11:11:43}
\Level{C}
\SubArea{Quadratic functions}
...
de funciones cuadráticas, como visto en el dibujo. Cualquier función cuadrática en esta familia se puede expresar analíticamente por
\[ 
 y = ax^{2} + bx + c
\]
dónde \(a\),
...
\(a\not = 0\). Para cada función el conjunto \(K\) denota el conjunto de \(x\)-intesecantes.. Completa la frase: Las expresiónes analíticas para las funciones en la familia 
\(M\) difieren solamente en ...}
{el coeficiente \(a\)}{el coeficiente \(b\)}{el coeficiente \(c\)}{el conjunto \(K\)}{}{}}
\End

\Data\ID{9000007102}
\Updated{2020-11-20 11:11:26}
\Level{C}
\SubArea{Quadratic functions}
...
\(a\not = 0\). Para cada función el conjunto \(K\) denota el conjunto de \(x\)-intesecantes.. Completa la frase: Las expresiónes analíticas para las funciones en la familia 
\(M\) tienen en común solamente ...}
{el conjunto de soluciones \(K\)}{ale valor del coeficiente \(a\)}{el valor del coeficiente \(b\)}{el valor del coeficiente \(c\)}{}{}}
\End
