...
\LANGes{
\Question{
Una bobina de \( 0.5\,\mathrm{kg} \) de masa está  rodeada por un alambre de aluminio de longitud de \( 100\,\mathrm{m} \). Elije la función que describe la dependencia de la masa de la bobina con el alambre  \( m \) (en kilos) respecto al diámetro del alambre \( d \) (en milímetros). La densidad del alambre es \( 2\,700\frac{kg}{m^3} \).
