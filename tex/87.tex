...
\LANGcs{
\Question{
Hliníková a mosazná tyč mají při dané teplotě stejnou délku. Známe materiálové konstanty obou tyčí: \(\alpha_{\mathrm{hliník}}=24\cdot 10^{-6}\,\mathrm{K}^{-1}\) a \(\alpha_{\mathrm{mosaz}}=18\cdot 10^{-6}\,\mathrm{K}^{-1}\). Rozhodněte, co platí o prodloužení obou tyčí, když je zahřejeme o stejnou teplotu. Procentuální rozdíl v prodloužení tyčí zaokrouhlete na celá procenta.
\[~\]
...
\LANGsk{
\Question{
Hliníková a mosadzná tyč majú pri danej teplote rovnakú dĺžku. Materiálové konštanty obidvoch tyčí sú: \(\alpha_{\mathrm{hliník}}=24\cdot 10^{-6}\,\mathrm{K}^{-1}\) a \(\alpha_{\mathrm{mosaz}}=18\cdot 10^{-6}\,\mathrm{K}^{-1}\). Rozhodnite, čo platí o predĺžení oboch tyčí, ak ich zohrejeme o rovnakú teplotu. Percentuálny rozdiel v predĺžení tyčí zaokrúhlite na celé percentá.
\[~\]
...
\LANGsk{
\Question{
Ekonómovia predpovedali, že v istej zemi dôjde k ročnej inflácii \( 10\% \), a to po dobu dvoch rokov. O koľko percent po týchto dvoch rokoch vzrastú v zemi ceny?}
{o \( 21\% \)}{o \( 20\% \)}{o \( 10\% \)}{o \( 1{,}21\% \)}{}{}}
\LANGes{
\Question{
...
\LANGsk{
\Question{
Banka \( A \) obdržala \( 3000 \) zlotých za investície s ročnou sadzbou \( p\% \). Banka \( B \) získala \( 4000 \) zlotých za úrokovou sadzbu, ktorá bola o \( 2 \) percentné body lepšia než banka \( A \). Po jednom roku bol celkový zisk oboch bánk \( 360 \) zlotých. Aká bola sadzba \( p \)?}
{\( 4\% \)}{\( 4{,}5\% \)}{\( 5\% \)}{\( 2\% \)}{}{}}
\LANGes{
\Question{
...
\LANGsk{
\Question{
Spoločnosť \( A \)  mala v druhom kvartále obrat o \( 50\% \) vyšší než v prvom. V treťom kvartále jej obrat klesol o \( 20\% \) a vo štvrtom klesol o ďalších \( 20\% \). Aký bol obrat spoločnosti \( A \) v druhom kvartále, ak vieme, že vo štvrtom kvartále bol obrat vyčíslený na \( 1440000 \) zlotých?}
{\( 2250000\) zlotých}{\( 1500000 \) zlotých}{\( 1800000\) zlotých}{\( 2000000 \) zlotých}{}{}}
\LANGes{
\Question{
