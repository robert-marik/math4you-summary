...
\Data\ID{9000033701}
\Updated{2020-08-21 07:08:58}
\Level{B}
\SubArea{Quadratic equations and inequalities}
\LANGen{
\Question{
Find the number of integer solutions of the following inequality. 
\[ 
 m^{2} + 2m - 4 < 0
\]}
...
\LANGcs{
\Question{
Rozhodněte o počtu řešení nerovnice
\(m^{2} + 2m - 4 < 0\), kde
\(m\in \mathbb{Z}\).}
...
\Data\ID{9000039004}
\Updated{2020-08-20 08:08:54}
\Level{B}
\SubArea{Quadratic equations and inequalities}
\LANGen{
\Question{
Find all the values of \(x\) 
for which the following expression is negative. 
\[ 
 (x - 1)(x - 7)
\]}
