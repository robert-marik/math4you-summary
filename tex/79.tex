...
\LANGes{
\Question{
Elige el mejor primer paso para calcular el límite de la siguiente sucesión:
\[ \left( \frac{4n^5+n^4-n^3+2}{7n^4-2n^2+7n} \right)^{\infty}_{n=1} \]}
...
\LANGes{
\Question{
Elige el mejor primer paso para calcular el límite de la siguiente sucesión: \[ \left(\frac{3\cdot5^n+2\cdot6^n}{2\cdot5^n+4\cdot6^n}\right)_{n=1}^{\infty} \]}
...
\LANGes{
\Question{
Elige el mejor primer paso para calcular el límite de la siguiente sucesión: \(\lim\limits_{n\rightarrow\infty}\frac{3^n+4^{n-1}}{3^n+4^{n+1}} \).}
...
\LANGes{
\Question{
Elige el mejor primer paso para calcular el límite de la siguiente sucesión: \( \left(n-\sqrt{n^2-1} \right)_{n=1}^{\infty} \).}
...
\LANGes{
\Question{
Elige el mejor primer paso para calcular el límite de la siguiente sucesión: \( \left( \frac{3n+2}{\sqrt{n^2-1}} \right)_{n=1}^{\infty} \).}
