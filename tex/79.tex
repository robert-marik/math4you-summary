...
{\( \left(\left(\frac13\right)^n-3\right)_{n=1}^{\infty} \)}{\( \left(3^n-3\right)_{n=1}^{\infty} \)}{\( \left(3-3^n\right)_{n=1}^{\infty} \)}{\( \left(3-\left(\frac13\right)^n\right)_{n=1}^{\infty} \)}{\( \left((-3)^n-3\right)_{n=1}^{\infty} \)}{}}
\LANGpl{
\Question{
Wybierz ciąg z granicą równą \( -3 \).}
{\( \left(\left(\frac13\right)^n-3\right)_{n=1}^{\infty} \)}{\( \left(3^n-3\right)_{n=1}^{\infty} \)}{\( \left(3-3^n\right)_{n=1}^{\infty} \)}{\( \left(3-\left(\frac13\right)^n\right)_{n=1}^{\infty} \)}{\( \left((-3)^n-3\right)_{n=1}^{\infty} \)}{}}
\LANGcs{
\Question{
...
\Question{
Choose the sequence with the limit equal to \(-3\).}
{\( \Bigl( \frac{(-2)^n+(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{\( \Bigl( \frac{(-5)^n+(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{\( \Bigl( \frac{(-2)^n-(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{\( \Bigl( \frac{(-5)^n-(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{\( \Bigl( \frac{(-3)^n+(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{}}
\LANGpl{
\Question{
Wybierz ciąg o granicy równej \(-3\).}
{\( \Bigl( \frac{(-2)^n+(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{\( \Bigl( \frac{(-5)^n+(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{\( \Bigl( \frac{(-2)^n-(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{\( \Bigl( \frac{(-5)^n-(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{\( \Bigl( \frac{(-3)^n+(-3)^{n+1}}{(-3)^n} \Bigr)_{n=1}^{\infty} \)}{}}
\LANGcs{
\Question{
Vyberte posloupnost, jejíž limita je rovna \(-3\).}
...
{\(\mathrm{e}^{4}\)}{\(\mathrm{e}+4\)}{\(4\mathrm{e} \)}{\(\infty \)}{}{}}
\LANGpl{
\Question{
...
\[
 ...
 {n^{2n}} \right)}_{n=1}^{\infty}
\]
Podpowiedź: Granica ciągu \({\left({\left(1 + \frac{2}
{n}\right)}^{n}\right)}_{n=1}^{\infty}\)
to \(\mathrm{e}^2\), gdzie \(\mathrm{e}\) jest liczbą Eulera.}
{\(\mathrm{e}^{4}\)}{\(\mathrm{e}+4\)}{\(4\mathrm{e} \)}{\(\infty \)}{}{}}
\LANGcs{
\Question{
Určete limitu dané posloupnosti.
\[ 
 {\left(\frac{(n^{2} + 4n + 4)^{n}}
 {n^{2n}} \right)}_{n=1}^{\infty }
\]
Nápověda: Limita posloupnosti \({\left({\left(1 + \frac{2} 
{n}\right)}^{n}\right)}_{n=1}^{\infty }\) 
je \(\mathrm{e}^2\), kde  \(\mathrm{e}\) je Eulerovo číslo.}
{\(\mathrm{e}^{4}\)}{\(\mathrm{e}+4\)}{\(4\mathrm{e} \)}{\(\infty \)}{}{}}
\LANGsk{
\Question{
...
{\(\frac12 \mathrm{e}\)}{\(\mathrm{e}^{\frac12}\)}{\(\frac12 + \mathrm{e} \)}{\(\infty \)}{}{}}
\LANGpl{
\Question{
...
n=1}^{\infty }
\]
Podpowiedź: Granica ciągu \({\left({\left(1 + \frac{1}
{n}\right)}^{n}\right)}_{n=1}^{\infty}\)
jest liczbą Eulera \(\mathrm{e}\).}
{\(\frac12 \mathrm{e}\)}{\(\mathrm{e}^{\frac12}\)}{\(\frac12 + \mathrm{e} \)}{\(\infty \)}{}{}}
\LANGcs{
\Question{
Určete limitu dané posloupnosti.
...
n=1}^{\infty }
\]
Nápověda: Limita posloupnosti \({\left({\left(1 + \frac{1} 
{n}\right)}^{n}\right)}_{n=1}^{\infty }\) 
je Eulerovo číslo \(\mathrm{e}\).}
{\(\frac12 \mathrm{e}\)}{\(\mathrm{e}^{\frac12}\)}{\(\frac12 + \mathrm{e} \)}{\(\infty \)}{}{}}
\LANGsk{
\Question{
Určte limitu postupnosti.
...
\lim\limits_{n\to\infty}\left(10^{-1} + 10^{-2} + \dots + 10^{-n} \right)
 \]}
{\( \frac19 \)}{\( \frac{1}{10} \)}{\( \frac{9}{10} \)}{\( 0 \)}{\( \infty \)}{}}
\LANGpl{
\Question{
Wyznacz granicę.
\[ 
...
\[ 
 ...
 {n^{2n}} \right)}_{n=1}^{\infty }
\]
Nápověda: Posloupnost \({\bigl ({\bigl (1 + \frac{1} 
{n}\bigr )}^{n}\bigr )}_{n=1}^{\infty }\) 
