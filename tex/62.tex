...
\LANGen{
\Question{
Find the angle between the solid diagonal and the side of a cube. Round the result
...
\(b = 4\, \mathrm{cm}\) and
\(c = 12\, \mathrm{cm}\). The solid diagonal
...
\LANGen{
\Question{
The base of a pyramid is a square with one side
\(2\, \mathrm{cm}\). The height of
the pyramid is \(4\, \mathrm{cm}\).
Find the angle between the side of the pyramid and the base. Round your answer to
two decimal places.}
