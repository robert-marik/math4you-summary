...
\LANGes{
\Question{
Identifica cuál de las siguientes funciones tiene el período más pequeño.}
{\( f(x)=(\cos(2x) )^2 \)}{\( h(x)=\sin\bigl(\frac{x}{2}\bigr) \)}{\( m(x)=\mathrm{tg}\,\bigl(\frac{x}{2}\bigr) \)}{\( g(x)=(\mathrm{cotg}\, x)^2 \)}{}{}}
\End
...
\LANGes{
\Question{
Elige la proposición verdadera que es válida para cada una de las funciones\( f(x)=\sin x \), \( g(x)=\cos x \), \( h(x)= \mathrm{tg}\,x \):}
{La función tiene infinitos puntos cero.}{La función es impar.}{La función está acotada.}{La función es simple.}{}{}}
\End
...
\LANGes{
\Question{
Para qué \( x \in[0;\frac{\pi}2] \) es \( \sin x = \cos x \)?}
{\( \frac{\pi}4 \)}{\( 0 \)}{\( \frac{\pi}2 \)}{\( \frac{\pi}3 \)}{}{}}
\End
...
\LANGes{
\Question{
Para qué \( \alpha\in[0;90^{\circ} ] \) es \( \mathrm{tg}\,\alpha = \mathrm{cotg}\,\alpha \)?}
{\( 45^{\circ} \)}{\( 60^{\circ} \)}{\( 35^{\circ} \)}{\( 30^{\circ} \)}{}{}}
\End
...
{La función \(f\) 
posee un máximo único y ningún mínimo en
\(I\).}{La función  \(f\) no tiene
un mínimo o máximo en \(I\).}{La función  \(f\) 
posee un máximo único y un mínimo único en
\(I\).}{La función \(f\) 
posee un mínimo único y ningún máximo en
\(I\).}{}{}}
\End
...
\LANGes{
\Question{
Considera la función \(f\colon y =\sin x\) con el dominio \(\mathop{\mathrm{Dom}}(f) =\mathbb{R}_{ 0}^{+}\). Identifica cuál de las siguientes funciones tiene el dominio 
 \([ - 5;+\infty )\).}
{\(f(x + 5)\)}{\(f(x - 5)\)}{\(f(x) + 5\)}{\(f(x) - 5\)}{\(5\cdot f(x)\)}{}}
\End
...
\(f\colon y =\sin (3x + 5)\)
de la gráfica de la función \(g\colon y =\sin 3x\)?}
{Desplaza la gráfica de  \(g\) 
hacia izquierda  \(\frac{5}
{3}\) 
unidades.}{Desplaza la gráfica de \(g\) 
hacia derecha \(5\) 
unidades.}{Desplaza la gráfica de \(g\) 
hacia izquierda  \(5\) 
unidades.}{Desplaza la gráfica de \(g\) 
...
{Ninguna de las funciones dadas  no tiene valores no negativos.}{\(A\cdot f(x)\),
...
\LANGes{
\Question{
Considera la función  \(f\colon y =\mathop{\mathrm{cotg}}\nolimits x\) con el dominio \(\mathop{\mathrm{Dom}}(f) = (0;\pi )\).
...
\LANGes{
\Question{
Considera la función \(f\colon y =\mathop{\mathrm{tg}}\nolimits x\) con el dominio \(\mathop{\mathrm{Dom}}(f) = \left ( \frac{\pi }{2}; \frac{3\pi } 
{2}\right )\).
En la siguiente lista, identifica la función con el dominio
\((0;\pi )\).}
{\(f\left (x + \frac{\pi } {2}\right )\)}{\(\left ( \frac{\pi }{2}\right )\cdot f(x)\)}{\(f\left (x - \frac{\pi } {2}\right )\)}{\(f(x) + \frac{\pi } {2}\)}{\(f(x) - \frac{\pi } {2}\)}{}}
