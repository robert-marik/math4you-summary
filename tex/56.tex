...
\LANGen{
\Question{
Calculate the value of the expression \(\sin{45^{\circ}} -2\sin{225^{\circ}} - 5\sin{135^{\circ}}\).}
{\(- \sqrt{2}\)}{\( \sqrt{2}\)}{\( -2\sqrt{2}\)}{\(- \sqrt{3}\)}{}{}}
\LANGpl{
\Question{
Oblicz wartość wyrażenia \(\sin{45^{\circ}} -2\sin{225^{\circ}} - 5\sin{135^{\circ}}\).}
{\(- \sqrt{2}\)}{\( \sqrt{2}\)}{\( -2\sqrt{2}\)}{\(- \sqrt{3}\)}{}{}}
\LANGcs{
\Question{
Vypočtěte hodnotu výrazu \(\sin{45^{\circ}} -2\sin{225^{\circ}} - 5\sin{135^{\circ}}\).}
{\(- \sqrt{2}\)}{\( \sqrt{2}\)}{\( -2\sqrt{2}\)}{\(- \sqrt{3}\)}{}{}}
\LANGsk{
\Question{
...
\LANGes{
\Question{
Calcula el valor de la expresión \(\sin{45^{\circ}} -2\sin{225^{\circ}} - 5\sin{135^{\circ}}\).}
{\(- \sqrt{2}\)}{\( \sqrt{2}\)}{\( -2\sqrt{2}\)}{\(- \sqrt{3}\)}{}{}}
\End
...
\LANGen{
\Question{
Calculate the value of the expression \(\sin\left( {\frac{2}{3}\pi} \right) +2\sin\left( {\frac{5}{3}\pi} \right) - 3\sin\left( {\frac{4}{3}\pi} \right) \).}
{\( \sqrt{3}\)}{\( -\sqrt{3}\)}{\( \frac{\sqrt{3}}{2}\)}{\(2 \sqrt{3}\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Calcula el valor de la expresión \(\sin\left( {\frac{2}{3}\pi} \right) +2\sin\left( {\frac{5}{3}\pi} \right) - 3\sin\left( {\frac{4}{3}\pi} \right) \).}
{\( \sqrt{3}\)}{\( -\sqrt{3}\)}{\( \frac{\sqrt{3}}{2}\)}{\(2 \sqrt{3}\)}{}{}}
\End
...
{\( \frac{7}{6}\pi\)}{\( \frac{5}{6}\pi\)}{\( \frac{11}{6}\pi\)}{\( \frac{1}{6}\pi\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
¿Cuál es la medida del ángulo \(x\), \(x \in [ 0;2\pi)\), para el cual \(\sin x = -\frac{1}{2}\) y \(\cos x < 0\)?}
{\( \frac{7}{6}\pi\)}{\( \frac{5}{6}\pi\)}{\( \frac{11}{6}\pi\)}{\( \frac{1}{6}\pi\)}{}{}}
\End
...
{\( \frac{7}{4}\pi\)}{\( \frac{1}{4}\pi\)}{\( \frac{3}{4}\pi\)}{\( \frac{5}{4}\pi\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
¿Cuál es la medida del ángulo \(x\), \(x \in [ 0;2\pi)\),  para el cual  \(\cos x = \frac{\sqrt{2}}{2}\) y \(\mathrm{tg}\,x < 0\)?}
{\( \frac{7}{4}\pi\)}{\( \frac{1}{4}\pi\)}{\( \frac{3}{4}\pi\)}{\( \frac{5}{4}\pi\)}{}{}}
\End
...
{\( \frac{3}{4}\pi\)}{\( \frac{5}{4}\pi\)}{\( \frac{1}{4}\pi\)}{\( \frac{7}{4}\pi\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
¿Cuál es la medida del ángulo \(x\), \(x \in [ 0;2\pi)\),  para el cual  \(\mathrm{tg}\,x = -1\) y \(\sin x >0\)?}
{\( \frac{3}{4}\pi\)}{\( \frac{5}{4}\pi\)}{\( \frac{1}{4}\pi\)}{\( \frac{7}{4}\pi\)}{}{}}
\End
...
{\( \sin 700^{\circ} = \sin 200^{\circ} \)}{\( \cos 550^{\circ} = \cos 10^{\circ} \)}{\( \mathrm{tg}\, 20^{\circ} = \mathrm{tg}\, (-20^{\circ}) \)}{\( \cos 520^{\circ} = \cos 20^{\circ} \)}{}{}}
\LANGpl{
\Question{
...
\Data\ID{2000005405}
\Updated{2021-12-26 08:12:44}
\Level{B}
\SubArea{Sine, Cosine, Tangent, and Cotangent}
\LANGen{
\Question{
Which of the following statements is true?}
{All values of the function \(f(x)=2-\cos x\) are positive.}{Function \(f(x)=\mathrm{tg}\,x\) is increasing over the whole domain.}{The smallest positive period of the function \(f(x)=\sin 4x\) is \(\frac{\pi}{4}\).}{Function \(f(x)=1+\sin x\) is an odd function.}{}{}}
\LANGpl{
\Question{
Które stwierdzenie jest prawdzie?}
{Wszystkie wartości funkcji \(f(x)=2-\cos x\) są dodatnie.}{Funkcja \(f(x)=\mathrm{tg}\,x\) jest rosnąca w całej dziedzinie.}{Najmniejszy dodatni okres funkcji \(f(x)=\sin 4x\) to \(\frac{\pi}{4}\).}{Funkcja \(f(x)=1+\sin x\) jest funkcją nieparzystą.}{}{}}
\LANGcs{
\Question{
Které z následujících tvrzení je pravdivé?}
{Všechny hodnoty funkce \(f(x)=2-\cos x\) jsou kladné.}{Funkce \(f(x)=\mathrm{tg}\,x\) je rostoucí v celém definičním oboru.}{Nejmenší kladná perioda funkce \(f(x)=\sin 4x\) je \(\frac{\pi}{4}\).}{Funkce \(f(x)=1+\sin x\) je lichá.}{}{}}
\LANGsk{
\Question{
Ktoré z nasledujúcich tvrdení je pravdivé?}
{Všetky hodnoty funkcie \(f(x)=2-\cos x\) sú kladné.}{Funkcia \(f(x)=\mathrm{tg}\,x\) je rastúca na celom definičnom obore.}{Najmenšia kladná perióda funkcie \(f(x)=\sin 4x\) je \(\frac{\pi}{4}\).}{Funkcia \(f(x)=1+\sin x\) je nepárna.}{}{}}
\LANGes{
\Question{
¿Cuál de las siguientes proposiciones lógicas es verdadera?}
{Todos los valores de la función \(f(x)=2-\cos x\) son positivos.}{La función\(f(x)=\mathrm{tg}\,x\) es creciente en todo su dominio.}{El período positivo menor de la función \(f(x)=\sin 4x\) es \(\frac{\pi}{4}\).}{La función \(f(x)=1+\sin x\) es una función impar.}{}{}}
\End
...
{Functions \(f(x)=\cos\left(x+\frac{\pi}{6}\right)\) and \(g(x)=\sin\left(x-\frac{\pi}{6}\right)\) are equal.}{Functions \(f(x)=2-\cos 3x\) is even and its range of values is \([ 1;3]\).}{Functions \(f(x)=\cos\left(x-\frac{\pi}{3}\right)\) and \(g(x)=\sin\left(x+\frac{\pi}{6}\right)\) are equal.}{Functions \(f(x)=\cos x\) and \(g(x)=\sin\left(x+\frac{\pi}{2}\right)\) are equal.}{}{}}
\LANGpl{
\Question{
Które stwierdzenie jest  nieprawdziwe?}
{Funkcje \(f(x)=\cos\left(x+\frac{\pi}{6}\right)\) i \(g(x)=\sin\left(x-\frac{\pi}{6}\right)\) są równe.}{Funkcja \(f(x)=2-\cos 3x\) jest parzysta a jej przedział wartości to \(\langle 1;3\rangle\).}{Funkcje \(f(x)=\cos\left(x-\frac{\pi}{3}\right)\) i \(g(x)=\sin\left(x+\frac{\pi}{6}\right)\) są równe.}{Funkcje \(f(x)=\cos x\) i \(g(x)=\sin\left(x+\frac{\pi}{2}\right)\) są równe.}{}{}}
\LANGcs{
\Question{
Které z uvedených tvrzení není pravdivé?}
{Funkce \(f(x)=\cos\left(x+\frac{\pi}{6}\right)\) a \(g(x)=\sin\left(x-\frac{\pi}{6}\right)\) jsou shodné.}{Funkce \(f(x)=2-\cos 3x\) je sudá a její obor hodnot je \(\langle 1;3\rangle\).}{Funkce \(f(x)=\cos\left(x-\frac{\pi}{3}\right)\) a \(g(x)=\sin\left(x+\frac{\pi}{6}\right)\) jsou shodné.}{Funkce \(f(x)=\cos x\) a \(g(x)=\sin\left(x+\frac{\pi}{2}\right)\) jsou shodné.}{}{}}
\LANGsk{
\Question{
Ktoré z nasledujúcich tvrdení je nepravdivé?}
{Funkcie \(f(x)=\cos\left(x+\frac{\pi}{6}\right)\) a \(g(x)=\sin\left(x-\frac{\pi}{6}\right)\) sa rovnajú.}{Funkcia \(f(x)=2-\cos 3x\) je párna a jej obor hodnôt je \(\langle 1;3\rangle\).}{Funkcie \(f(x)=\cos\left(x-\frac{\pi}{3}\right)\) a \(g(x)=\sin\left(x+\frac{\pi}{6}\right)\) sa rovnajú.}{Funkcie \(f(x)=\cos x\) a \(g(x)=\sin\left(x+\frac{\pi}{2}\right)\) sa rovnajú.}{}{}}
\LANGes{
\Question{
¿Cuál de las siguientes proposiciones lógicas  no es verdadera?}
{Funciones \(f(x)=\cos\left(x+\frac{\pi}{6}\right)\) y \(g(x)=\sin\left(x-\frac{\pi}{6}\right)\) son iguales.}{La función \(f(x)=2-\cos 3x\) es par y su rango de valores es \([ 1;3]\).}{Funciones \(f(x)=\cos\left(x-\frac{\pi}{3}\right)\) y \(g(x)=\sin\left(x+\frac{\pi}{6}\right)\) son iguales.}{Funciones \(f(x)=\cos x\) y \(g(x)=\sin\left(x+\frac{\pi}{2}\right)\) son iguales.}{}{}}
\End
...
{\( \frac{2}{3}\pi\)}{\( 2\pi\)}{\( \frac{1}{3}\pi\)}{\( \frac{1}{4}\pi\)}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Určte najmenšiu periódu funkcie \(f(x)=2\cos 3x\).}
{\( \frac{2}{3}\pi\)}{\( 2\pi\)}{\( \frac{1}{3}\pi\)}{\( \frac{1}{4}\pi\)}{}{}}
\LANGes{
\Question{
Determina menor período de la función \(f(x)=2\cos 3x\).}
{\( \frac{2}{3}\pi\)}{\( 2\pi\)}{\( \frac{1}{3}\pi\)}{\( \frac{1}{4}\pi\)}{}{}}
\End

\Data\ID{2010016402}
\Updated{2022-08-25 10:08:22}
\Level{B}
\SubArea{Sine, Cosine, Tangent, and Cotangent}
\IMG{2010016401-figure1.pdf}
\LANGen{
\Question{
Identify the function shown in the graph.}
{\( f(x) = -\cos\left(x+\frac{\pi}4\right)\)}{\( f(x) = \cos\left(x+\frac{\pi}4\right)\)}{\( f(x) = \sin\left(x+\frac{\pi}4\right)\)}{\( f(x) = -\cos\left(x-\frac{\pi}4\right)\)}{}{}}
\LANGpl{
\Question{
...
{The function \(f\) 
is neither increasing nor decreasing.}{The function \(f\) 
is decreasing.}{The function \(f\) 
is increasing.}{The function \(f\) is increasing and decreasing.}{}{}}
\LANGpl{
\Question{
...
{Funkcja \(f\) 
ani nie rośnie ani nie maleje.}{Funkcja \(f\) 
maleje.}{Funkcja \(f\) 
rośnie.}{Funkcja \(f\) rośnie i maleje.}{}{}}
\LANGcs{
\Question{
Vyberte pravdivé tvrzení týkající se funkce
\(f(x) =\cos x\), kde
\(x\in \left\langle -\frac{\pi }{2}; \frac{\pi } {2} \right\rangle  \).}
{Funkce \(f\) 
není rostoucí, ani klesající.}{Funkce \(f\) 
je klesající.}{Funkce \(f\) 
je rostoucí.}{Funkce \(f\) je rostoucí i klesající.}{}{}}
\LANGsk{
\Question{
Je daná funkcia \(f(x) =\cos x\), \(x\in \left\langle -\frac{\pi }{2}; \frac{\pi } {2} \right\rangle  \). Vyberte pravdivé tvrdenie.}
{Funkcia \(f\) nie je rastúca, ani klesajúca.}{Funkcia \(f\) je klesajúca.}{Funkcia \(f\) je rastúca.}{Funkcia \(f\) je rastúca aj klesajúca.}{}{}}
\LANGes{
\Question{
...
\(x\in \left[ -\frac{\pi }{2}; \frac{\pi } {2} \right]   \).}
{La función \(f\) 
no es ni creciente ni decreciente.}{La función \(f\) 
es decreciente}{La función \(f\) 
es creciente}{La función \(f\) es creciente y decreciente.}{}{}}
\End
...
a minimum or maximum on \(I\).}{The function \(f\) has a unique minimum and no maximum on \(I\).}{The function \(f\) has a unique maximum and no minimum on \(I\).}{The function \(f\) has a unique maximum and a unique minimum on \(I\).}{}{}}
\LANGpl{
\Question{
Wskaż poprawne stwierdzenie o funkcji 
\(f(x) =\sin x\) w przedziale \(I=\left( -\frac{\pi }{2}; \frac{\pi } {2} \right)  \).}
{Funkcja \(f\) nie posiada minimum ani maksimum w przedziale \(I\).}{Funkcja \(f\) posiada jedno minimum ale nie ma maksimum w przedziale \(I\).}{Funkcja \(f\) posiada jedno maksimum ale nie posiada minimum w przedziale \(I\).}{Funkcja \(f\) posiada jedno maksimum i jedno minimum w przedziale \(I\).}{}{}}
\LANGcs{
\Question{
Pro extrémy funkce
\(f(x) =\sin x\) v intervalu \(I=\left( -\frac{\pi }{2}; \frac{\pi } {2} \right)  \) platí, že:}
{funkce \(f\) nemá v \(I\) žádný extrém.}{funkce \(f\) má v \(I\) jediné minimum a žádné maximum.}{funkce \(f\) má v \(I\) jediné maximum a žádné minimum.}{funkce \(f\) má v \(I\) jediné maximum a jediné minimum.}{}{}}
\LANGsk{
\Question{
Pre extrémy funkcie \(f(x) =\sin x\) v intervale \(I=\left( -\frac{\pi }{2}; \frac{\pi } {2} \right)  \) platí:}
{v intervale \(I\) nemá funkcia \(f\) žiadny extrém.}{v intervale \(I\) existuje jediné minimum funkcie \(f\) a maximum funkcie \(f\) v tomto intervale neexistuje.}{v intervale \(I\) existuje jediné maximum funkcie \(f\) a minimum funkcie \(f\) v tomto intervale neexistuje.}{v intervale \(I\) existuje jediné maximum a jediné minimum funkcie.}{}{}}
\LANGes{
\Question{
En la siguiente lista, identifica una proposición verdadera sobre la función
\(f(x) =\sin x\) en el intervalo \(I=\left( -\frac{\pi }{2}; \frac{\pi } {2} \right)  \).}
{La función \(f\) no tiene mínimo o máximo en \(I\).}{La función \(f\) 
...
by \(\frac{1}
{2}\)  of a 
unit to the right.}{Shift of graph of \(g\) 
by \(\frac{1}
{2}\)  of a 
unit to the left.}{Shift of graph of \(g\) 
by \(1\) unit to the left.}{Shift of graph of \(g\) 
...
o \(\frac{1}
{2}\) jednostki w prawo.}{Przesunięcie wykresu \(g\) 
o \(\frac{1}
{2}\)  jednostki w lewo.}{Przesunięcie wykresu \(g\) 
o \(1\) jednostkę w lewo.}{Przesunięcie wykresu \(g\) 
...
{Graf funkce \(g\) 
posuneme o \(\frac{1}
{2}\) ve směru kladné poloosy \(x\).}{Graf funkce \(g\) 
posuneme o \(\frac{1}
{2}\)  ve směru záporné poloosy \(x\).}{Graf funkce \(g\) 
posuneme o \(1\) ve směru záporné poloosy \(x\).}{Graf funkce \(g\) 
posuneme o \(1\) ve směru kladné poloosy \(x\).}{}{}}
\LANGsk{
\Question{
Ako získame graf funkcie \(f(x) =\cos (2x -1)\) z grafu funkcie \(g(x) =\cos (2x)\)?}
{Graf funkcie \(g\)  posunieme o \(\frac{1}{2}\) v smere kladnej polosi \(x\).}{Graf funkcie \(g\)  posunieme o \(\frac{1}{2}\) v smere zápornej polosi \(x\).}{Graf funkcie \(g\)  posunieme o \(1\) v smere zápornej polosi \(x\).}{Graf funkcie \(g\)  posunieme o \(1\) v smere kladnej polosi \(x\).}{}{}}
\LANGes{
\Question{
...
\(\frac{1} {2}\) unidades hacia la derecha.}{Desplazando la gráfica de \(g\) 
\(\frac{1} {2}\) unidades hacia la izquierda.}{Desplazando la gráfica de \(g\) \(1\) unidad hacia la izquierda}{Desplazando la gráfica de \(g\) \(1\) unidad hacia la derecha.}{}{}}
\End
...
{\(f(2\cdot x)\)}{\(f(x+2)\)}{\(f(x-2)\)}{\(f(\frac{x}2)\)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Je dána funkce \(f(x)=\mathop{\mathrm{cotg}}\nolimits x\) s definičním oborem \( (0;\pi )\).
Která z následujících funkcí má definiční obor
\(\left (0; \frac{\pi } {2}\right )\)?}
{\(f(2\cdot x)\)}{\(f(x+2)\)}{\(f(x-2)\)}{\(f(\frac{x}2)\)}{}{}}
\LANGsk{
\Question{
...
\LANGcs{
\Question{
Do kterého kvadrantu patří úhel \( \varphi \), pokud platí, že \( \cos\varphi=0{,}8 \) a \( \sin\varphi < 0 \)?}
{IV.}{I.}{II.}{III.}{}{}}
\LANGsk{
\Question{
...
{\( \sin 240^{\circ} < \sin 120^{\circ} \)}{\( \cos50^{\circ} < \cos130^{\circ} \)}{\( \sin 300^{\circ} < \sin 270^{\circ} \)}{\( \cos330^{\circ} < \cos150^{\circ} \)}{}{}}
\LANGpl{
\Question{
...
{\( \cos\frac{4\pi}3 \).}{\( \cos\frac{\pi}3 \).}{\( \cos\left(-\frac{7\pi}3\right) \).}{\( \cos\frac{5\pi}3 \).}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Hodnota výrazu \( \cos\left(-\frac{28\pi}3\right) \) je stejná jako hodnota}
{\( \cos\frac{4\pi}3 \).}{\( \cos\frac{\pi}3 \).}{\( \cos\left(-\frac{7\pi}3\right) \).}{\( \cos\frac{5\pi}3 \).}{}{}}
\LANGsk{
\Question{
...
\LANGcs{
\Question{
Kolik průsečíků s osou \( x \) má graf funkce \( f(x)=\sin 2x \) v intervalu \( \langle -\pi; 2\pi \rangle \)?}
{\( 7\)}{\( 5\)}{\( 8\)}{\( 6\)}{}{}}
\LANGsk{
\Question{
...
\LANGcs{
\Question{
Který z grafů je grafem funkce \(f(x)=2-2\sin\left(x-\frac{\pi}{2}\right)\)?}
{}{}{}{}{}{}}
\LANGsk{
\Question{
Ktorý z grafov je grafom funkcie \(f(x)=2-2\sin\left(x-\frac{\pi}{2}\right)\)?}
{}{}{}{}{}{}}
\LANGes{
\Question{
¿Cuál de las gráficas es la gráfica de la función \(f(x)=2-2\sin\left(x-\frac{\pi}{2}\right)\)?}
{}{}{}{}{}{}}

\IMGanswer{2100005401_8-figure0.pdf}
\IMGanswer{2100005401_8-figure1.pdf}
\IMGanswer{2100005401_8-figure2.pdf}
\IMGanswer{2100005401_8-figure3.pdf}\End
...
\LANGcs{
\Question{
Který z grafů je grafem funkce \(f(x)=\mathrm{tg}\,\left(x+\frac{\pi}{4}\right)\)?}
{}{}{}{}{}{}}
\LANGsk{
\Question{
Ktorý z grafov je grafom funkcie \(f(x)=\mathrm{tg}\,\left(x+\frac{\pi}{4}\right)\)?}
{}{}{}{}{}{}}
\LANGes{
\Question{
...
\IMGanswer{2100005401_8-figure4.pdf}
\IMGanswer{2100005401_8-figure5.pdf}
\IMGanswer{2100005401_8-figure6_0.pdf}
\IMGanswer{2100005401_8-figure7.pdf}\End

\Data\ID{9000004801}
\Updated{2022-06-08 01:06:25}
\Level{B}
\SubArea{Sine, Cosine, Tangent, and Cotangent}
\LANGen{
\Question{
...
is decreasing.}{The function \(f\) 
is neither increasing nor decreasing.}{The function \(f\) is non-increasing.}{}{}}
\LANGpl{
\Question{
Dana jest funkcja 
\(f\colon y =\sin x\),
...
nie jest ani rosnąca, ani malejąca.}{Funkcja \(f\) 
jest nierosnąca.}{}{}}
\LANGcs{
\Question{
...
nie je rastúca, ani klesajúca.}{Funkcia \(f\) 
je nerastúca.}{}{}}
\LANGes{
\Question{
En la siguiente lista, identifica una proposición verdadera sobre la función
...
{The function \(f\) has a unique maximum and no minimum on \(I\).}{The function \(f\) does not have
a minimum or maximum on \(I\).}{The function \(f\) has a unique maximum and a unique minimum on \(I\).}{The function \(f\) has a unique minimum and no maximum on \(I\).}{}{}}
\LANGpl{
\Question{
Dana jest funkcja 
...
interval \(I = \left (-\frac{\pi }{2}; \frac{\pi } {2}\right )\).}
{The function \(f\) does not have
a minimum or maximum on \(I\).}{The function \(f\) has a unique maximum and a unique minimum on \(I\).}{The function \(f\) has a unique maximum and no minimum on \(I\).}{The function \(f\) has a unique minimum and no maximum on \(I\).}{}{}}
\LANGpl{
\Question{
Dana jest funkcja 
...
\Question{
Identify the transformation which transforms the graph of the function
\(g(x) =\sin 3x\) to the graph
of the function \(f(x) =\sin (3x + 5)\).}
{Shift of graph of \(g\) 
by \(\frac{5}
{3}\)  of a 
unit to the left.}{Shift of graph of \(g\) 
by \(5\) 
units to the right.}{Shift of graph of \(g\) 
by \(5\) 
units to the left.}{Shift of graph of \(g\) 
by \(3\) 
units to the right.}{Shift of graph of \(g\) 
by \(3\) 
units to the left.}{Shift of graph of \(g\) 
...
unidades hacia la izquierda.}{Desplazando la gráfica de \(g\) 
\(5\) unidades hacia la derecha.}{Desplazando la gráfica de \(g\) 
 \(5\) unidades hacia la izquierda.}{Desplazando la gráfica de \(g\)  \(3\) unidades hacia la derecha.}{Desplazando la gráfica de \(g\)  \(3\) 
unidades hacia la izquierda.}{Desplazando la gráfica de \(g\) 
 \(\frac{5} {3}\) 
...
\Data\ID{2000004201}
\Updated{2021-12-01 04:12:26}
\Level{C}
\SubArea{Sine, Cosine, Tangent, and Cotangent}
\LANGen{
\Question{
On the interval \( (0;\pi)\), simplify the expression \(\frac{2\sin x + \sin 2x}{2\sin x -\sin 2x}\).}
{\(\frac{1+\cos x}{1-\cos x}\)}{\(\frac{1-\cos x}{1+\cos x}\)}{\( 1+\cos x\)}{\( 1-\cos x\)}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Na intervale \( (0;\pi)\) zjednodušte výraz \(\frac{2\sin x + \sin 2x}{2\sin x -\sin 2x}\).}
{\(\frac{1+\cos x}{1-\cos x}\)}{\(\frac{1-\cos x}{1+\cos x}\)}{\( 1+\cos x\)}{\( 1-\cos x\)}{}{}}
\LANGes{
\Question{
...
{\( 2\ \mathrm{tg}\,x\)}{\(\mathrm{tg}\,x\)}{\(  \mathrm{tg}^2\,x\)}{\( 1-\mathrm{tg}\,x\)}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Na intervale \( (-\frac{\pi}{2};\frac{\pi}{2})\) zjednodušte výraz \(\frac{\sin 2x}{1 -\sin^2 x}\).}
{\( 2\ \mathrm{tg}\,x\)}{\(\mathrm{tg}\,x\)}{\(  \mathrm{tg}^2\,x\)}{\( 1-\mathrm{tg}\,x\)}{}{}}
\LANGes{
\Question{
...
\Data\ID{2000004204}
\Updated{2021-12-26 08:12:47}
\Level{C}
\SubArea{Sine, Cosine, Tangent, and Cotangent}
\IMG{2000004201_3-figure4.pdf}
\LANGen{
\Question{
Choose the function that has its graph shown in the picture.}
{\( f(x)=2-|\sin x|\)}{\( f(x)=2+|\sin x|\)}{\( f(x)=|\sin x|-2\)}{\( f(x)=|\sin 2x|\)}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Vyberte funkciu, ktorej graf je zobrazený na obrázku.}
{\( f(x)=2-|\sin x|\)}{\( f(x)=2+|\sin x|\)}{\( f(x)=|\sin x|-2\)}{\( f(x)=|\sin 2x|\)}{}{}}
\LANGes{
\Question{
...
\Level{C}
\SubArea{Sine, Cosine, Tangent, and Cotangent}
\IMG{2010016401-figure0.pdf}
\LANGen{
\Question{
Identify the function shown in the graph.}
{\( f(x) = 2\sin x\)}{\( f(x) = -2\sin x\)}{\( f(x) = |2\sin x|\)}{\( f(x) = |\sin x|\)}{}{}}
\LANGpl{
\Question{
Wskaż funkcję pokazaną na wykresie.}
{\( f(x) = 2\sin x\)}{\( f(x) = -2\sin x\)}{\( f(x) = |2\sin x|\)}{\( f(x) = |\sin x|\)}{}{}}
...
\Level{C}
\SubArea{Sine, Cosine, Tangent, and Cotangent}
\IMG{2010016401-figure3.pdf}
\LANGen{
\Question{
Function \( f \) is given completely by the next graph. Identify which of the following statements is true.}
{\( f(x)=|-\cos x|;\ x\in [ -2\pi;2\pi ]\)}{\( f(x)=-|\cos x|;\ x\in [ -2\pi;2\pi ]\)}{\( f(x)=|\sin x|;\ x\in [ -2\pi;2\pi ]\)}{\( f(x)=-|\sin x|;\ x\in [ -2\pi;2\pi ]\)}{}{}}
\LANGpl{
\Question{
Wykres przedstawia funkcję \( f \). Wskaż poprawne stwierdzenie.}
{\( f(x)=|-\cos x|;\ x\in \langle -2\pi;2\pi \rangle\)}{\( f(x)=-|\cos x|;\ x\in \langle -2\pi;2\pi \rangle\)}{\( f(x)=|\sin x|;\ x\in \langle -2\pi;2\pi \rangle\)}{\( f(x)=-|\sin x|;\ x\in \langle -2\pi;2\pi \rangle\)}{}{}}
\LANGcs{
\Question{
...
{\( \mathrm{cotg}\,x \)}{\( \mathrm{tg}\,x \)}{\( \sin x \cdot \cos x \)}{\( 2\,\mathrm{tg}\,x \)}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Ktorý z grafov je graf funkcie \(f(x)=|1+\cos x|\)?}
{}{}{}{}{}{}}
\LANGes{
\Question{
¿Cuál de las gráficas es la gráfica de la función \(f(x)=|1+\cos x|\)?}
{}{}{}{}{}{}}

\IMGanswer{2000004201_3-figure0.pdf}
\IMGanswer{2000004201_3-figure1_0.pdf}
\IMGanswer{2000004201_3-figure2_0.pdf}
\IMGanswer{2000004201_3-figure3_0.pdf}\End
