...
\Level{A}
\SubArea{Applications of Definite Integrals}
\LANGen{
\Question{
...
\LANGen{
\Question{
Calculate the area of a plane region bounded by the graphs of the functions $f(x)=x^2-2x+2$ and $g(x)=14-x^2$.}
{\( \frac{125}3\)}{\( \frac{19}3\)}{\( \frac{93}3\)}{\(75\)}{}{}}
\LANGpl{
\Question{
Oblicz pole płaskiego obszaru ograniczonego wykresami funkcji $f(x)=x^2-2x+2$ i $g(x)=14-x^2$.}
{\( \frac{125}3\)}{\( \frac{19}3\)}{\( \frac{93}3\)}{\(75\)}{}{}}
\LANGcs{
\Question{
...
\LANGsk{
\Question{
Vypočítajte obsah plochy ohraničenej grafmi funkcií $f(x)=x^2-2x+2$ a $g(x)=14-x^2$.}
{\( \frac{125}3\)}{\( \frac{19}3\)}{\( \frac{93}3\)}{\(75\)}{}{}}
\LANGes{
\Question{
...
\LANGpl{
\Question{
Określ pole trójkąta $ABC$ zaznaczonego na żółto. Odczytaj wszystkie potrzebne wartości z obrazka.}
{\( 10{,}5\)}{\( 36{,}75\)}{\( 10\)}{\(15{,}75\)}{}{}}
\LANGcs{
\Question{
...
\LANGsk{
\Question{
Určte obsah plochy žlto vyznačeného trojúholníka $ABC$. Všetky potrebné hodnoty vyčítajte z obrázku.}
{\( 10{,}5\)}{\( 36{,}75\)}{\( 10\)}{\(15{,}75\)}{}{}}
\LANGes{
\Question{
...
\Level{A}
\SubArea{Applications of Definite Integrals}
\IMG{2010011401-figure1.pdf}
\LANGen{
\Question{
Find the area of the yellow  region indicated in the picture.}
{\( 2\sqrt{2}\)}{\( 2\sqrt{3}\)}{\( \sqrt{2}\)}{\( 4\sqrt{2}\)}{}{}}
\LANGpl{
\Question{
Oblicz pole żółtego obszaru zaznaczonego na rysunku.}
{\( 2\sqrt{2}\)}{\( 2\sqrt{3}\)}{\( \sqrt{2}\)}{\( 4\sqrt{2}\)}{}{}}
\LANGcs{
\Question{
Určete obsah žlutě vyznačené plochy.}
...
\LANGpl{
\Question{
Wyznacz pole trójkąta $ABC$ zaznaczonego na żółto (patrz rysunek).}
{\( 16\)}{\(12\)}{\(8\)}{\( 20\)}{}{}}
\LANGcs{
\Question{
Určete obsah žlutě vyznačeného trojúhelníku  $ABC$.}
...
\LANGsk{
\Question{
Určte obsah plochy žlto vyznačeného trojúholníka $ABC$.}
{\( 16\)}{\(12\)}{\(8\)}{\( 20\)}{}{}}
\LANGes{
\Question{
...
\LANGpl{
\Question{
Wyznacz powierzchnię obszaru ograniczonego przez
Oś \(x\),
wykres \(f(x)= x^{2} + 5\)
i proste \(x = -1\)
i \(x = 2\).}
...
lines \(y = 0\) 
and \(x =\pi \).}
{\( \frac{\pi}2-1\)}{\( \frac{\pi}2\)}{\(1\)}{\( \frac{3\pi}2-1\)}{}{}}
\LANGpl{
\Question{
...
\(y = x+1\) and
\(y = -x^{2} + 3\).}
{\( \frac{9}2\)}{\(2\)}{\(6\)}{\( \frac{21}2\)}{}{}}
\LANGpl{
\Question{
Wyznacz powierzchnię obszaru ograniczonego krzywymi
\(y = x+1\) i
\(y = -x^{2} + 3\).}
{\( \frac{9}2\)}{\(2\)}{\(6\)}{\( \frac{21}2\)}{}{}}
\LANGcs{
...
\(y = -\mathrm{e}^{x} + 1\) and
\(x = 1\).}
{\(2\mathrm{e}-4 \)}{\(2\mathrm{e}-2\)}{\(2\)}{\(4-2\mathrm{e} \)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
En la imagen se puede ver la gráfica de la función \(f(x) = 1\). Determina el sólido de revolución cuyo el volumen viene dado por esta fórmula. 
\[ 
 \pi \int _{-1}^{1}f^{2}(x)\, \mathrm{d}x
\]}
{Cilindro cuyo radio de la base es igual a \(1\) 
y cuya altura es igual a \(2\).}{Cono cuyo radio de la base es igual a \(1\) 
y de altura  \(2\).}{Cono cuyo radio de la base es igual a \(2\) 
y su altura es \(1\).}{Cilindro cuyo radio de la base es igual a \(2\) 
y su altura de \(1\).}{}{}}
\End
...
{\(108\, \mathrm{m}\)}{\(54\, \mathrm{m}\)}{\(324\, \mathrm{m}\)}{}{}{}}
\LANGpl{
\Question{
...
to \(5\, \mathrm{m}\).}
{\(\frac{3}
{10}c\, \mathrm{J}\)}{\(\frac{2}
{5}c\, \mathrm{J}\)}{\(c\, \mathrm{J}\)}{}{}{}}
\LANGpl{
\Question{
...
\Level{C}
\SubArea{Applications of Definite Integrals}
\IMG{2010014301-figure1.pdf}
\LANGen{
\Question{
Find the area of the sickle bounded by half the ellipse and half the circle (see the picture). Points \(A\) and \(B\) lying on the circle are the foci of the ellipse.}
{\(\frac{\pi}2(\sqrt{2}-1)\)}{\(1.3\)}{\(1.5\pi\)}{\(0.3\)}{}{}}
\LANGpl{
\Question{
...
{\(\frac{3}2\pi(3-\sqrt{5})\)}{\(1.8\)}{\(\frac32\pi\)}{\(7.2\)}{}{}}
\LANGpl{
\Question{
...
\Level{C}
\SubArea{Applications of Definite Integrals}
\IMG{2010014301-figure3.pdf}
\LANGen{
\Question{
Find the area of the “smile” bounded by half the circle and half the ellipse (see the picture). Points \(A\) and \(B\) are the foci of the ellipse.}
{\(\pi(\sqrt{13}-2)\)}{\(2.52\)}{\(\pi\)}{\(10.09\)}{}{}}
\LANGpl{
\Question{
Znajdź obszar „uśmiechu” ograniczony połową koła i połową elipsy (patrz rysunek). Punkty \(A\) i \(B\) są ogniskami elipsy.}
{\(\pi(\sqrt{13}-2)\)}{\(2{,}52\)}{\(\pi\)}{\(10{,}09\)}{}{}}
...
{\(V\doteq 1.083\cdot 10^{21}\,\mathrm{m}^3 \)}{\(V\doteq 1.080\cdot 10^{21}\,\mathrm{m}^3 \)}{\(V\doteq 4.002\cdot 10^{14}\,\mathrm{m}^3 \)}{\(V\doteq 1.274\cdot 10^{14}\,\mathrm{m}^3 \)}{}{}}
\LANGpl{
\Question{
...
{\(V\doteq 1.631\cdot 10^{20}\,\mathrm{m}^3 \)}{\(V\doteq 1.622\cdot 10^{20}\,\mathrm{m}^3 \)}{\(V\doteq 3.602\cdot 10^{13}\,\mathrm{m}^3 \)}{\(V\doteq 1.132\cdot 10^{14}\,\mathrm{m}^3 \)}{}{}}
\LANGpl{
\Question{
...
{\( I=\frac{\sqrt{3}}3 I_m\)}{\( I=\frac{\sqrt{2}}2 I_m\)}{\( I=\frac{1}3 I_m\)}{\( I=\frac{1}2 I_m\)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Vypočítejte efektivní hodnotu střídavého proudu \(i\), jehož časový průběh je na obrázku, kde \(I_m\) je vrcholová hodnota \(i\).
Pro efektivní hodnotu
 \(I\) střídavého proudu platí  \(I^2T=\int_0^T i^2\mathrm{d}t\).}
{\( I=\frac{\sqrt{3}}3 I_m\)}{\( I=\frac{\sqrt{2}}2 I_m\)}{\( I=\frac{1}3 I_m\)}{\( I=\frac{1}2 I_m\)}{}{}}
\LANGsk{
\Question{
...
{\( U=\frac{\sqrt{3}}3 U_m\)}{\( U=\frac{\sqrt{2}}2 U_m\)}{\( U=\frac{1}3 U_m\)}{\( U=\frac{1}2 U_m\)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Vypočítejte efektivní hodnotu střídavého napětí  \(u\), jehož časový průběh je na obrázku, kde \(U_m\) je vrcholová hodnota \(u\).
Pro efektivní hodnotu 
  \(U\) střídavého napětí platí  \(U^2T=\int_0^T u^2\mathrm{d}t\).}
{\( U=\frac{\sqrt{3}}3 U_m\)}{\( U=\frac{\sqrt{2}}2 U_m\)}{\( U=\frac{1}3 U_m\)}{\( U=\frac{1}2 U_m\)}{}{}}
\LANGsk{
\Question{
...
{\( U=325\,\mathrm{V}\)}{\( U\doteq 230\,\mathrm{V}\)}{\( U=0\,\mathrm{V}\)}{\( U=\frac{325}2\,\mathrm{V}\)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Vypočítejte efektivní hodnotu střídavého napětí \(u\), jehož časový průběh je na obrázku.
Pro efektivní hodnotu
 \(U\) střídavého napětí platí  \(U^2T=\int_0^T u^2\mathrm{d}t\).}
{\( U=325\,\mathrm{V}\)}{\( U\doteq 230\,\mathrm{V}\)}{\( U=0\,\mathrm{V}\)}{\( U=\frac{325}2\,\mathrm{V}\)}{}{}}
\LANGsk{
...
{\( I=500\,\mathrm{mA}\)}{\( I=354\,\mathrm{mA}\)}{\( I=0\,\mathrm{mA}\)}{\( I=250\,\mathrm{mA}\)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Vypočítejte efektivní hodnotu střídavého proudu \(i\), jehož časový průběh je na obrázku.
Pro efektivní hodnotu
 \(I\) střídavého proudu platí  \(I^2T=\int_0^T i^2\mathrm{d}t\).}
{\( I=500\,\mathrm{mA}\)}{\( I=354\,\mathrm{mA}\)}{\( I=0\,\mathrm{mA}\)}{\( I=250\,\mathrm{mA}\)}{}{}}
\LANGsk{
...
{\( W\doteq 333\,\mathrm{kJ}\)}{\( W \doteq 216\,\mathrm{kJ}\)}{\( W \doteq 720\,\mathrm{kJ}\)}{\( W \doteq 178\,\mathrm{kJ}\)}{}{}}
\LANGpl{
\Question{
...
{\( W\doteq 1.313c\,\mathrm{J}\)}{\( W \doteq 0.375c\,\mathrm{J}\)}{\( W \doteq 6.782c\,\mathrm{J}\)}{\( W \doteq 0.221c\,\mathrm{J}\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
La velocidad instantánea del movimiento de un cuerpo es proporcional al tiempo al cuadrado. La velocidad en \(t = 2\, \mathrm{s}\) 
es \(v = 6\, \mathrm{m\, s}^{-1}\).
...
\LANGes{
\Question{
La fuerza necesaria para prolongar un resorte es directamente proporcional a la extensión del resorte. Para prolongar el resorte \(2\, \mathrm{cm}\) más se requiere la fuerza de \(3\, \mathrm{N}\).
...
{x^{2}},
\]
donde \(x\) es la distancia en metros y \(c\) una constante positiva. Encuentra el trabajo necesario para desplazar las partículas dese una distancia de \(3\, \mathrm{m}\) 
hasta una distancia de \(1\, \mathrm{m}\) .}
{\(\frac{2}
{3}c\, \mathrm{J}\)}{\(\frac{1}
{3}c\, \mathrm{J}\)}{\(c\, \mathrm{J}\)}{}{}{}}
\End
...
\LANGes{
\Question{
Un satélite que pesa \(1000\, \mathrm{kg}\) se transportó a una órbita situada a \(150\, \mathrm{km}\) 
sobre la Tierra. Calcula el trabajo mecánico requerido para este transporte. La masa de la Tierra es \(M = 6\cdot 10^{24}\, \mathrm{kg}\), la constante gravitacional
...
\LANGes{
\Question{
Un acuario tiene forma de prisma rectangular y está completamente lleno de agua. Las dimensiones de un lado vertical son \(50\, \mathrm{cm}\) de altura y
\(40\, \mathrm{cm}\) de longitud. Calcula la fuerza que genera el agua sobre ese lado. La densidad del agua es \(1\: 000\, \mathrm{kg\, m}^{-3}\) y la gravedad de la Tierra es \(g = 9.81\, \mathrm{m\, s}^{-2}\).}
{\(490.5\, \mathrm{N}\)}{\(981\, \mathrm{N}\)}{\(245.25\, \mathrm{N}\)}{}{}{}}
\End

\Data\ID{9000072907}
\Updated{2021-09-19 09:09:39}
\Level{C}
\SubArea{Applications of Definite Integrals}
\LANGen{
\Question{
...
\LANGes{
\Question{
Un ancla que pesa \(100\, \mathrm{kg}\) está colgada en una cuerda que mide \(20\, \mathrm{m}\). Cada metro de la cuerda pesa \(1\, \mathrm{kg}\).
Busca el trabajo requerido para subir el ancla \(20\, \mathrm{m}\) sin tener en cuenta la flotación (la fuerza de principio de Arquímedes). La gravedad de la Tierra es \(9.81\, \mathrm{m\, s}^{-2}\).}
{\(21\: 582\, \mathrm{J}\)}{\(23\: 544\, \mathrm{J}\)}{\(19\: 620\, \mathrm{J}\)}{}{}{}}
\End
