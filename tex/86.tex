...
\LANGes{
\Question{
¿Cuál es el área de la figura plana limitada por las rectas $x=2$, $x=3$ y las gráficas de funciones $f(x)=\sin x$ y $g(x)=\frac1{x^2}$? Aproxima el resultado a tres decimales.}
{$0.407$}{$0.167$}{$1.573$}{$0.623$}{}{}}
\End
...
\LANGes{
\Question{
¿Cuál es el radio del círculo inscrito en un cuadro si el área del cuadro es definida por la expresión $\int\limits_1^6(6-x)\,\mathrm{d}x$ ?}
{$\frac{5\sqrt2}4$}{$3\sqrt2$}{$2\sqrt2$}{$\frac{7\sqrt2}2$}{}{}}
\End
...
\LANGes{
\Question{
Calcula el área de una figura plana limitada por gráficas de las funciones $f(x)=x^2+2x+2$ y $g(x)=6-x^2$.}
{$9$}{$21$}{$15$}{$\frac{59}3$}{}{}}
\End
...
\LANGes{
\Question{
Calcula el área de una figura plana limitada por gráficas de las funciones $f(x)=-\frac x{\pi}+1$ y $g(x)=-\sin x$, y por las rectas $x=\pi$ y $x=0$.}
{$2+\frac{\pi}2$}{$2-\frac{\pi}2$}{$-2-\frac{\pi}2$}{$\frac{2+\pi}2$}{}{}}
\End
...
\LANGes{
\Question{
Define la constanta desconocida real positiva \( a \) para que el área de la superficie amarilla marcada en la imagen sea \( 9 \) unidades cuadradas.}
{\( a=3 \)}{\( a=27 \)}{\( a=9 \)}{\( a=1 \)}{}{}}
\End
...
\LANGes{
\Question{
Encuentra la constanta real positiva ausente \( a \) a modo de que el área del triángulo amarillo marcado en la imagen sea \( 12 \) unidades cuadradas.}
{\( a=\frac23 \)}{\( a=\frac43 \)}{\( a=1 \)}{The constant \( a \) can not be determined from the picture.}{}{}}
\End
...
\LANGes{
\Question{
Encuentra la constanta real ausente \( a \) para que la proporción del área verde y de la roja marcadas en la imagen sea \( 4:1 \).}
{\( a=-\frac{5}3\pi \)}{\( a=-2\pi \)}{\( a=-\pi \)}{\( a=-\frac{5}4\pi \)}{}{}}
\End
...
\LANGes{
\Question{
Encuentra la constanta real \( a \) que falta para que las áreas marcadas en rojo y verde sean iguales.}
{\( a=-2\pi \)}{\( a=-\frac32\pi \)}{\( a=-\frac{\pi}2 \)}{\( a=-3\pi \)}{}{}}
\End
...
\LANGes{
\Question{
Calcula el área de la superficie amarilla que es limitada por la parábola y la recta (mira la imagen). Lee todos los valores necesarios de la imagen.}
{\( 4.5 \)}{\( 22.5 \)}{\( 3.75 \)}{\( 10.25 \)}{}{}}
\End
...
\LANGes{
\Question{
Encuentra el área del triángulo $ACB$ marcado de color amarillo (mira la imagen).}
{$20.5$}{$22.5$}{$20$}{$21$}{}{}}
\End
...
\LANGes{
\Question{
Encuentra el área de la superficie marcada de color rojo (mira la imagen).}
{$1.5\pi$}{$2\pi$}{$2.5\pi$}{$4.5\pi$}{}{}}
\End
...
\LANGes{
\Question{
Utiizando integral definida encuentra el área del triángulo definido por las siguientes tres desigualdades 
\[ 
\begin{aligned}y& > 0, &
\\y& < x + 3,
\\y& < 3 - x.
...
{el volumen de un cono cuya base tiene el radio de \( 2\,\mathrm{cm} \) y la altura son \( 3\,\mathrm{cm} \).}{el volumen de un cono cuya base tiene el radio de \( 3\,\mathrm{cm} \) y la altura son \( 2\,\mathrm{cm} \).}{el volumen de un casquete esférico que forma parte de una esfera cuyo radio son \( \frac23\,\mathrm{cm} \) y la altura son \( 3\,\mathrm{cm} \).}{el volumen de un casquete esférico que forma parte de una esfera cuyo radio son \( 3\,\mathrm{cm} \) y la altura son \( \frac23\,\mathrm{cm} \).}{}{}}
\End
...
\[ \pi\cdot\int\limits_0^6\left[9-(x-3)^2\right]\,\mathrm{d}x \]
es un número que representa:}
{el volumen de una esfera cuyo radio son \( 3\,\mathrm{cm} \).}{el volumen de una esfera cuyo radio son \( 6\,\mathrm{cm} \).}{el volumen de una esfera cuyo diámetro son \( 3\,\mathrm{cm} \).}{el volumen de una semiesfera cuyo radio son \( 3\,\mathrm{cm} \).}{}{}}
\End
...
\LANGes{
\Question{
Calcula el volumen del sólido hecho por la rotación de la curva
\[ y=\frac1{x^2} \]
...
\LANGes{
\Question{
Es posible calcular el volumen de una esfera con el radio de \( 3 \) usando una integral definida. ¿Cuál de las siguientes expresiones no es correcta?}
{\( \int\limits_{-3}^3\left(9-x^2\right)\,\mathrm{d}x \)}{\( \pi\int\limits_{-3}^3\left(9-x^2\right)\,\mathrm{d}x \)}{\( 2\pi\int\limits_{0}^3\left(9-x^2\right)\,\mathrm{d}x \)}{\( \pi\int\limits_{-3}^3\left(-\sqrt{9-x^2}\right)^2\,\mathrm{d}x \)}{}{}}
\End
...
\LANGes{
\Question{
El trapecio recto está limitado por \( y=ax+1 \), \( x=0 \), \( x=6 \), y por el eje \( x \). Rotamos el trapecio alrededor del eje \( x \) tenemos un cono truncado. Encuentra el valor del parámetro  \( a > 0 \) cuyo volumen es \( 26\pi \).}
{\( a=\frac13 \)}{\( a=\frac12 \)}{\( a=3 \)}{\( a=2 \)}{}{}}
\End
...
\LANGes{
\Question{
Pedro y Juana calcularon el volumen de un sólido de revolución usando la integral definida. Ambos eligieron un sólido obtenido por rotación de un segmento de línea alrededor del eje \( x \).  Pedro eligió el segmento de extremos \( [0;1] \) y \( [5;4] \),  y Juana eligió el de extremos \( [0;3] \) y \( [5;0] \). Finalmente compararon los volúmenes que cada uno había calculado.  ¿Cuál de los enunciados es verdadero?}
...
\LANGes{
\Question{
Considera un cono truncado cuyos diámetros de sus bases son \( 2\,\mathrm{cm} \) y \( 10\,\mathrm{cm} \), y cuya altura es \( 4\,\mathrm{cm} \). ¿Cuál de las fórmulas no debe ser usada para calcular el volumen de dicho cono truncado?}
{\( V=\pi\int\limits_0^4(5-x)\,\mathrm{d}x \)}{\( V=\pi\int\limits_0^4(5-x)^2\mathrm{d}x \)}{\( V=\frac{\pi}3\cdot4\cdot(25+5+1) \)}{\( V=\frac{\pi}3\cdot25\cdot5-\frac{\pi}3\cdot1\cdot1 \)}{}{}}
\End
...
\LANGes{
\Question{
¿Cuál de las siguientes fórmulas no va a dar el volumen del sólido hecho por rotación del área roja alrededor del eje \( x \) (mira la imagen)?}
{\( \pi\cdot\int\limits_{\frac{\pi}4}^{\frac{3\pi}4}\sin x\,\mathrm{d}x \)}{\( \pi\cdot\int\limits_{\frac{\pi}4}^{\frac{3\pi}4}\sin^2x\,\mathrm{d}x \)}{\( 2\pi\cdot\int\limits_{\frac{\pi}2}^{\frac{3\pi}4}\sin^2x\,\mathrm{d}x \)}{\( \pi\cdot\int\limits_{\frac{9\pi}4}^{\frac{11\pi}4}\sin^2x\,\mathrm{d}x \)}{}{}}
\End
...
\LANGes{
\Question{
Encuentra el volumen del cono truncado obtenido por rotación de trapecio marcado (mira la imagen) alrededor del eje \( x \).}
{\( 42\pi \)}{\( 42 \)}{\( 16\pi \)}{\( 16 \)}{}{}}
\End

\Data\ID{1103118704}
\Updated{2020-07-20 04:07:48}
\Level{B}
\SubArea{Applications of definite integral}
...
\LANGes{
\Question{
¿Cuál de las ecuaciones dadas define la recta que junto con \( x=0 \) y el eje \( x \) limita el triángulo rectángulo? Por rotación de este triángulo alrededor del eje \( x \) se obtiene un cono de altura \( 10 \) como esta indicado en la imagen.}
{\( y=-0.4x+4 \)}{\( y=-2.5x+10 \)}{\( y=4x+10 \)}{\( y=10x+4 \)}{}{}}
\End
...
{Un sólido general que no sea ni cono ni cilindro.}{Cono con el radio de la base igual a \(1\).}{Cilindro con el radio de la base igual a \(2\).}{Cono con el radio de la base igual a \(2\).}{}{}}
\End
...
la fórmula de volumen del sólido de revolución obtenido por rotación de esta región alrededor del eje \(x\).}
{\(V =\pi \int _{ 1}^{4}x\, \mathrm{d}x\)}{\(V =\int _{ 1}^{4}x\, \mathrm{d}x\)}{\(V =\pi \int _{ 1}^{4}\sqrt{x}\, \mathrm{d}x\)}{\(V =\int _{ 1}^{4}\sqrt{x}\, \mathrm{d}x\)}{}{}}
\End

\Data\ID{9000100007}
\Updated{2020-08-03 04:08:18}
\Level{B}
\SubArea{Applications of definite integral}
...
\(x = 4\) y el eje \(x\).
Halla el volumen del sólido de revolución obtenido por rotación de esta región alrededor del eje \(x\).}
{\(\frac{15}
 {2} \pi \)}{\(\frac{17}
 {2} \pi \)}{\(\frac{17}
 {2} \pi ^{2}\)}{\(\frac{15}
...
\LANGes{
\Question{
La velocidad del cuerpo en movimiento por segundo es dada por la función \(v(t) = 3\sqrt{t} + 2t\), donde el tiempo \(t\) se mide en segundos. Encuentra la distancia hecha por el cuerpo en el intervalo temporal de \(t = 1\, \mathrm{s}\) 
y \(t = 9\, \mathrm{s}\).}
{\(132\, \mathrm{m}\)}{\(4\left (4 + \sqrt{2}\right )\mathrm{m}\)}{\(10\, \mathrm{m}\)}{}{}{}}
\End
