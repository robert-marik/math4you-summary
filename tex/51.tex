...
\([4;14]\).}
{\(f(x) = \left (\frac{1}
{3}\right )^{2-x} +5\)}{\(f(x) = \left (\frac{1}
{3}\right )^{2-x} -5\)}{\(f(x) = \left (\frac{1}
{3}\right )^{x-2} -5\)}{\(f(x) = 5-\left (\frac{1}
{3}\right )^{x-2} \)}{\( f(x)=5+\left(\frac13\right)^{x-2}\)}{\( f(x)=5-\left(\frac13\right)^{2-x}\)}}
\LANGpl{
\Question{
...
\(f(x) = 4 -\left (\frac{1}
{2}\right )^{x}\).}
{\(A = [-2;8]\)}{\(B =\left [1;\frac72\right]\)}{\(C =\left [-1;2\right]\)}{\(D =\left [0;3\right]\)}{\(E =\left [-3;-4\right]\)}{\(F =\left [2;\frac{15}4\right]\)}}
\LANGpl{
\Question{
...
\LANGen{
\Question{
What value takes the function \(f(x)=9^x\) for the value of the argument \(x=-\frac32\)?}
{\(\frac1{3^3}\)}{\(27\)}{\(\frac1{\sqrt[3]{81}}\)}{\(\frac1{81}\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
¿Qué valor toma la función \(f(x)=9^x\) para \(x=-\frac32\)?}
{\(\frac1{3^3}\)}{\(27\)}{\(\frac1{\sqrt[3]{81}}\)}{\(\frac1{81}\)}{}{}}
\End
...
\LANGen{
\Question{
What value takes the function \(f(x)=8^x\) for the value of the argument \(x=-\frac23\)?}
{\(0.25\)}{\(4\)}{\(\frac1{2^3}\)}{\(\frac1{\sqrt[3]{8}}\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
¿Qué valor toma la función \(f(x)=8^x\) para \(x=-\frac23\)?}
{\(0.25\)}{\(4\)}{\(\frac1{2^3}\)}{\(\frac1{\sqrt[3]{8}}\)}{}{}}
\End
...
\LANGen{
\Question{
Find the range of a function \(f(x)=2^{1-x}-3\).}
{\(\left(-3;\infty\right)\)}{\(\left(1;\infty\right)\)}{\(\left(-\infty;-3\right)\)}{\(\left(3;\infty\right)\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Halla el rango de la función \(f(x)=2^{1-x}-3\).}
{\(\left(-3;\infty\right)\)}{\(\left(1;\infty\right)\)}{\(\left(-\infty;-3\right)\)}{\(\left(3;\infty\right)\)}{}{}}
\End
...
\LANGen{
\Question{
Find the range of the function \(f(x)=\left(\frac12\right)^{1-x}+2\).}
{\(\left(2;\infty\right)\)}{\(\left(-2;\infty\right)\)}{\(\left(-\infty;2\right)\)}{\(\left(1;\infty\right)\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Halla el rango de la función \(f(x)=\left(\frac12\right)^{1-x}+2\).}
{\(\left(2;\infty\right)\)}{\(\left(-2;\infty\right)\)}{\(\left(-\infty;2\right)\)}{\(\left(1;\infty\right)\)}{}{}}
\End
...
\LANGen{
\Question{
Given the function \(f(x)=3^x+1\), find the value of the function \(g(x)=f(x+1)\) for \(x=2\).}
{\(28\)}{\(16\)}{\(25\)}{\(10\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Dada la función \(f(x)=3^x+1\), halla el valor de la función \(g(x)=f(x+1)\) para \(x=2\).}
{\(28\)}{\(16\)}{\(25\)}{\(10\)}{}{}}
\End
...
\LANGen{
\Question{
Given the function \(f(x)=2^x-3\), find the value of the function \(g(x)=f(x+1)-1\) for \(x=2\).}
{\(4\)}{\(2\)}{\(6\)}{\(5\)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Dada la función \(f(x)=2^x-3\), halla el valor de la función \(g(x)=f(x+1)-1\) para \(x=2\).}
{\(4\)}{\(2\)}{\(6\)}{\(5\)}{}{}}
\End
...
\LANGen{
\Question{
Find the formula of an exponential function \(f(x)=a^x\), if you know that the point \(P=\left[-\frac12;8\right]\) lies on its graph.}
{\(f(x)=\left(\frac1{64}\right)^x\)}{\(f(x)=\left(\frac12\right)^x\)}{\(f(x)=\left(\frac18\right)^x\)}{\(f(x)=\left(-\frac12\right)^x\)}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Nájdite exponenciálnu funkciu \(f(x)=a^x\), ak viete, že bod \(P=\left[-\frac12;8\right]\) leží na jej grafe.}
{\(f(x)=\left(\frac1{64}\right)^x\)}{\(f(x)=\left(\frac12\right)^x\)}{\(f(x)=\left(\frac18\right)^x\)}{\(f(x)=\left(-\frac12\right)^x\)}{}{}}
\LANGes{
\Question{
Halla al fórmula de una función exponencial \(f(x)=a^x\), sabiendo que el punto \(P=\left[-\frac12;8\right]\) pertenece a su gráfica.}
{\(f(x)=\left(\frac1{64}\right)^x\)}{\(f(x)=\left(\frac12\right)^x\)}{\(f(x)=\left(\frac18\right)^x\)}{\(f(x)=\left(-\frac12\right)^x\)}{}{}}
\End
...
\LANGen{
\Question{
Find the formula of an exponential function \(f(x)=a^x\), if you know that the point \(P=\left[-\frac12;7\right]\) lies on its graph.}
{\(f(x)=\left(\frac1{49}\right)^x\)}{\(f(x)=\left(-\frac12\right)^x\)}{\(f(x)=\left(\frac17\right)^x\)}{\(f(x)=\left(-\frac17\right)^x\)}{}{}}
\LANGpl{
\Question{
...
{\(\vec{u}=\left(3;-4\right)\)}{\(\vec{u}=\left(-3;-4\right)\)}{\(\vec{u}=\left(3;4\right)\)}{\(\vec{u}=\left(-3;4\right)\)}{}{}}
\LANGpl{
\Question{
...
{\(\vec{u}=\left(4;2\right)\)}{\(\vec{u}=\left(-4;-2\right)\)}{\(\vec{u}=\left(4;-2\right)\)}{\(\vec{u}=\left(-4;2\right)\)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Který z uvedených grafů je grafem funkce \( f(x)=5\cdot 0{,}2^{-x}\)?}
{}{}{}{}{}{}}
\LANGsk{
\Question{
Ktorý z uvedených grafov je grafom funkcie \( f(x)=5\cdot 0{,}2^{-x}\)?}
{}{}{}{}{}{}}
\LANGes{
\Question{
¿Cuál de las gráficas dadas corresponde a la función \( f(x)=5\cdot 0.2^{-x}\)?}
{}{}{}{}{}{}}
...
\([5;3]\).}
{\(f(x) = \left (\frac{1}
{2}\right )^{3-x} - 1\)}{\(f(x) = \left (\frac{1}
{2}\right )^{3-x} + 1\)}{\(f(x) = 1 -\left (\frac{1}
{2}\right )^{x-3}\)}{\(f(x) = \left (\frac{1}
{2}\right )^{x-3} + 1\)}{\(f(x) = 1 -\left (\frac{1}
{2}\right )^{x+3}\)}{\(f(x) = \left (\frac{1}
{2}\right )^{x-3} - 1\)}}
\LANGpl{
\Question{
...
{\(p\in (-\infty;-5 )\)}{\(p\in \mathbb{R}\)}{\(p\in (-\infty ;-5)\cup (2;\infty )\)}{\(p\in (-5;-2 )\)}{}{}}
\LANGpl{
\Question{
...
\(p\) aseguran que la función \(f(x) = \left (\frac{p-2}
{p+5}\right )^{x}\) 
es creciente?}
{\(p\in (-\infty;-5 )\)}{\(p\in \mathbb{R}\)}{\(p\in (-\infty ;-5)\cup (2;\infty )\)}{\(p\in (-5;-2 )\)}{}{}}
\End
...
\(a\) para los que se cumple la siguiente desigualdad.
\[ 
 \left (\sqrt{5} -\sqrt{3}\right )^{a+2} > \left (\sqrt{5} -\sqrt{3}\right )^{4a-1}
\]}
{\(a > 1\)}{\(a < 1\)}{\(a > 0\)}{\(0 < a < 1\)}{}{}}
...
\[ 0.7^{-0.5};\ \left(\frac58\right)^6;\ \left(\frac32\right)^{-5};\ 3.5^{0};\ 0.4^4;\ 5^3\text{.} \]
Sin usar la calculadora, determina cuántos de estos valores son mayores que \( 1 \).}
{\( 2 \)}{\( 4 \)}{\( 3 \)}{\( 1 \)}{}{}}
\End
...
{The graph of \(f\) and the line have always a common point for all \(m\in\left(-3;\infty\right)\).}{The graph of \(f\) and the line have always a common point for \(m =-3\).}{The graph of \(f\) and the line have always a common point for all \(m\in\left(-\infty;-3\right)\).}{The graph of \(f\) and the line have always a common point for all \(m\in\mathbb{R}\).}{}{}}
\LANGpl{
\Question{
...
{Wykres funkcji \(f\) i prosta mają zawsze wspólny punkt dla wszystkich \(m\in\left(-3;\infty\right)\).}{Wykres funkcji \(f\) i prosta mają zawsze wspólny punkt dla \(m =-3\).}{Wykres funkcji \(f\) i prosta mają zawsze wspólny punkt dla wszystkich \(m\in\left(-\infty;-3\right)\).}{Wykres funkcji \(f\) i linia zawsze mają wspólny punkt dla wszystkich \(m\in\mathbb{R}\).}{}{}}
\LANGcs{
\Question{
...
{Graf funkce \(f\) a přímka mají vždy společný bod pro všechna \(m\in\left(-3;\infty\right)\).}{Graf funkce \(f\) a přímka mají vždy společný bod pro \(m =-3\).}{Graf funkce \(f\) a přímka mají vždy společný bod pro všechna \(m\in\left(-\infty;-3\right)\).}{Graf funkce \(f\) a přímka mají vždy společný bod pro všechna \(m\in\mathbb{R}\).}{}{}}
\LANGsk{
\Question{
...
{Graf \(f\) a priamka majú vždy spoločný bod pre všetky \(m\in\left(-3;\infty\right)\).}{Graf \(f\) a priamka majú vždy spoločný bod pre \(m =-3\).}{Graf \(f\) a priamka majú vždy spoločný bod pre všetky \(m\in\left(-\infty;-3\right)\).}{Graf \(f\) a priamka majú vždy spoločný bod pre všetky \(m\in\mathbb{R}\).}{}{}}
\LANGes{
\Question{
...
{La gráfica de \(f\) y la recta tienen siempre un punto de intersección para todo \(m\in\left(-3;\infty\right)\).}{La gráfica de \(f\) y la recta tienen siempre un punto de intersección para todo \(m =-3\).}{La gráfica de \(f\) y la recta tienen siempre un punto de intersección para todo \(m\in\left(-\infty;-3\right)\).}{La gráfica de \(f\) y la recta tienen siempre un punto de intersección para todo \(m\in\mathbb{R}\).}{}{}}
\End
...
{Wykres funkcji \(f\) i prosta mają zawsze wspólny punkt dla wszystkich \(m\in\left(-\infty;-3\right)\).}{Wykres funkcji  \(f\)  i prosta mają zawsze wspólny punkt dla \(m =-3\).}{Wykres funkcji \(f\) i prosta mają zawsze wspólny punkt dla wszystkich \(m\in\left(-3;+\infty\right)\).}{Wykres funkcji  \(f\) i prosta zawsze mają wspólny punkt dla wszystkich \(m\in\mathbb{R}\).}{}{}}
\LANGcs{
\Question{
...
{Graf funkce \(f\) a přímka mají vždy společný bod pro všechna \(m\in\left(-\infty;-3\right)\).}{Graf funkce \(f\) a přímka mají vždy společný bod pro \(m =-3\).}{Graf funkce \(f\) a přímka mají vždy společný bod pro všechna \(m\in\left(-3;+\infty\right)\).}{Graf funkce \(f\) a přímka mají vždy společný bod pro všechna \(m\in\mathbb{R}\).}{}{}}
\LANGsk{
\Question{
...
{Graf funkcie \(f\) a priamka majú vždy spoločný bod pre všetky \(m\in\left(-\infty;-3\right)\).}{Graf funkcie \(f\) a priamka majú vždy spoločný bod pre \(m =-3\).}{Graf funkcie \(f\) a priamka majú vždy spoločný bod pre všetky \(m\in\left(-3;+\infty\right)\).}{Graf funkcie \(f\) a priamka majú vždy spoločný bod pre všetky \(m\in\mathbb{R}\).}{}{}}
\LANGes{
\Question{
...
{The graph of \(f\) and the line do not have a common point for any \(m\in\left(2;\infty\right)\).}{The graph of \(f\) and the line do not have a common point for any \(m\in\left(-\infty;2 \right. ] \).}{The graph of \(f\) and the line do not have a common point for \(m=2\).}{The graph of \(f\) and the line do not have a common point for any \(m\in\left(-\infty;2\right)\).}{}{}}
\LANGpl{
\Question{
...
{Wykres funkcji \(f\) i prosta nie mają wspólnego punktu dla dowolnego \(m\in\left(2;\infty\right)\).}{Wykres funkcji \(f\) i prosta nie mają wspólnego punktu dla dowolnego \(m\in\left(-\infty;2 \right. \rangle \).}{Wykres funkcji \(f\) i prosta nie mają wspólnego punktu dla dowolnego \(m=2\).}{Wykres funkcji \(f\) i linia nie mają wspólnego punktu dla \(m\in\left(-\infty;2\right)\).}{}{}}
\LANGcs{
\Question{
...
{Graf funkce \(f\) a přímka nemají žádný společný bod pro libovolné \(m\in\left(2;\infty\right)\).}{Graf funkce \(f\) a přímka nemají žádný společný bod pro libovolné \(m\in\left(-\infty;2 \right. \rangle \).}{Graf funkce \(f\) a přímka nemají žádný společný bod pro \(m=2\).}{Graf funkce \(f\) a přímka nemají žádný společný bod pro libovolné \(m\in\left(-\infty;2\right)\).}{}{}}
\LANGsk{
\Question{
...
{Graf \(f\) a priamka nemajú spoločný bod pre žiadne \(m\in\left(2;\infty\right)\).}{Graf \(f\) a priamka nemajú spoločný bod pre žiadne \(m\in\left(-\infty;2 \right. \rangle \).}{Graf \(f\) a priamka nemajú spoločný bod pre \(m=2\).}{Graf \(f\) a priamka nemajú spoločný bod pre žiadne \(m\in\left(-\infty;2\right)\).}{}{}}
\LANGes{
\Question{
...
{La gráfica de \(f\) y la recta no tienen ningún punto de intersección para \(m\in\left(2;\infty\right)\).}{La gráfica de \(f\) y la recta no tienen ningún punto de intersección para \(m\in\left(-\infty;2 \right. ] \).}{La gráfica de \(f\) y la recta no tienen ningún punto de intersección para \(m=2\).}{La gráfica de \(f\) y la recta no tienen ningún punto de intersección para \(m\in\left(-\infty;2\right)\).}{}{}}
\End
...
{The graph of \(f\) and the line do not have a common point for any \(m\in\left(-\infty;2\right)\).}{The graph of \(f\) and the line do not have a common point for any \(m\in\left. [ 2;\infty\right)\).}{The graph of \(f\) and the line do not have a common point for \(m=2\).}{The graph of \(f\) and the line do not have a common point for any \(m\in\left(2;\infty\right)\).}{}{}}
\LANGpl{
\Question{
...
{Wykres funkcji \(f\) i prosta nie mają wspólnego punktu dla żadnego \(m\in\left(-\infty;2\right)\).}{Wykres funkcji \(f\)  i prosta nie mają wspólnego punktu dla dowolnego \(m\in\left. \langle 2;\infty\right)\).}{Wykres funkcji \(f\)  i prosta nie mają wspólnego punktu dla \(m=2\).}{Wykres funkcji \(f\) i prosta nie mają wspólnego punktu dla dowolnego \(m\in\left(2;\infty\right)\).}{}{}}
\LANGcs{
\Question{
...
{Graf funkce \(f\) a přímka nemají žádný společný bod pro libovolné \(m\in\left(-\infty;2\right)\).}{Graf funkce \(f\) a přímka nemají žádný společný bod pro libovolné \(m\in\left. \langle 2;\infty\right)\).}{Graf funkce \(f\) a přímka nemají žádný společný bod pro \(m=2\).}{Graf funkce \(f\) a přímka nemají žádný společný bod pro libovolné \(m\in\left(2;\infty\right)\).}{}{}}
\LANGsk{
\Question{
...
{Graf \(f\) a priamka nemajú spoločný bod pre žiadne \(m\in\left(-\infty;2\right)\).}{Graf \(f\) a priamka nemajú spoločný bod pre žiadne \(m\in\left. \langle 2;\infty\right)\).}{Graf \(f\) a priamka nemajú spoločný bod pre \(m=2\).}{Graf \(f\) a priamka nemajú spoločný bod pre žiadne \(m\in\left(2;\infty\right)\).}{}{}}
\LANGes{
\Question{
