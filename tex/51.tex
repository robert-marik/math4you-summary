...
\LANGes{
\Question{
¿Cuál de las ecuaciones siguientes es la función de la asíntota horizontal \( f(x)=2^x+3 \)?}
{\( y=3 \)}{\( y=-3 \)}{\( x=3 \)}{\( x=-3 \)}{}{}}
\End
...
\LANGes{
\Question{
Identifica la expresión analítica de la función exponencial representada por la gráfica abajo.}
{\(y = 2^{x-1} - 2\)}{\(y = 2^{x+1} - 2\)}{\(y = 2^{x+1} + 2\)}{\(y = 2^{x-1} + 2\)}{}{}}
\End
...
\LANGes{
\Question{
Identifica la función con la gráfica que pasa por los puntos 
\([3;0]\) y
\([5;3]\).}
{\(y = \left (\frac{1}
{2}\right )^{3-x} - 1\)}{\(y = \left (\frac{1}
...
\LANGes{
\Question{
¿Para qué reales \( a \) se verifica esta desigualdad \( a^{\frac25} > a^{\frac45}\)?}
{\( 0 < a < 1 \)}{\( a > 1 \)}{\( a < 1 \)}{\( a > 0 \)}{}{}}
\End
...
\LANGes{
\Question{
¿Para qué reales \( a \) se verifica esta desigualdad \( a^{-3} > a^{-2}\)?}
{\( 0 < a < 1 \)}{\( a > 1 \)}{\( a < 1 \)}{\( a > 0 \)}{}{}}
\End
...
\LANGes{
\Question{
Dada la función exponencial \(f(x)=a^x\), elige para qué base \(a\) es la función creciente.}
{\(a > 1\)}{\(a=1\)}{\(a < 1\)}{\(  0 < a < 1 \)}{}{}}
\End
...
{decreciente, acotada por arriba, asíntota \( y=0 \)}{decreciente, acotaba por abajo, asíntota \( x=0 \)}{creciente, acotada por abajo, asíntota \( x=0 \)}{creciente, acotada por abajo, asíntota \( y=0 \)}{}{}}
\End
...
Considera valores
\[ 0.7^{-0.5};\  \left(\frac58\right)^6;\ \left(\frac32\right)^{-5};\  3.5^0;\  0.4^4;\  5^3\text{.} \]
Determina cuántos valores son mayores que \( 1 \). Usa la gráfica de una función exponencial dada abajo.}
{\( 2 \)}{\( 4 \)}{\( 3 \)}{\( 1 \)}{}{}}
\End
...
{creciente, acotada por arriba, la asíntota \( y=0 \)}{decreciente, acotada por arriba, la asíntota \( y=0 \)}{decreciente, acotada por abajo, la asíntota \( x=0 \)}{creciente, acotada por abajo, la asíntota \( x=0 \)}{}{}}
\End

\Data\ID{1103024908}
\Updated{2020-11-16 12:11:09}
\Level{B}
\SubArea{Exponential functions}
\LANGen{
\Question{
...
\LANGes{
\Question{
Usando las propiedades de la función exponencial convierte la siguiente desigualdad a la desigualdad explícita para el parametro 
\(a\).
\[ 
 \left (\sqrt{3} -\sqrt{2}\right )^{2a+1} > \left (\sqrt{3} -\sqrt{2}\right )^{4-a}
\]}
...
\LANGes{
\Question{
Hall el rango de la función \( f(x)=\Bigl|\left(\frac13\right)^x-1\Bigr|\).}
{\( [ 0;\infty) \)}{\( ( 0;\infty) \)}{\( (-1;\infty) \)}{\( [ -1;\infty) \)}{}{}}
\End
...
\LANGes{
\Question{
María compró un coche nuevo por \( 12\,000 \) EUR. La disminución de valor del coche es el \( 12\% \) al año. Susana compró un coche nuevo el mismo año como María y pagó \( 14\,500\) EUR. La disminución del valor del coche de Susana es el  \( 15\% \) al año. Sea \( p \) el precio de coche en miles de euros y \( t \) la edad de coche en años. ¿Cuál de las siguientes posibilidades es correcta según la gráfica representada?}
...
\LANGes{
\Question{
María compró un coche nuevo por el precio de \(12\,000\) euros y el valor del coche baja el \( 12\% \) al año. Susana compró un coche nuevo el mismo año como María y pagó \( 14\,500 \) euros. El valor del coche de Susana baja el \( 15\% \) al año. Sea \( p \) el precio de coche en miles de euros y \( t \) la edad de coche en años. En el gráfico abajo determina qué color de la gráfica representa la relación entre el precio del coche de María y su edad. (Ojo: Las respuestas incluyen no solo el color de la gráfica sino también la ecuación de la función adecuada.)}
...
\LANGes{
\Question{
En el año \( 2000 \) (\(t=0\)) un pueblo pequeño tiene \( 350 \) habitantes. La gráfica abajo muestra la función de la población para los siguientes \( 50 \) años. ¿Cuál de los siguientes enunciados es verdadero?}
{La población disminuye de un \( 3.8\% \) al año.}{La población crece de un \( 3.8\% \) al año.}{La población disminuye de \( 5 \) personas al año.}{La población crece de \( 5 \) personas al año.}{}{}}
\End
