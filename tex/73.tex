...
\(x \geq 2\) určte množinu všetkých riešení danej nerovnice.
\[ 
 \left({ x\above 0.0pt 
x - 2}\right)\cdot \left({x\above 0.0pt 
2}\right) - 20\cdot \left({x\above 0.0pt 
...
\(x \geq 2\) determina el conjunto de todas las soluciones de una desigualdad dada.
\[ 
 \left({ x\above 0.0pt 
x - 2}\right)\cdot \left({x\above 0.0pt 
2}\right) - 20\cdot \left({x\above 0.0pt 
