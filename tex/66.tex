...
\(B = [-5;3]\) y 
\(C = [-1;-1]\), halla la longitud de la altura al punto \(C\) del triángulo \(ABC\). Pista: En geometría, la altura al punto \(C\) del triángulo \(ABC\) es un segmento que une un vértice \(C\) con un punto de su lado opuesto y es perpendicular al lado \(AB\) del triángulo.}
{\(4\)}{\(\frac43\)}{\(6\)}{\(\frac23\)}{}{}}
\End
