...
\LANGes{
\Question{
De la siguiente lista, elige ecuaciones paramétricas, que   no representan  la  recta que pasa por los puntos \( A \) y \( B \) (mira la imagen).}
{$\begin{aligned}
p\colon x&=2+4t, \\
y&=6+2t;\  t\in\mathbb{R}
\end{aligned}$}{$\begin{aligned}
...
\LANGes{
\Question{
La recta \( p \) está dada por el punto \( A \) y el vector normal \( \vec{n} \) (mira la imagen). Determina su ecuación general.}
{\( p\colon 2x-5y-6=0 \)}{\( p\colon 2x+5y-6=0 \)}{\( p\colon 5x-2y-15=0 \)}{\( p\colon 5x+2y-15=0 \)}{}{}}
\End
...
\LANGes{
\Question{
La recta\( p \) está dada por el punto \( A \) y el ángulo director \( \varphi \) (mira la imagen). Determina la ecuación de la recta \( p \) en la forma pendiente-intersección.}
{\( p\colon y=-\sqrt3x+3 \)}{\( p\colon y=\sqrt3x+3 \)}{\( p\colon y=1.7x+3 \)}{\( p\colon y=-1.7x+3 \)}{}{}}
\End
...
\LANGes{
\Question{
De la siguiente lista, elige la  ecuación, que pasa por el punto \( K \) y  no es paralela   a la recta \( m \) (mira la imagen).}
{\( g\colon y=-\frac32x+\frac{13}2 \)}{\( b\colon 2x-3y-13=0 \)}{\( f\colon y=\frac23x-\frac{13}3 \)}{$\begin{aligned}
q\colon x&=5+3t, \\
y&=-1+2t;\ t\in\mathbb{R}
\end{aligned}$}{}{}}
...
\LANGes{
\Question{
De la siguiente lista, elige la ecuación, que pasa por el punto\( K \) y  no es perpendicular a la rectar \( m \) (mira la imagen).}
{\( r\colon y=\frac23x-\frac{13}3 \)}{\( p\colon 3x+2y-13=0 \)}{\( s\colon y=-\frac32x+\frac{13}2 \)}{$\begin{aligned}
q\colon x&=5+2t, \\
y&=-1-3t;\ t\in\mathbb{R}
\end{aligned}$}{}{}}
...
\LANGes{
\Question{
Dada la recta  \( m= \left\{[3-t;t]\text{, } t\in\mathbb{R} \right\} \) que corta a la recta \( a \), \( b \), \( c \) en los puntos \( A \), \( B \), \( C \) consecutivamente (mira la imagen). Halla los valores del parámetro \( t \) que corresponde a estas intersecciones.}
{\( t_A=1; t_B=\frac32;\ t_C=2 \)}{\( t_A=-1; t_B=-2;\ t_C=-3 \)}{\( t_A=2; t_B=\frac32;\ t_C=1 \)}{\( t_A=2; t_B=\frac52;\ t_C=3 \)}{}{}}
\End
...
\LANGes{
\Question{
En la siguiente lista, identifica un vector que tiene la misma dirección que la recta pasando por los puntos \(A\) 
y \(B\).
\[ 
 A = \left [2;1\right ]\text{, }\qquad B = \left [3;2\right ]
\]}
...
\LANGes{
\Question{
En la siguiente lista, identifica un vector que tiene la misma dirección que la recta pasando por los puntos \(A = [3;-3]\) 
y \(B = [-1;-9]\).}
{\((2;3)\)}{\((2;-12)\)}{\((4;-6)\)}{\((-4;6)\)}{}{}}
\End

\Data\ID{9000106206}
\Updated{2020-07-17 08:07:42}
\Level{A}
\SubArea{Analytic geometry in a plane}
\LANGen{
\Question{
...
\LANGes{
\Question{
En la siguiente lista, identifica un vector que tiene la misma dirección que la recta pasando por los puntos  \(A = [3;4]\) 
y \(B = [5;8]\).}
{\((1;2)\)}{\((4;2)\)}{\((1;3)\)}{\((2;-4)\)}{}{}}
\End
...
\LANGes{
\Question{
Halla un vector normal de la recta pasando por los puntos \(A = [3;-1]\) y
\(B = [2;2]\).}
{\((3;1)\)}{\((-1;3)\)}{\((1;-3)\)}{\((1;3)\)}{}{}}
\End
...
\Data\ID{9000107503}
\Updated{2020-07-17 09:07:50}
\Level{A}
\SubArea{Analytic geometry in a plane}
\LANGen{
\Question{
Among the lines in the following list (lines in a slope-intercept form) identify a line perpendicular
to the line \(q\).
\[ 
 q\colon y = \frac{3} 
{4}x + 1
...
\LANGes{
\Question{
Entre las rectas de la siguiente lista (rectas en forma de pendiente-intersección) identifica una recta perpendicular
a la recta \(q\).
\[ 
 q\colon y = \frac{3} 
{4}x + 1
...
\(a\) para que las siguientes rectas \(p\) 
y \(q\) 
...
\LANGes{
\Question{
Halla la distancia entre las rectas paralelas \( p \) y \( q \) que están dadas por sus ecuaciones parámetricas.
\begin{align*}
 p\colon x&=3+3t, & q\colon x&=2-3s, \\
y&=-1+t;\ t\in\mathbb{R}; & y&=1-s;\ s\in\mathbb{R}.
\end{align*}}
...
\LANGes{
\Question{
Sea \( ABC \) un triángulo (mira la imagen). Determina la ecuación general de la recta \( t \), \( v \) y \( o \), donde \( t \) es la mediana al lado \( AB \), \( v \) es la altura al lado \( AB \) y \( o \) es el eje de simetría del lado \( AB \). 
...
\LANGes{
\Question{
Determina la ecuación general de la recta que pasa por el punto \( M=[2;3] \) y es paralela al eje del segmento \( AB  )\, donde \( A=[-1;4] \) y \( B=\left[\frac52;-3\right] \) (mira la imagen).}
{\( x-2y+4=0 \)}{\( 2x+y-7=0 \)}{\( 3x+2y-12=0 \)}{\( 2x-3y+5=0 \)}{}{}}
\End
...
\LANGes{
\Question{
Halla las rectas que pasan por el origen de coordenadas  y tienen la distancia \( 2 \) desde el punto \( M=[0;4] \). Expresa sus ecuaciones en la forma pendiente-intersección.}
{\( y=\pm\sqrt3 x \)}{\( y=\pm4 x \)}{\( y=\pm\frac32 x \)}{\( y=\pm2\sqrt3 x \)}{}{}}
\End
...
\LANGes{
\Question{
Sea \( A \) un punto \( [4;3] \) y sea \( p \) una recta que tiene la ecuación \( x-y+3=0 \). Halla las coordenadas del punto \( A' \) que es un reflejo de espejo de \( A \) en el eje de simetría   \( p \) (mira la imagen).}
{\( A'=[0;7] \)}{\( A'=[1;8] \)}{\( A'=[-1;8] \)}{\( A'=[-1;7] \)}{}{}}
\End
...
\LANGes{
\Question{
Sean \( A=[0;1] \), \( B=[4;-2] \) y \( S=[4;3] \) los puntos (mira la imagen). Determina las coordenadas de los puntos \( C \) y \( D \) para que \( ABCD \) sea un paralelogramo con el centro \( S \).}
{\( C=[8;5]\text{, } D=[4;8] \)}{\( C=[7;5]\text{, } D=[4;8] \)}{\( C=[8;5]\text{, } D=[4;7] \)}{\( C=[4;8]\text{, } D=[8;5] \)}{}{}}
\End
...
\LANGes{
\Question{
Sea \( 2x+6y-5=0 \) la recta \( p \) y \( x+3y-4=0 \) la recta \( o \), donde \( p \) y \( o \) son paralelas (mira la imagen). Determina la ecuación general de una recta \( p' \) que es el reflejo de la recta \( p \) en el eje de simetría \( o \).}
{\( p'\colon 2x+6y-11=0 \)}{\( p'\colon 2x+6y-2=0 \)}{\( p'\colon 2x+6y+5=0 \)}{\( p'\colon -2x-6y-11=0 \)}{}{}}
\End
...
\LANGes{
\Question{
Sea \( p \) la recta con una ecuación \( x-2y-1=0 \) y sea \( S \) un punto con coordenadas \( [2;2] \) (mira la imagen). Determina la ecuación general de la recta \( p' \)  que es el reflejo de la recta \( p \) en el punto de simetría con el centro \( S \).}
{\( p'\colon x-2y+5=0 \)}{\( p'\colon 2x-4y+9=0 \)}{\( p'\colon x-2y+4=0 \)}{\( p'\colon x-2y+6=0 \)}{}{}}
\End
...
\LANGes{
\Question{
Sea \( p \) la recta con una ecuación \( x-2y+5=0 \) y sea \( \vec{v} \) el vector \( (3;-2) \) (mira la imagen). Determina la ecuación general de la recta \( p' \) que es el reflejo de la recta \( p \) trasladado por el vector \( \vec{v} \).}
{\( p'\colon x-2y-2=0 \)}{\( p'\colon 2x-4y-3=0 \)}{\( p'\colon x-2y-1=0 \)}{\( p'\colon 2x-4y+3=0 \)}{}{}}
\End
...
\LANGes{
\Question{
Sea \( p \)  la recta con una ecuación \( x-2y-1=0 \). Determina las ecuaciones generales de todas las rectas paralelas a la recta \( p \) suponiendo que la distancia de \( p \) equivale a \( \sqrt5 \).}
{\( x-2y+4=0;\ x-2y-6=0 \)}{\( x-2y+\sqrt5=0;\ x-2y-\sqrt5=0 \)}{\( x-2y-1+\sqrt5=0;\ x-2y-1-\sqrt5=0 \)}{\( x-2y+6=0;\ x-2y-4=0 \)}{}{}}
\End
...
\LANGes{
\Question{
Sea \( p \)  la recta con una ecuación \( x-2y-1=0 \). Halla las coordenadas de todos los puntos que se encuentran en la recta \( p \) suponiendo que la distancia de la recta \( x=4 \) equivale a \( 2 \).}
{\( X_1 = \left[2;\frac12\right]\text{, }X_2 = \left[6;\frac52\right] \)}{\( X_1 = \left[2;1\right]\text{, }X_2 = \left[6;5\right] \)}{\( X_1 = \left[2;\frac14\right]\text{, }X_2 = \left[6;\frac54\right] \)}{\( X_1 = \left[2;\frac32\right]\text{, }X_2 = \left[6;\frac72\right] \)}{}{}}
\End

\Data\ID{1103109008}
\Updated{2020-07-13 11:07:36}
\Level{B}
\SubArea{Analytic geometry in a plane}
\IMG{1103109008.pdf}
\LANGen{
...
\LANGes{
\Question{
Sea \( p \)  la recta con una ecuación \( x-2y-1=0 \). Halla las coordenadas de todos los puntos que se encuentran en la recta \( p \) suponiendo que la distancia de la recta \( y=3 \) equivale a \( 1 \).}
{\( X_1 = \left[5;2\right]\text{, }X_2 = \left[9;4\right] \)}{\( X_1 = \left[4;2\right]\text{, }X_2 = \left[8;4\right] \)}{\( X_1 = \left[2;4\right]\text{, }X_2 = \left[6;4\right] \)}{\( X_1 = \left[2;5\right]\text{, }X_2 = \left[4;9\right] \)}{}{}}
\End
...
\LANGes{
\Question{
En la siguiente lista, identifica una recta paramétrica para que el ángulo entre esta recta y
la recta \(q\) 
sea \(0^{\circ }\).
\[ 
 q\colon x - 2y + 11 = 0
...
\Data\ID{9000149401}
\Updated{2020-07-17 04:07:20}
\Level{B}
\SubArea{Analytic geometry in a plane}
\LANGen{
\Question{
Find the distance from the point \(P = [-4;2]\) 
to the line \(p\colon 3x - 4y - 5 = 0\).}
{\(5\)}{\(1\)}{The point is on the line \(p\).}{\(\sqrt{5}\)}{}{}}
\LANGpl{
\Question{
...
\Data\ID{9000149405}
\Updated{2020-07-17 05:07:42}
\Level{B}
\SubArea{Analytic geometry in a plane}
\LANGen{
\Question{
Find the value (values) of the parameter
\(c\) which ensures, that the
distance from the point \(M = [2;-1]\) 
to the line \(p\) 
is \(5\). The
line \(p\) is
...
Given points \(A = [2;-5]\),
\(B = [2;3]\),
\(C = [-4;-1]\), find the length of the
altitude through the point \(C\) 
of the triangle \(ABC\). Hint: In geometry, the altitude through the point
\(C\) of the triangle
\(ABC\) is the line segment through the
vertex \(C\) and perpendicular to
the line containing the side \(AB\) 
of the triangle.}
{\(6\)}{\(\sqrt{2}\)}{\(\frac{3}
{2}\)}{The points \(A\),
\(B\),
...
\Question{
En el eje \(x\)
halla los puntos suponiendo que la distancia de estos puntos a la recta
\(p\colon x - 2y + 2 = 0\) es
\(\sqrt{5}\).}
{\([3;0]\),
\([-7;0]\)}{\([5;0]\)}{\(\left [\sqrt{5};0\right ]\),
...
y la distancia de cada estasa recta a la recta (p\) es
\(\sqrt{10}\).}
{\(p_{1}\colon x - 3y + 12 = 0\),
\(p_{2}\colon x - 3y - 8 = 0\)}{\(p\colon x - 3y = 0\)}{\(p\colon x - 3y + \sqrt{10} = 0\)}{\(p_{1}\colon x - 3y + \sqrt{10} = 0\),
\(p_{2}\colon x - 3y -\sqrt{10} = 0\)}{}{}}
...
\Question{
Determina el ángulo \(\varphi \)
entre las rectas dadas por sus ecuaciones de pendiente-intersección
\(y = 6\) y
\(y = \frac{3} 
{4}x\).}
{\(36^{\circ }52'\)}{\(45^{\circ }59'\)}{\(64^{\circ }33'\)}{\(76^{\circ }11'\)}{}{}}
...
\Question{
Determina el ángulo \(\varphi \) 
entre las rectas paramétricas \(x + \sqrt{3}y - 6 = 0\) 
y  \(p\).
...
\LANGes{
\Question{
Determina las ecuaciones generales de todas las rectas que son perpendiculares a la recta \( p \): \( 2x+6y-3=0 \) y tienen desde el punto \( M=[5;4] \) la distancia  \( \sqrt{10} \) (mira la imagen).}
{\( 3x-y-1=0;\ 3x-y-21=0 \)}{\( 3x-y+1=0;\ 3x-y-18=0 \)}{\( x+3y+1=0;\ x+3y+21=0 \)}{\( x+3y-1=0;\ x+3y-18=0 \)}{}{}}
\End
...
\LANGes{
\Question{
Sea \( p \)  y \( q \) las rectas secantes con ecuaciones \( y=\frac{\sqrt3}3x \) y \( x=0 \) respectivamente. Determina la ecuación de la recta \( o_1 \) y \( o_2 \) que son ejes de simetría de los ángulos  entre \( p \) y \( q \) (mira la imagen).}
{\( y=\sqrt3x;\  y=-\frac{\sqrt3}3x \)}{\( y=2x;\ y=-\frac12x \)}{\( y=\sqrt2x;\ y=-\frac{\sqrt2}2x \)}{\( y=3x;\ y=-\frac13x \)}{}{}}
\End
...
\LANGes{
\Question{
Sea \( y=-\frac{\sqrt3}3x+1 \) la ecuación de la recta \( p \) y sea \( M \) el punto \( [0;-3] \). Determina las ecuaciones de todas las rectas que pasan por el punto \( M \) y cortan la recta \( p \) formando un ángulo de \( 60^{\circ} \) (mira la imagen).}
{\( x=0;\ y=\frac{\sqrt3}3x-3 \)}{\( y=0;\ y=\frac{\sqrt3}3x-3 \)}{\( y=0;\ y=x-3 \)}{\( x=0;\  y=\sqrt3x-3 \)}{}{}}
\End
...
\LANGes{
\Question{
Sea \( 2x-3y+6=0 \) la ecuación de la recta \( p \) y sea \( M \) el punto \( [5;3] \).  Determina las ecuaciones de todas las rectas que pasan por el punto \( M \) y cortan la recta  \( p \) formando un ángulo de \( 45^{\circ} \) (mira la imagen).}
{\( x+5y-20=0;\ 5x-y-22=0 \)}{\( x+6y-23=0;\ 6x-y-27=0 \)}{\( x+4y-17=0;\ 4x-y-16=0 \)}{\( x+5y-28=0;\ 5x-y-10=0 \)}{}{}}
\End
...
\LANGes{
\Question{
Sean \( p \) y \( q \) las rectas con ecuaciones \( x-2y-1=0 \) y \( 2x+y-12=0 \) respectivamente. Halla todos los puntos que están en la misma distancia \( \sqrt5 \) desde \( p \) y \( q \)  (mira la imagen).}
{\([2;3] \), \([6;5] \), \([8;1] \), \([4;-1] \)}{\([2;3] \), \([6;5] \), \([8.5;1] \), \([4.5;-1] \)}{\([2;3.5] \), \([6;5.5] \), \([8;1] \), \([4;-1] \)}{\([2;3] \), \([6;5.5] \), \([8;1.5] \), \([4;-1] \)}{}{}}
\End
...
\LANGes{
\Question{
Halla las ecuaciones generales de todas las rectas que pasan por el punto \( M=[-2;4] \) y tienen la distancia \( 2 \) desde el origen \( O \) (mira la imagen).}
{\( x+2=0;\ 3x+4y-10=0 \)}{\( x-2=0;\ 3x+4y-10=0 \)}{\( x+2=0;\ 4x-3y+20=0 \)}{\( x-2=0;\ 4x-3y+20=0 \)}{}{}}
\End
...
{\( \varphi\,\dot{=}\,21^{\circ}48' \)}{\( \varphi\,\dot{=}\,21^{\circ}24' \)}{\( \varphi\,\dot{=}\,21^{\circ}36' \)}{\( \varphi\,\dot{=}\,21^{\circ}52' \)}{}{}}
\LANGpl{
\Question{
...
{\( \varphi\,\dot{=}\,71^{\circ}34' \)}{\( \varphi\,\dot{=}\,71^{\circ}33' \)}{\( \varphi\,\dot{=}\,71^{\circ}40' \)}{\( \varphi\,\dot{=}\,71^{\circ}38' \)}{}{}}
\LANGpl{
\Question{
...
y \(B = [-3;2]\). Identifica un número \(m\ en \mathbb{R}\) suponiendo que el punto \(C = [1;m]\) 
está en la recta\(AB\).}
{\(m = \frac{22} 
 {5} \)}{\(m = 20\)}{\(m = -3\)}{\(m = \frac{2} 
{3}\)}{\(m = -\frac{5}
...
Para un triángulo dado\(ABC\) 
selecciona de la siguiente lista un vector director de una recta 
 en la que se encuentra su altura al lado
...
\Question{
Para un triángulo dado  \(ABC\) 
 selecciona de la siguiente lista un vector director del eje del lado 
...
\Question{
Para un triángulo dado \(ABC\) 
selecciona de la siguiente lista un vector director del eje del ángulo del vértice
