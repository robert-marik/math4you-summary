...
\LANGes{
\Question{
Calcula las medidas de los ángulos interiores \( \alpha \), \( \beta \) and \( \gamma \) de un triángulo si \( \gamma=2\beta \) y \( \beta=3\alpha \).}
{\( \alpha=18^{\circ};\ \beta=54^{\circ};\ \gamma=108^{\circ} \)}{\( \alpha=15^{\circ};\ \beta=45^{\circ};\ \gamma=90^{\circ} \)}{\( \alpha=12^{\circ};\ \beta=54^{\circ};\ \gamma=111^{\circ} \)}{\( \alpha=54^{\circ};\ \beta=18^{\circ};\ \gamma=108^{\circ} \)}{}{}}
\End
...
{En un triángulo rectángulo, todas las alturas son perpendiculares entre sí.}{El baricentro de un triángulo divide a cada mediana en la razón \( 2:1 \).}{La paralela media de un triángulo tiene la misma longitud que la mitad del lado con el que es paralela.}{Las tres medianas de un triángulo se cortan en un punto llamado baricentro.}{}{}}
\End
...
{Hay triángulos equiláteros que sean rectángulos.}{Hay triángulos isósceles que sean acutángulos.}{Hay triángulos equiláteros que sean acutángulos.}{Hay triángulos isósceles que sean obtusángulos.}{}{}}
\End
...
\LANGes{
\Question{
Dado el triángulo \( ABC \), donde \( \alpha:\beta=5:7 \) y el ángulo \( \gamma \) es un \( 42^{\circ} \)  menor que el ángulo \( \omega \), calcula la medida del ángulo \( \gamma \).}
{\( 108^{\circ} \)}{\( 42^{\circ} \)}{\( 30^{\circ} \)}{\( 60^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
Dado el triángulo \( ABC \) con \( \alpha=80^{\circ} \) y \( \beta=70^{\circ} \). ¿Qué ángulo forman la altura sobre el lado \( AB \) con la altura sobre el lado \( BC \)?}
{\( 70^{\circ} \)}{\( 120^{\circ} \)}{\( 30^{\circ} \)}{\( 60^{\circ} \)}{}{}}
\End
...
\LANGen{
\Question{
What is the measure of the angle \( \alpha \)? (See the diagram.)}
...
\LANGes{
\Question{
El triángulo en la imagen se divide en dos triángulos isósceles \( AKC \) y \( KBC \), cuyas áres son iguales. Calcula la medida del ángulo \( \beta \), si sabes que \(\measuredangle AKC \) mide \( 140^{\circ} \).}
{\( 70^{\circ} \)}{\( 60^{\circ} \)}{\( 50^{\circ} \)}{\( 40^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
Dado un triángulo isósceles \(ABC\) con los lados \(AC\) y \(BC\) de la misma longitud. La medida del ángulo \( BAC\) es \(40^{\circ }\). \(X\) es el punto de intersección entre la línea $AB$ y la línea a través del vértice \(C\) perpendicular a ella. Calcula la medida del ángulo \( BCX\).}
{\(50^{\circ }\)}{\(80^{\circ }\)}{\(100^{\circ }\)}{\(40^{\circ }\)}{}{}}
\End
...
\LANGen{
\Question{
The ladder is leaning against the wall of a house. Its length is \( 6 \) meters. How high does the ladder reach if the angle between it and the wall is \( 30^{\circ} \)?}
...
\LANGes{
\Question{
Una escalera se apoya en una pared de una casa. La escalera mide \( 6 \) metros. ¿A qué altura llega la escalera si forma un ángulo de \( 30^{\circ} \) con la pared?}
{\( 3\sqrt3\,\mathrm{m} \)}{\( 3\,\mathrm{m} \)}{\( 6\,\mathrm{m} \)}{\( \frac{\sqrt3}2\,\mathrm{m} \)}{}{}}
\End
...
\LANGen{
\Question{
In a triangle with interior angles \( 30^{\circ} \), \( 60^{\circ} \) a \( 90^{\circ} \), the longest side is \( 10\,\mathrm{cm} \) long. Find the length of its shortest side.}
...
\LANGes{
\Question{
Dado el triángulo con las longitudes de los lados \( 6\,\mathrm{cm} \), \( 7\,\mathrm{cm} \) y \( 9\,\mathrm{cm} \). Halla el valor del coseno de su ángulo interior más grande.}
{\( \frac1{21} \)}{\( 87.27^{\circ} \)}{\( 1.98 \)}{\( -\frac1{21} \)}{}{}}
\End
...
\LANGes{
\Question{
El frontón del techo tiene una forma del triángulo isósceles. La anchura del frontón mide \( 12\,\mathrm{m} \) y el pendiente del techo es \( 38^{\circ} \). Calcula la altura del frontón. Redondea el resultado a dos decimales.}
{\( 4.69\,\mathrm{m} \)}{\( 7.39\,\mathrm{m} \)}{\( 9.46\,\mathrm{m} \)}{\( 3.70\,\mathrm{m} \)}{}{}}
\End
...
\LANGes{
\Question{
La imagen representa una torre de agua. Desde el sitio \( 85 \) metros de distancia a una altura de \( 1.2 \) metros, el ángulo de elevación medido de la parte superior de la torre es \( 20^{\circ}30' \). Calcula la altura de la torre. Redondea el resultado a dos decimales.}
{\( 32.98\,\mathrm{m} \)}{\( 31.78\,\mathrm{m} \)}{\( 31.44\,\mathrm{m} \)}{\( 32.64\,\mathrm{m} \)}{}{}}
\End
...
\LANGen{
\Question{
An artillery battery is placed on a cliff. From the edge of the cliff \( 200\,\mathrm{m} \) high, the angle of depression to the ship on the sea is \( 10^{\circ} \). What is the distance \( d \) from the battery to the ship? Round the result to two decimal places.}
...
\LANGes{
\Question{
En la cima de una montaña hay una cabaña. Desde nuestro sitio \( P \), que está a \( 2\,\mathrm{km} \) en línea recta, podemos observar la cabaña bajo el ángulo de elevación de \( 30^{\circ} \). ¿Cuántos metros de altitud tenemos que superar para llegar a la cabaña?}
{\( 1000\,\mathrm{m} \)}{\( 1732\,\mathrm{m} \)}{\( 2\,\mathrm{km} \)}{\( 1155\,\mathrm{m} \)}{}{}}
\End
...
\LANGes{
\Question{
¿Cuál es la diferencia de altitud entre dos estaciones del teleférico si su pendiente es \( 30^{\circ} \) y la distancia entre las dos estaciones mide \( 1500\,\mathrm{m} \)?}
{\( 750\,\mathrm{m} \)}{\( 1299\,\mathrm{m} \)}{\( 866\,\mathrm{m} \)}{\( 890\,\mathrm{m} \)}{}{}}
\End
...
\LANGes{
\Question{
La imagen representa un cuadrado inscrito en un triángulo equilátero con el lado que mide \( 4\,\mathrm{cm} \). Calcula la longitud del lado del cuadrado. Redondea el resultado a dos decimales.}
{\( 1.86\,\mathrm{cm} \)}{\( 2.14\,\mathrm{cm} \)}{\( 3.12\,\mathrm{cm} \)}{\( 4.61\,\mathrm{cm} \)}{}{}}
\End
...
\Data\ID{1103076903}
\Updated{2020-11-12 12:11:21}
\Level{B}
\SubArea{Triangles}
\IMG{1103076903.pdf}
\LANGen{
\Question{
Which of the following formulas applies to the triangle \( ABC \)?}
...
\LANGes{
\Question{
En un triángulo isósceles \( ABC \), con la base \( AB = 6\,\mathrm{cm} \), el ángulo \( ABC \) mide \( 20^{\circ} \). La bisectriz angular del ángulo \( BAC \) se corta con el lado \( BC \) en el punto \( K \). Halla la longitud del segmento \( BK \). Redondea el resultado a dos decimales.}
{\( 2.08\,\mathrm{cm} \)}{\( 5.64\,\mathrm{cm} \)}{\( 2.05\,\mathrm{cm} \)}{\( 2.18\,\mathrm{cm} \)}{}{}}
\End
...
\LANGes{
\Question{
Dado el triángulo \( ABC \), con los lados \( a=15\,\mathrm{cm} \), \( b=6\,\mathrm{cm} \) y la medida del ángulo \( CAB \) es \( 120^{\circ} \). ¿Cuál de los siguientes números da la medida más precisa posible del ángulo \( ABC \)?}
{\( 20.27^{\circ} \)}{\( 25.66^{\circ} \)}{\( 60^{\circ} \)}{\( 30^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
Dado el triángulo \( ABC \), \( a:b=1:2 \) y la medida del ángulo \( BAC \) es \( 30^{\circ} \). Calcula la medida del ángulo interior más pequeño del triángulo.}
{\( 30^{\circ} \)}{\( 20^{\circ} \)}{\( 10^{\circ} \)}{\( 90^{\circ} \)}{}{}}
\End
...
\LANGen{
\Question{
The angles \( \alpha \), \(\beta \), \( \gamma \) of a right-angled triangle \( ABC \) are in the ratio \( 1:2:3 \). From the following ratios of sides select the one that is equal to \( \sqrt3:1 \).}
{\( b:a \)}{\( a:b \)}{\( c:b \)}{\( c:a \)}{}{}}
\LANGpl{
\Question{
...
\LANGes{
\Question{
Dado el triángulo \( ABC \) con \( a=1\,\mathrm{cm} \) y \( b = \sqrt3\,\mathrm{cm} \). El ángulo opuesto al lado más largo es el doble del ángulo opuesto al lado más corto. Calcula el área del triángulo.}
{\( \frac{\sqrt3}2\,\mathrm{cm}^2 \)}{\( 2\sqrt3\,\mathrm{cm}^2 \)}{\( \sqrt3\,\mathrm{cm}^2 \)}{\( \frac{\sqrt3}4\,\mathrm{cm}^2 \)}{}{}}
\End
...
\LANGen{
\Question{
The angle of elevation of the road is \(3^{\circ }30'\).
The distance between two places (measured along the road) is
\(2\, \mathrm{km}\). Find
the difference in altitudes (i.e. the vertical distance) for these places and round to the
nearest meters.}
...
\LANGes{
\Question{
Observamos un árbol, que mide \(12\, \mathrm{m}\), desde el lugar horizontal con la base del árbol. El ángulo de elevación es \(10^{\circ }\). ¿A qué distancia estamos del árbol? Expresa el resultado en metros.}
{\(68\, \mathrm{m}\)}{\(2\, \mathrm{m}\)}{\(12\, \mathrm{m}\)}{\(48\, \mathrm{m}\)}{}{}}
\End
...
\LANGen{
\Question{
A roof gable has the shape of an isosceles triangle (triangle having two sides of equal length)
with the base \(14\, \mathrm{m}\).
The angle between the roof and the horizontal direction is
\(31^{\circ }\). Find
the height of the gable and round your answer to the nearest decimals of meters.}
...
\LANGes{
\Question{
Un frontón del techo tiene una forma del triángulo isósceles con la base de \(14\, \mathrm{m}\).
El ángulo entre el techo y el plano horizontal mide \(31^{\circ }\). Halla la altura del frontón del techo y redondea el resultado a los decimales de metros.}
{\(4.2\, \mathrm{m}\)}{\(5.9\, \mathrm{m}\)}{\(3.6\, \mathrm{m}\)}{\(11.2\, \mathrm{m}\)}{}{}}
\End
...
\LANGes{
\Question{
El ángulo con que los rayos solares caen sobre la Tierra mide \(53^{\circ }22'\). Una columna eléctrica cerca de la carretera proyecta una sombra de \(4.5\, \mathrm{m}\). Calcula la altura de la columna y expresa el resultado en metros.}
{\(6\, \mathrm{m}\)}{\(3\, \mathrm{m}\)}{\(4\, \mathrm{m}\)}{\(5\, \mathrm{m}\)}{}{}}
\End
...
\LANGes{
\Question{
Dos fuerzas actúan sobre el cuerpo en un punto. La fuerza \(F_{1} = 760\, \mathrm{N}\) actúa horizontalmente de la izquiera a la derecha y la fuerza \(F_{2} = 28.8\, \mathrm{N}\) actúa verticalmente de arriba hacia abajo. Calcula la medida del ángulo entre la dirección horizontal y la dirección de la fueza resultante y redondea el resultado a los grados y minutos más cercanos.}
{\(2^{\circ }10'\)}{\(3^{\circ }10'\)}{\(2^{\circ }20'\)}{\(3^{\circ }20'\)}{}{}}
\End
...
\LANGen{
\Question{
Given a right triangle \(ABC\) (see the picture). Find the valid relation between the angles and the sides of the triangle.}
{\(\cos \beta = \frac{a} 
{c}\)}{\(\cos \beta = \frac{b} 
...
\LANGes{
\Question{
Un observador observaba un avión que se aproximaba volando, a una altura de \( 3000\,\mathrm{m} \), en línea recta con una velocidad constante.  En el primer momento, el observador vio que el avión estaba en un ángulo de elevación de \( 25^{\circ} \). Después de \( 10 \) segundos, el ángulo de elevación cambió a \( 35^{\circ} \). Calcula la velocidad del avión. Redondea el resultado a las unidades.}
{\( 215\,\mathrm{m}\cdot\mathrm{s}^{-1} \)}{\( 2149\,\mathrm{m}\cdot\mathrm{s}^{-1} \)}{\( 6576\,\mathrm{m}\cdot\mathrm{s}^{-1} \)}{\( 658\,\mathrm{m}\cdot\mathrm{s}^{-1} \)}{}{}}
\End
...
\LANGes{
\Question{
Desde la ventana más alta del castillo de Orava, los ángulos de depresión a las orillas del río Orava son \( 60^{\circ} \) y \( 20^{\circ} \). La altura de la ventana sobre el río es \( 50\,\mathrm{m} \). ¿Cuál es el ancho del río?}
{\( 108.5\,\mathrm{m} \)}{\( 137.4\,\mathrm{m} \)}{\( 100.5\,\mathrm{m} \)}{\( 125.4\,\mathrm{m} \)}{}{}}
\End
...
\LANGes{
\Question{
La distancia entre los sitios \( A \) y \( C \) en línea recta es \( 300\,\mathrm{m} \). Hay un globo \( B \) sobre el camino entre los sitios \( A \) y \( C \). Mira la imagen. Los ángulos de elevación desde los sitios \( A \) y \( C \) hacia el globo \( B \) son \( 20^{\circ} \) y \( 40^{\circ} \) respectivamente. ¿Cuál es la altura \( h \) del globo?}
{\( 76\,\mathrm{m} \)}{\( 168\,\mathrm{m} \)}{\( 488\,\mathrm{m} \)}{\( 523\,\mathrm{m} \)}{}{}}
\End
...
\LANGes{
\Question{
Una barra larga de \(3\, \mathrm{m}\) está inclinada con respecto al ojo del observador: un extremo está en la distancia de
\(20\, \mathrm{m}\) y el otro de \(18\, \mathrm{m}\).
Halla el ángulo visual de la barra (el ángulo entre las líneas que conectan el ojo del observador con los extremos de la barra) y redondea el resultado a los grados.}
{\(7^{\circ }\)}{\(3^{\circ }\)}{\(45^{\circ }\)}{\(83^{\circ }\)}{}{}}
\End
...
\LANGes{
\Question{
Tres fuerzas actúan sobre el mismo cuerpo en el mismo punto y la fuerza total sobre el cuerpo es cero (las fuerzas se cancelan). Las dos primeras fuerzas miden
...
\LANGes{
\Question{
Tres fuerzas \(F_{1}\), \(F_{2}\) y \(F_{3}\) actúan sobre el mismo cuerpo en el mismo punto y la fuerza total sobre ele cuerpo es cero (las fuerzas se cancelan). Las dos primeras fuerzas miden \(F_{1} = 8\, \mathrm{N}\) y \(F_{2} = 10\, \mathrm{N}\) y el ángulo entre \(F_{1}\) y \(F_{2}\) mide \(55^{\circ }\). Halla el ángulo entre \(F_{3}\) y \(F_{1}\). Redondea el resultado a los grados más cercanos.}
{\(149^{\circ }\)}{\(125^{\circ }\)}{\(55^{\circ }\)}{\(30^{\circ }\)}{}{}}
\End
...
\LANGes{
\Question{
Dos caminos rectos salen del poste indicador \(R\) y forman un ángulo \(52^{\circ }18'\). En uno de los caminos a distancia de \(250\, \mathrm{m}\) 
desde el poste indicador \(R\) hay un sitio \(A\), en otro camino a distancia de \(380\, \mathrm{m}\) 
desde el poste indicador \(R\) hay un sitio \(B\). Calcula la distancia entre los sitios \(A\) y \(B\) (es decir, el segmento \(AB\)). Redondea el resultado a metros.}
{\(301\, \mathrm{m}\)}{\(411\, \mathrm{m}\)}{\(568\, \mathrm{m}\)}{\(629\, \mathrm{m}\)}{}{}}
\End
...
\LANGes{
\Question{
En un parque hay tres paneles de información \(A\), \(B\) y \(C\). La distancia directa entre \(B\) y \(C\) es \(150\, \mathrm{m}\). El ángulo visual de esta distancia desde el panel \(A\) es \(55^{\circ }\). El ángulo visual de la distancia \(AC\) desde el panel \(B\) es \(39^{\circ }\). Clacula la distancia directa entre los paneles \(A\) y \(B\) y redondea el resultado a los metros más cercanos.}
{\(183\, \mathrm{m}\)}{\(147\, \mathrm{m}\)}{\(195\, \mathrm{m}\)}{\(218\, \mathrm{m}\)}{}{}}
\End
...
\LANGes{
\Question{
El centro de un globo esférico está a una altura de \(500\, \mathrm{m}\). El ángulo visual del globo mide \(1^{\circ }30'\). El ángulo de elevación del centro del globo mide \(42^{\circ }50'\). Calcula el diámetro del globo en metros y redondea el resultado al decimal más cercano.}
{\(19.3\, \mathrm{m}\)}{\(18.2\, \mathrm{m}\)}{\(18.9\, \mathrm{m}\)}{\(19.5\, \mathrm{m}\)}{}{}}
\End
...
\LANGes{
\Question{
El punto \(A\) se sitúa \(20\, \mathrm{cm}\) desde el espejo y el punto \(B\) se sitúa \(50\, \mathrm{cm}\) desde le mismo espejo. La distancia directa entre \(A\) y
...
\LANGes{
\Question{
Se observa una torre desde los lugares \(A\) y \(B\). La distancia directa entre \(A\) y \(B\) es \(65\, \mathrm{m}\). Si denotamos la parte inferior de la torre por \(C\), obtenemos un triángulo \(ABC\) en el que la medida de \(\measuredangle CAB \) es \(71^{\circ }\) y al medida de \(\measuredangle ABC \) es \( 34^{\circ }\). Desde el punto \(A\) el ángulo de elevación de la parte superior de la torre es \(40^{\circ }18'\). Halla la altura de la torre. Suponemos que \(A\), \(B\) y \(C\) tienen la misma altitud. Redondea el resultado a los metros más cercanos.}
{\(32\, \mathrm{m}\)}{\(30\, \mathrm{m}\)}{\(35\, \mathrm{m}\)}{\(38\, \mathrm{m}\)}{}{}}
\End
...
\LANGes{
\Question{
El ortoedro está en un plano inclinado (mira la imagen). El ángulo de la pendiente es \(\alpha \). Las fuerzas que actúan sobre el ortoedro son la fuerza de gravedad \(\vec{F_{G}}\) y la fricción \(\vec{F_{t}}\). La fuerza de gravedad se puede reemplazar por dos componentes \(\vec{F_{1}}\) y \(\vec{F_{n}}\). (La fuerza \(\vec{F_{1}}\) es paralela a la pendiente y \(\vec{F_{n}}\) es perpendicular a la pendiente.) La fricción \(F_{t}\) viene dada por la fórmula \(F_{t} = fF_{n}\), donde \(f\) es el coeficiente de la fricción. ¿Cuál es la influencia del ángulo creciente \(\alpha \) en las fuerzas que actúan sobre el ortoedro?}
{\(F_{1}\) se hace mayor y \(F_{t}\) 
se hace menor}{tanto \(F_{1}\) 
como \(F_{t}\) 
se hacen menores}{\(F_{1}\) se hace mayor, \(F_{t}\) 
no se cambia}{\(F_{1}\) se hace menor, \(F_{t}\) 
no se cambia}{tanto \(F_{1}\) 
como \(F_{t}\) 
se hacen mayores}{\(F_{1}\)se hace menor y \(F_{t}\) 
se hace mayor}}
\End
...
\LANGes{
\Question{
El ortoedro está en un plano inclinado (mira la imagen).  El ángulo de la pendiente es
\(\alpha \).
...
corresponding \(\alpha \).}
{\(\alpha \ \dot{ =}\ 20^{\circ }\)}{\(\alpha \ \dot{ =}\ 21^{\circ }\)}{\(\alpha \ \dot{ =}\ 69^{\circ }\)}{\(\alpha \ \dot{ =}\ 70^{\circ }\)}{\(\alpha \ \dot{ =}\ 30^{\circ }\)}{\(\alpha \ \dot{ =}\ 29^{\circ }\)}}
\LANGpl{
\Question{
Pudełko znajduje się na równi pochyłej o kącie nachylenia \( \alpha \) (jak na zdjęciu). Siły działające na pudełko to siła grawitacji \(\vec{F_{G}}\) i tarcia \(\vec{F_{t}}\). Siłę grawitacji można zastąpić dwoma składowymi  \(\vec{F_{1}}\) i 
...
Tíhové zrychlení \(g\ \dot{ =}\ 10\, \mathrm{m\, s^{-2}}\). Kvádr se bude pohybovat po nakloněné rovině se zrychlením o velikosti:}
{\(a = \frac{5\sqrt{2}} 
 {2} \, \mathrm{m\, s^{-2}}\)}{\(a = 5\sqrt{2}\, \mathrm{m\, s^{-2}}\)}{\(a = 5\sqrt{3}\, \mathrm{m\, s^{-2}}\)}{\(a = 0\, \mathrm{m\, s^{-2}}\)}{\(a = 5\, \mathrm{m\, s^{-2}}\)}{\(a = \frac{5\sqrt{3}} 
 {2} \, \mathrm{m\, s^{-2}}\)}}
\LANGsk{
...
Gravitačné zrýchlenie \(g\ \dot{ =}\ 10\, \mathrm{m\, s^{-2}}\). Kváder sa bude pohybovať po naklonenej rovine so zrýchlením o veľkosti:}
{\(a = \frac{5\sqrt{2}} 
 {2} \, \mathrm{m\, s^{-2}}\)}{\(a = 5\sqrt{2}\, \mathrm{m\, s^{-2}}\)}{\(a = 5\sqrt{3}\, \mathrm{m\, s^{-2}}\)}{\(a = 0\, \mathrm{m\, s^{-2}}\)}{\(a = 5\, \mathrm{m\, s^{-2}}\)}{\(a = \frac{5\sqrt{3}} 
 {2} \, \mathrm{m\, s^{-2}}\)}}
\LANGes{
...
{\(\alpha \ \dot{ =}\ 25^{\circ }\)}{\(\alpha \ \dot{ =}\ 15^{\circ }\)}{\(\alpha \ \dot{ =}\ 20^{\circ }\)}{\(\alpha \ \dot{ =}\ 65^{\circ }\)}{\(\alpha \ \dot{ =}\ 28^{\circ }\)}{\(\alpha \ \dot{ =}\ 62^{\circ }\)}}
\LANGpl{
\Question{
Pudełko znajduje się na równi pochyłej o kącie nachylenia \( \alpha \) (jak na zdjęciu). Siły działające na pudełko to siła grawitacji \(\vec{F_{G}}\) i tarcia \(\vec{F_{t}}\). Siłę grawitacji można zastąpić dwoma składowymi  \(\vec{F_{1}}\) i 
...
Tíhové zrychlení \(g\ \dot{ =}\ 10\, \mathrm{m\, s^{-2}}\). Při jakém úhlu \(\alpha \) 
...
Gravitačné zrýchlenie \(g\ \dot{ =}\ 10\, \mathrm{m\, s^{-2}}\). Pri akom uhle \(\alpha \) 
...
\(\vec{F_{1}}\) y
\(\vec{F_{n}}\). (La fuerza
\(\vec{F_{1}}\) es paralela a la pendiente y \(\vec{F_{n}}\) es perpendicular a la pendiente). La fricción \(F_{t}\) viene dada por la fórmula \(F_{t} = fF_{n}\). El coeficiente de la fricción es \(f = 0.47\).
Consideramos la aceleración estándar de la gravedad
...
\(g\ \dot{ =}\ 10\, \mathrm{m\, s^{-2}}\). Jak velký musí být součinitel smykového tření
\(f\), aby
...
\(g\ \dot{ =}\ 10\, \mathrm{m\, s^{-2}}\). Aký veľký musí byť súčiniteľ šmykového trenia
\(f\), aby
sa kváder nepohyboval zrýchlene? Musel by byť aspoň:}
{\(f = 0{,}75\)}{\(f = 0{,}6\)}{\(f = 0{,}65\)}{\(f = 0{,}7\)}{\(f = 0{,}55\)}{\(f = 0{,}8\)}}
\LANGes{
\Question{
El ortoedro está en un plano inclinado (mira la imagen). La longitud del plano inclunado es
...
donde \(f\) 
es el coeficiente de la fricción. Consideramos la aceleración estándar de la gravedad
\(g = 10\, \mathrm{m\, s^{-2}}\). Halla el valor mínimo para el coeficiente de la fricción
...
\LANGes{
\Question{
Es posible usar triángulos similares para estimar la distancia desde un objeto distante de un ancho dado. Considera una puerta del ancho de \(85\, \mathrm{cm}\). Un hombre se encuentra a una distancia desconocida de la puerta y tiene un lápiz delgado verticalmente en su mano en la distancia de \(35\, \mathrm{cm}\) desde su cara. Si cierra el ojo izquierdo, el ojo derecho, el lápiz y la parte izquierda de la puerta están en una línea. Si cierra el ojo derecho, el ojo izquierdo, el lápiz y la parte derecha de la puerta también están en una línea. Suponiendo que la distancia entre sus ojos es \(6\, \mathrm{cm}\), estima la distancia desde el hombre hasta la puerta. Expresa el resultado en metros y redóndealo a un decimal.}
{\(5.3\, \mathrm{m}\)}{\(5.0\, \mathrm{m}\)}{\(0.5\, \mathrm{m}\)}{\(4.5\, \mathrm{m}\)}{}{}}
\End
...
\LANGes{
\Question{
Un mástil de radio alto está atado por varios cables. Cada cable mide
\(30\, \mathrm{m}\) y todos
están atados \(2\, \mathrm{m}\) 
bajo el punto superior del mástil. El segundo extremo del cable está anclado al suelo. El cable está en la altura de \(6\, \mathrm{m}\) 
si se mide directamente sobre el punto que está en la distancia de
\(8\, \mathrm{m}\) desde el punto donde el cable está anclado al suelo. Halla la altura del mástil.}
{\(20\, \mathrm{m}\)}{\(24\, \mathrm{m}\)}{\(22.5\, \mathrm{m}\)}{\(24.5\, \mathrm{m}\)}{}{}}
\End
...
\LANGes{
\Question{
Una fuerza que actúa sobre un cuerpo por la gravedad es
\(1\: 800\, \mathrm{N}\). Este cuerpo lo tenemos que levantar a la altura de \(50\, \mathrm{cm}\) 
usando un plano inclinado. La fuerza máxima que se puede usar para levantar el cuerpo es
\(600\, \mathrm{N}\).
Omite la fricción y halla la longitud mínima de la pendiente requerida para lograr esta tarea.}
{\(\frac{3}
{2}\, \mathrm{m}\)}{\(\frac{2}
{3}\, \mathrm{m}\)}{\(\frac{1}
{6}\, \mathrm{m}\)}{\(\frac{20}
...
y \(F'\) son puntos focales de la lente. La distancia desde la lente a cada uno de los focos es
\(20\, \mathrm{cm}\). La altura del objeto \(y\) es
\(25\, \, \mathrm{cm}\) y está en una distancia de \(50\, \mathrm{cm}\) 
...
\LANGen{
\Question{
A man of height \(180\, \mathrm{cm}\) casts
a \(200\, \mathrm{cm}\) shadow. A tree of an
unknown height casts a \(35\, \mathrm{m}\) 
long shadow at the same time. Find the height of the tree.}
{\(\frac{63}
 {2} \, \mathrm{m}\)}{\(\frac{350}
 {9} \, \mathrm{m}\)}{\(\frac{72}
 {7} \, \mathrm{m}\)}{\(\frac{36}
...
\LANGes{
\Question{
Un hombre que mide \(180\, \mathrm{cm}\) refleja una sombra de \(200\, \mathrm{cm}\). Un árbol de una altura desconocida refleja una sombra de \(35\, \mathrm{m}\). Calcula la altura del árbol.}
{\(\frac{63}
 {2} \, \mathrm{m}\)}{\(\frac{350}
 {9} \, \mathrm{m}\)}{\(\frac{72}
 {7} \, \mathrm{m}\)}{\(\frac{36}
...
\LANGes{
\Question{
Hay un péndulo constituido por una cuerda de la longitud \(l\) y un cuerpo que se desplaza de su equilibrio. La fuerza que por la gravedad actúa sobre el cuerpo es \(F_{g} = 20\, \mathrm{N}\). El cuerpo está un \(h = 10\, \mathrm{cm}\) más alto en la posición desplazada (comparando con la posición de equilibrio). La tensión en la cuerda en la posición desplazada es \(F_{1} = 12\, \mathrm{N}\). Halla la longitud de la cuerda \(l\). Sugerencia: Usando un paralelogramo, la fuerza de gravedad sobre el cuerpo puede descomponerse en una fuerza \(F_{1}\) en la dirección de la cuerda y \(F_{2}\) en la dirección perpendicular.}
{\(25\, \mathrm{cm}\)}{\(25\, \mathrm{m}\)}{\(6\, \mathrm{cm}\)}{\(16\frac{2}
{3}\, \mathrm{cm}\)}{}{}}
\End
...
\LANGes{
\Question{
Un soporte de hierro tiene una forma del triángulo rectángulo
\(ABC\) con el cateto
\(AB\) que mide
