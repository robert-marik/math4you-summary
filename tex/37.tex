...
\LANGcs{
\Question{
Které reálné číslo je třeba doplnit do rámečku, aby rovnice měla kořen  \(x = 2\)?
\[-x+10= \fbox{$\phantom{5}$} \cdot x-6 \]}
{\( 7 \)}{\( 8 \)}{\( 2 \)}{\( 6 \)}{}{}}
\LANGsk{
\Question{
...
\LANGcs{
\Question{
Které reálné číslo je třeba doplnit do rámečku, aby rovnice měla kořen  \(x = 0\)?
\[-3x+10= \fbox{$\phantom{5}$}+2x \]}
{\( 10 \)}{\( 5 \)}{\( -10 \)}{\( 0 \)}{}{}}
\LANGsk{
\Question{
...
{such a number does not exist}{any real number}{\( 16 \)}{\( -4 \)}{}{}}
\LANGpl{
\Question{
Znajdź brakującą liczbę rzeczywistą, tak aby podane równanie miało rozwiązanie \(x = 0\).
\[-3x+10= \fbox{$\phantom{5}$}\cdot x-6 \]}
{taka liczba nie istnieje}{każda liczba rzeczywista}{\( 16 \)}{\( -4 \)}{}{}}
\LANGcs{
\Question{
Které reálné číslo je třeba doplnit do rámečku, aby rovnice měla kořen  \(x = 0\)?
\[-3x+10= \fbox{$\phantom{5}$}\cdot x-6 \]}
{takové číslo neexistuje}{libovolné reálné číslo}{\( 16 \)}{\( -4 \)}{}{}}
\LANGsk{
\Question{
Ktoré reálne číslo treba doplniť do rámčeka, aby rovnica mala koreň \(x = 0\)?
\[-3x+10= \fbox{$\phantom{5}$}\cdot x-6 \]}
{také číslo neexistuje}{ľubovoľné reálne číslo}{\( 16 \)}{\( -4 \)}{}{}}
\LANGes{
\Question{
¿Cuál de los siguientes números reales hay que colocar en el cuadr para que la solución de la ecuación dada sea \(x = 0\)?
\[-3x+10= \fbox{$\phantom{5}$}\cdot x-6 \]}
{No hay ningún número natural así}{Cualquier número real}{\( 16 \)}{\( -4 \)}{}{}}
\End

\Data\ID{2000002305}
\Updated{2021-12-26 08:12:36}
\Level{A}
\SubArea{Linear equations and inequalities}
\LANGen{
\Question{
...
\LANGcs{
\Question{
Které reálné číslo je třeba doplnit do rámečku, aby rovnice měla kořen  \(x = 3\)?
\[\frac{2}{3}x-5= \fbox{$\phantom{5}$}\cdot x-1 \]}
{\( -\frac{2}{3} \)}{\( 6 \)}{\( 2 \)}{\( \frac{4}{3} \)}{}{}}
\LANGsk{
\Question{
...
\LANGes{
\Question{
¿Cuál de los siguientes números reales hay que colocar en el cuadro para que la solución de la ecuación dada sea \(x = 3\)?
\[\frac{2}{3}x-5= \fbox{$\phantom{5}$}\cdot x-1 \]}
{\( -\frac{2}{3} \)}{\( 6 \)}{\( 2 \)}{\( \frac{4}{3} \)}{}{}}
\End
...
{\( \left\{\frac52 \right\} \)}{\( \left\{\frac{23}2\right\} \)}{\( \mathbb{R} \)}{\( \emptyset \)}{}{}}
\LANGpl{
\Question{
...
Find the solution set of the following equation.
\[x-3[x-5(x-4)]=10(x-3) \]}
{\( \{10\} \)}{\( \left\{-\frac{10}9\right\} \)}{\( \{-14\} \)}{\( \emptyset \)}{}{}}
\LANGpl{
\Question{
Znajdź zbiór rozwiązań następującego równania.
\[x-3[x-5(x-4)]=10(x-3) \]}
...
Find the solution set of the following equation.
\[(x+3)^2-(2-2x)^2=1-3x^2 \]}
{\( \left\{-\frac27\right\} \)}{\( \{2\} \)}{\( \left\{\frac72\right\} \)}{\( \emptyset \)}{}{}}
\LANGpl{
\Question{
Znajdź zbiór rozwiązań następującego równania.
\[(x+3)^2-(2-2x)^2=1-3x^2 \]}
...
\Level{A}
\SubArea{Linear equations and inequalities}
\IMG{2010015401-figure0.pdf}
\LANGen{
\Question{
Choose the equation whose graphical solution is in the picture.}
{\( \frac12x+2=5-x\)}{\( x+2=-x+5 \)}{\( \frac14x+2=5-x \)}{\( -x+2=5-\frac12x \)}{}{}}
\LANGpl{
\Question{
Wybierz równanie, którego graficzne rozwiązanie przedstawione jest na rysunku.}
{\( \frac12x+2=5-x\)}{\( x+2=-x+5 \)}{\( \frac14x+2=5-x \)}{\( -x+2=5-\frac12x \)}{}{}}
\LANGcs{
\Question{
Vyberte rovnici, jejíž grafické řešení je na obrázku.}
...
\Level{A}
\SubArea{Linear equations and inequalities}
\IMG{2010015401-figure1.pdf}
\LANGen{
\Question{
Choose the equation whose graphical solution is in the picture.}
{\( \frac25x-2=-4x+4\)}{\( \frac52x-2=-4x+4\)}{\( \frac12x-2=-x+4\)}{\( \frac25x-2=-x+4\)}{}{}}
\LANGpl{
\Question{
Wybierz równanie, którego graficzne rozwiązanie przedstawione jest na rysunku.}
{\( \frac25x-2=-4x+4\)}{\( \frac52x-2=-4x+4\)}{\( \frac12x-2=-x+4\)}{\( \frac25x-2=-x+4\)}{}{}}
...
\Level{A}
\SubArea{Linear equations and inequalities}
\IMG{2010015401-figure2.pdf}
\LANGen{
\Question{
Choose the equation whose graphical solution is in the picture.}
{\( -\frac49x+1=\frac29x-2\)}{\( -\frac94x+1=\frac29x-2\)}{\( -\frac49x+1=\frac92x-2\)}{\( -\frac94x+1=\frac92x-2\)}{}{}}
\LANGpl{
\Question{
Wybierz równanie, którego graficzne rozwiązanie przedstawione jest na rysunku.}
{\( -\frac49x+1=\frac29x-2\)}{\( -\frac94x+1=\frac29x-2\)}{\( -\frac49x+1=\frac92x-2\)}{\( -\frac94x+1=\frac92x-2\)}{}{}}
...
Find the solution set of the following equation.
\[2\sqrt2 x-5 =x\sqrt3\]}
{\( \left\{ 2\sqrt2+\sqrt3\right\}\)}{\( \left\{ 2\sqrt2-\sqrt3\right\}\)}{\( \left\{ \sqrt2+\sqrt3\right\}\)}{\( \left\{ \sqrt2-\sqrt3\right\}\)}{}{}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Určete množinu řešení následující rovnice.
\[2\sqrt2 x-5 =x\sqrt3\]}
{\( \left\{ 2\sqrt2+\sqrt3\right\}\)}{\( \left\{ 2\sqrt2-\sqrt3\right\}\)}{\( \left\{ \sqrt2+\sqrt3\right\}\)}{\( \left\{ \sqrt2-\sqrt3\right\}\)}{}{}}
\LANGsk{
\Question{
Určte množinu riešení nasledujúcej rovnice.
\[2\sqrt2 x-5 =x\sqrt3\]}
{\( \left\{ 2\sqrt2+\sqrt3\right\}\)}{\( \left\{ 2\sqrt2-\sqrt3\right\}\)}{\( \left\{ \sqrt2+\sqrt3\right\}\)}{\( \left\{ \sqrt2-\sqrt3\right\}\)}{}{}}
\LANGes{
\Question{
...
{\( \left\{ \sqrt5+2\sqrt{10}\right\}\)}{\( \left\{ \sqrt5-2\sqrt{10}\right\}\)}{\( \left\{ -\sqrt5+\sqrt{10}\right\}\)}{\( \left\{ \sqrt5-\sqrt{10}\right\}\)}{}{}}
\LANGpl{
\Question{
Wskaż zbiór rozwiązań równania.
\[x\sqrt5 -2\sqrt{10}x=-35\]}
...
\LANGen{
\Question{
Identify a picture that shows the correct solution set of the following inequality.  The solution set is marked in red.
...
\LANGes{
\Question{
Elige la imagen donde están todas las soluciones, marcadas en rojo, de la inecuación siguiente.
\[ 2x-\frac{1+4x}4\geq-2 \]}
{}{}{}{}{}{}}
...
-\frac{x}{7} < \frac{5}{7} 
\]}
{\( x \in \mathbb{N} \)}{\( x \in \{0;1;2;3;4\} \)}{\( x \in \{1;2;3;4\} \)}{\( x \in \mathbb{N} \cup \{0;-1;-2;-3;-4\}  \)}{}{}}
\LANGpl{
\Question{
Wyznacz wszystkie liczby naturalne, które są rozwiązaniami nierówności:
\[
-\frac{x}{7} < \frac{5}{7} 
\]}
{\( x \in \mathbb{N} \)}{\( x \in \{0;1;2;3;4\} \)}{\( x \in \{1;2;3;4\} \)}{\( x \in \mathbb{N} \cup \{0;-1;-2;-3;-4\}  \)}{}{}}
\LANGcs{
\Question{
Určete všechna přirozená čísla, která jsou řešením nerovnice:
\[
-\frac{x}{7} < \frac{5}{7} 
\]}
{\( x \in \mathbb{N} \)}{\( x \in \{0;1;2;3;4\} \)}{\( x \in \{1;2;3;4\} \)}{\( x \in \mathbb{N} \cup \{0;-1;-2;-3;-4\}  \)}{}{}}
\LANGsk{
\Question{
Určte všetky prirodzené čísla, ktoré sú riešením nerovnice:
\[
-\frac{x}{7} < \frac{5}{7} 
\]}
{\( x \in \mathbb{N} \)}{\( x \in \{0;1;2;3;4\} \)}{\( x \in \{1;2;3;4\} \)}{\( x \in \mathbb{N} \cup \{0;-1;-2;-3;-4\}  \)}{}{}}
...
\LANGpl{
\Question{
Wyznacz najmniejszą liczbę całkowitą będącą rozwiązaniem nierówności:
\[
-5{,}2x < 1{,}3\]}
{\( 0\)}{\( -1\)}{\( 4\)}{\( 1\)}{}{}}
\LANGcs{
...
\LANGpl{
\Question{
Wyznacz największą liczbę całkowitą będącą rozwiązaniem nierówności:
\[
-0{,}16x > 6{,}4
\]}
{\( -41\)}{\( -39 \)}{\( -40\)}{\( -42\)}{}{}}
\LANGcs{
\Question{
Určete největší celé číslo, které je řešením nerovnice:
\[
-0{,}16x > 6{,}4
\]}
{\( -41\)}{\( -39 \)}{\( -40\)}{\( -42\)}{}{}}
\LANGsk{
\Question{
Určte najväčšie celé číslo, ktoré je riešením nerovnice:
\[
-0{,}16x > 6{,}4
\]}
{\( -41\)}{\( -39 \)}{\( -40\)}{\( -42\)}{}{}}
...
\]}
{\( x \in \{ 1;2;3;4\} \)}{\( x \in \mathbb{N} \)}{\( x \in \{0; 1;2;3;4\} \)}{\( x \in \{ 1;2;3;4;5\} \)}{}{}}
\LANGpl{
\Question{
Wskaż wszystkie liczby naturalne, które są rozwiązaniami nierówności:
\[
-\frac{9}{8} \leq -\frac{x}{4}
\]}
{\( x \in \{ 1;2;3;4\} \)}{\( x \in \mathbb{N} \)}{\( x \in \{0; 1;2;3;4\} \)}{\( x \in \{ 1;2;3;4;5\} \)}{}{}}
...
\]}
{\(x\in \left (-\infty;\infty \right )\)}{\(x\in  (-\infty ;-1]\)}{\(x\in [ -1;\infty )\)}{\( x \in \emptyset\)}{}{}}
\LANGpl{
\Question{
Rozwiąż nierówność:
\[ 
 6 -3\left (2x +4 \right ) \leq 2\left (3-3x\right )
\]}
{\(x\in \left (-\infty;\infty \right )\)}{\(x\in  (-\infty ;-1\rangle\)}{\(x\in \langle -1;\infty )\)}{\( x \in \emptyset\)}{}{}}
\LANGcs{
\Question{
...
\]}
{\( x \in \emptyset\)}{\(x\in  (-\infty ;0) \)}{\(x\in \left (-\infty;\infty \right )\)}{\(x\in (0;\infty )\)}{}{}}
\LANGpl{
\Question{
Rozwiąż nierówność:
\[ 
...
\]}
{\(x\in  [ 3;8] \)}{\(x\in  (-\infty ;3] \)}{\(x\in [ 8;\infty )\)}{\( x \in \mathbb{R}\setminus (3;8)\)}{}{}}
\LANGpl{
\Question{
Rozwiąż układ nierówności dla \(x\in \mathbb{R}\).
\[ 
3 x -1 \leq 2x + 7 \leq 7x-8
\]}
{\(x\in  \langle 3;8\rangle \)}{\(x\in  (-\infty ;3\rangle \)}{\(x\in \langle 8;\infty )\)}{\( x \in \mathbb{R}\setminus (3;8)\)}{}{}}
\LANGcs{
\Question{
Pro \(x\in \mathbb{R}\)
...
{\( 0\cdot x < 4 \)}{\( 0\cdot x < -4\)}{\( 0\cdot x > 4 \)}{\( 2\cdot x > -4 \)}{}{}}
\LANGpl{
\Question{
...
(x+3)^2-1+3x^2 >(2-2x)^2
\]}
{\(\left( -\frac27;\infty\right)\)}{\(\left( \frac27;\infty\right)\)}{\(\left( -\infty;\frac27 \right)\)}{\(\left( -\infty;-\frac27\right)\)}{}{}}
\LANGpl{
\Question{
Rozwiąż nierówność dla \(x\in \mathbb{R}\). 
\[ 
(x+3)^2-1+3x^2 >(2-2x)^2
\]}
{\(\left( -\frac27;\infty\right)\)}{\(\left( \frac27;\infty\right)\)}{\(\left( -\infty;\frac27 \right)\)}{\(\left( -\infty;-\frac27\right)\)}{}{}}
...
\]}
{\(\mathbb{R}\)}{\(\emptyset \)}{\([ 0;8]\)}{\([ -8;0]\)}{}{}}
\LANGpl{
\Question{
Dla \(x\in \mathbb{R}\), wyznacz zbiór rozwiązań następującej nierówności. 
\[ 
(x-2)^2+(2+x)^2 \leq 8+2x^2
\]}
{\(\mathbb{R}\)}{\(\emptyset \)}{\(\langle 0;8\rangle\)}{\(\langle -8;0\rangle\)}{}{}}
\LANGcs{
\Question{
Pro \(x\in \mathbb{R}\)
určete množinu řešení následující nerovnice:
...
\Level{B}
\SubArea{Linear equations and inequalities}
\IMG{2010016201-figure0.pdf}
\LANGen{
\Question{
Find the linear inequality of which the solution set is shown in red in the graph below.}
{\( \frac{x+4}2 > 6-x \)}{\( \frac{x-4}2 > 6-x \)}{\( x+2 \geq 6-x \)}{\( \frac{x+4}2 < 6-x \)}{}{}}
\LANGpl{
\Question{
Znajdź nierówność liniową, dla której zbiór rozwiązań jest pokazany na czerwono na poniższym wykresie.}
{\( \frac{x+4}2 > 6-x \)}{\( \frac{x-4}2 > 6-x \)}{\( x+2 \geq 6-x \)}{\( \frac{x+4}2 < 6-x \)}{}{}}
\LANGcs{
\Question{
Na obrázku jsou červeně vyznačena všechna řešení lineární nerovnice. Vyberte nerovnici, jejíž grafické řešení je na obrázku.}
...
\LANGen{
\Question{
Find the minimal integer which satisfies the following inequality.
\[ 
 3x - 1 \leq 7x-8
\]}
{\( 2 \)}{\( 0 \)}{\(3\)}{\( 1 \)}{}{}}
\LANGpl{
\Question{
Znajdź najmniejszą liczbę całkowitą, która spełnia następującą nierówność.
\[ 
 3x - 1 \leq 7x-8
\]}
{\( 2 \)}{\( 0 \)}{\(3\)}{\( 1 \)}{}{}}
...
\LANGpl{
\Question{
Rozwiąż poniższą nierówność i wybierz diagram, który pokazuje prawidłowy zbiór rozwiązań zaznaczony na czerwono na osi liczbowej.
\[ 
4{,}5-0{,}7x < 1-2{,}1x
\]}
{}{}{}{}{}{}}
...
\IMGanswer{2010016201-figure1_0.pdf}
\IMGanswer{2010016201-figure2.pdf}
\IMGanswer{2010016201-figure3.pdf}
\IMGanswer{2010016201-figure4.pdf}\End
...
\LANGpl{
\Question{
Wskaż rysunek, który pokazuje poprawny zbiór rozwiązań poniższej nierówności. Zbiór rozwiązań jest zaznaczony na czerwono.
\[ 
0{,}5x + 2 < -2x +8
\]}
{}{}{}{}{}{}}
...
\IMGanswer{2010016201-figure5.pdf}
\IMGanswer{2010016201-figure6.pdf}
\IMGanswer{2010016201-figure7.pdf}
\IMGanswer{2010016201-figure8.pdf}\End
...
\IMGanswer{2010016201-figure9.pdf}
\IMGanswer{2010016201-figure10.pdf}
\IMGanswer{2010016201-figure11.pdf}
\IMGanswer{2010016201-figure12.pdf}\End
...
\LANGes{
\Question{
Elige la imagen que representa el conjunto solución, marcado en rojo, de la inecuación siguiente.
\[ 
 \frac{1}
{2}x + 1\leq 3x - 4
\]}
...
\IMGanswer{2010016201-figure13_0.pdf}
\IMGanswer{2010016201-figure14_0.pdf}
\IMGanswer{2010016201-figure15.pdf}
\IMGanswer{2010016201-figure16.pdf}\End
...
{\(33\) years}{\(32.5\) years}{\(39.5\) years}{\(43\) years}{}{}}
\LANGpl{
\Question{
Średnia wieku w grupie sześciu osób to \(48\) lat.  Średnia wieku pierwszych pięciu osób to \(51\) lat. Ile lat ma szósta osoba?}
{\(33\) lata}{\(32{,}5\) lat}{\(39{,}5\) lat}{\(43\) lata}{}{}}
\LANGcs{
\Question{
Průměrný věk ve skupině šesti osob je  \(48\) let. Průměrný věk prvních pěti z nich je  \(51\) let. Kolik let je šestému člověku?}
{\(33\) let}{\(32{,}5\) let}{\(39{,}5\) let}{\(43\) let}{}{}}
\LANGsk{
\Question{
...
{\(33\) rokov}{\(32{,}5\) rokov}{\(39{,}5\) rokov}{\(43\) rokov}{}{}}
\LANGes{
\Question{
La edad promedio de un grupo de seis personas es de \(48\) años. La edad promedio de las primeras cinco personas es de \(51\) años. ¿Cuántos años tiene la sexta persona?}
{\(33\) años}{\(32.5\) años}{\(39.5\) años}{\(43\) años}{}{}}
\End
...
\LANGen{
\Question{
The ratio of ages of a mother and her daughter is \(3: 1\). Ten years ago, the ratio of their ages was \(8 : 1\). How old is the mother today?}
{\(42\) years}{\(32\) years}{\(52\) years}{\(45\) years}{}{}}
\LANGpl{
\Question{
Stosunek wieku matki do córki wynosi \(3: 1\).  Dziesięć lat temu stosunek ich wieku wynosił \(8 : 1\). Ile lat ma dzisiaj matka?}
{\(42\) lata}{\(32\) lata}{\(52\) lata}{\(45\) lat}{}{}}
\LANGcs{
\Question{
Poměr věků matky a dcery je  \(3: 1\). Před deseti lety byl poměr jejich věků  \(8 : 1\). Kolik let je matce dnes?}
{\(42\) let}{\(32\) let}{\(52\) let}{\(45\) let}{}{}}
\LANGsk{
\Question{
Pomer veku matky a dcéry je  \(3: 1\). Pred desiatimi rokmi bol pomer ich veku  \(8 : 1\). Koľko rokov má matka dnes?}
{\(42\) rokov}{\(32\) rokov}{\(52\) rokov}{\(45\) rokov}{}{}}
\LANGes{
\Question{
La edad de una madre y de su hija están en proporción \(3: 1\). Hace diez años sus edades estuvieron en proporción \(8 : 1\). ¿Cuántos años tiene la madre hoy?}
{\(42\) años}{\(32\) años}{\(52\) años}{\(45\) años}{}{}}
\End
