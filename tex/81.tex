...
\LANGes{
\Question{
¿Cuáles de las siguientes proposiciones A, B, C, D, E son correctas?
\[ \begin{aligned}
\text{A: }&  \lim\limits_{x\to1^+}\frac{2x}{x-1}=\infty  \\
\text{B: }&  \lim\limits_{x\to-2^+}\frac{x+1}{x+2}=-\infty \\
\text{C: }&  \lim\limits_{x\to3^-}\frac{x+1}{3-x}=-\infty \\
...
{\( x_1=-1\), \( x_2 = 3 \)}{\( x_1=-1\), \( x_2 = -3 \)}{\( x_1=-1\)}{La función no tiene los puntos de discontinuidad.}{}{}}
\End
...
{\( x_1 = -2 \), \( x_2 = -5 \)}{\( x_1 = 2 \), \( x_2 = 5 \)}{\( x_1 = -2 \)}{La función no tiene los puntos de discontinuidad.}{}{}}
\End

\Data\ID{1003085510}
\Updated{2021-01-31 10:01:40}
\Level{B}
\SubArea{Limits and continuity}
\LANGen{
\Question{
...
{La función no tiene los puntos de discontinuidad.}{\( x_1 = -3 \), \( x_2 = 4 \)}{\( x_1 = -3 \)}{\( x_1 = 3 \), \( x_2 = -4 \)}{}{}}
\End
...
\LANGes{
\Question{
¿Cuáles de las siguientes proposiciones A, B, C, D, E son falsas?
\[ \begin{aligned}
\text{A: } & \lim\limits_{x\to-\infty}\left(3-\frac1x\right)=3 \\
\text{B: } & \lim\limits_{x\to-\infty}\left(x^5-2\right)=\infty \\
\text{C: } & \lim\limits_{x\to-\infty}\left(0.3\cdot2^x\right)=-\infty \\
