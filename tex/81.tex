...
\Data\ID{1003021103}
\Updated{2022-08-25 10:08:16}
\Level{A}
\SubArea{Limits and Continuity of Functions}
\LANGen{
\Question{
...
{\( 2 \)}{\( 1 \)}{\( -1 \)}{This limit does not exist.}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Vypočítajte nasledujúcu limitu. \[ \lim\limits_{x\to-\infty}\left(-x^4+2x-5\right) \]}
{\( -\infty\)}{\( \infty\)}{\( -5\)}{\(0\)}{}{}}
\LANGes{
\Question{
Resuelve el siguiente límite.
...
\Level{A}
\SubArea{Limits and Continuity of Functions}
\IMG{2010012701-figure0.pdf}
\LANGen{
\Question{
Given the graph of the function \( f \), find \( \lim\limits_{x\rightarrow 2}f(x) \).}
{\( 1\)}{\( 4\)}{\( 2\)}{This limit does not exist.}{}{}}
\LANGpl{
\Question{
Dany jest wykres funkcji  \( f \), wyznacz \( \lim\limits_{x\rightarrow 2}f(x) \).}
{\( 1\)}{\( 4\)}{\( 2\)}{Granica nie istnieje.}{}{}}
\LANGcs{
\Question{
Je dán graf funkce \( f \), Určete \( \lim\limits_{x\rightarrow 2}f(x) \).}
{\( 1\)}{\( 4\)}{\( 2\)}{Daná limita neexistuje.}{}{}}
\LANGsk{
\Question{
Je daný graf funkcie \( f \). Určte \( \lim\limits_{x\rightarrow 2}f(x) \).}
{\( 1\)}{\( 4\)}{\( 2\)}{Táto limita neexistuje.}{}{}}
\LANGes{
\Question{
...
g(x)=\begin{cases}
 ...
 \end{cases}
\]}
{This limit does not exist.}{\( 3\)}{\( 2\)}{\( 1\)}{}{}}
\LANGpl{
\Question{
...
g(x)=\begin{cases}
 ...
 \end{cases}
\]}
{Granica nie istnieje.}{\( 3\)}{\( 2\)}{\( 1\)}{}{}}
\LANGcs{
\Question{
Je dána funkce \(g\) (viz obrázek).
Určete \(\lim\limits_{x\to 1}g(x)\).
\[
g(x)=\begin{cases}
 \frac12(x-1)^2+1 & \text{pro } x < 1,\\
 \frac1{x^2}+2 & \text{pro } x \geq 1
 \end{cases}
\]}
{Daná limita neexistuje.}{\( 3\)}{\( 2\)}{\( 1\)}{}{}}
\LANGsk{
\Question{
Daná je funkcia \(g\) (pozri obrázok).
Určte \(\lim\limits_{x\to 1}g(x)\).
\[
g(x)=\begin{cases}
 \frac12(x-1)^2+1 & \text{pre } x < 1,\\
 \frac1{x^2}+2 & \text{pre } x \geq 1
 \end{cases}
\]}
{Daná limita neexistuje.}{\( 3\)}{\( 2\)}{\( 1\)}{}{}}
\LANGes{
...
g(x)=\begin{cases}
 ...
 \end{cases}
\]}
{\(2\)}{\( \infty\)}{\( -\infty\)}{\( 0\)}{This limit does not exist.}{}}
\LANGpl{
\Question{
...
g(x)=\begin{cases}
 ...
 \end{cases}
\]}
{\(2\)}{\( \infty\)}{\( -\infty\)}{\( 0\)}{Granica nie istnieje.}{}}
\LANGcs{
\Question{
Je dána funkce \(g\) (viz obrázek).
Určete \(\lim\limits_{x\to \infty}g(x)\).
\[
g(x)=\begin{cases}
 \frac12(x-1)^2+1 & \text{pro } x < 1,\\
 \frac1{x^2}+2 & \text{pro } x \geq 1
 \end{cases}
\]}
{\(2\)}{\( \infty\)}{\( -\infty\)}{\( 0\)}{Daná limita neexistuje.}{}}
\LANGsk{
\Question{
Daná je funkcia \(g\) (pozri obrázok).
Určte \(\lim\limits_{x\to \infty}g(x)\).
\[
g(x)=\begin{cases}
 \frac12(x-1)^2+1 & \text{pre } x < 1,\\
 \frac1{x^2}+2 & \text{pre } x \geq 1
...
g(x)=\begin{cases}
 ...
 \end{cases}
\]}
{\( \infty\)}{\(- \infty\)}{\(1\)}{\( -2\)}{This limit does not exist.}{}}
\LANGpl{
\Question{
...
g(x)=\begin{cases}
 ...
 \end{cases}
\]}
{\( \infty\)}{\(- \infty\)}{\(1\)}{\( -2\)}{Granica nie istnieje.}{}}
\LANGcs{
\Question{
Je dána funkce \(g\) (viz obrázek).
Určete \(\lim\limits_{x\to -2^{+}}g(x)\).
\[
g(x)=\begin{cases}
 \frac1{x+4}-1 & \text{pro } x< -4,\\
 \frac1{x+2}+1 & \text{pro } x > -2
 \end{cases}
\]}
{\( \infty\)}{\(- \infty\)}{\(1\)}{\( -2\)}{Daná limita neexistuje.}{}}
\LANGsk{
\Question{
Daná je funkcia \(g\) (pozri obrázok).
Určte \(\lim\limits_{x\to -2^{+}}g(x)\).
\[
g(x)=\begin{cases}
 \frac1{x+4}-1 & \text{pre } x< -4,\\
 \frac1{x+2}+1 & \text{pre } x > -2
 \end{cases}
\]}
{\( \infty\)}{\(- \infty\)}{\(1\)}{\( -2\)}{Daná limita neexistuje.}{}}
\LANGes{
...
g(x)=\begin{cases}
 ...
 \end{cases}
\]}
{\(1\)}{\(0\)}{\(\infty \)}{\(-\infty \)}{This limit does not exist.}{}}
\LANGpl{
\Question{
Podano funkcję \(g\),
...
h(x)=\begin{cases}
 ...
 \end{cases}
\]}
{\(\infty \)}{\(1\)}{\(2\)}{\(-\infty \)}{This limit does not exist.}{}}
\LANGpl{
\Question{
Podano funkcję \(h\),
...
\Level{B}
\SubArea{Limits and Continuity of Functions}
\IMG{2010018701-figure0.pdf}
\LANGen{
\Question{
The following pictures show graphs of \(3\) functions. Choose the true statement about the limit at \(x = 3\).}
{The functions \(f\), \(g\), \(h\) have the same limit at \(x = 3\).}{The function \(g\) has no limit at \(x = 3\).}{The function \(f\) has no limit at \(x = 3\).}{The limits of functions \(f\), \(g\), \(h\) at \(x = 3\) differ.}{Only the function \(h\) has a limit at \(x = 3\).}{}}
\LANGpl{
\Question{
Poniższe rysunki przedstawiają wykresy \(3\) funkcji. Wybierz prawdziwe stwierdzenie o granicy w punkcie \(x = 3\).}
{Funkcje \(f\), \(g\), \(h\) mają taką samą granicę w punkcie \(x = 3\).}{Funkcja \(g\) nie ma granicy w punkcie \(x = 3\).}{Funkcja \(f\) nie ma granicy w punkcie \(x = 3\).}{Granice funkcji \(f\), \(g\), \(h\) w punkcie \(x = 3\) różnią się.}{Tylko funkcja \(h\) ma granicę w punkcie \(x = 3\).}{}}
\LANGcs{
\Question{
Na následujících obrázcích jsou grafy \(3\) funkcí. Vyberte pravdivé tvrzení o limitě v bodě \(x = 3\).}
{Funkce \(f\), \(g\), \(h\) mají v bodě \(x = 3\) stejnou limitu.}{Funkce \(g\) nemá v bodě \(x = 3\) limitu.}{Funkce \(f\) nemá v bodě \(x = 3\) limitu.}{Funkce \(f\), \(g\), \(h\) mají v bodě \(x = 3\) navzájem různé limity.}{Pouze funkce \(h\) má v bodě \(x = 3\) limitu.}{}}
\LANGsk{
\Question{
Nasledujúce obrázky predstavujú grafy \(3\) funkcií. Vyberte pravdivé tvrdenie o limite v bode \(x = 3\).}
{Funkcie \(f\), \(g\), \(h\) majú v bode \(x = 3\) rovnakú limitu.}{Funkcia \(g\) nemá v bode \(x = 3\) limitu.}{Funkcia \(f\) nemá v bode \(x = 3\) limitu.}{Limity funkcií \(f\), \(g\), \(h\) sú v bode \(x = 3\) navzájom rôzne.}{Funkcia \(h\) je jediná, ktorá má v bode \(x = 3\) limitu.}{}}
\LANGes{
\Question{
Las siguientes imágenes muestran las gráficas de \(3\) funciones. Elige la afirmación verdadera sobre el límite en \(x = 3\).}
{Las funciones \(f\), \(g\), \(h\) tienen el mismo límite en \(x = 3\).}{La función \(g\) no tiene límite en \(x = 3\).}{La función \(f\) no tiene límite en \(x = 3\).}{Los límites de las funciones \(f\), \(g\), \(h\) en \(x = 3\) son diferentes.}{Solo la función \(h\) tiene límite en \(x = 3\).}{}}
\End
...
{The function has the limit "negative infinity" only at \(x_2\) and at "negative infinity" it has the limit \(a_2\).}{The function has the limit "negative infinity" at \(x_2\) and \(x_3\) and at "negative infinity" it has the limit \(a_2\).}{The function has the limit "negative infinity" only at \(x_2\) and at "negative infinity" there is no limit.}{The function has the limit "negative infinity" at \(x_2\) and \(x_3\) and at "negative infinity" there is no limit.}{}{}}
\LANGpl{
\Question{
...
{Funkcja ma granicę "minus nieskończoność" tylko w punkcie \(x_2\) a w punkcie "minus nieskończoność" ma granicę \(a_2\).}{Funkcja ma granicę "minus nieskończoność" w punktach \(x_2\) i \(x_3\)  i w punkcie "minus nieskończoność" ma granicę \(a_2\).}{Funkcja ma granicę "minus nieskończoność" tylko w punkcie \(x_2\) i nie ma limitu w punkcie "minus nieskończoność".}{Funkcja ma granicę "minus nieskończoność" w punktach \(x_2\) i \(x_3\) i nie ma limitu w punkcie "minus nieskończoność".}{}{}}
\LANGcs{
\Question{
Vyberte pravdivé tvrzení o limitách funkce, jejíž graf je na obrázku. (Poznámka: čárkované čáry jsou asymptotami dané funkce.)}
{Funkce má limitu „mínus nekonečno” pouze v bodě  \(x_2\) a v bodě „mínus nekonečno” má limitu \(a_2\).}{Funkce má limitu „mínus nekonečno” v bodech  \(x_2\) a \(x_3\) a v bodě „mínus nekonečno” má limitu \(a_2\).}{Funkce má limitu „mínus nekonečno” pouze v bodě  \(x_2\) a v bodě „mínus nekonečno” limita neexistuje.}{Funkce má limitu „mínus nekonečno” v bodech  \(x_2\) a \(x_3\) a v bodě „mínus nekonečno” limita neexistuje.}{}{}}
\LANGsk{
\Question{
...
{Funkcia má limitu „mínus nekonečno” len v bode \(x_2\) a v bode „mínus nekonečno” má limitu \(a_2\).}{Funkcia má limitu „mínus nekonečno” v bodoch \(x_2\), \(x_3\) a v bode „mínus nekonečno” má limitu \(a_2\).}{Funkcia má limitu „mínus nekonečno” len v bode \(x_2\) a v bode „mínus nekonečno” limita neexistuje.}{Funkcia má limitu „mínus nekonečno” v bodoch \(x_2\), \(x_3\) a v bode „mínus nekonečno” limita neexistuje.}{}{}}
\LANGes{
\Question{
...
{La función tiene límite "menos infinito" solo en \(x_2\) y en "menos infinito" tiene límite \(a_2\).}{La función tiene límite "menos infinito" en \(x_2\) y \(x_3\) y en "menos infinito" tiene límite \(a_2\).}{La función tiene límite "menos infinito" solo en \(x_2\) y en "menos infinito" no existe el límite.}{La función tiene límite "menos infinito" en \(x_2\) y \(x_3\) y en "menos infinito" no existe el límite.}{}{}}
\End
...
{Only at \(x_1\) and \(x_3\).}{Only at \(x_1\).}{Only at \(x_3\).}{The left-hand and right-hand limit is the same at any marked point.}{}{}}
\LANGpl{
\Question{
...
{Tylko w punktach \(x_1\) i \(x_3\).}{Tylko w punkcie \(x_1\).}{Tylko w punkcie \(x_3\).}{We wszystkich zaznaczonych punktach granica po lewej stronie jest taka sama jak granica po prawej stronie.}{}{}}
\LANGcs{
\Question{
...
{Pouze v bodech \(x_1\) a \(x_3\).}{Pouze v bodě \(x_1\).}{Pouze v bodě \(x_3\).}{Ve všech vyznačených bodech je limita zleva stejná jako limita zprava.}{}{}}
\LANGsk{
\Question{
...
{Len v bodoch \(x_1\) a \(x_3\).}{Len v bode \(x_1\).}{Len v bode \(x_3\).}{Vo všetkých vyznačených bodoch je limita zľava rovnaká, ako limita sprava.}{}{}}
\LANGes{
\Question{
...
{Solo en \(x_1\) y \(x_3\).}{Solo en \(x_1\).}{Solo en \(x_3\).}{El límite por la izquierda y por la derecha coincide en cualquiera de los puntos marcados.}{}{}}
\End

\Data\ID{2010001801}
\Updated{2022-11-01 09:11:07}
\Level{B}
\SubArea{Limits and Continuity of Functions}
\LANGen{
\Question{
Find all points of discontinuity of the function \( f(x)=\frac{x^2-2x-8}{x^2-7x+12} \).}
{\( x_1 = 3\), \( x_2 = 4 \)}{\( x_1 = -3 \), \( x_2 = -4 \)}{\( x_1 = 3 \)}{There is no point of discontinuity.}{}{}}
\LANGpl{
\Question{
Wyznacz wszystkie punkty nieciągłości funkcji \( f(x)=\frac{x^2-2x-8}{x^2-7x+12} \).}
{\( x_1 = 3\), \( x_2 = 4 \)}{\( x_1 = -3 \), \( x_2 = -4 \)}{\( x_1 = 3 \)}{Funkcja \(f\) nie ma punktów  nieciągłości.}{}{}}
\LANGcs{
\Question{
Určete všechny body nespojitosti funkce  \( f(x)=\frac{x^2-2x-8}{x^2-7x+12} \).}
{\( x_1 = 3\), \( x_2 = 4 \)}{\( x_1 = -3 \), \( x_2 = -4 \)}{\( x_1 = 3 \)}{Funkce \(f\) nemá bod nespojitosti.}{}{}}
\LANGsk{
\Question{
Určite všetky body nespojitosti funkcie \( f(x)=\frac{x^2-2x-8}{x^2-7x+12} \).}
{\( x_1 = 3\), \( x_2 = 4 \)}{\( x_1 = -3 \), \( x_2 = -4 \)}{\( x_1 = 3 \)}{Funkcia \(f\) nemá body nespojitosti.}{}{}}
\LANGes{
\Question{
Halla todos los puntos de discontinuidad de la función \( f(x)=\frac{x^2-2x-8}{x^2-7x+12} \).}
{\( x_1 = 3\), \( x_2 = 4 \)}{\( x_1 = -3 \), \( x_2 = -4 \)}{\( x_1 = 3 \)}{La función no tiene puntos de discontinuidad.}{}{}}
\End

\Data\ID{2010001802}
\Updated{2022-11-01 09:11:47}
\Level{B}
\SubArea{Limits and Continuity of Functions}
\LANGen{
\Question{
Find all points of discontinuity of the function \( f(x)=\frac{9-x^2}{x^2+2x+3} \).}
{There is no point of discontinuity.}{\( x_1 = 1\), \( x_2 =3 \)}{\( x_1 = -1\), \( x_2 = -3 \)}{\( x_1 = 1\)}{}{}}
\LANGpl{
\Question{
Wyznacz wszystkie punkty nieciągłości funkcji \( f(x)=\frac{9-x^2}{x^2+2x+3} \).}
{Funkcja \(f\) nie ma punktów  nieciągłości.}{\( x_1 = 1\), \( x_2 =3 \)}{\( x_1 = -1\), \( x_2 = -3 \)}{\( x_1 = 1\)}{}{}}
\LANGcs{
\Question{
Určete všechny body nespojitosti funkce  \( f(x)=\frac{9-x^2}{x^2+2x+3} \).}
{Funkce \(f\) nemá bod nespojitosti.}{\( x_1 = 1\), \( x_2 =3 \)}{\( x_1 = -1\), \( x_2 = -3 \)}{\( x_1 = 1\)}{}{}}
\LANGsk{
\Question{
Určite všetky body nespojitosti funkcie \( f(x)=\frac{9-x^2}{x^2+2x+3} \).}
{Funkcia \(f\) nemá body nespojitosti.}{\( x_1 = 1\), \( x_2 =3 \)}{\( x_1 = -1\), \( x_2 = -3 \)}{\( x_1 = 1\)}{}{}}
\LANGes{
\Question{
Halla todos los puntos de discontinuidad de la función \( f(x)=\frac{9-x^2}{x^2+2x+3} \).}
{La función no tiene puntos de discontinuidad.}{\( x_1 = 1\), \( x_2 =3 \)}{\( x_1 = -1\), \( x_2 = -3 \)}{\( x_1 = 1\)}{}{}}
\End
