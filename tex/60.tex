...
\LANGen{
\Question{
A triangle is inscribed in the circle. Its vertices divide the circle into three arcs whose lengths are in the ratio \( 2:4:9 \). Determine the measures of the interior angles of the triangle.}
...
\LANGen{
\Question{
What is the measure of the angle contained by two line segments: first  joining  numbers \( 8 \) and \( 11 \), and second joining numbers \( 11 \) and \( 2 \), on a clock face?  (See the picture.)}
...
\LANGes{
\Question{
¿Cuál es la medida del ángulo formado por dos segmentos: el primer segmento marcado  por \( 8 \) y \( 11 \), y el segundo marcado por \( 11 \) y \( 2 \) en un reloj?  (Mira la imagen).}
{\( 90^{\circ} \)}{\( 100^{\circ} \)}{\( 80^{\circ} \)}{\( 70^{\circ} \)}{}{}}
\End
...
\LANGen{
\Question{
Determine the measure of the angle contained by two line segments: first joining numbers \( 7 \) and \( 1 \), and second joining numbers \( 1 \) and \( 4 \), on a clock face. (See the picture.)}
...
\LANGes{
\Question{
¿Cuál es la medida del ángulo formado por dos segmentos: el primer segmento marcado por \( 7 \) y \( 1 \), y el segundo marcado por \( 1 \) y \( 4 \) en un reloj? (Mira la imagen).}
{\( 45^{\circ} \)}{\( 60^{\circ} \)}{\( 30^{\circ} \)}{\( 90^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
¿Cuál es la medida del ángulo formado por dos segmentos: el primer segmento marcado por \( 7 \) y \( 8 \), y el segundo marcado por \( 8 \), \( 10 \) en un reloj? (Mira la imagen).}
{\( 135^{\circ} \)}{\( 90^{\circ} \)}{\( 45^{\circ} \)}{\( 120^{\circ} \)}{}{}}
\End
...
\LANGen{
\Question{
Give the measure of the angle between two line segments: first connecting  numbers \( 7 \) and \( 11 \), second connecting numbers \( 3 \) and \( 10 \) on a clock face. (See the picture.)}
...
\LANGes{
\Question{
¿Cuál es la medida del ángulo formado por dos segmentos: el primer segmento marcado por \( 7 \) y \( 11 \), y el segundo marcado por \( 3 \) y \( 10 \) en un reloj? (Mira la imagen).}
{\( 75^{\circ} \)}{\( 60^{\circ} \)}{\( 45^{\circ} \)}{\( 80^{\circ} \)}{}{}}
\End
...
\LANGen{
\Question{
Points \( A \) and \( B \) divide the circle \( k \) into two arcs whose lengths are in the ratio \( 5:13 \). Point \( C \) is an interior point of a longer arc. What is the degree measure of the angle \( ACB \)?}
...
\LANGes{
\Question{
Los puntos \( A \) y \( B \) dividen a la circunferencia \( k \) en dos arcos cuyas longitudes están en proporción \( 5:13 \). El punto \( C \) es un punto interior de un arco más largo. Calcula la medida del ángulo \( ACB \).}
{\( 50^{\circ} \)}{\( 40^{\circ} \)}{\( 100^{\circ} \)}{\( 20^{\circ} \)}{}{}}
\End
...
\LANGen{
\Question{
A regular dodecagon \( ABCDEFGHIJKL \) is inscribed in the circle. Find the measures of all interior angles of the quadrilateral \( ABHJ \). (See the picture.)}
...
\LANGen{
\Question{
A regular nonagon \( ABCDEFGHI \) is inscribed in the circle. Calculate the measures of all interior angles of the quadrilateral \( ABEH \). (See the picture.)}
...
\LANGen{
\Question{
Which of the following  formulas expresses the area of a regular decagon inscribed in a circle of radius \( r \)?}
{\( 10r^2\sin18^{\circ}\cos18^{\circ} \)}{\( 10r^2\sin36^{\circ}\cos36^{\circ} \)}{\( 5r^2\sin36^{\circ} \)}{\( 5r^2\sin18^{\circ} \)}{}{}}
\LANGpl{
\Question{
Które z podanych wyrażeń określa obraz dziesięciokąta foremnego wpisanego w okrąg o promieniu \( r \)?}
{\( 10r^2\sin18^{\circ}\cos18^{\circ} \)}{\( 10r^2\sin36^{\circ}\cos36^{\circ} \)}{\( 5r^2\sin36^{\circ} \)}{\( 5r^2\sin18^{\circ} \)}{}{}}
\LANGcs{
\Question{
Která z uvedených rovnic vyjadřuje obsah pravidelného desetiúhelníku vepsaného do kružnice o poloměru \( r \)?}
{\( 10r^2\sin18^{\circ}\cos18^{\circ} \)}{\( 10r^2\sin36^{\circ}\cos36^{\circ} \)}{\( 5r^2\sin36^{\circ} \)}{\( 5r^2\sin18^{\circ} \)}{}{}}
\LANGsk{
\Question{
Ktorý z uvedených vzorcov vyjadruje obsah pravidelného desaťuholníka vpísaného do kružnice  s polomerom  \( r \)?}
{\( 10r^2\sin18^{\circ}\cos18^{\circ} \)}{\( 10r^2\sin36^{\circ}\cos36^{\circ} \)}{\( 5r^2\sin36^{\circ} \)}{\( 5r^2\sin18^{\circ} \)}{}{}}
\LANGes{
\Question{
¿Cuál de las siguientes fórmulas expresa el área de un decágono inscrito en una circunferencia con el radio \( r \)?}
{\( 10r^2\sin18^{\circ}\cos18^{\circ} \)}{\( 10r^2\sin36^{\circ}\cos36^{\circ} \)}{\( 5r^2\sin36^{\circ} \)}{\( 5r^2\sin18^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
Dado un círculo cuya área tiene el mismo valor numérico como su perímetro. Halla el diámetro del círculo y exprésalo en \( \mathrm{cm} \).}
{\( 4 \)}{\( 2 \)}{\( \sqrt2 \)}{\( \pi \)}{}{}}
\End
...
\LANGes{
\Question{
Un triángulo acutángulo \( ABC \) se inscribe en una circunferencia con el radio \( r=4\,\mathrm{cm} \). Calcula la medida del ángulo \( ACB \), suponiendo que el lado \( c \) mide \( 6\,\mathrm{cm} \). Redondea el resultado a dos decimales.}
{\( 48.59^{\circ} \)}{\( 97.18^{\circ} \)}{\( 24.30^{\circ} \)}{\( 41.41^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
Una circunferencia con el radio de \( 22\,\mathrm{cm} \) se inscribe en el rombo \( ABCD \). Calcula la medida del ángulo \( CAB \), suponiendo que el lado del rombo mide \( 90\,\mathrm{cm} \). Redondea el resultado a dos decimales.}
{\( 14.63^{\circ} \)}{\( 29.27^{\circ} \)}{\( 30.37^{\circ} \)}{\( 28.30^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
Los puntos \( A \), \( B \) y \( C \) pertenecen a la circunferencia \( k \). El segmento \( AC \) es el diámetro de la circunferencia y los segmentos \( AC \) y \( BC \) forman el ángulo de \( 60^{\circ} \). Calcula la longitud del \( AC \) si la longitud del \( BC \) es \( 10\,\mathrm{cm} \).}
{\( 20\,\mathrm{cm} \)}{\( 5\sqrt3\,\mathrm{cm} \)}{\( 5\,\mathrm{cm} \)}{\( 2\sqrt3\,\mathrm{cm} \)}{}{}}
\End
...
\LANGes{
\Question{
Dado una circunferencia, cuyo radio mide  \( 9\,\mathrm{cm} \), que se inscribe en un pentágono regular. ¿Cuánto mide su lado? Redondea el resultado a dos decimales.}
{\( 13.08\,\mathrm{cm} \)}{\( 55.39\,\mathrm{cm} \)}{\( 6.54\,\mathrm{cm} \)}{\( 10.58\,\mathrm{cm} \)}{}{}}
\End
...
\LANGes{
\Question{
Dadas dos circunferencias: la circunferencia \( k \) con el centro \( S_1 \) y el radio de \( 3\,\mathrm{cm} \), y la circunferencia \( n \) con el centro \( S_2 \) y el radio de \( 8\,\mathrm{cm} \). La distancia entre \( S_1 \) y \( S_2 \) es \( 22\,\mathrm{cm} \). Las tangentes comunes se cortan en el punto \( A \). Calcula la distancia desde el punto \( A \) hacia el centro \( S_1 \).}
{\( 6\,\mathrm{cm} \)}{\( 16\,\mathrm{cm} \)}{\( 11\,\mathrm{cm} \)}{\( 5\,\mathrm{cm} \)}{}{}}
\End
...
\LANGes{
\Question{
Deriva la fórmula para calcular el perímetro de un triángulo equilátero inscrito en una circunferencia con el radio \( r \).}
{\( 3\sqrt3 r \)}{\( \sqrt3 r \)}{\( 3 r \)}{\( \frac{3\sqrt3 r}2 \)}{}{}}
\End
...
\LANGes{
\Question{
Deriva la fórmula para calcular el perímetro de un triángulo equilátero circunscrito alrededor de una circunferencia con el radio \( r \).}
{\( 6\sqrt3 r \)}{\( 2\sqrt3 r \)}{\( \frac{2r}{\sqrt3} \)}{\( \frac{6r}{\sqrt3} \)}{}{}}
\End
...
\LANGes{
\Question{
La longitud de la diagonal más corta en un polígono regular es \( 8\,\mathrm{cm} \). El ángulo entre esta diagonal y el lado del polígono mide \( 20^{\circ} \). Calcula el radio de la circunferencia circunscrita a este polígono. Redondea el resultado a dos decimales.}
{\( 6.22\,\mathrm{cm} \)}{\( 5.22\,\mathrm{cm} \)}{\( 4.26\,\mathrm{cm} \)}{\( 11.69\,\mathrm{cm} \)}{}{}}
\End
...
\LANGes{
\Question{
Tres circunferencias iguales con el radio de \( 6\,\mathrm{cm} \) se tocan. Calcula el área de la superficie delimitada por las circunferencias. (Mira la imagen). Redondea el resultado a un decimal.}
{\( 5.8\,\mathrm{cm}^2 \)}{\( 62.3\,\mathrm{cm}^2 \)}{\( 6.2\,\mathrm{cm}^2 \)}{\( 8.4\,\mathrm{cm}^2 \)}{}{}}
\End
...
\LANGes{
\Question{
Dado un triángulo equilátero cuyo lado mide \( 10\,\mathrm{cm} \). En el triángulo se inscribe un sector circular cuyo centro es uno de los vértices del triángulo y el arco toca el lado opuesto (mira la imagen). Halla la razón del perímetro del sector circular al perímetro del triángulo. Redondea el resultado a un decimal.}
{\( 0.9 \)}{\( 0.5 \)}{\( 0.8 \)}{\( 1.5 \)}{}{}}
\End
...
\LANGes{
\Question{
Un sector circular con el ángulo central de \( 60^{\circ} \) tiene un área de \( 201\,\mathrm{cm}^2 \). Calcula el radio \( r \). Redondea el resultado a un decimal.}
{\( 19.6\,\mathrm{cm} \)}{\( 384.1\,\mathrm{cm} \)}{\( 22.5\,\mathrm{cm} \)}{\( 123.7\,\mathrm{cm} \)}{}{}}
\End
...
\LANGes{
\Question{
Necesitamos cercar una parcela que tiene forma de sector circular con el ángulo central de \( 60^{\circ} \). Hemos usado \( 10 \) metros de malla de alambre para la parte redonda. ¿Cuántos metros de malla de alambre aún tenemos que comprar? Redondea el resultado a los metros más cercanos.}
{\( 19\,\mathrm{m} \)}{\( 10\,\mathrm{m} \)}{\( 15\,\mathrm{m} \)}{\( 25\,\mathrm{m} \)}{}{}}
\End
...
\LANGes{
\Question{
Un macizo de flores tiene forma de sector circular, cuyo radio mide \( 3\,\mathrm{m} \), con el ángulo central de \( 75^{\circ} \). Calcula el área del macizo de flores. Redondea el resultado a dos decimales.}
{\( 5.89\,\mathrm{m}^2 \)}{\( 1.96\,\mathrm{m}^2 \)}{\( 11.78\,\mathrm{m}^2 \)}{\( 9.34\,\mathrm{m}^2 \)}{}{}}
\End
...
\LANGes{
\Question{
La punta de un minutero está a una distancia de \( 15\,\mathrm{mm} \) desde el centro del reloj. Calcula la longitud del camino que recorre la punta durante \( 42 \) minutos. Redondea el resultado a dos decimales.}
{\( 65.97\,\mathrm{mm} \)}{\( 94.20\,\mathrm{mm} \)}{\( 35.27\,\mathrm{mm} \)}{\( 72.12\,\mathrm{mm} \)}{}{}}
\End
...
\LANGes{
\Question{
Dado una circunferencia cuya cuerda \( AB \) mide \( 16\,\mathrm{cm} \) y la altura \( v \) del sector circular correspondiente mide \( 5\,\mathrm{cm} \) (mira la imagen). Calcula el área del sector circular. Redondea el resultado a dos decimales.}
{\( 57.29\,\mathrm{cm}^2 \)}{\( 55.12\,\mathrm{cm}^2 \)}{\( 47.12\,\mathrm{cm}^2 \)}{\( 63.12\,\mathrm{cm}^2 \)}{}{}}
\End
...
\LANGes{
\Question{
Un agricultor tiene un jardín vallado en forma de rombo cuyo lado mide \( 4\,\mathrm{m} \). En una esquina, donde el ángulo entre los lados mide \( 60^{\circ} \), el agricultor ató a una cabra (mira la imagen). ¿Cuánto tiene que medir la cuerda para que la cabra pueda pastar exactamente la mitad del área del jardín? Redondea el resultado a un decimal.}
{\( 3.6\,\mathrm{m} \)}{\( 3.2\,\mathrm{m} \)}{\( 4.1\,\mathrm{m} \)}{\( 2.9\,\mathrm{m} \)}{}{}}
\End
...
\LANGes{
\Question{
La cuerda en una circunferencia, cuyo radio es \(30\, \mathrm{cm}\), 
...
\LANGes{
\Question{
Una circunferencia está circunscrita al octógono regular. El perímetro del octógono mide
...
\LANGes{
\Question{
El agricultor ató a dos cabras en un prado. La distancia entre las estacas \( K_1 \), \( K_2 \) es \( 5\,\mathrm{m} \) y las cuerdas miden \( 3\,\mathrm{m} \) y \( 4\,\mathrm{m} \). Calcula el área del pasto que es común para ambas cabras. Redondea el resultado a dos decimales.}
{\( 6.64\,\mathrm{m}^2 \)}{\( 0.57\,\mathrm{m}^2 \)}{\( 0.35\,\mathrm{m}^2 \)}{\( 1.52\,\mathrm{m}^2 \)}{}{}}
\End
...
\LANGes{
\Question{
Dado el triángulo isósceles \( ABC \), \( |AB| = 8\,\mathrm{cm} \), \( |BC|=|AC| = 6\,\mathrm{cm} \). En el triángulo se inscribe un círculo. Calcula, qué porcentaje del área del triángulo lo forma el círculo inscrito. Redondea el resultado a un porcentaje determinado.}
{\( 56\,\% \)}{\( 48\,\% \)}{\( 62\,\% \)}{\( 64\,\% \)}{}{}}
\End
