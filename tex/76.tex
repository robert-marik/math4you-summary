...
\LANGes{
\Question{
Dada la sucesión \( \left( 2n \right)^{\infty}_{n=1} \). ¿Qué expresa esta fórmula?}
{Una secuencia de todos lo números naturales pares}{Una secuencia de todos los números naturales}{Una secuencia de todos lo números naturales impares}{Una secuencia de todos los números naturales que son divisibles por \( 5 \)}{}{}}
\End

\Data\ID{1003084902}
\Updated{2020-07-17 09:07:47}
\Level{A}
\SubArea{Introduction to sequences}
\LANGen{
\Question{
...
¿Qué expresa esta fórmula?}
{Una secuencia de todos los números naturales que después de dividirlos por \( 3 \) dan el resto \( 1 \)}{Una secuencia de todos los números naturales que son divisibles por \( 3 \)}{Una secuencia de todos los números naturales que son divisibles por \( 2 \)}{Una secuencia de todos lo números naturales impares}{}{}}
\End
...
Para el término \( a_{n-1}\ (n\in\mathbb{N}; n>1 ) \) de la sucesión vale:}
{\( a_{n-1} = \frac1{n-1} \)}{\( a_{n-1} = n-1 \)}{\( a_{n-1} = \frac1n \)}{\( a_{n-1} = \frac1{2n-1} \)}{}{}}
\End

\Data\ID{1003084906}
\Updated{2020-09-30 07:09:38}
\Level{A}
\SubArea{Introduction to sequences}
\LANGen{
\Question{
...
¿En qué proporción están los cuartos términos?}
{\( 4:1 \)}{\( 2:1 \)}{\( 3:1 \)}{\( 1:1 \)}{}{}}
\End
