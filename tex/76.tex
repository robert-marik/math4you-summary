...
\LANGcs{
\Question{
Posloupnost je dána \(n\)-tým člem \(3n^2-4n+1\). Součet dvou po sobě jdoucích členů je \(581\).  Určete větší z nich.}
{\(320\)}{\(11\)}{\(261\)}{\(10\)}{}{}}
\LANGsk{
\Question{
...
\LANGcs{
\Question{
Je dána posloupnost \( \left( a_n \right)^{5}_{n=1}\), která je definována nasledujícím grafem. Vzorec pro \(n\)-tý člen této posloupnosti je:}
{\( a_n = 3-2n,\ n \in\{1,\ \ 2,\ \ 3,\ \ 4,\ \ 5 \}\)}{\( a_n = 2n,\ n\in\{1,\ \ 2,\ \ 3,\ \ 4,\ \ 5 \}\)}{\( a_n = 1-2n,\ n\in\{1,\ \ 2,\ \ 3,\ \ 4,\ \ 5 \}\)}{\( a_n = 2n-3,\ n\in\{1,\ \ 2,\ \ 3,\ \ 4,\ \ 5 \}\)}{}{}}
\LANGsk{
\Question{
...
\LANGcs{
\Question{
Je dána posloupnost \( \left( a_n \right)^{5}_{n=1}\), která je definována následujícím grafem. Vzorec pro \(n\)-tý člen této posloupnosti je:}
{\( a_n = 2n-3,\ n \in\{1,\ \ 2,\ \ 3,\ \ 4,\ \ 5 \}\)}{\( a_n = 2n,\ n \in\{1,\ \ 2,\ \ 3,\ \ 4,\ \ 5 \}\)}{\( a_n = 3-2n,\ n \in\{1,\ \ 2,\ \ 3,\ \ 4,\ \ 5 \}\)}{\( a_n = 2n-1,\ n \in\{1,\ \ 2,\ \ 3,\ \ 4,\ \ 5 \}\)}{}{}}
\LANGsk{
\Question{
Je daná postupnosť \( \left( a_n \right)^{5}_{n=1}\), ktorá je definovaná nasledujúcim grafom. Vzorec pre \(n\)-tý člen tejto postupnosti je:}
...
\LANGcs{
\Question{
Která posloupnost určená rekurzivně není klesající?}
{\( a_{n+1} = \frac{1}{a_n}\), \( a_1=5\)}{\( a_{n+1} = \sqrt{a_n}\), \( a_1=16\)}{\( a_{n+1} = 0{,}5\cdot {a_n}\), \( a_1=12\)}{\( a_{n+1} = \frac{a_n}{n}\), \( a_1=24\)}{}{}}
\LANGsk{
\Question{
...
\LANGcs{
\Question{
Je dána rekurentně zadaná posloupnost \(2a_{n} = a_{n+1} - a_{n-1}\), 
kde \(a_{3} = 2\) 
a \(a_{4} = 5\).
Potom platí:}
...
\[\]
(Nápověda: Posloupnost je omezená zdola, pokud jsou všechny její členy větší nebo rovny reálnému číslu \(L\), které nazýváme dolní mez posloupnosti. Podobně, posloupnost je omezená shora, pokud jsou všechny její členy menší nebo rovny reálnému číslu \(U\), které nezýváme horní mez posloupnosti.)}
