...
\LANGes{
\Question{
Decide cuál de los siguientes intervalos contiene \( d \) si \( \left(0.1^{d-1}\right)^3=10^{d-1} \).}
{\( [-1;3] \)}{\( [9;13] \)}{\( [4;8] \)}{\( [-6;-2] \)}{}{}}
\End
...
¿Cuántas soluciones tiene la siguiente ecuación? 
\[ 2^x\cdot5^x=100^{3-x} \]}
{Única solución.}{No tiene solución.}{Número infinito de soluciones.}{Exactamente dos soluciones.}{}{}}
\End
...
\LANGes{
\Question{
La siguiente ecuación tiene las raíces \( x_1 \) y \( x_2 \). Halla la suma de \( x_1 \) y \( x_2 \).
\[ \frac{4^{x^2 }}{16^{x+1}} =16\cdot4^x \]}
{\( 3 \)}{\( -3 \)}{\( -1 \)}{\( 2 \)}{}{}}
\End
...
¿Cuántas soluciones tiene la siguiente ecuación? 
\[ 5^x+5^{x+1}+5^{x+2}+5^{x+3}=156 \]}
{Única solución.}{No hay solución.}{Número infinito de soluciones.}{Exactamente dos soluciones.}{}{}}
\End
...
\[ 2^{x+2}+3\cdot3^{x+2}=3^{x+3}+2\cdot2^{x+1} \]}
{Número infinito de soluciones.}{Única solución.}{No hay solución.}{Exactamente dos soluciones.}{}{}}
\End
...
¿Cuántas soluciones hay para la siguiente ecuación? 
\[ 81^x-8\cdot9^x=9 \]}
{Única solución.}{Exactamente dos soluciones.}{No hay solución.}{Número infinito de soluciones.}{}{}}
\End
...
¿Cuántas soluciones tiene la siguiente ecuación? 
\[ 7^{\sqrt x}+7^{1-\sqrt x}=8 \]}
{Exactamente dos soluciones.}{Única solución.}{No hay solución}{Número infinito de soluciones.}{}{}}
\End
...
\LANGes{
\Question{
Identifica la solución de la siguiente ecuación.
\[10\cdot25^x+10\cdot4^x=29\cdot10^x \]}
{\( x_1=-1;\ x_2=1 \)}{The equation has no solution.}{\( x_1=\frac25;\ x_2=\frac52 \)}{\( x_1=-\frac52;\ x_2=-\frac25 \)}{}{}}
\End
...
¿Cuántas soluciones tiene la siguiente ecuación? 
\[ 2^x\cdot3^{1-x}-2^{1-x}\cdot3^x=1 \]}
{Única solución,  \( x=0 \)}{Única solución, \( x=-1 \)}{Exactamente dos soluciones, \( x_1=-1\), \( x_2=0 \)}{Exactamente dos soluciones, \( x_1=-\frac23\), \( x_2=1 \)}{}{}}
\End
...
\LANGes{
\Question{
La siguiente ecuación tiene dos soluciones \( x_1 \)  y \( x_2 \). La solución \( x_1 \) es número primo. Halla la suma de \( 3x_1 \) y \( 2x_2 \).
\[ 3^{3-x}\cdot4^{x-1}+3^x\cdot4^{2-x}=21 \]}
{\( 8 \)}{\( 7 \)}{\( 0 \)}{\( 3 \)}{}{}}
\End
...
\LANGes{
\Question{
Identifica cuál de las siguientes ecuaciones exponenciales no tiene ni solución 
\(x = 2\) ni
\(x = -2\).}
{\(\sqrt{2^{x}}\cdot \sqrt{3^{x}} = 36\)}{\(0.25^{x} = 16\)}{\(6^{-x} = \frac{1} 
{36}\)}{\(25^{x} = \left (\frac{1}
...
{La ecuación tiene única solución \(x\in \mathbb{N}\).}{La ecuación tiene única solución. La solución es un número negativo.}{La ecuación no tiene solución.}{La ecuación tiene dos soluciones.}{Cero es la solución de esta ecuación.}{La ecuación tiene única solución \(x\in \mathbb{Z}^{-}\).}}
\End
...
\[ 5^x < 0 \]}
{No hay solución.}{Número infinito de soluciones.}{Única solución.}{Exactamente dos soluciones.}{}{}}
\End
...
\LANGes{
\Question{
¿Cuántas soluciones de esta inecuación hay en el conjunto de números naturales? 
\[ \left(\frac34\right)^{x+1}\leq\left(\frac43\right)^{3-2x} \]}
{\( 4 \)}{\( 5 \)}{\( 1 \)}{\( 0 \)}{}{}}
\End
...
\[ 16^x-3\cdot4^x-4\leq0 \]}
{Única solución.}{Número infinito de soluciones.}{Exactamente dos soluciones.}{No hay soluciones.}{}{}}
\End
...
¿Cuántas soluciones tiene la siguiente inecuación? 
\[ 2^{x-1}-2^{x-3}-2^{x-4} \geq 2^{-4}-2^{-3}-2^{-2} \]}
{Número infinito de soluciones.}{No hay solución.}{Única solución.}{Exactamente dos soluciones.}{}{}}
\End
