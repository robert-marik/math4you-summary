...
\LANGes{
\Question{
Determina el conjugado de un complejo del siguiente número complejo.
\[z= \frac{2-\mathrm{i}}{2+\mathrm{i}}-\frac{2+\mathrm{i}}{2-\mathrm{i}} \]}
{\( \frac85\mathrm{i} \)}{\( -\frac85\mathrm{i} \)}{\( \frac83\mathrm{i} \)}{\( -\frac83\mathrm{i} \)}{}{}}
\End
...
\LANGes{
\Question{
El diagrama muestra en rojo todos los números complejos  \( z \) suponiendo que:}
{\( |z + \mathrm{i}| \geq 2 \)}{\( |z - \mathrm{i}| \geq 2 \)}{\( |z + 1| \geq 2 \)}{\( |z - 1| \geq 2 \)}{}{}}
\End
...
\LANGes{
\Question{
Determina el conjugado de un complejo \(z = \mathrm{i}^{5} - 3\mathrm{i}^{10}\).}
{\(3 -\mathrm{i}\)}{\(- 3 -\mathrm{i}\)}{\(- 3 + \mathrm{i}\)}{\(3 + \mathrm{i}\)}{}{}}
\End

\Data\ID{9000031206}
\Updated{2020-07-18 09:07:50}
\Level{A}
\SubArea{Complex numbers in algebraic and trigonometric form}
\LANGen{
\Question{
...
\LANGes{
\Question{
Determina el opuesto de un número complejo
\(z = \frac{1+\mathrm{i}} 
{1-\mathrm{i}}\).}
{\(-\mathrm{i}\)}{\(1\)}{\(- 1\)}{\(\mathrm{i}\)}{}{}}
\End
...
\LANGes{
\Question{
Calcula el valor absoluto del númer complejo \(z = 3 -\mathrm{i}\).}
{\(\sqrt{10}\)}{\(2\)}{\(2\sqrt{2}\)}{\(\sqrt{2}\)}{}{}}
\End
...
\LANGes{
\Question{
Determina el conjugado de un complejo \(z=\frac{3+\mathrm{i}}
{2-\mathrm{i}} + (\mathrm{i} + 1)(2 + \mathrm{i})\).}
{\(2 - 4\mathrm{i}\)}{\(2 + 4\mathrm{i}\)}{\(- 2 - 4\mathrm{i}\)}{\(- 2 + 4\mathrm{i}\)}{}{}}
\End
...
\LANGes{
\Question{
Sean \( [x;y]\in\mathbb{R}\times\mathbb{R} \), \( z_1   = 5 + xy\,\mathrm{i} \)  y \( z_2  = x + y - 4\,\mathrm{i} \). Calcula todos \( [x;y] \) suponiendo que \( z_1 \) y \( z_2 \) son conjugados de un complejo.}
{\( [x;y] \in\left\{[4;1],[1;4]\right\} \)}{\( [x;y]\in\left\{[6;1],[9;4]\right\} \)}{\( [x;y]\in\left\{[4;9],[1;6]\right\} \)}{\([x;y]\in\left\{[-4;9],[-1;6]\right\} \)}{\(  [x;y]\in\left\{[6;-1],[9;-4]\right\}  \)}{}}
\End

\Data\ID{1003082401}
\Updated{2020-07-18 08:07:35}
\Level{B}
\SubArea{Complex numbers in algebraic and trigonometric form}
\LANGen{
\Question{
...
\LANGes{
\Question{
Determina el argumento de un número complejo \(\sqrt2\left(\cos160^{\circ}+\mathrm{i}\cdot\sin160^{\circ}\right) \).}
{\( 160^{\circ} \)}{\( 200^{\circ} \)}{\( \sqrt{2}  \)}{\( 340^{\circ} \)}{}{}}
\End
...
\LANGes{
\Question{
Determina el argumento de un número complejo  \( 4\left(\cos\frac{\pi}3+\mathrm{i}\cdot\sin\frac{\pi}3\right) \).}
{\( \frac{\pi}3  \)}{\( \frac{4\pi}3 \)}{\( 4 \)}{\( \frac{5\pi}3 \)}{}{}}
\End

\Data\ID{1003082403}
\Updated{2020-07-18 08:07:25}
\Level{B}
\SubArea{Complex numbers in algebraic and trigonometric form}
\LANGen{
\Question{
...
\LANGes{
\Question{
Determina el argumento de un número complejo  \( 2\left(\cos60^{\circ}-\mathrm{i}\cdot\sin60^{\circ}\right) \).}
{\( 300^{\circ} \)}{\( 60^{\circ} \)}{\( 120^{\circ} \)}{\(  240^{\circ} \)}{}{}}
\End

\Data\ID{1003082404}
\Updated{2020-07-18 08:07:37}
\Level{B}
\SubArea{Complex numbers in algebraic and trigonometric form}
\LANGen{
\Question{
...
\LANGes{
\Question{
Determina el argumento de un número complejo  \(4\left(\cos\frac{\pi}6-\mathrm{i}\cdot\sin\frac{\pi}6\right) \).}
{\( \frac{11\pi}6 \)}{\( \frac{\pi}6 \)}{\(  \frac{5\pi}6 \)}{\( \frac{7\pi}6 \)}{}{}}
\End
...
y \(z_{2} = \sqrt{3}\left (\cos \frac{4\pi }
{3} + \mathrm{i}\sin \frac{4\pi }
{3}\right )\), determina el ángulo en la forma polar del producto \(z_{1}z_{2}\).}
{\(\frac{3\pi }
{2}\)}{\(\frac{2}
{9}\pi \)}{\(\frac{5}
{9}\pi \)}{\(3\pi \)}{}{}}
...
\LANGes{
\Question{
Sea \( [x;y]\in\mathbb{R}\times\mathbb{R} \). Calcula todos \( [x;y] \) suponiendo que
\[ (3x + 2y\,\mathrm{i})\cdot(3x - 2y\,\mathrm{i}) + y^2\,\mathrm{i} = 97 + 4\,\mathrm{i}. \]}
{\( [x;y]\in\left\{[3;2], [-3;2], [3;-2], [-3;-2]\right\} \)}{\( [x;y]\in\left\{[3;2], [-3;2]\right\} \)}{\(  [x;y]\in\left\{[3;2], [3;-2]\right\}\)}{\( [x;y]\in\left\{[3;2], [-3;-2]\right\} \)}{}{}}
\End

\Data\ID{1003082307}
\Updated{2020-07-18 08:07:12}
\Level{C}
\SubArea{Complex numbers in algebraic and trigonometric form}
\LANGen{
\Question{
