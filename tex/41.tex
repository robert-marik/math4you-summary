...
\Data\ID{9000018005}
\Updated{2020-11-09 07:11:01}
\Level{B}
\SubArea{Rational equations and inequalities}
\LANGen{
\Question{
Find all the positive real \(x\) 
which ensure that the fraction \(\frac{3}
{2-x}\) 
is positive.}
{\(x < 2\)}{\(x < -2\)}{\(x > -2\)}{\(x > 2\)}{}{}}
\LANGpl{
...
\Data\ID{9000026108}
\Updated{2020-08-22 12:08:20}
\Level{B}
\SubArea{Rational equations and inequalities}
\IMG{000261_08-figure0.pdf}
\LANGen{
\Question{
Identify an inequality which corresponds to the picture.}
{\(2\leq \frac{x+3}
 {x} \)}{\(2\geq \frac{3}
{x}\)}{\(2\geq \frac{x+3}
 {x} \)}{\(2\leq \frac{3}
...
\LANGes{
\Question{
Halla el conjunto de soluciones de la siguiente inecuación. \[ \frac{|3-5x|}{x(x-2)} \geq 0 \]}
{\( (-\infty;0)\cup(2;\infty) \)}{\( (-\infty;0)\cup\left(\frac35;2\right)\cup(2;\infty) \)}{\( (-\infty;0]\cup[2;\infty) \)}{\( (2;\infty) \)}{}{}}
\End
