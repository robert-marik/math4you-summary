...
\Data\ID{9000021706}
\Updated{2020-12-29 04:12:15}
\Level{A}
\SubArea{Equations and inequalities with parameters}
\LANGen{
\Question{
Find the values of the parameter \(k\) 
which ensure that the solution of the following equation is bigger than
\(10\).
\[ 
 3x - 18 = \frac{10x - 4k} 
 {2}
...
\Question{
Find the values of the parameter \(k\) 
which ensure that the solution of the following equation is positive. 
\[ 
 2kx + k = 4x + 3
\]}
...
\[ 
 x^{2} - 2dx + 2d^{2} - 9 = 0
\]
does not have solution in \(\mathbb{R}\).}
...
\[ 
 x^{2} + (t + 2)x + 1 = 0
\]
has two mutually different solutions.}
