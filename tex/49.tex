...
\((-1;\infty )\).}
{\(f\colon y = x^{3}\)}{\(f\colon y= x^{4}\)}{\(f\colon y= -x^{3}\)}{\(f\colon y = x^{-4}\)}{\(f\colon y =- x^{-2}\)}{\(f\colon y = -x^{-3}\)}}
\LANGpl{
\Question{
...
\LANGcs{
\Question{
Vyberte funkci, která je na intervalu  
\((-1;\infty )\) rostoucí.}
{\(f\colon y = x^{3}\)}{\(f\colon y= x^{4}\)}{\(f\colon y= -x^{3}\)}{\(f\colon y = x^{-4}\)}{\(f\colon y =- x^{-2}\)}{\(f\colon y = -x^{-3}\)}}
\LANGsk{
\Question{
...
\((-3;2 )\).}
{\(f \colon y = (x - 2)^{2}\)}{\(f \colon y = (x + 2)^{2}\)}{\(f \colon y = (x +3)^{2}\)}{\(f \colon y = x^{2}-2x\)}{\(f \colon y =-x^{2}+1\)}{\(f \colon y = x^{3}\)}}
\LANGpl{
\Question{
...
\([ - 2;2 ] \).}
{\(f \colon y = x^{2}-2\)}{\(f \colon y = x^{2}+4x\)}{\(f \colon y = -x^{3}\)}{\(f \colon y = (x - 2)^{2}\)}{\(f \colon y = (x +2)^{2}\)}{\(f \colon y = x^{3}-2\)}}
\LANGpl{
\Question{
...
{\(f \colon y =-x^{3}\)}{\(f \colon y = x^{4}\)}{\(f \colon y = -x^{4}\)}{\(f \colon y = x^{-3}\)}{\(f \colon y = -x^{2}\)}{}}
\LANGpl{
\Question{
...
{The function \( f \) is an injective (one-to-one) function.}{The function \( f \) is decreasing.}{The function \( f \) is odd.}{The function \( f \) has the minimum at \( x=-1 \).}{}{}}
\LANGpl{
\Question{
Wskaż prawdziwe stwierdzenie dotyczące funkcji \( f(x)=(x+1)^3-2 \).}
{Funkcja \( f \) jest różnowartościowa.}{Funkcja \( f \) maleje.}{Funkcja  \( f \) jest nieparzysta.}{Funkcja \( f \) ma minimum w punkcie  \( x=-1 \).}{}{}}
\LANGcs{
\Question{
Funkce \(f\) je dána předpisem  \( f(x)=(x+1)^3-2 \). Vyberte pravdivý výrok.}
{Funkce \( f \) je prostá.}{Funkce \( f \) je klesající.}{Funkce \( f \) je lichá.}{Funkce \( f \)  má v bodě  \( x=-1 \) minimum.}{}{}}
\LANGsk{
\Question{
Funkcia \(f\) je daná predpisom  \( f(x)=(x+1)^3-2 \). Vyberte pravdivý výrok.}
{Funkcia \( f \) je prostá.}{Funkcia \( f \) je klesajúca.}{Funkcia \( f \) je nepárna.}{Funkcia \( f \) má svoje minimum v bode \( x=-1 \).}{}{}}
\LANGes{
\Question{
Determina la proposición lógica verdadera sobre la función \( f(x)=(x+1)^3-2 \).}
{La función \( f \) es una función inyectiva (uno a uno).}{La función \( f \) es decreciente}{La función \( f \) es impar.}{La función \( f \) tiene el mínimo en \( x=-1 \).}{}{}}
\End
...
{The function \( f \) is even.}{The function \( f \) has the minimum at \( x=2 \).}{The function \( f \) is bounded below.}{The range of the function \( f \) is the interval \( [ -3;\infty) \).}{}{}}
\LANGpl{
\Question{
Wskaż nieprawdziwe stwierdzenie dotyczące funkcji \( f(x)=(x-2)^4-3 \).}
{Funkcja \( f \) jest parzysta.}{Funkcja \( f \) ma minimum przy \( x=2 \).}{Funkcja \( f \) jest ograniczona z dołu.}{Zbiór wartości funkcji \( f \) to przedział \( \langle -3;\infty) \).}{}{}}
\LANGcs{
\Question{
Funkce  \( f \)  je dána předpisem  \( f(x)=(x-2)^4-3 \). Vyberte nepravdivý výrok.}
{Funkce  \( f \)  je sudá.}{Funkce  \( f \) má minimum v bodě  \( x=2 \).}{Funkce  \( f \)  je omezená zdola.}{Obor hodnot funkce  \( f \) je interval  \( \langle -3;\infty) \).}{}{}}
\LANGsk{
\Question{
Funkcia  \( f \)  je daná predpisom  \( f(x)=(x-2)^4-3 \). Vyberte nepravdivý výrok.}
{Funkcia \( f \) je párna.}{Funkcia \( f \) má svoje minimum v bode \( x=2 \).}{Funkcia \( f \) je zdola ohraničená.}{Obor hodnôt funkcie \( f \) je na intervale \( \langle -3;\infty) \).}{}{}}
\LANGes{
\Question{
Determina la proposición lógica falsa sobre la función \( f(x)=(x-2)^4-3 \).}
{La función \( f \) es par.}{La función \( f \) tiene el mínimo en \( x=2 \).}{La función \( f \) está limitada inferiormente.}{El rango de la función \( f \) es en el intervalo \( [ -3;\infty) \).}{}{}}
\End
...
Identify a function which is increasing on
\((-1;3)\).}
{\(f(x) = (x + 2)^{2}\)}{\(f(x) = x^{2} + x\)}{\(f(x) = x^{2} - x\)}{\(f(x) = (x - 2)^{2}\)}{\(f(x) = -x^{3}\)}{\(f(x) = x^{2} + 1\)}}
\LANGpl{
\Question{
Wybierz funkcję rosnącą w przedziale
\((-1;3)\).}
{\(f \colon y = (x + 2)^{2}\)}{\(f \colon y = x^{2} + x\)}{\(f \colon y = x^{2} - x\)}{\(f \colon y = (x - 2)^{2}\)}{\(f \colon y = -x^{3}\)}{\(f \colon y = x^{2} + 1\)}}
\LANGcs{
\Question{
...
\([ - 2;2] \).}
{\(f(x) = x^{3} - 2\)}{\(f(x) = x^{2} - 2\)}{\(f(x) = -x^{2} + 2\)}{\(f(x) = x^{-2} + 2\)}{\(f(x) = \frac{1} 
{x} - 2\)}{\(f(x) = x^{4}\)}}
\LANGpl{
\Question{
Która z funkcji poniżej jest prosta w przedziale
\([ - 2;2] \)?}
{\(f \colon y = x^{3} - 2\)}{\(f \colon y = x^{2} - 2\)}{\(f \colon y = -x^{2} + 2\)}{\(f \colon y = x^{-2} + 2\)}{\(f \colon y = \frac{1} 
{x} - 2\)}{\(f \colon y = x^{4}\)}}
\LANGcs{
\Question{
Vyberte funkci, která je v intervalu
...
\Level{B}
\SubArea{Power and Radical Functions}
\IMG{powerradical-figure8.pdf}
\LANGen{
\Question{
The graphs represent the parts of the functions \(f(x)= \sqrt{x}\), \(g(x)=\sqrt[4]{x}\) and \(h(x)=\sqrt[10]{x}\).  Choose the legend which assigns the correct color of the graph to each of the given functions.}
{\(f\) — red, \(g\) — green, \(h\) — blue}{\(f\) — blue, \(g\) — green, \(h\) — red}{\(f\) — green, \(g\) — red, \(h\) — blue}{\(f\) — green, \(g\) — blue, \(h\) — red}{}{}}
\LANGpl{
\Question{
...
{\(f\) — czerwony, \(g\) — zielony, \(h\) — niebieski}{\(f\) — niebieski, \(g\) — zielony, \(h\) — czerwony}{\(f\) — zielony, \(g\) — czerwony, \(h\) — niebieski}{\(f\) — zielony, \(g\) — niebieski, \(h\) — czerwony}{}{}}
\LANGcs{
\Question{
...
{\(f\) — červená, \(g\) — zelená, \(h\) — modrá}{\(f\) — modrá, \(g\) — zelená, \(h\) — červená}{\(f\) — zelená, \(g\) — červená, \(h\) — modrá}{\(f\) — zelená, \(g\) — modrá, \(h\) — červená}{}{}}
\LANGsk{
\Question{
Na obrázku sú časti grafov troch funkcií, ktoré sú dané predpismi \(f(x)= \sqrt{x}\), \(g(x)=\sqrt[4]{x}\) a \(h(x)=\sqrt[10]{x}\).  Vyberte odpoveď, v ktorej sú grafom funkcií priradené správne farby.}
{\(f\) — červená, \(g\) — zelená, \(h\) — modrá}{\(f\) — modrá, \(g\) — zelená, \(h\) — červená}{\(f\) — zelená, \(g\) — červená, \(h\) — modrá}{\(f\) — zelená, \(g\) — modrá, \(h\) — červená}{}{}}
\LANGes{
\Question{
Las gráficas representan las partes de las funciones \(f(x)= \sqrt{x}\), \(g(x)=\sqrt[4]{x}\) y \(h(x)=\sqrt[10]{x}\).  Elige la leyenda que asigna el color correcto de la gráfica a cada una de las funciones dadas.}
{\(f\) — rojo, \(g\) — verde, \(h\) — azul}{\(f\) — azul, \(g\) — verde, \(h\) — rojo}{\(f\) — verde, \(g\) — rojo \(h\) — azul}{\(f\) — verde, \(g\) — azul. \(h\) — rojo}{}{}}
\End

\Data\ID{2000001704}
\Updated{2021-12-05 12:12:10}
\Level{B}
\SubArea{Power and Radical Functions}
\IMG{powerradical-figure9.pdf}
\LANGen{
\Question{
The graphs represent the parts of the functions \(f(x)= \sqrt[3]{x}\), \(g(x)=\sqrt[5]{x}\) and \(h(x)=\sqrt[9]{x}\).  Choose the legend which assigns the correct color of the graph to each of the given functions.}
{\(f\) — red, \(g\) — green, \(h\) — blue}{\(f\) — blue, \(g\) — green, \(h\) — red}{\(f\) — green, \(g\) — red, \(h\) — blue}{\(f\) — green, \(g\) — blue, \(h\) — red}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Na obrázku sú časti grafov troch funkcií, ktoré sú dané predpismi \(f(x)= \sqrt[3]{x}\), \(g(x)=\sqrt[5]{x}\) a \(h(x)=\sqrt[9]{x}\).  Vyberte odpoveď, v ktorej sú grafom funkcií priradené správne farby.}
{\(f\) — červená, \(g\) — zelená, \(h\) — modrá}{\(f\) — modrá, \(g\) — zelená, \(h\) — červená}{\(f\) — zelená, \(g\) — červená, \(h\) — modrá}{\(f\) — zelená, \(g\) — modrá, \(h\) — červená}{}{}}
\LANGes{
\Question{
Las gráficas representan partes de las funciones \(f(x)= \sqrt[3]{x}\), \(g(x)=\sqrt[5]{x}\) y \(h(x)=\sqrt[9]{x}\).  Elige la leyenda que asigna el color correcto de la gráfica a cada una de las funciones dadas.}
{\(f\) — rojo, \(g\) — verde, \(h\) — azul}{\(f\) — azul, \(g\) — verde, \(h\) — rojo}{\(f\) — verde, \(g\) — rojo, \(h\) — azul}{\(f\) — verde, \(g\) — azul, \(h\) — rojo}{}{}}
\End
...
{\(f(x)= \sqrt{ \frac{5}
{9x-3}}\)}{\(f(x)= \sqrt{ \frac{9x-3}
{5}}\)}{\(f(x)= \sqrt{9x-3}\)}{\(f(x)= \sqrt{ \frac{9x-3}
{3x}}\)}{}{}}
\LANGpl{
\Question{
...
\IMGanswer{powerradical-figure0_0.pdf}
\IMGanswer{powerradical-figure1_3.pdf}
\IMGanswer{powerradical-figure2_1.pdf}
\IMGanswer{powerradical-figure3.pdf}\End
...
\LANGen{
\Question{
Identify which of the graphs represents a part of the function \(f(x) = \sqrt[3]{x} \).}
{}{}{}{}{}{}}
\LANGpl{
\Question{
...
\LANGsk{
\Question{
Na ktorom obrázku je časť grafu funkcie  \(f(x) = \sqrt[3]{x} \).}
{}{}{}{}{}{}}
\LANGes{
\Question{
Identifica cuál de las gráficas representa una parte de la función \(f(x) = \sqrt[3]{x} \).}
{}{}{}{}{}{}}

\IMGanswer{powerradical-figure4.pdf}
\IMGanswer{powerradical-figure5_1.pdf}
\IMGanswer{powerradical-figure6_1.pdf}
\IMGanswer{powerradical-figure7_0.pdf}\End
...
\IMGanswer{2010014801-figure0.pdf}
\IMGanswer{2010014801-figure1.pdf}
\IMGanswer{2010014801-figure2.pdf}
\IMGanswer{2010014801-figure3.pdf}\End
...
{The function \( f \) has the minima at \( x=-1 \) and \( x=1 \).}{The function \( f \) has no minimum.}{The function \( f \) has the minimum at \( x=0 \).}{The function \( f \) has the minima at \( x=-1 \), \(x=0\) and \( x=1 \).}{}{}}
\LANGpl{
\Question{
Funkcja  \( f \)  wyrażona jest wzorem \( f(x)=\left|x^4-1\right| \). Wybierz prawdziwe stwierdzenie.}
{Funkcja \( f \) ma minimum w punktach \( x=-1 \) i \( x=1 \).}{Funkcja \( f \) nie ma minimum.}{Funkcja \( f \) ma minimum w punkcie \( x=0 \).}{Funkcja \( f \) ma minimum w punktach \( x=-1 \), \(x=0\) i \( x=1 \).}{}{}}
\LANGcs{
\Question{
Funkce \(f\) je dána předpisem  \( f(x)=\left|x^4-1\right| \). Vyberte pravdivý výrok.}
{Funkce \( f \) má minima v bodech  \( x=-1 \) a \( x=1 \).}{Funkce \( f \) nemá minimum.}{Funkce  \( f \) má minimum v bodě \( x=0 \).}{Funkce  \( f \) má minima v bodech  \( x=-1 \), \(x=0\) a \( x=1 \).}{}{}}
\LANGsk{
\Question{
Funkcia \(f\) je daná predpisom  \( f(x)=\left|x^4-1\right| \). Vyberte pravdivý výrok.}
{Funkcia \( f \) má minimum v bode \( x=-1 \) a \( x=1 \).}{Funkcia \( f \) nemá minimum.}{Funkcia \( f \) má minimum v bode \( x=0 \).}{Funkcia \( f \) má minimum v bode \( x=-1 \), \(x=0\) a \( x=1 \).}{}{}}
\LANGes{
\Question{
Determina la proposición lógica verdadera sobre la función \( f(x)=\left|x^4-1\right| \).}
{La función \( f \) tiene mínimos en \( x=-1 \) y \( x=1 \).}{La función \( f \) no tiene mínimo.}{La función \( f \) tiene el mínimo en \( x=0 \).}{La función \( f \) tiene mínimos en \( x=-1 \), \(x=0\) y \( x=1 \).}{}{}}
\End
...
{\( S=2u^2;\ u\in(0;\infty) \)}{\( S=6u^2;\ u\in(0;\infty) \)}{\( S=3u^2;\ u\in(0;\infty) \)}{\( S=18u^2;\ u\in(0;\infty) \)}{}{}}
\LANGpl{
\Question{
...
\IMGanswer{2010014801-figure4.pdf}
\IMGanswer{2010014801-figure5_0.pdf}
\IMGanswer{2010014801-figure6.pdf}
\IMGanswer{2010014801-figure7.pdf}\End
