...
\LANGes{
\Question{
Los gráficos representan las partes de las funciones \( f(x)=x^3 \)  y \( g(x)=x^4 \). Identifica cuál de las siguientes proposiciones lógicas es  falsa.}
{\( \left(-\frac12\right)^3 > (2)^3 \)}{\( 	(-2)^3 < \left(-\frac12\right)^3 \)}{\( \left(\frac13\right)^3 \geq (0.3)^3 \)}{\( 	(-1)^3 \leq (1)^3 \)}{}{}}
\End
...
\LANGes{
\Question{
Los gráficos representan las partes de las funciones \( f(x)=x^3 \) y \( g(x)=x^4 \). Identifica cuál de las siguientes proposiciones lógicas es verdadera.}
{\( (-3)^4 > (2)^4 \)}{\( (-2)^4 < \left(-\frac12\right)^4 \)}{\( \left(-\frac14\right)^4 \geq (0.3)^4 \)}{\( (-1)^4 < (1)^4 \)}{}{}}
\End
...
\LANGes{
\Question{
Los gráficos representan las partes de las funciones \( f(x)=x^3 ;\ g(x)=x^4;\ h(x)=x^5 \). Identifica cuál de las siguientes proposiciones lógicas es falsa.}
{\( \left(-\frac13\right)^5 < \left(-\frac13\right)^3 \)}{\( \left(\frac12\right)^5 < \left(-\frac12\right)^4 \)}{\( (-3)^4 > (3)^3 \)}{\( \left(\frac14\right)^3 \geq (-0.25)^4 \)}{}{}}
\End
...
\LANGes{
\Question{
Los gráficos representan las partes de las funciones  \( f(x)=x^3 \) y \( g(x)=x^5 \). Identifica cuál de las siguientes desigualdades tiene el conjunto de soluciones \( (-1;0)\cup(1;\infty) \).}
{\( x^3 < x^5 \)}{\( x^5 \geq x^3 \)}{\( x^3 > x^5 \)}{\( x^3 > -1 \)}{}{}}
\End
...
\LANGes{
\Question{
Los gráficos representan las partes de las funciones \( f(x)=x^4 \)  y \( g(x)=x^6 \). Identifica cuál de las siguientes proposiciones lógicas es verdadera.}
...
\LANGes{
\Question{
Las gráficas representan las partes de las funciones \( f(x)=x^{-2} \)  y \( g(x)=x^{-4} \). Identifica cuál de las siguientes desigualdades tiene el conjunto de soluciones  \( (-\infty; -1]\cup[1;\infty) \).}
{\( x^{-4} \leq x^{-2} \)}{\( x^{-2} \leq x^{-4} \)}{\( x^{-2} > x^{-4} \)}{\( x^{-2} < 1 \)}{}{}}
\End
...
\LANGes{
\Question{
Identifica una función que está disminuyendo en
\((-\infty ;1)\).}
{\(f(x) = -x^{3}\)}{\(f(x) = -x^{2}\)}{\(f(x) = x^{3}\)}{\(f(x) = -x^{4}\)}{\(f(x)= x^{-2}\)}{\(f(x) = x^{2}\)}}
\End
...
\LANGes{
\Question{
Identifica una función que está aumentando en
\((-1;3)\).}
{\(y = (x + 2)^{2}\)}{\(y = x^{2} + x\)}{\(y = x^{2} - x\)}{\(y = (x - 2)^{2}\)}{\(y = -x^{3}\)}{\(y = x^{2} + 1\)}}
\End
...
\LANGes{
\Question{
Identifica una función que sea uno a uno en el intervalo
\([ - 2;2] \).}
{\(y = x^{3} - 2\)}{\(y = x^{2} - 2\)}{\(y = -x^{2} + 2\)}{\(y = x^{-2} + 2\)}{\(y = \frac{1} 
{x} - 2\)}{\(y = x^{4}\)}}
\End
...
\LANGes{
\Question{
En la siguiente lista, identifica una función con un dominio
\(\left (-\infty ; \frac{1} 
{2}\right )\).}
{\(f(x)= \sqrt{ \frac{10}
{2-4x}}\)}{\(f(x)= \sqrt{\frac{2-4x}
...
\LANGen{
\Question{
Choose the function that describes the dependence of a cube volume \( V \) on the length \( u \) of its space diagonal.}
...
\LANGes{
\Question{
Elige la función que describe la dependencia de un volumen del cubo  \( V \) en la longitud  \( u \) de su diagonal espacial.}
{\( V=\frac{\sqrt3\cdot u^3}9;\ u\in(0;\infty) \)}{\( V=u^3;\ u\in(0;\infty) \)}{\( V=\frac{u^3}3;\ u\in(0;\infty) \)}{\( V=27u^3;\ u\in(0;\infty) \)}{}{}}
\End
