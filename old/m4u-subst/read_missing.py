...
with open("diff.txt", 'rb') as diff:
    content = diff.readlines()
...
database_missing=[]
filenames=set()
with open("old/csv/all_text.csv", 'rb') as csvfile:
    spamreader = csv.DictReader(csvfile, delimiter=',', quotechar='"')
    for row in spamreader:
        if row['project_id']  in content:
            print row['project_id']
            #print row['question_en']
            #print row['question_image']
            #print row['project_id'] 
            database.append(row)
            id=id+1
...
output="nid, project_id, level, subarea, fix, title_en, question_en, answer_1_en, answer_2_en, answer_3_en, answer_4_en, answer_5_en, answer_6_en, title_cs, question_cs, answer_1_cs, answer_2_cs, answer_3_cs, answer_4_cs, answer_5_cs, answer_6_cs, title_pl, question_pl, answer_1_pl, answer_2_pl, answer_3_pl, answer_4_pl, answer_5_pl, answer_6_pl, title_sk, question_sk, answer_1_sk, answer_2_sk, answer_3_sk, answer_4_sk, answer_5_sk, answer_6_sk\n"
        

for i in database:
    outtputstring=""
    for j in ("nid","project_id","level","subarea","fixed_answer","title_en","question_en","answer_1_en","answer_2_en","answer_3_en","answer_4_en","answer_5_en","answer_6_en","title_cs","question_cs","answer_1_cs","answer_2_cs","answer_3_cs","answer_4_cs","answer_5_cs","answer_6_cs","title_pl","question_pl","answer_1_pl","answer_2_pl","answer_3_pl","answer_4_pl","answer_5_pl","answer_6_pl","title_sk","question_sk","answer_1_sk","answer_2_sk","answer_3_sk","answer_4_sk","answer_5_sk","answer_6_sk"):
        outtputstring=outtputstring+i[j]+","
    outtputstring= outtputstring[:-1]
    output=output+outputstring+"\n"

with open("import.csv", 'a') as the_file:
...
with open("old/csv/problem_img.csv", 'rb') as csvfile:
    spamreader = csv.DictReader(csvfile, delimiter=',', quotechar='"')
    for row in spamreader:
