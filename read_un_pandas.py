...
subareaToName("35","Expressions with powers and radicals")
...
subareaToName("48","Linear functions with absolute values")
...
subareaToName("61","Positional properties")
subareaToName("62","Metric properties")
subareaToName("63","Volume and surface of solids")
subareaToName("64","Geometric mappings")
subareaToName("65","Points and vectors")
subareaToName("66","Analytic plane geometry")
subareaToName("67","Analytic space geometry")
subareaToName("68","Conics")
subareaToName("69","Complex numbers in algebraic and polar form")
subareaToName("70","Powers and roots of complex numbers")
...
subareaToName("87","Percent problems and financial mathematics")
...
subareaToName("146","Positional problems")
